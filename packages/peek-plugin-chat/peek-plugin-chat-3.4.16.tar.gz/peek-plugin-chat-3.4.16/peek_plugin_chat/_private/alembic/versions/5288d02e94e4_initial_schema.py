...
def upgrade():
    ...
    op.create_index(
        "idx_Chat_usersKey", "ChatTuple", ["usersKey"], unique=True, schema="pl_chat"
    )
    op.create_table(
        "Setting",
        sa.Column("id", sa.Integer(), nullable=False),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        "idx_ChatPayloads", table_name="MessageReadPayloadTuple", schema="pl_chat"
    )
    op.drop_table("MessageReadPayloadTuple", schema="pl_chat")
    op.drop_index(
        "idx_SettingProperty_settingId", table_name="SettingProperty", schema="pl_chat"
    )
