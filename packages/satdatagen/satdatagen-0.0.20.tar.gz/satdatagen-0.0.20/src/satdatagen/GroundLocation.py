...
class GroundLocation:
	...
	def generate_dataset(self, method = 'krag', debug = False, limit = None, orbit = 'all', mixing_coeff = 0.8, output_file = None):
		'''
		...
		'''
		return hel._generate_dataset(self.credentials, self.el, self.time_range.times, limit = 500)
