...
class CustomInstallCommand(install):
    ISAAC_SIM_PACKAGES = [
        ...
        "isaacsim_kernel-4.1.0.0", "isaacsim_app-4.1.0.0", "isaacsim_core-4.1.0.0",
        "isaacsim_gui-4.1.0.0", "isaacsim_utils-4.1.0.0", "isaacsim_storage-4.1.0.0",
        "isaacsim_asset-4.1.0.0", "isaacsim_sensor-4.1.0.0", "isaacsim_robot_motion-4.1.0.0",
        "isaacsim_robot-4.1.0.0", "isaacsim_benchmark-4.1.0.0", "isaacsim_code_editor-4.1.0.0",
        "isaacsim_ros1-4.1.0.0", "isaacsim_cortex-4.1.0.0", "isaacsim_example-4.1.0.0",
        "isaacsim_replicator-4.1.0.0", "isaacsim_rl-4.1.0.0", "isaacsim_robot_setup-4.1.0.0",
        "isaacsim_ros2-4.1.0.0", "isaacsim_template-4.1.0.0", "isaacsim_test-4.1.0.0",
        "isaacsim-4.1.0.0", "isaacsim_extscache_physics-4.1.0.0", "isaacsim_extscache_kit-4.1.0.0",
