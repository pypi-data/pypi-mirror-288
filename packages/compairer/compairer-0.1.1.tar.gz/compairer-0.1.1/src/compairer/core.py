...
class ComparisonResult:
    ...
    def todict(self): return {"method": self.method, "scores": self.scores, "targets": self.targets, "normalized": self.normalize().scores, "top": self.top(3), "stats": self.stats(), "confint": self.confint(), "explanation": self.explain()}
