...
class ComparisonResult:
    ...
    def todict(self): return {"method": self.method, "scores": self.scores, "targets": self.targets, "normalized": self.normalize().scores, "top": self.top(3), "stats": self.stats(), "confInt": self.confInt(), "isMatch":self.isMatch(), "aboveThreshold":self.aboveThreshold(0.8), "explanation": self.explain()}
