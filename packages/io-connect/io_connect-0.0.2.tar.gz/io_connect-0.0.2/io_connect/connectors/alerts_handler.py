...
class AlertsHandler:
    ...
    This class provides methods to send alerts via email and Microsoft Teams using the specified domain.

    Attributes:
        domain (str): The domain name used for constructing URLs for email and Microsoft Teams endpoints.
    ...
    Example:
        To handle alerts for a domain '203.0.113.0':
        >>> alerts_handler = AlertsHandler(domain='203.0.113.0')
    ...
    def __init__(self, domain: str):
        """
        Initializes an instance of AlertsHandler with the specified domain.

        Args:
            domain (str): The domain name used for constructing URLs for email and Microsoft Teams endpoints.

        Attributes:
            domain (str): The domain where the messenger service is hosted.
            __mail_url (str): The URL for sending mail messages.
            __teams_url (str): The URL for sending Teams alerts.

        """
        self.domain = domain
        self.__mail_url = c.MAIL_URL.format(domain=domain)
        self.__teams_url = c.TEAMS_URL.format(domain=domain)
