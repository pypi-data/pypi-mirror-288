...
from osagent.agents.accessibility_tree_wrap.heuristic_retrieve import filter_nodes, draw_bounding_boxes
from osagent.agents.prompts import SYS_PROMPT_IN_SCREENSHOT_OUT_CODE, SYS_PROMPT_IN_SCREENSHOT_OUT_ACTION, \
...
state_ns_macos = "https://accessibility.macos.example.org/ns/state"
component_ns_macos = "https://accessibility.macos.example.org/ns/component"
attributes_ns_macos = "https://accessibility.macos.example.org/ns/attributes"
value_ns_macos = "https://accessibility.macos.example.org/ns/value"
role_ns_macos = "https://accessibility.macos.example.org/ns/role"
...
def linearize_accessibility_tree(accessibility_tree, platform="ubuntu"):
    if platform == "ubuntu":
        ...
        _class_ns = class_ns_windows
        _state_ns = state_ns_windows
        _component_ns = component_ns_windows
        _value_ns = value_ns_windows
    elif platform == "macos":
        _attributes_ns = attributes_ns_macos
        _state_ns = state_ns_macos
        _component_ns = component_ns_macos
        _value_ns = value_ns_macos
        _role_ns = role_ns_macos
    else:
        raise ValueError("Invalid platform, must be 'ubuntu' or 'windows' or 'macos'")
    ...
    for node in filtered_nodes:
        ...
        if platform == "ubuntu":
            _class = node.get("{{{:}}}class".format(_attributes_ns), "")
            _description = node.get("{{{:}}}description".format(_attributes_ns), "")
        elif platform == "windows":
            _class = node.get("{{{:}}}class".format(_class_ns), "")
            _description = node.get("{{{:}}}description".format(_attributes_ns), "")
        elif platform == "macos":
            _class = node.get("{{{:}}}AXRole".format(_role_ns), "")
            _description = node.get("{{:}}AXDescription".format(attributes_ns_macos), "")
