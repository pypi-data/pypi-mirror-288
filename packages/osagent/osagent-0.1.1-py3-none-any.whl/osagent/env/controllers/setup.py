...
from osagent.env.evaluators.metrics.utils import compare_urls
...
class SetupController:
    def __init__(self, vm_ip: str, cache_dir: str):
        ...
        self.http_server: str = f"http://{vm_ip}:5023"
        self.http_server_setup_root: str = f"http://{vm_ip}:5023/setup"
