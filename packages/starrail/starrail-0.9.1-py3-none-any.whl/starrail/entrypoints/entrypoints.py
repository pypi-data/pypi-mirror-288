...
def start_starrail():
    ...
    about_group = parser.add_group('About', 'Get information about the starrail module in general.')
    ...
    pt_config = subparsers.add_parser('playtime', help='Show time in hour, minutes, and seconds since this game session has started', description='Show time in hour, minutes, and seconds since this game session has started')
    ...
    auto_group = parser.add_group('Automation Commands', 'Simple automation for automating Honkai: Star Rail gameplays')
