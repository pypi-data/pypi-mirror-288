...
class Valley(Node):
    ...
    def __eq__(self, other):
        """
        Determine the equality between Valley and other objects.

        Args:
            other: The other Valley object to compare with.
    ...
    def __lt__(self, other) -> bool:
        """
        Compare a Valley node and other node by their weight.
