...
class ArchiveProvider(
    ...
    def __init__(
        ...
        *,
        ...
        :param alias: Alias name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/archive/2.5.0/docs#alias ArchiveProvider#alias}
        '''
        if __debug__:
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing ArchiveProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/archive/2.5.0/docs#import import section} in the documentation of this resource for the id to use
