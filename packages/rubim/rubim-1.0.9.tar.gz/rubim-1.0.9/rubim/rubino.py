...
class rubino:
    ...
    def __init__(self,auth:str,client:str="android"):
        self.req = req(auth,client)

        try:
            config.mainPage = tools.dictFind(self.getPageList['data']['profiles'],'is_default',True)
        except KeyError:
            raise SystemError('invalid auth')
    ...
    def checkRubinoUsername(self,username:str):
        return self.req.send_request({
            "username":username
        },'checkRubinoUsername',api=5)

    def createPage(self,username:str=None,name:str=None,bio:str=None,email:str=None,phone:str=None,website:str=None):
        return self.req.send_request(tools.noneKeysFind({
            "username":username,
            "website":website,
            "phone":phone,
            "email":email,
    ...
    def editPageInfo(self,username:str=None,name:str=None,bio:str=None,email:str=None,phone:str=None,website:str=None,profile_id:str=None):
        ...
        if "username" in data and profile_id != config.mainPage["id"]:
            ...
            return {"status":"EROR_GENERIC","status_det":"PERMISSION_DENIED"}
