...
class QueClient:
    ...
    async def get_all_photos_from_db(self, *, access_token: str) -> ResponseT[list[dict[str, Any]]]:
        client = self.get_client(client_name="photo")
        return await client.get_all_photos_from_db(access_token=access_token)
