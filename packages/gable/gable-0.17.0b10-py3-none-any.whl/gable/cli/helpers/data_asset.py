...
def gather_pyspark_asset_data(
    ...
    print("Raw python_path.stdout:", python_path.stdout)
    print("Stripped python_path.stdout:", python_path.stdout.strip())
    ...
    print("Absolute python_executable_path:", python_executable_path)
