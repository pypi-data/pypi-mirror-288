...
class EntitiesApi:
    ...
    def entity_list(
        ...
        **kwargs
        ...
        >>> thread = api.entity_list(organization_id, sport, added, age_group, discipline, external, fields, gender, hide_null, include, limit, name_full_latin_contains, name_full_local_contains, offset, representing, sort_by, standard, status, updated, async_req=True)
        >>> result = thread.get()
    ...
    def entity_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.entity_list_with_http_info(organization_id, sport, added, age_group, discipline, external, fields, gender, hide_null, include, limit, name_full_latin_contains, name_full_local_contains, offset, representing, sort_by, standard, status, updated, async_req=True)
        >>> result = thread.get()
