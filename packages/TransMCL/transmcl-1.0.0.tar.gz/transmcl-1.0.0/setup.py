...
setup(name='TransMCL',  # 包名 别人安装时就是用此名来按照 如：pip install pyutilitytool
      version='1.0.0',  # 包的版本号
      description='Transcriptome assembly refinement tool',  # 包的介绍、概述
      author='shenjingting',  # 包的作者
      author_email='20110700125@fudan.edu.cn',  # 邮箱
