...
class AuroraClusterProps:
    def __init__(
        ...
        *,
        ...
        :param security_group_name: (experimental) The name of the security group. Default: - if clusterIdentifier is set, it uses ``${clusterIdentifier}-sg``, otherwise, it uses ``${construct.node.path}-sg``.
...
class DatabaseInstanceProps:
    def __init__(
        ...
        *,
        ...
        :param removal_policy: (experimental) The removal policy to apply when the cluster is removed. Default: RemovalPolicy.RETAIN
        :param security_group_name: (experimental) The name of the security group. Default: - if instanceIdentifier is set, it uses ``${instanceIdentifier}-sg``, otherwise, it uses ``${construct.node.path}-sg``.
