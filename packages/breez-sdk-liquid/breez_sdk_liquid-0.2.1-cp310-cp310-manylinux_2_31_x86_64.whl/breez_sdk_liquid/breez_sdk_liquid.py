...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_prepare_receive_onchain() != 48074:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_prepare_receive_payment() != 52400:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
class BindingLiquidSdkProtocol(typing.Protocol):
    ...
    def prepare_receive_onchain(self, req: "PrepareReceiveOnchainRequest"):
        raise NotImplementedError
    def prepare_receive_payment(self, req: "PrepareReceivePaymentRequest"):
        raise NotImplementedError
...
class BindingLiquidSdk:
    ...
    def prepare_receive_payment(self, req: "PrepareReceivePaymentRequest") -> "PrepareReceivePaymentResponse":
        _UniffiConverterTypePrepareReceivePaymentRequest.check_lower(req)
        ...
        _UniffiConverterTypePrepareReceivePaymentRequest.lower(req))
        )
...
class BuyBitcoinRequest:
    ...
    @typing.no_type_check
    def __init__(self, *, prepare_res: "PrepareBuyBitcoinResponse", redirect_url: "typing.Optional[str]" = _DEFAULT):
    ...
    def __str__(self):
        return "BuyBitcoinRequest(prepare_res={}, redirect_url={})".format(self.prepare_res, self.redirect_url)
...
class _UniffiConverterTypeBuyBitcoinRequest(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return BuyBitcoinRequest(
            prepare_res=_UniffiConverterTypePrepareBuyBitcoinResponse.read(buf),
            redirect_url=_UniffiConverterOptionalString.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterTypePrepareBuyBitcoinResponse.check_lower(value.prepare_res)
        _UniffiConverterOptionalString.check_lower(value.redirect_url)

    @staticmethod
    def write(value, buf):
        _UniffiConverterTypePrepareBuyBitcoinResponse.write(value.prepare_res, buf)
...
class Payment:
    ...
    @typing.no_type_check
    def __init__(self, *, timestamp: "int", amount_sat: "int", fees_sat: "int", payment_type: "PaymentType", status: "PaymentState", description: "str", tx_id: "typing.Optional[str]" = _DEFAULT, swap_id: "typing.Optional[str]" = _DEFAULT, preimage: "typing.Optional[str]" = _DEFAULT, bolt11: "typing.Optional[str]" = _DEFAULT, refund_tx_id: "typing.Optional[str]" = _DEFAULT, refund_tx_amount_sat: "typing.Optional[int]" = _DEFAULT):
        self.timestamp = timestamp
        self.amount_sat = amount_sat
    ...
    def __str__(self):
        return "Payment(timestamp={}, amount_sat={}, fees_sat={}, payment_type={}, status={}, description={}, tx_id={}, swap_id={}, preimage={}, bolt11={}, refund_tx_id={}, refund_tx_amount_sat={})".format(self.timestamp, self.amount_sat, self.fees_sat, self.payment_type, self.status, self.description, self.tx_id, self.swap_id, self.preimage, self.bolt11, self.refund_tx_id, self.refund_tx_amount_sat)
...
class PrepareReceivePaymentRequest:
    ...
    def __str__(self):
        return "PrepareReceivePaymentRequest(payer_amount_sat={})".format(self.payer_amount_sat)
...
class PrepareReceivePaymentResponse:
    ...
    def __str__(self):
        return "PrepareReceivePaymentResponse(payer_amount_sat={}, fees_sat={})".format(self.payer_amount_sat, self.fees_sat)
...
class ReceivePaymentRequest:
    prepare_res: "PrepareReceivePaymentResponse"
    description: "typing.Optional[str]"
    @typing.no_type_check
    def __init__(self, *, prepare_res: "PrepareReceivePaymentResponse", description: "typing.Optional[str]" = _DEFAULT):
        self.prepare_res = prepare_res
        if description is _DEFAULT:
            self.description = None
        else:
    ...
    def __str__(self):
        return "ReceivePaymentRequest(prepare_res={}, description={})".format(self.prepare_res, self.description)
...
class _UniffiConverterTypeReceivePaymentRequest(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return ReceivePaymentRequest(
            prepare_res=_UniffiConverterTypePrepareReceivePaymentResponse.read(buf),
            description=_UniffiConverterOptionalString.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterTypePrepareReceivePaymentResponse.check_lower(value.prepare_res)
        _UniffiConverterOptionalString.check_lower(value.description)

    @staticmethod
    def write(value, buf):
        _UniffiConverterTypePrepareReceivePaymentResponse.write(value.prepare_res, buf)
        _UniffiConverterOptionalString.write(value.description, buf)
