...
def get_chosung(c):
    ...
    """
    warnings.warn(
        "The get_chosung function will be removed in a future version. Use the get_chosung_string function. Check out https://github.com/gaon12/hangulpy/issue/5 for more information!",
        DeprecationWarning,
        stacklevel=2
    )
    if is_hangul_char(c):
