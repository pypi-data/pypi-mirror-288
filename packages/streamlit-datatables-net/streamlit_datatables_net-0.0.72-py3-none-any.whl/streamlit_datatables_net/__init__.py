...
if not _RELEASE:
    ...
    with content_column:
        with st.container(border=True):
            ...
            dt_click = st_datatable(None, options=options, common_js_functions=common_js_functions, ajax_setup=ajax_setup, ajax_reload=ajax_reload,
                ...
                with st.echo():
                    ...
                    columns = [
                        ...
                        {"data": "salary", "title": "Salary",
                            "render": ['number', ',', '.', 0, '$']},
                        {"data": "", "defaultContent": "", "title": "New Actions",
