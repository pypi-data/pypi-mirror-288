                ...
                with st.echo():
                    ...
                    columns = [
                        ...
                        {"data": "salary", "title": "Salary",
                            "render": ['number', ',', '.', 0, '$']},
                        {"data": "", "title": "New Actions",
                            "render": show_action_buttons},
                        {"data": "", "title": "Open", "render": show_link},
                    ...
                    with dt_container:
                        ...
                        if on_select == "callable":
                            on_select = my_on_click_function
                        dt_response = st_datatable(
                            data, props=props, key="example_1b", enable_top_navigation=True, date_format="%b %d %Y", is_datetime=True, on_select=on_select, enable_diagnostics=False)
                        st.write(dt_response)
