...
from infomark_terminal.account.account_view import (
    display_default_routines,
    display_personal_routines,
)
from infomark_terminal.account.show_prompt import set_show_prompt
...
from infomark_terminal.core.session.routines_handler import (
    get_default_routines_info,
    get_personal_routines_info,
    read_routine,
    save_routine,
)
from infomark_terminal.core.session.session_model import logout
...
from infomark_terminal.helper_funcs import check_positive
...
from infomark_terminal.terminal_helper import is_installer, print_guest_block_msg
