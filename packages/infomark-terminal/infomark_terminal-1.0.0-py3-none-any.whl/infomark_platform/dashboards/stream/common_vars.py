...
# Import the Infomark SDK
# pylint: disable=wrong-import-position
from infomark_terminal.sdk import infomark  # noqa: E402
...
FORECAST_MODEL_OPTS = {
    "expo": infomark.forecast.expo,  # type: ignore
    "theta": infomark.forecast.theta,  # type: ignore
    "linregr": infomark.forecast.linregr,  # type: ignore
    "regr": infomark.forecast.regr,  # type: ignore
    "rnn": infomark.forecast.rnn,  # type: ignore
    "brnn": infomark.forecast.brnn,  # type: ignore
    "nbeats": infomark.forecast.nbeats,  # type: ignore
    "tcn": infomark.forecast.tcn,  # type: ignore
    "trans": infomark.forecast.trans,  # type: ignore
    "tft": infomark.forecast.tft,  # type: ignore
}

FORECAST_FEAT_ENGS = {
    "ema": infomark.forecast.ema,  # type: ignore
    "sto": infomark.forecast.sto,  # type: ignore
    "rsi": infomark.forecast.rsi,  # type: ignore
    "roc": infomark.forecast.roc,  # type: ignore
    "mom": infomark.forecast.mom,  # type: ignore
    "atr": infomark.forecast.atr,  # type: ignore
    "delta": infomark.forecast.delta,  # type: ignore
    "signal": infomark.forecast.signal,  # type: ignore
}
# pylint: enable=E1101
