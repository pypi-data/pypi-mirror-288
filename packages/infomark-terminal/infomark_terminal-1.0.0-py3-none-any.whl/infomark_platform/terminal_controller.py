...
import infomark_terminal.config_terminal as cfg
from infomark_terminal.account.show_prompt import get_show_prompt, set_show_prompt
from infomark_terminal.common import biztoc_model, biztoc_view, feedparser_view
from infomark_terminal.core.config.paths import (
    HOME_DIRECTORY,
    MISCELLANEOUS_DIRECTORY,
    REPOSITORY_DIRECTORY,
    SETTINGS_ENV_FILE,
)
from infomark_terminal.core.log.generation.custom_logger import log_terminal
from infomark_terminal.core.session import constants, session_controller
from infomark_terminal.core.session.current_system import set_system_variable
from infomark_terminal.core.session.current_user import get_current_user, set_preference
from infomark_terminal.custom_prompt_toolkit import NestedCompleter
from infomark_terminal.helper_funcs import (
    EXPORT_ONLY_RAW_DATA_ALLOWED,
    check_positive,
    get_flair,
    parse_and_split_input,
)
from infomark_terminal.menu import is_papermill, session
from infomark_terminal.parent_classes import BaseController
from infomark_terminal.reports.reports_model import ipykernel_launcher
from infomark_terminal.rich_config import MenuText, console
from infomark_terminal.routine_functions import is_reset, parse_openbb_script
from infomark_terminal.terminal_helper import (
    bootup,
    check_for_updates,
    first_time_user,
    is_auth_enabled,
...
class TerminalController(BaseController):
    ...
    def call_alternative(self, _):
        ...
        from infomark_terminal.alternative.alt_controller import AlternativeDataController

        self.queue = self.load_class(AlternativeDataController, self.queue)

    def call_econometrics(self, _):
        """Process econometrics command."""
        from infomark_terminal.econometrics.econometrics_controller import (
    ...
    def call_funds(self, _):
        """Process etf command"""
        from infomark_terminal.mutual_funds.mutual_fund_controller import FundController
