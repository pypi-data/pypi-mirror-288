...
from infomark_terminal.core.config.paths import I18N_DICT_LOCATION
from infomark_terminal.core.config.paths_helper import init_userdata
...
if TYPE_CHECKING:
    from infomark_terminal import InfomarkFigure


InfomarkFigureT = TypeVar("InfomarkFigureT", bound="InfomarkFigure")
HOLD: bool = False
COMMAND_ON_CHART: bool = True
current_figure: Optional[InfomarkFigureT] = None  # type: ignore
new_axis: bool = True
legends = []
last_legend = ""
...
def get_current_figure() -> Optional["InfomarkFigure"]:
    return current_figure


def set_current_figure(fig: Optional[InfomarkFigureT] = None):
    # pylint: disable=global-statement
    ...
    def try_get_version_from_dist() -> Optional[str]:
        ...
        if not check_using_git():
            try:
                ...
                return pkg_resources.get_distribution("Infomark").version
