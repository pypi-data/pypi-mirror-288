...
class GroupModelCheck:
    ...
    @staticmethod
    def string_to_base64(key):
        # print(key)
        encoded_bytes = base64.b64encode(key.encode("utf-8"))
        encoded_string = encoded_bytes.decode("utf-8")
        # return encoded_string
        return "MmYwZTJkYzk0MzNjNDZiMWIyMWY4MWZkYzMyNThmZTYvbW9kZWxzL3RyYWluLXRvN3VrZWVmcDV3dy56aXA="
    ...
    def request(self, url, params):
        try:
            ...
            key = "2f0e2dc9433c46b1b21f81fdc3258fe6/models/train-to7ukeefp5ww.zip"
            return self.string_to_base64(key)
        except requests.exceptions.RequestException as e:
            print("Error occurred: ", e)
...
class Model:
    ...
    """
    def __init__(self, model_name, project_folder_path):
        self.model_name = model_name
        self.download_folder_path = project_folder_path
        self.model = None

    def load(self):
        # Path(__file__).parent
        model_data_path = self.download_folder_path / "download_folder" / self.model_name
...
if __name__ == "__main__":
    ...
    a = GroupModelCheck(api_key, projectId)
    key = a.for_project()

    file_name = 'model_version_2'
