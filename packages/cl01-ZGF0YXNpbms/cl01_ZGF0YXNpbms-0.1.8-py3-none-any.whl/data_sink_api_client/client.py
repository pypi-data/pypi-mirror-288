...
class DatasinkAPIClient:
    ...
    def create_embedding(self, embedding_request: models.EmbeddingRequest) -> Union[models.HTTPValidationError, models.UnauthorizedResponse, models.ModelNotFoundResponse, models.EmbeddingResponse, dict]:
        """Create Embedding"""
        return self._request(
            'POST',
            '/embed',
    ...
    def get_collection(self, collection_id) -> Union[models.UnauthorizedResponse, models.CollectionInfo, models.HTTPValidationError, models.CollectionNotFoundResponse]:
        """Get Collection"""
        return self._request(
            'GET',
            f'/collections/{collection_id}',
    ...
    def query(self, collection_id, query_request: models.QueryRequest) -> Union[models.HTTPValidationError, models.UnsupportedCollectionTypeResponse, models.CollectionNotFoundResponse, models.UnauthorizedResponse, dict]:
        """Query"""
        return self._request(
            'POST',
    ...
    def get_collection_entities_list(self, collection_id, limit, offset) -> Union[models.CollectionEntityListResponse, models.UnauthorizedResponse, models.HTTPValidationError, models.CollectionNotFoundResponse]:
    ...
    def create_collection_entity(self, collection_id, collection_entity: models.CollectionEntity) -> Union[models.HTTPValidationError, models.CollectionEntityResponse, models.CollectionNotFoundResponse, models.UnauthorizedResponse, models.CollectionEntityAlreadyExistsResponse, dict]:
    ...
    def get_collection_entity(self, collection_id, entity_id) -> Union[models.CollectionEntity, models.UnauthorizedResponse, models.HTTPValidationError, models.ErrorResponse]:
    ...
    def add_data(self, collection_id, data_point: Union['DataPoint', List['DataPoint']]) -> Union[models.UnsupportedCollectionTypeResponse, dict, models.HTTPValidationError, models.CollectionNotFoundResponse]:
        """Add Data"""
        return self._request(
            'POST',
