...
class AsyncDatasinkAPIClient:
    ...
    async def create_model(self, embedding_model: models.EmbeddingModel) -> Union[models.HTTPValidationError, models.EmbeddingModel, models.UnauthorizedResponse, dict]:
        """Create Model"""
        return await self._request(
            'POST',
            '/models',
    ...
    async def create_embedding(self, embedding_request: models.EmbeddingRequest) -> Union[models.EmbeddingResponse, models.HTTPValidationError, dict, models.ModelNotFoundResponse, models.UnauthorizedResponse]:
        """Create Embedding"""
        return await self._request(
            'POST',
            '/embed',
    ...
    async def update_collection(self, collection_id, partial_collection_info: models.PartialCollectionInfo) -> Union[models.QdrantCollectionInfo, models.HTTPValidationError, models.UnauthorizedResponse, models.ErrorResponse]:
        """Update Collection"""
        return await self._request(
            'PATCH',
    ...
    async def get_collection_entities_list(self, collection_id, limit, offset) -> Union[models.HTTPValidationError, models.CollectionEntityListResponse, models.UnauthorizedResponse, models.CollectionNotFoundResponse]:
    ...
    async def create_collection_entity(self, collection_id, collection_entity: models.CollectionEntity) -> Union[models.CollectionNotFoundResponse, models.CollectionEntityResponse, models.HTTPValidationError, models.CollectionEntityAlreadyExistsResponse, dict, models.UnauthorizedResponse]:
    ...
    async def get_collection_entity(self, collection_id, entity_id) -> Union[models.HTTPValidationError, models.UnauthorizedResponse, models.CollectionEntity, models.ErrorResponse]:
