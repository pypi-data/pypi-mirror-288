...
from .js_plugin import DeephavenPluginMicrophoneJsPlugin
from .deephaven_plugin_microphone_type import DeephavenPluginMicrophoneType

# The namespace that the Python plugin will be registered under.
PACKAGE_NAMESPACE = "deephaven_plugin_microphone"
# Where the Javascript plugin is. This is set in setup.py.
JS_NAME = "_js"
# The JsPlugin class that will be created and registered.
PLUGIN_CLASS = DeephavenPluginMicrophoneJsPlugin


class DeephavenPluginMicrophoneRegistration(Registration):
    @classmethod
    def register_into(cls, callback: Callback) -> None:

        # Register the Python plugin
        callback.register(DeephavenPluginMicrophoneType)
