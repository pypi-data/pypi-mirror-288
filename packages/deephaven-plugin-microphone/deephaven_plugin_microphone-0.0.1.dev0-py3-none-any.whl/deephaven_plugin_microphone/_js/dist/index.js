...
function q(c, a, k) {
  ...
  for (b in a)
    n.call(a, b) && !p$1.hasOwnProperty(b) && (d2[b] = a[b]);
  if (c && c.defaultProps)
...
function DeephavenPluginMicrophoneView(props) {
  const { fetch } = props;
    ...
    try {
      ...
      recorder2.ondataavailable = (e) => {
        ...
        reader.onload = async () => {
          ...
          await (widget == null ? void 0 : widget.sendMessage(data));
        };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(components.View, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    components.ActionButton,
    {
      ...
      UNSAFE_style: {
        color: isRecording ? "var(--dh-color-visual-red)" : void 0
      },
      children: isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(components.LoadingSpinner, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(components.Icon, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(FontAwesomeIcon, { icon: isRecording ? icons.vsMicFilled : icons.vsMic }) })
    }
  ) });
}
const DeephavenPluginMicrophonePlugin = {
...
module.exports = DeephavenPluginMicrophonePlugin;
