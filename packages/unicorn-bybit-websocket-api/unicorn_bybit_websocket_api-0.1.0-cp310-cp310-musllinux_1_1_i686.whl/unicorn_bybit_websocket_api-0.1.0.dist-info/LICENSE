...
The "LUCIT Synergetic Open Source License" oversees the utilization and distribution of the UNICORN Bybit WebSocket
API, a part of the UNICORN Bybit Suite by LUCIT IT-Management GmbH. This API enables the effortless integration of
Bybit features into diverse applications.


2. PROJECT INFORMATION

- Project name: UNICORN Bybit WebSocket API
- Project page: https://www.lucit.tech/unicorn-bybit-websocket-api.html
- GitHub repository: https://github.com/LUCIT-Systems-and-Development/unicorn-bybit-websocket-api
- PyPI repository: https://pypi.org/project/unicorn-bybit-websocket-api
- Get a license: https://shop.lucit.services/software


3. LICENSE CONDITIONS AND VERIFICATION

The use of UNICORN Bybit WebSocket API requires a license key and an API secret.
...
Thank you for selecting the UNICORN Bybit WebSocket API and products from LUCIT IT-Management GmbH. We deeply value
