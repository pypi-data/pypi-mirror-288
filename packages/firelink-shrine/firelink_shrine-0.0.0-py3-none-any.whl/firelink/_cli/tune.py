...
from firelink._cli.cp import Copy
from firelink._cli.download import Download
from firelink._cli.ls import List
from firelink._cli.run import Run
from firelink._cli.validate import Validate
