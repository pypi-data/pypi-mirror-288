...
def calculate_velocity(
    ...
    numerator = roundOffTwoDecimals(corrected_end) - roundOffTwoDecimals(
        corrected_start
    )
    denominator = roundOffTwoDecimals(time_of_end_zone) - roundOffTwoDecimals(
        time_of_start_zone
    )

    velocity = float(roundOffTwoDecimals(abs(numerator / denominator)))
