...
def connect(list_mod: ModuleType) -> None:
    ...
    if ENV not in ["prod", "staging", "dev-int", "dev-cloudtwo", "stage-cloudtwo", "prod-cloudtwo"]:
    ...
    connections = {
        ...
        "prod-cloudtwo": "nih-nci-cimac-cidc:us-east4:cidc-postgresql-prod2"
    }
