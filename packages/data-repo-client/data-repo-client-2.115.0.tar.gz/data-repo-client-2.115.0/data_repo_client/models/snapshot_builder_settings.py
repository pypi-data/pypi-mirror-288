...
class SnapshotBuilderSettings(object):
    ...
    def __init__(self, domain_options=None, program_data_options=None, dataset_concept_sets=None, root_table=None, dictionary_table=None, local_vars_configuration=None):  # noqa: E501
