...
class SDS_Base:
    ...
    def __init__(self, loop=None, connector=SDS_Socket_Connector, analog_channels=4, waveform_width=16, waveform_grid=10, open_device=True, **kwargs):
    ...
    def waveform_data(self, block=True, callback=None, error_callback=None):
        ...
        def handle_waveform_data(data):
            ...
            if len(data) <= 2:
                ...
                return
            data = np.frombuffer(data[:-2], dtype=(np.int16 if self._waveform_width == 16 else np.int8))
            data = (
