...
class V1WorkerRuntime(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["workerId", "deviceId", "revision", "launchTime", "lastServeTime", "successCount", "failedCount", "replaceWorkerId", "status", "detailStatus", "numberOfSessions", "gpuType", "region", "currentRequest", "publicAddress"]
