...
class V1AppSpecV1Alpha1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["image", "imagePullSecrets", "volumeMounts", "env", "command", "port", "readinessProbe", "volumes", "resource", "routeAuthType", "routePublicKey", "requestQuota", "autoscaler", "services", "lifeCycle"]
