...
class TestTypeTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.logger = logging.getLogger("TestTypeTests")
    ...
    def test_pull(self):
        ...
        self.logger.info("Testing Test Type")

        test_obj = abobjs.AB_TestType(id=self.test_config["test"]["read_test_type_id"],
    ...
    def test_create_delete(self):
        ...
        self.logger.info("Testing Test Type Create/Delete")

        sample_control = {"name": "CR TestType"}

        create_obj = abobjs.AB_TestType(api_info=self.test_config["api"],
        ...
        search_obj = abobjs.AB_TestType(api_info=self.test_config["api"],
                                        init_action="read",
                                        search_name=sample_control["name"])
