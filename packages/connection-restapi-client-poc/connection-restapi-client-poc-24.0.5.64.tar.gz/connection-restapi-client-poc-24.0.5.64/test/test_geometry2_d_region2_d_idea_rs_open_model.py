...
class TestGeometry2DRegion2DIdeaRSOpenModel(unittest.TestCase):
    """Geometry2DRegion2DIdeaRSOpenModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Geometry2DRegion2DIdeaRSOpenModel:
        """Test Geometry2DRegion2DIdeaRSOpenModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Geometry2DRegion2DIdeaRSOpenModel`
        """
        model = Geometry2DRegion2DIdeaRSOpenModel()
        if include_optional:
            return Geometry2DRegion2DIdeaRSOpenModel(
    ...
    def testGeometry2DRegion2DIdeaRSOpenModel(self):
        """Test Geometry2DRegion2DIdeaRSOpenModel"""
