...
class TestConnectionAnchorGridIdeaRSOpenModel(unittest.TestCase):
    """ConnectionAnchorGridIdeaRSOpenModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectionAnchorGridIdeaRSOpenModel:
        """Test ConnectionAnchorGridIdeaRSOpenModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectionAnchorGridIdeaRSOpenModel`
        """
        model = ConnectionAnchorGridIdeaRSOpenModel()
        if include_optional:
            return ConnectionAnchorGridIdeaRSOpenModel(
    ...
    def testConnectionAnchorGridIdeaRSOpenModel(self):
        """Test ConnectionAnchorGridIdeaRSOpenModel"""
