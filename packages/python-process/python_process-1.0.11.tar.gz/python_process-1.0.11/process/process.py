...
class Process(AbstractProcess[StreamWriter, StreamReader]):
    ...
    def __init__(
        ...
        Args:
            ...
            stdin: A [`bytes`][bytes] object containing the input data, file-like object, file descriptor, or special value ([`None`][None], [`PIPE`][process.PIPE], and [`DEVNULL`][process.DEVNULL]) to use as the standard input.
            stdout: A file-like object, file descriptor, or special value ([`None`][None], [`PIPE`][process.PIPE], and [`DEVNULL`][process.DEVNULL]) to use as the standard output.
            stderr: A file-like object, file descriptor, or special value ([`None`][None], [`PIPE`][process.PIPE], [`DEVNULL`][process.DEVNULL], and [`STDOUT`][process.STDOUT]) to use as the standard error.
