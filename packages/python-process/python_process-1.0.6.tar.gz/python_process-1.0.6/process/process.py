...
import process.types as types
from process.constants import DEFAULT_BUFFER_SIZE
from process.core.constants import PIPE
from process.core.errors import ProcessAlreadyRunError, ProcessError, ProcessInvalidStreamError, ProcessTimeoutError
...
class Process(AbstractProcess[types.Process, types.StreamReader, types.StreamWriter]):
    ...
    @property
    def stdin(self) -> types.StreamWriter:
    ...
    @property
    def stdout(self) -> types.StreamReader:
    ...
    @property
    def stderr(self) -> types.StreamReader:
