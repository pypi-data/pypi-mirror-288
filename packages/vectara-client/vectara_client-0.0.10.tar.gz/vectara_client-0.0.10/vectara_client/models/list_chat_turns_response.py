...
class ListChatTurnsResponse(BaseModel):
    """
    ListChatTurnsResponse
    """ # noqa: E501
    turns: Optional[List[Turn]] = Field(default=None, description="List of turns.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListChatTurnsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListChatTurnsResponse from a dict"""
        if obj is None:
            return None
