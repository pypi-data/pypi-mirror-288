...
class SearchCorpusParameters(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["custom_dimensions", "metadata_filter", "lexical_interpolation", "semantics", "offset", "limit", "context_configuration", "reranker"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchCorpusParameters from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchCorpusParameters from a dict"""
        if obj is None:
            return None
