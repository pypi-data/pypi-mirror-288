...
class UpdateUserRequest(BaseModel):
    ...
    UpdateUserRequest
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Indicates whether to disable or disable the user.")
    api_roles: Optional[List[ApiRole]] = Field(default=None, description="The new role names of the user.")
    __properties: ClassVar[List[str]] = ["enabled", "api_roles"]
