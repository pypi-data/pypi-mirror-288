...
class ListLLMsResponse(BaseModel):
    ...
    ListLLMsResponse
    """ # noqa: E501
    llms: Optional[List[LLM]] = Field(default=None, description="List of LLMs.")
    metadata: Optional[ListMetadata] = None
    __properties: ClassVar[List[str]] = ["llms", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "llms": [LLM.from_dict(_item) for _item in obj["llms"]] if obj.get("llms") is not None else None,
