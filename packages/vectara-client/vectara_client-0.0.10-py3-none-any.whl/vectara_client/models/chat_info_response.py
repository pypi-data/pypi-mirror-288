...
class ChatInfoResponse(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='chat_info', description="This will be `chat_info` when the stream event contains information about how the chat is stored. ")
    chat_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="ID of the chat.")
    turn_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="ID of the turn.")
    __properties: ClassVar[List[str]] = ["type", "chat_id", "turn_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'chat_info',
