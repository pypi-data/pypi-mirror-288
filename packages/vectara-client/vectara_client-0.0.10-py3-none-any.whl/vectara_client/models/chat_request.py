...
class ChatRequest(BaseModel):
    ...
    ChatRequest
    """ # noqa: E501
    query: StrictStr = Field(description="The chat message or question.")
    search: SearchCorporaParameters
    generation: Optional[GenerationParameters] = None
    chat: Optional[ChatParameters] = None
    ...
    __properties: ClassVar[List[str]] = ["query", "search", "generation", "chat", "stream_response"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "query": obj.get("query"),
            "search": SearchCorporaParameters.from_dict(obj["search"]) if obj.get("search") is not None else None,
            "generation": GenerationParameters.from_dict(obj["generation"]) if obj.get("generation") is not None else None,
            "chat": ChatParameters.from_dict(obj["chat"]) if obj.get("chat") is not None else None,
