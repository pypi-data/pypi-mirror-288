...
class ReplaceFilterAttributesRequest(BaseModel):
    """
    ReplaceFilterAttributesRequest
    """ # noqa: E501
    filter_attributes: List[FilterAttribute] = Field(description="The new filter attributes.")
    __properties: ClassVar[List[str]] = ["filter_attributes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReplaceFilterAttributesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReplaceFilterAttributesRequest from a dict"""
        if obj is None:
            return None
