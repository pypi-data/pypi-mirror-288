...
class DockerBuild:
    ...
    def build_image(self, dockerfile: str, name: str, version: str, command_tip: str, push=False):
        ...
        self.__command(command=f"docker build -f {dockerfile} -t {image_name} .", command_tip=command_tip)
...
if __name__ == "__main__":
    ...
    build = (DockerBuild(docker_hub_domain=_docker_hub_domain, docker_hub_namespace=_docker_hub_namespace)
             ...
             # .build_image(dockerfile="Dockerfile_env", name="zhousf_fd_py39_cuda11.6.1-cudnn8", version="1.0.7", push=False, command_tip="构建环境镜像")
