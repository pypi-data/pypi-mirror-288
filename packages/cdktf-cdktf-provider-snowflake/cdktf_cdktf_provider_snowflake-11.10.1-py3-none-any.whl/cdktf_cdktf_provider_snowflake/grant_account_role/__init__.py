...
class GrantAccountRole(
    ...
    def __init__(
        ...
        *,
        ...
        :param role_name: The fully qualified name of the role which will be granted to the user or parent role. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs/resources/grant_account_role#role_name GrantAccountRole#role_name}
        ...
        :param user_name: The fully qualified name of the user on which specified role will be granted. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs/resources/grant_account_role#user_name GrantAccountRole#user_name}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing GrantAccountRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs/resources/grant_account_role#import import section} in the documentation of this resource for the id to use
