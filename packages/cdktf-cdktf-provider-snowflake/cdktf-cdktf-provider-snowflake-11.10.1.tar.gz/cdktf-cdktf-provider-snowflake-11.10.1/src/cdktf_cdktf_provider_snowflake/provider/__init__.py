...
class SnowflakeProvider(
    ...
    def __init__(
        ...
        *,
        ...
        :param alias: Alias name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#alias SnowflakeProvider#alias}
        :param authenticator: Specifies the `authentication type <https://pkg.go.dev/github.com/snowflakedb/gosnowflake#AuthType>`_ to use when connecting to Snowflake. Valid values include: Snowflake, OAuth, ExternalBrowser, Okta, JWT, TokenAccessor, UsernamePasswordMFA. Can also be sourced from the ``SNOWFLAKE_AUTHENTICATOR`` environment variable. It has to be set explicitly to JWT for private key authentication. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#authenticator SnowflakeProvider#authenticator}
        :param browser_auth: Required when ``oauth_refresh_token`` is used. Can also be sourced from ``SNOWFLAKE_USE_BROWSER_AUTH`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#browser_auth SnowflakeProvider#browser_auth}
        :param client_ip: IP address for network checks. Can also be sourced from the ``SNOWFLAKE_CLIENT_IP`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#client_ip SnowflakeProvider#client_ip}
        ...
        :param oauth_client_id: Required when ``oauth_refresh_token`` is used. Can also be sourced from ``SNOWFLAKE_OAUTH_CLIENT_ID`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#oauth_client_id SnowflakeProvider#oauth_client_id}
        :param oauth_client_secret: Required when ``oauth_refresh_token`` is used. Can also be sourced from ``SNOWFLAKE_OAUTH_CLIENT_SECRET`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#oauth_client_secret SnowflakeProvider#oauth_client_secret}
        :param oauth_endpoint: Required when ``oauth_refresh_token`` is used. Can also be sourced from ``SNOWFLAKE_OAUTH_ENDPOINT`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#oauth_endpoint SnowflakeProvider#oauth_endpoint}
        :param oauth_redirect_url: Required when ``oauth_refresh_token`` is used. Can also be sourced from ``SNOWFLAKE_OAUTH_REDIRECT_URL`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#oauth_redirect_url SnowflakeProvider#oauth_redirect_url}
        ...
        :param okta_url: The URL of the Okta server. e.g. https://example.okta.com. Can also be sourced from the ``SNOWFLAKE_OKTA_URL`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#okta_url SnowflakeProvider#okta_url}
        :param params: Sets other connection (i.e. session) parameters. `Parameters <https://docs.snowflake.com/en/sql-reference/parameters>`_. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#params SnowflakeProvider#params}
        :param passcode: Specifies the passcode provided by Duo when using multi-factor authentication (MFA) for login. Can also be sourced from the ``SNOWFLAKE_PASSCODE`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#passcode SnowflakeProvider#passcode}
        ...
        :param port: Support custom port values to snowflake go driver for use with privatelink. Can also be sourced from the ``SNOWFLAKE_PORT`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#port SnowflakeProvider#port}
        :param private_key: Private Key for username+private-key auth. Cannot be used with ``browser_auth`` or ``password``. Can also be sourced from ``SNOWFLAKE_PRIVATE_KEY`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#private_key SnowflakeProvider#private_key}
        ...
        :param private_key_path: Path to a private key for using keypair authentication. Cannot be used with ``browser_auth``, ``oauth_access_token`` or ``password``. Can also be sourced from ``SNOWFLAKE_PRIVATE_KEY_PATH`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#private_key_path SnowflakeProvider#private_key_path}
        :param profile: Sets the profile to read from ~/.snowflake/config file. Can also be sourced from the ``SNOWFLAKE_PROFILE`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#profile SnowflakeProvider#profile}
        :param protocol: Either http or https, defaults to https. Can also be sourced from the ``SNOWFLAKE_PROTOCOL`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#protocol SnowflakeProvider#protocol}
        ...
        :param role: Specifies the role to use by default for accessing Snowflake objects in the client session. Can also be sourced from the ``SNOWFLAKE_ROLE`` environment variable. . Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#role SnowflakeProvider#role}
        :param session_params: Sets session parameters. `Parameters <https://docs.snowflake.com/en/sql-reference/parameters>`_. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#session_params SnowflakeProvider#session_params}
        :param token: Token to use for OAuth and other forms of token based auth. Can also be sourced from the ``SNOWFLAKE_TOKEN`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#token SnowflakeProvider#token}
        :param token_accessor: token_accessor block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#token_accessor SnowflakeProvider#token_accessor}
        :param user: Username. Can also be sourced from the ``SNOWFLAKE_USER`` environment variable. Required unless using ``profile``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#user SnowflakeProvider#user}
        :param username: Username for username+password authentication. Can also be sourced from the ``SNOWFLAKE_USERNAME`` environment variable. Required unless using ``profile``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#username SnowflakeProvider#username}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing SnowflakeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs#import import section} in the documentation of this resource for the id to use
