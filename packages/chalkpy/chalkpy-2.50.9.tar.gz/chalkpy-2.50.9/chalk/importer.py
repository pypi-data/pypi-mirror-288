...
def _check_types(
    ...
    elif aggregation in {"count", "approx_count_distinct"}:
        if this_annotation is not int:
            return f"feature '{feature_name}' should be an 'int' for 'count' aggregation; found '{this_annotation.__name__}'"
    ...
    for filt in filters:
        ...
        if isinstance(left, UnderscoreAttr):
            ...
            try:
                ...
                return ([], f"could not find feature '{left_attr}' in the joined class")
        ...
        if isinstance(right, UnderscoreAttr):
            ...
            try:
                ...
                return (
                    [],
                    f"could not find feature '{right_attr}' in the joined class",
                )
