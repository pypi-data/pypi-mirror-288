...
from .symbols import list_of_coveredwarrant
...
class SubscribeCoveredWarrantEvents:
    def __init__(self, access_token: str, tickers: list, callback: callable):
        ...
        symbolsset = set(list_of_coveredwarrant())
        tickersset = set(tickers)
        if not tickersset.issubset(symbolsset):
            raise ValueError("Invalid Convered Warrant")
