...
with B.subgraph(name='cluster6') as c:
    c.graph_attr['color']='none'
    c.add_node('input6', shape='box', style='rounded', label='...')
    c.add_node('NodeXI', shape='box', style='rounded, filled', fillcolor='.8 .3 1')
    c.add_node('output6', shape='box', style='rounded', label='...')
    c.add_edge('input6', 'NodeXI')
    c.add_edge('NodeXI', 'output6')
