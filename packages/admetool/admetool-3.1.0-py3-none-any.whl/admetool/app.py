...
from models.admetspreadsheet import *
from models.selenium import *
from models.extract import *
from models.output import *
from models.sdf import *
import argparse
...
def main():
    ...
    parser.add_argument('-v','--version', action='version', version='admetscore 1.0.0')
