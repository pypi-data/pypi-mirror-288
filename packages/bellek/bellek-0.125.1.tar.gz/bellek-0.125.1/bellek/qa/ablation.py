...
# %% auto 0
__all__ = ['log', 'DEFAULT_MODEL', 'USER_PROMPT', 'SYSTEM_PROMPT_STANDARD', 'SYSTEM_PROMPT_COT', 'SYSTEM_PROMPT_COT_FS',
           'SYSTEM_PROMPT_CTE', 'SYSTEM_PROMPT_CTE_COT', 'QuestionAnsweringResultStandard', 'answer_question_standard',
