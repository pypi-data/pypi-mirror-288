...
from scope_resolution import LocalScope, LocalDef, Reference, Scoping
from scope_resolution.imports import (
    LocalImportStmt,
    parse_from,
    parse_alias,
    parse_name,
...
from scope_resolution.graph import ScopeGraph

from ts.capture_types import (
    LocalDefCapture,
    LocalRefCapture,
