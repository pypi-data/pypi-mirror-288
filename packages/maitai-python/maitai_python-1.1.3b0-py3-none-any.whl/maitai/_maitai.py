        ...
        if server_side_inference:
            ...
            try:
                ...
                if stream:
                    ...
                    return _process_inference_stream(response, retry_args, self.create)
                # ChatCompletion only
...
def _process_inference_stream(stream: Iterable[InferenceStreamResponse], retry_args: dict, retry_func) -> Iterable[MaitaiChunk]:
    try:
