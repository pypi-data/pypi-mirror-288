...
class PhoenixVision:
    def __init__(self, training_data_dir='training_data'):
        ...
        self.load_training_data()  # Carregamos os dados primeiro
        self.model = self.create_model()  # Depois criamos o modelo
    ...
    def create_model(self):
        ...
        # Adapta o número de saídas (classes) de acordo com self.labels
    ...
    def recognize(self):
        ...
        # Chamamos load_training_data() DEPOIS da captura das imagens
        self.load_training_data() 

        # Treinar o modelo após capturar as imagens
        self.train_model()
