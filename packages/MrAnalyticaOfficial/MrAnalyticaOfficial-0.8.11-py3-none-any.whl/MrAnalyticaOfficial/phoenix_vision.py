...
class PhoenixVision:
    def __init__(self, training_data_dir='training_data'):
        ...
        # Escolhendo Fisherfaces para melhor precisão
    ...
    def recognize(self, duration=60): # Captura por 1 minuto
        ...
        while time.time() - start_time < duration:
            ...
            # Ajustando parâmetros para detecção de rosto
    ...
    def start(self):
        ...
        while True:
            ...
            for (x, y, w, h) in faces:
                ...
                # Aplicando equalização de histograma antes do reconhecimento
                roi_gray = cv2.equalizeHist(roi_gray)
                
                id_, confidence = self.recognizer.predict(roi_gray)

                if confidence < 90: # Ajuste de confiança
