...
function getEmIds(model) {
    ...
    for (var i = 0, il = db_name.rowCount; i < il; ++i) {
        if (db_name.value(i).toUpperCase() === 'EMDB' &&
...
function getContourLevel(provider, plugin, taskCtx, emdbId) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (provider) {
                case 'emdb':
                    return [2 /*return*/, getContourLevelEmdb(plugin, taskCtx, emdbId)];
                case 'pdbe':
                    return [2 /*return*/, getContourLevelPdbe(plugin, taskCtx, emdbId)];
            }
            return [2 /*return*/];
        });
    });
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, plugin
                            .fetch({
                            url: "".concat(emdbHeaderServer, "/").concat(emdbId.toUpperCase(), "/header/").concat(emdbId.toLowerCase(), ".xml"),
                            type: 'xml'
                        })
        ...
        return (0, tslib_1.__generator)(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    return [4 /*yield*/, plugin
                            .fetch({
                            url: "https://www.ebi.ac.uk/emdb/api/entry/map/".concat(emdbId),
                            type: 'json'
                        })
                            .runInContext(taskCtx)];
                case 1:
        ...
        return (0, tslib_1.__generator)(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, plugin
                            .fetch({
                            url: "https://www.ebi.ac.uk/pdbe/api/emdb/entry/map/".concat(emdbId),
                            type: 'json'
                        })
                            .runInContext(taskCtx)];
                case 1:
...
function getEmdbIds(plugin, taskCtx, pdbId) {
    ...
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, plugin
                        .fetch({
                        url: "https://www.ebi.ac.uk/pdbe/api/pdb/entry/summary/".concat(pdbId),
                        type: 'json'
                    })
                        .runInContext(taskCtx)];
                case 1:
