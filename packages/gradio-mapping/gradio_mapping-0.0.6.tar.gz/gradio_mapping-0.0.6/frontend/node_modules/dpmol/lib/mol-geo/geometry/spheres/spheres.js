...
(function (Spheres) {
    ...
    function createValues(spheres, transform, locationIt, theme, props) {
        ...
        var padding = spheres.boundingSphere.radius
            ? (0, size_data_1.getMaxSize)(size) * props.sizeFactor
            : 0;
    ...
    function createValuesSimple(spheres, props, colorValue, sizeValue, transform) {
        ...
        var p = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, param_definition_1.ParamDefinition.getDefaultValues(Spheres.Params)), props);
