...
function gpuSupport(webgl) {
    return (webgl.extensions.colorBufferFloat &&
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, algorithm_1.computeMarchingCubesMesh)({
                            isoLevel: volume_1.Volume.IsoValue.toAbsolute(props.isoValue, volume.grid.stats)
                                .absoluteValue,
...
function IsosurfaceMeshVisual(materialId) {
    return (0, representation_1.VolumeVisual)({
        ...
        createLocationIterator: function (volume) {
            return (0, location_iterator_1.LocationIterator)(volume.grid.cells.data.length, 1, 1, function () { return location_1.NullLocation; });
        },
    ...
    function get(volume, webgl) {
        ...
        if (!volume._propertyData[name]) {
            ...
            volume.customProperties.assets(VolumeIsosurfaceTexture.descriptor, [
                { dispose: function () { return texture_1.destroy(); } }
            ]);
        }
...
function createVolumeIsosurfaceTextureMesh(ctx, volume, theme, props, textureMesh) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_c) {
            ...
            gv = (0, isosurface_1.extractIsosurface)(ctx.webgl, texture, gridDimension, gridTexDim, gridTexScale, transform, isoLevel, value < 0, false, axisOrder, buffer === null || buffer === void 0 ? void 0 : buffer.vertex, buffer === null || buffer === void 0 ? void 0 : buffer.group, buffer === null || buffer === void 0 ? void 0 : buffer.normal);
...
var IsosurfaceVisuals = {
    solid: function (ctx, getParams) {
        return (0, representation_1.VolumeRepresentation)('Isosurface mesh', ctx, getParams, IsosurfaceVisual, getLoci);
    },
    wireframe: function (ctx, getParams) {
        return (0, representation_1.VolumeRepresentation)('Isosurface wireframe', ctx, getParams, IsosurfaceWireframeVisual, getLoci);
    }
};
exports.IsosurfaceParams = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, exports.IsosurfaceMeshParams), exports.IsosurfaceWireframeParams), { visuals: param_definition_1.ParamDefinition.MultiSelect(['solid'], param_definition_1.ParamDefinition.objectToOptions(IsosurfaceVisuals)), bumpFrequency: param_definition_1.ParamDefinition.Numeric(1, { min: 0, max: 10, step: 0.1 }, base_1.BaseGeometry.ShadingCategory), alpha: param_definition_1.ParamDefinition.Numeric(0.12, { min: 0, max: 1, step: 0.01 }, {
        label: 'Opacity',
        isEssential: true,
