...
var StructureRepresentationBuilder = /** @class */ (function () {
    ...
    StructureRepresentationBuilder.prototype.getPresetsWithOptions = function (s) {
        ...
        for (var _i = 0, _a = this._providers; _i < _a.length; _i++) {
            ...
            map[p.id] = p.params
                ? param_definition_1.ParamDefinition.Group(p.params(s, this.plugin))
    ...
    StructureRepresentationBuilder.prototype.applyPreset = function (parent, providerRef, params) {
        ...
        var prms = params || (provider.params ? param_definition_1.ParamDefinition.getDefaultValues(pd) : {});
    ...
    StructureRepresentationBuilder.prototype.buildRepresentation = function (builder, structure, props, options) {
        ...
        if (params.type.params && data.model.sourceData.kind) {
            params.type.params = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, params.type), { aromaticBonds: data.model.sourceData.kind === 'mmCIF' });
        }
        return (options === null || options === void 0 ? void 0 : options.tag)
            ? builder
                .to(structure)
                .applyOrUpdateTagged(options.tag, representation_1.StructureRepresentation3D, params, {
                state: options === null || options === void 0 ? void 0 : options.initialState
            }).selector
            : builder
                .to(structure)
                .apply(representation_1.StructureRepresentation3D, params, {
                state: options === null || options === void 0 ? void 0 : options.initialState
            }).selector;
    };
