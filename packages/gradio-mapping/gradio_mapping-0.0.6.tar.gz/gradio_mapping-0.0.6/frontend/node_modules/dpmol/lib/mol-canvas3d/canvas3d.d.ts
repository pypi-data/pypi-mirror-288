...
export declare const Canvas3DParams: {
    ...
    marking: PD.Group<PD.Normalize<{
        enabled: boolean;
        highlightEdgeColor: import("../mol-util").Color;
        selectEdgeColor: import("../mol-util").Color;
        edgeScale: number;
        ghostEdgeStrength: number;
        innerEdgeFactor: number;
    }>>;
    renderer: PD.Group<PD.Normalize<{
        backgroundColor: import("../mol-util").Color;
        pickingAlphaThreshold: number;
        interiorDarkening: number;
        interiorColorFlag: boolean;
        interiorColor: import("../mol-util").Color;
        highlightColor: import("../mol-util").Color;
        selectColor: import("../mol-util").Color;
        ...
        light: PD.Normalize<{
            inclination: number;
            azimuth: number;
            color: import("../mol-util").Color;
            intensity: number;
        }>[];
        ambientColor: import("../mol-util").Color;
        ambientIntensity: number;
        invalidColor: import("../mol-util").Color;
