...
var HighlightLociParams = {
    ...
    preferAtoms: param_definition_1.ParamDefinition.Boolean(false, {
        ...
        class_2.prototype.register = function () {
            ...
            var actions = [
                ...
                [
                    ...
                    function () { return _this.ctx.managers.interactivity.lociSelects.deselectAll(); },
                    lociIsEmpty
                ]
            ];
            ...
            actions.sort(function (a, b) {
                ...
                var k = x.triggers.length === 0
                    ? 0
                    : (0, array_1.arrayMax)(x.triggers.map(function (t) { return M.size(t.modifiers); }));
                var l = y.triggers.length === 0
                    ? 0
                    : (0, array_1.arrayMax)(y.triggers.map(function (t) { return M.size(t.modifiers); }));
                return l - k;
            });
            this.subscribeObservable(this.ctx.behaviors.interaction.click, function (_a) {
                ...
                for (var _i = 0, actions_1 = actions; _i < actions_1.length; _i++) {
                    ...
                    if (binding_1.Binding.match(_this.params.bindings[binding], button, modifiers) &&
            ...
            this.subscribeObservable(this.ctx.state.events.object.updated, function (_a) {
                ...
                if (cell && objects_1.PluginStateObject.Molecule.Structure.is(cell.obj)) {
                    ...
                    var oldStructure = action === 'recreate'
                        ? oldObj === null || oldObj === void 0 ? void 0 : oldObj.data
                        : action === 'in-place'
                            ? oldData
                            : undefined;
                    if (oldStructure &&
                ...
                label: function (loci) {
                    ...
                    if (structure_1.StructureElement.Loci.is(loci)) {
                        ...
                        for (var _i = 0, _a = loci.elements; _i < _a.length; _i++) {
                            ...
                            var name_1 = structure_1.StructureProperties.entity
                                .pdbx_description(l)
                                .join(', ');
...
var DefaultFocusLociBindings = {
    clickFocus: (0, binding_1.Binding)([Trigger(1 /* Primary */, M.create())], 'Representation Focus', 'Click element using ${triggers}'),
    clickFocusAdd: (0, binding_1.Binding)([Trigger(1 /* Primary */, M.create({ shift: true }))], 'Representation Focus Add', 'Click element using ${triggers}'),
    ...
    ctor: /** @class */ (function (_super) {
        ...
        class_4.prototype.register = function () {
            ...
            this.subscribeObservable(this.ctx.behaviors.interaction.click, function (_a) {
                ...
                var bindingAdd = _this.ctx.selectionMode
