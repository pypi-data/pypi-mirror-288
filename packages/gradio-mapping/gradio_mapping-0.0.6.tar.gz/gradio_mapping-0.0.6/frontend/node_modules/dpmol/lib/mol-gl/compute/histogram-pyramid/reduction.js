...
var reduction_frag_1 = require("../../shader/histogram-pyramid/reduction.frag");
...
function getHistopyramidReductionRenderable(ctx, inputLevel, previousLevel) {
    if (ctx.namedComputeRenderables[HistogramPyramidName]) {
        var v = ctx.namedComputeRenderables[HistogramPyramidName]
            .values;
        ...
        ctx.namedComputeRenderables[HistogramPyramidName] =
            createHistopyramidReductionRenderable(ctx, inputLevel, previousLevel);
    }
