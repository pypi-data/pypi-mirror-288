...
function SecondaryStructureColorTheme(ctx, props) {
    ...
    var contextHash = computedSecondaryStructure
        ? (0, util_2.hash2)(computedSecondaryStructure.id, computedSecondaryStructure.version)
        : -1;
    var colorMap = (0, color_2.getAdjustedColorMap)(props.colors.name === 'default'
        ? SecondaryStructureColors
        : props.colors.params, props.saturation, props.lightness);
    ...
    return {
        ...
        legend: (0, legend_1.TableLegend)(Object.keys(colorMap)
            .map(function (name) {
    ...
    ensureCustomProperties: {
        attach: function (ctx, data) {
            return data.structure
                ? secondary_structure_1.SecondaryStructureProvider.attach(ctx, data.structure, void 0, true)
                : Promise.resolve();
        },
        detach: function (data) {
            return data.structure && secondary_structure_1.SecondaryStructureProvider.ref(data.structure, false);
        }
    }
};
