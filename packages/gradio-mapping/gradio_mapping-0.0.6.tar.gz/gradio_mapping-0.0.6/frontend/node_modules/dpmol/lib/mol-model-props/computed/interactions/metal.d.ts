...
export declare const DefaultMetalCoordinationParams: PD.Values<{
    distanceMax: PD.Numeric;
}>;
export declare type MetalCoordinationParams = typeof MetalCoordinationParams;
export declare type MetalCoordinationProps = PD.Values<MetalCoordinationParams>;
