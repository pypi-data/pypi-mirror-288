...
var CarbohydrateVisuals = {
    'carbohydrate-symbol': function (ctx, getParams) {
        return (0, complex_representation_1.ComplexRepresentation)('Carbohydrate symbol mesh', ctx, getParams, carbohydrate_symbol_mesh_1.CarbohydrateSymbolVisual);
    },
    'carbohydrate-link': function (ctx, getParams) {
        return (0, complex_representation_1.ComplexRepresentation)('Carbohydrate link cylinder', ctx, getParams, carbohydrate_link_cylinder_1.CarbohydrateLinkVisual);
    },
    'carbohydrate-terminal-link': function (ctx, getParams) {
        return (0, complex_representation_1.ComplexRepresentation)('Carbohydrate terminal link cylinder', ctx, getParams, carbohydrate_terminal_link_cylinder_1.CarbohydrateTerminalLinkVisual);
    }
};
exports.CarbohydrateParams = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, carbohydrate_symbol_mesh_1.CarbohydrateSymbolParams), carbohydrate_link_cylinder_1.CarbohydrateLinkParams), carbohydrate_terminal_link_cylinder_1.CarbohydrateTerminalLinkParams), { visuals: param_definition_1.ParamDefinition.MultiSelect(['carbohydrate-symbol', 'carbohydrate-link', 'carbohydrate-terminal-link'], param_definition_1.ParamDefinition.objectToOptions(CarbohydrateVisuals)), bumpFrequency: param_definition_1.ParamDefinition.Numeric(0, { min: 0, max: 10, step: 0.1 }, base_1.BaseGeometry.ShadingCategory) });
function getCarbohydrateParams(ctx, structure) {
    return param_definition_1.ParamDefinition.clone(exports.CarbohydrateParams);
}
