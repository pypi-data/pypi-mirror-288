...
var LineVisuals = {
    'intra-bond': function (ctx, getParams) {
        return (0, units_representation_1.UnitsRepresentation)('Intra-unit bond line', ctx, getParams, bond_intra_unit_line_1.IntraUnitBondLineVisual);
    },
    'inter-bond': function (ctx, getParams) {
        return (0, complex_representation_1.ComplexRepresentation)('Inter-unit bond line', ctx, getParams, bond_inter_unit_line_1.InterUnitBondLineVisual);
    },
...
exports.LineParams = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, bond_intra_unit_line_1.IntraUnitBondLineParams), bond_inter_unit_line_1.InterUnitBondLineParams), element_point_1.ElementPointParams), element_cross_1.ElementCrossParams), { multipleBonds: param_definition_1.ParamDefinition.Select('offset', param_definition_1.ParamDefinition.arrayToOptions(['off', 'symmetric', 'offset'])), includeParent: param_definition_1.ParamDefinition.Boolean(false), sizeFactor: param_definition_1.ParamDefinition.Numeric(0.01, { min: 0.01, max: 10, step: 0.01 }), unitKinds: (0, params_1.getUnitKindsParam)(['atomic']), visuals: param_definition_1.ParamDefinition.MultiSelect(['intra-bond', 'inter-bond', 'element-point', 'element-cross', 'charge-text'], param_definition_1.ParamDefinition.objectToOptions(LineVisuals)), lineSizeAttenuation: param_definition_1.ParamDefinition.Boolean(true), traceOnly: param_definition_1.ParamDefinition.Boolean(false, { isHidden: true }), pointSizeAttenuation: param_definition_1.ParamDefinition.Boolean(true), pointStyle: param_definition_1.ParamDefinition.Select('circle', param_definition_1.ParamDefinition.objectToOptions(StyleTypes)) });
function getLineParams(ctx, structure) {
    var params = param_definition_1.ParamDefinition.clone(exports.LineParams);
