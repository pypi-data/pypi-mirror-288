...
function getIntraUnitBondCylinderBuilderProps(unit, structure, theme, props) {
    ...
    if (props.includeParent && child) {
        ...
        stub = function (edgeIndex) {
            ...
            return (int_1.SortedArray.has(childUnit_1.elements, eA) &&
                !int_1.SortedArray.has(childUnit_1.elements, eB));
        };
    }
    ...
    var deloTriplets = aromaticBonds
        ? unit.resonance.delocalizedTriplets
        : undefined;
    return {
        ...
        style: function (edgeIndex) {
            ...
            if (isBondType(f, 2 /* MetallicCoordination */) ||
                isBondType(f, 4 /* HydrogenBond */)) {
...
//# sourceMappingURL=bond-intra-unit-cylinder.js.map