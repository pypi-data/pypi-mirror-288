...
(function (Transformer) {
    function getParamDefinition(t, a, globalCtx) {
        return t.definition.params
            ? t.definition.params(a, globalCtx)
            : {};
    }
    Transformer.getParamDefinition = getParamDefinition;
    function is(obj) {
        return (!!obj &&
            typeof obj.toAction === 'function' &&
    ...
    function create(namespace, definition) {
        ...
        var t = {
            apply: function (parent, params, props) {
                return transform_1.StateTransform.create(parent, t, params, props);
            },
            toAction: function () {
                return action_1.StateAction.fromTransformer(t);
            },
            namespace: namespace,
            id: id,
            ...
            createDefaultParams: function (a, globalCtx) {
                return definition.params
                    ? param_definition_1.ParamDefinition.getDefaultValues(definition.params(a, globalCtx))
                    : {};
            }
        };
        registry.set(id, t);
    ...
    (function (Builder) {
        function root(namespace, info) {
            return function (def) {
                return create(namespace, (0, tslib_1.__assign)({ name: info.name, from: info.from instanceof Array ? info.from : [info.from], to: info.to instanceof Array ? info.to : [info.to], display: typeof info.display === 'string'
                        ? { name: info.display }
                        : !!info.display
                            ? info.display
