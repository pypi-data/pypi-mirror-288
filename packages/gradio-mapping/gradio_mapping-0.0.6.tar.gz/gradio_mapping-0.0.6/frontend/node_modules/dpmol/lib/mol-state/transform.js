...
(function (Transform) {
    ...
    function withParams(t, params) {
        var dependsOn = params.dependsOn, restParams = (0, tslib_1.__rest)(params
        // CHANGED by cly, 强行在更新的时候修改transform的dependsOn
        , ["dependsOn"]);
        // CHANGED by cly, 强行在更新的时候修改transform的dependsOn
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, t), { dependsOn: dependsOn !== null && dependsOn !== void 0 ? dependsOn : t.dependsOn, params: restParams, version: mol_util_1.UUID.create22() });
    }
    Transform.withParams = withParams;
    function withState(t, state) {
        if (!state)
            return t;
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, t), { state: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, t.state), state) });
    }
    ...
    function withTags(t, newTags) {
        ...
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, t), { tags: tags, version: mol_util_1.UUID.create22() });
    }
    Transform.withTags = withTags;
    function withParent(t, parent) {
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, t), { parent: parent, version: mol_util_1.UUID.create22() });
    }
