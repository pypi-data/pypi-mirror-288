...
export declare const DefaultHydrogenBondsParams: PD.Values<{
    water: PD.BooleanParam;
    sulfurDistanceMax: PD.Numeric;
    distanceMax: PD.Numeric;
    backbone: PD.BooleanParam;
...
declare type HydrogenBondsParams = typeof HydrogenBondsParams;
export declare type HydrogenBondsProps = PD.Values<HydrogenBondsParams>;
...
export declare const DefaultWeakHydrogenBondsParams: PD.Values<{
    distanceMax: PD.Numeric;
    backbone: PD.BooleanParam;
    accAngleDevMax: PD.Numeric;
    donAngleDevMax: PD.Numeric;
...
declare type WeakHydrogenBondsParams = typeof WeakHydrogenBondsParams;
export declare type WeakHydrogenBondsProps = PD.Values<WeakHydrogenBondsParams>;
