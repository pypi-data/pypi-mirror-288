...
export declare const DistanceParams: {
    ...
    attachment: PD.Select<import("../../../mol-geo/geometry/text/text").TextAttachment>;
...
export declare type DistanceParams = typeof DistanceParams;
export declare type DistanceProps = PD.Values<DistanceParams>;
export declare type DistanceRepresentation = Representation<DistanceData, DistanceParams>;
