            ...
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, builder.tryCreateUnitcell(modelProperties, undefined, {
                                isHidden: true
                            })];
                    case 5:
                        _a = _b.sent();
                    ...
                    case 7:
                        unitcell = _a;
                        representationPreset = params.representationPreset ||
                            plugin.config.get(config_1.PluginConfig.Structure.DefaultRepresentationPreset) ||
                            representation_preset_1.PresetStructureRepresentations.auto.id;
            ...
            return (0, tslib_1.__generator)(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 5:
                        ...
                        quality = structure.obj
                            ? (0, util_1.getStructureQuality)(structure.obj.data, {
...
var supercell = TrajectoryHierarchyPresetProvider({
    ...
    apply: function (trajectory, params, plugin) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, applyCrystalSymmetry({
                            ijkMin: linear_algebra_1.Vec3.create(-1, -1, -1),
                            ijkMax: linear_algebra_1.Vec3.create(1, 1, 1),
                            theme: 'operator-hkl'
                ...
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        representationPreset = params.representationPreset ||
                            plugin.config.get(config_1.PluginConfig.Structure.DefaultRepresentationPreset) ||
                            representation_preset_1.PresetStructureRepresentations.auto.id;
                        return [4 /*yield*/, plugin.builders.structure.representation.applyPreset(structureProperties, representationPreset, {
                                theme: {
                                    ...
                                    focus: {
                                        ...
                                        params: {
                                            carbonColor: {
                                                name: 'operator-name',
                                                params: operator_name_1.OperatorNameColorThemeProvider.defaultValues
                                            }
                                        }
                                    }
                                }
