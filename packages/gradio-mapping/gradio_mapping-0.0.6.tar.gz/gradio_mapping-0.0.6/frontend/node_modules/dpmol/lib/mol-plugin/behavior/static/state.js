...
function Snapshots(ctx) {
    ...
    commands_1.PluginCommands.State.Snapshots.Add.subscribe(ctx, function (_a) {
        ...
        var entry = snapshots_1.PluginStateSnapshotManager.Entry(ctx.state.getSnapshot(params), { name: name, description: description });
    ...
    commands_1.PluginCommands.State.Snapshots.Upload.subscribe(ctx, function (_a) {
        ...
        return fetch((0, url_1.urlCombine)(serverUrl, "set?name=".concat(encodeURIComponent(name || ''), "&description=").concat(encodeURIComponent(description || ''))), {
            method: 'POST',
            mode: 'cors',
    ...
    commands_1.PluginCommands.State.Snapshots.Fetch.subscribe(ctx, function (_a) {
        ...
        return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, ctx.runTask(ctx.fetch({ url: url, type: 'json' }))]; //  fetch(url, { referrer: 'no-referrer' });
                    case 1:
                        json = _b.sent() //  fetch(url, { referrer: 'no-referrer' });
                        ;
