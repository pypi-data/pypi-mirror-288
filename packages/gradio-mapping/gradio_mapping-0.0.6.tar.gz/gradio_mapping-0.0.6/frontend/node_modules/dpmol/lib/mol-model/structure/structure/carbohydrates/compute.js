...
function computeCarbohydrates(structure) {
        ...
        while (chainIt.hasNext) {
            ...
            while (residueIt.hasNext) {
                ...
                for (var j = 0, jl = sugarRings.length; j < jl; ++j) {
                    ...
                    var center = linear_algebra_1.Vec3.copy(linear_algebra_1.Vec3.zero(), ma.origin);
                    var normal = linear_algebra_1.Vec3.copy(linear_algebra_1.Vec3.zero(), ma.dirC);
                    var direction = getDirection(linear_algebra_1.Vec3.zero(), unit, anomericCarbon, center);
    ...
    return (0, tslib_1.__assign)({ links: links, terminalLinks: terminalLinks, elements: elements, partialElements: partialElements }, buildLookups(elements, links, terminalLinks));
}
