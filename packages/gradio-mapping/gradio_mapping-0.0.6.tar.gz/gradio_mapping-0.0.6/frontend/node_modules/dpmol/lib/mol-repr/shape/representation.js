...
function ShapeRepresentation(getShape, geometryUtils, builder) {
    ...
    function createOrUpdate(props, data) {
        ...
        return mol_task_1.Task.create('ShapeRepresentation.create', function (runtime) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                    ...
                    case 3:
                        ...
                        if (updateState.createNew) {
                            ...
                            if (updateState.updateTransform) {
                                ...
                                (0, marker_data_1.createMarkers)(instanceCount * groupCount, _renderObject.values);
                            }
                            if (updateState.createGeometry) {
