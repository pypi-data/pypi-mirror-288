...
var CartoonVisuals = {
    'polymer-trace': function (ctx, getParams) {
        return (0, units_representation_1.UnitsRepresentation)('Polymer trace mesh', ctx, getParams, polymer_trace_mesh_1.PolymerTraceVisual);
    },
    'polymer-gap': function (ctx, getParams) {
        return (0, units_representation_1.UnitsRepresentation)('Polymer gap cylinder', ctx, getParams, polymer_gap_cylinder_1.PolymerGapVisual);
    },
    'nucleotide-block': function (ctx, getParams) {
        return (0, units_representation_1.UnitsRepresentation)('Nucleotide block mesh', ctx, getParams, nucleotide_block_mesh_1.NucleotideBlockVisual);
    },
    'nucleotide-ring': function (ctx, getParams) {
        return (0, units_representation_1.UnitsRepresentation)('Nucleotide ring mesh', ctx, getParams, nucleotide_ring_mesh_1.NucleotideRingVisual);
    },
    'direction-wedge': function (ctx, getParams) {
        return (0, units_representation_1.UnitsRepresentation)('Polymer direction wedge', ctx, getParams, polymer_direction_wedge_1.PolymerDirectionVisual);
    }
};
...
exports.CartoonRepresentationProvider = (0, representation_2.StructureRepresentationProvider)({
    ...
    ensureCustomProperties: {
        attach: function (ctx, structure) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var _i, _a, m;
