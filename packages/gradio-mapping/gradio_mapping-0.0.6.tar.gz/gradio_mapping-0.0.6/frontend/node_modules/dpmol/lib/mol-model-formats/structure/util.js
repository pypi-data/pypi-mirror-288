...
var TwoCharElementNames = new Set(['NA', 'CL', 'FE', 'SI', 'BR', 'AS', 'LI']);
var OneCharElementNames = new Set(['C', 'H', 'N', 'O', 'P', 'S', 'F', 'B']);
...
function guessElementSymbolString(atomId, compId) {
    ...
    if (OneCharElementNames.has(atomId[0]))
        return atomId[0];
    return atomId; // no reasonable guess, return empty string
}
