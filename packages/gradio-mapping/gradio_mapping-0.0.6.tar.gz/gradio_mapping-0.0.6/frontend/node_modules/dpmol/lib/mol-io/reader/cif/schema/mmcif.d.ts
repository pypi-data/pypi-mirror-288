...
export declare const mmCIF_Schema: {
    ...
    ihm_ensemble_info: {
         ...
         */
        ensemble_clustering_method: Schema.Aliased<"Hierarchical" | "Partitioning (k-means)" | "Other">;
        /**
    ...
    ma_target_ref_db_details: {
         ...
         */
        db_name: Schema.Aliased<"GB" | "Other" | "UNP" | "OrthoDB" | "NCBI" | "JGI">;
        /**
