...
var DistanceVisuals = {
    lines: function (ctx, getParams) {
        return (0, representation_1.ShapeRepresentation)(getLinesShape, lines_1.Lines.Utils, {
            modifyState: function (s) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, s), { pickable: true, markerActions: marker_action_1.MarkerActions.All })); }
        });
    },
...
function getDistanceName(data, unitLabel) {
    return data.pairs.length === 1
        ? "Distance ".concat((0, label_1.distanceLabel)(data.pairs[0], {
            unitLabel: unitLabel,
            measureOnly: true
        }))
        : "".concat(data.pairs.length, " Distances");
}
//
...
function DistanceRepresentation(ctx, getParams) {
    var repr = representation_2.Representation.createMulti('Distance', ctx, getParams, representation_2.Representation.StateBuilder, DistanceVisuals);
