...
declare class StructureComponentManager extends StatefulPluginComponent<StructureComponentManagerState> {
    ...
    deleteByStructure(component: StructureComponentRef, deleteComponent: Structure): Promise<void>;
...
declare namespace StructureComponentManager {
    const OptionsParams: {
        ...
        interactions: PD.Group<PD.Normalize<{
            ...
            type: import("../../../light-plugin/representation").INTERACTION_TYPE;
            featuresList: import("../../../mol-model-props/computed/interactions/features").Features[];
