...
var uni_fold_1 = require("./color/uni-fold");
var cdr_1 = require("./color/cdr");
var multi_theme_1 = require("./color/multi-theme");
var em_confidence_1 = require("./color/em-confidence");
var ColorTheme;
(function (ColorTheme) {
    ...
    function areEqual(themeA, themeB) {
        return (themeA.contextHash === themeB.contextHash &&
            themeA.factory === themeB.factory &&
            (0, mol_util_1.deepEqual)(themeA.props, themeB.props));
    }
    ...
    ColorTheme.BuiltIn = {
        ...
        'uni-fold': uni_fold_1.UniFoldProvider,
        'cdr': cdr_1.CDRColorThemeProvider,
        'em-confidence': em_confidence_1.EMColorThemeProvider,
        'multi-theme': multi_theme_1.MultiThemeColorThemeProvider,
    };
})(ColorTheme || (ColorTheme = {}));
exports.ColorTheme = ColorTheme;
function ColorThemeProvider(p) {
    return p;
}
