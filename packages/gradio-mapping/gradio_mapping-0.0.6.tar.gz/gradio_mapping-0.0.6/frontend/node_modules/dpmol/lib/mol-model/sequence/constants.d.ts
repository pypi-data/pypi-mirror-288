 ...
 */
export declare type AminoAlphabet = 'H' | 'R' | 'K' | 'I' | 'F' | 'L' | 'W' | 'A' | 'M' | 'P' | 'C' | 'N' | 'V' | 'G' | 'S' | 'Q' | 'Y' | 'D' | 'E' | 'T' | 'U' | 'O' | 'X' /** = Unknown */ | '-' /** = Gap */ | 'ACE' /** ACE */ | 'NME'; /** NEM */
export declare type NuclecicAlphabet = 'A' | 'C' | 'G' | 'T' | 'U' | 'X' /** = Unknown */ | '-'; /** = Gap */
