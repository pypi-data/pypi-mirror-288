...
(function (ColorScale) {
    function create(props) {
        ...
        var list = typeof listOrName === 'string'
            ? (0, lists_1.getColorListFromName)(listOrName).list
            : listOrName;
        ...
        var minLabel = (0, index_1.defaults)(props.minLabel, min.toString());
        var maxLabel = (0, index_1.defaults)(props.maxLabel, max.toString());
        var color;
        ...
        return {
            ...
            setDomain: setDomain,
            get legend() {
                return (0, legend_1.ScaleLegend)(minLabel, maxLabel, colors);
            }
        };
    }
