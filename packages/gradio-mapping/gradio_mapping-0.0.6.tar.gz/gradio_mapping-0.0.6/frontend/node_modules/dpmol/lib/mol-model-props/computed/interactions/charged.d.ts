...
export declare const DefaultIonicParams: PD.Values<{
    distanceMax: PD.Numeric;
}>;
declare type IonicParams = typeof IonicParams;
export declare type IonicProps = PD.Values<IonicParams>;
declare const PiStackingParams: {
    distanceMax: PD.Numeric;
    offsetMax: PD.Numeric;
    angleDevMax: PD.Numeric;
};
export declare const DefaultPiStackingParams: PD.Values<{
    distanceMax: PD.Numeric;
    offsetMax: PD.Numeric;
    angleDevMax: PD.Numeric;
}>;
declare type PiStackingParams = typeof PiStackingParams;
export declare type PiStackingProps = PD.Values<PiStackingParams>;
declare const CationPiParams: {
    distanceMax: PD.Numeric;
    offsetMax: PD.Numeric;
};
export declare const DefaultCationPiParams: PD.Values<{
    distanceMax: PD.Numeric;
    offsetMax: PD.Numeric;
}>;
declare type CationPiParams = typeof CationPiParams;
export declare type CationPiProps = PD.Values<CationPiParams>;
