...
var stripIndicesRing5_6 = new Uint32Array([
...
var stripIndicesRing6 = new Uint32Array([
        ...
        while (residueIt.hasNext) {
            ...
            if ((0, types_1.isNucleic)(moleculeType[residueIndex])) {
                ...
                if (!isPurine && !isPyrimidine) {
                    ...
                    if (idxC4_1 !== -1 &&
                        idxN9_1 !== -1 &&
                        linear_algebra_1.Vec3.distance(pos(idxC4_1, pC4), pos(idxN9_1, pN9)) < 1.6) {
                        isPurine = true;
                    }
                    else {
                        isPyrimidine = true;
...
exports.NucleotideRingParams = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, units_visual_1.UnitsMeshParams), exports.NucleotideRingMeshParams);
...
//# sourceMappingURL=nucleotide-ring-mesh.js.map