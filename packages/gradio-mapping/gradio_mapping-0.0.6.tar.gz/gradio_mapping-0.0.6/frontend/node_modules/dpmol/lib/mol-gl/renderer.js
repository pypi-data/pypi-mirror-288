...
exports.RendererParams = {
    backgroundColor: param_definition_1.ParamDefinition.Color((0, color_1.Color)(0x000000), {
        description: 'Background color of the 3D canvas'
    }),
    pickingAlphaThreshold: param_definition_1.ParamDefinition.Numeric(0.3, { min: 0.0, max: 1.0, step: 0.01 }, {
    ...
    markerPriority: param_definition_1.ParamDefinition.Select(1, [
        [1, 'Highlight'],
        [2, 'Select']
    ]),
    ...
    }, function (o) { return color_1.Color.toHexString(o.color); }, {
        defaultValue: [
            {
                inclination: 180,
                azimuth: 0,
    ...
    ambientIntensity: param_definition_1.ParamDefinition.Numeric(0.45, { min: 0.0, max: 1.0, step: 0.01 }),
    invalidColor: param_definition_1.ParamDefinition.Color((0, color_1.Color)(0xfa6666)),
    invalidStrength: param_definition_1.ParamDefinition.Numeric(0.2, { min: 0.0, max: 1.0, step: 0.1 }),
};
...
(function (Renderer) {
    function create(ctx, props) {
        ...
        var sharedTexturesList = [['tDepth', emptyDepthTexture]];
        ...
        var globalUniforms = {
            ...
            uInvalidColor: mol_util_1.ValueCell.create(color_1.Color.toVec3Normalized((0, linear_algebra_1.Vec3)(), p.invalidColor)),
            uInvalidStrength: mol_util_1.ValueCell.create(p.invalidStrength),
        };
            ...
            if (r.values.dGeometryType.ref.value === 'directVolume') {
                ...
                if (r.values.uDoubleSided) {
                    if (r.values.uDoubleSided.ref.value ||
                        r.values.hasReflection.ref.value) {
                        state.disable(gl.CULL_FACE);
                    }
                    else {
        ...
        var update = function (camera) {
            ...
            mol_util_1.ValueCell.update(globalUniforms.uViewOffset, camera.viewOffset.enabled
                ? linear_algebra_1.Vec2.set(viewOffset, camera.viewOffset.offsetX * 16, camera.viewOffset.offsetY * 16)
                : linear_algebra_1.Vec2.set(viewOffset, 0, 0));
        ...
        var renderBlendedVolumeOpaque = function (group, camera, depthTexture) {
            ...
            for (var i = 0, il = renderables.length; i < il; ++i) {
                ...
                if (alpha === 1 &&
                    ...
                    !((_a = r.values.dXrayShaded) === null || _a === void 0 ? void 0 : _a.ref.value)) {
                    renderObject(r, 'colorBlended');
                }
            }
        };
        ...
        var renderWboitOpaque = function (group, camera, depthTexture) {
            ...
            for (var i = 0, il = renderables.length; i < il; ++i) {
                ...
                if (alpha === 1 &&
                    ...
                    ((_a = r.values.dPointStyle) === null || _a === void 0 ? void 0 : _a.ref.value) !== 'fuzzy' &&
                    !((_b = r.values.dXrayShaded) === null || _b === void 0 ? void 0 : _b.ref.value)) {
        ...
        return {
            ...
            setProps: function (props) {
                ...
                if (props.pickingAlphaThreshold !== undefined &&
                ...
                if (props.interiorDarkening !== undefined &&
                ...
                if (props.interiorColorFlag !== undefined &&
                ...
                if (props.interiorColor !== undefined &&
                    props.interiorColor !== p.interiorColor) {
                ...
                if (props.highlightColor !== undefined &&
                    props.highlightColor !== p.highlightColor) {
                ...
                if (props.selectColor !== undefined &&
                    props.selectColor !== p.selectColor) {
                ...
                if (props.highlightStrength !== undefined &&
                ...
                if (props.ambientColor !== undefined &&
                    props.ambientColor !== p.ambientColor) {
                ...
                if (props.invalidColor !== undefined && props.invalidColor !== p.invalidColor) {
                    p.invalidColor = props.invalidColor;
                    mol_util_1.ValueCell.update(globalUniforms.uInvalidColor, color_1.Color.toVec3Normalized(globalUniforms.uInvalidColor.ref.value, p.invalidColor));
                }
                if (props.invalidStrength !== undefined && props.invalidStrength !== p.invalidStrength) {
                    p.invalidStrength = props.invalidStrength;
                    mol_util_1.ValueCell.update(globalUniforms.uInvalidStrength, p.invalidStrength);
                }
            },
