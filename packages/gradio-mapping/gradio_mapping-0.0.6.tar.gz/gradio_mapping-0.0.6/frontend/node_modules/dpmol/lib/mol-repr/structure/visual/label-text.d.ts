...
export declare type LabelTextParams = typeof LabelTextParams;
export declare type LabelTextProps = PD.Values<LabelTextParams>;
export declare type LabelLevels = LabelTextProps['level'];
