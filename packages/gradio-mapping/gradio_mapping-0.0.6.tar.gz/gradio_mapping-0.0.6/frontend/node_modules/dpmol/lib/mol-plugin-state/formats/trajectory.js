...
exports.BuiltInTrajectoryFormats = exports.Mol2Provider = exports.SdfProvider = exports.MolProvider = exports.GroProvider = exports.PdbProvider = exports.MmcifProvider = exports.TrajectoryFormatCategory = void 0;
            ...
            switch (_c.label) {
                case 0:
                    ...
                    cif = state
                        .build()
                        .to(data)
                        .apply(transforms_1.StateTransforms.Data.ParseCif, void 0, {
                        state: { isGhost: true }
                    });
                    return [4 /*yield*/, cif
                            .apply(transforms_1.StateTransforms.Model.TrajectoryFromMmCif, void 0, {
...
function directTrajectory(transformer, transformerParams) {
    var _this = this;
    return function (plugin, data, params) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
