...
function GaussianSurfaceVisual(materialId, structure, props, webgl) {
    if (props.tryUseGpu &&
        webgl &&
        gpuSupport(webgl) &&
        suitableForGpu(structure, props, webgl)) {
...
function createGaussianSurfaceTextureMesh(ctx, unit, structure, theme, props, textureMesh) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        var _a, namedTextures, resources, _b, colorBufferFloat, textureFloat, colorBufferHalfFloat, textureHalfFloat, densityTextureData, isoLevel, axisOrder, buffer, gv, boundingSphere, surface;
        return (0, tslib_1.__generator)(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    surface.meta.resolution =
                        densityTextureData.resolution;
                    return [2 /*return*/, surface];
            }
        });
    });
