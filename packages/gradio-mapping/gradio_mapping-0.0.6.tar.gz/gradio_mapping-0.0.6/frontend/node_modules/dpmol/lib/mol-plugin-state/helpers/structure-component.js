...
function createStructureComponent(a, params, cache) {
        ...
        case 'static': {
            ...
            switch (params.type.params) {
                ...
                case 'coarse':
                    ...
                    break;
                default:
                    (0, type_helpers_1.assertUnreachable)(params.type);
            }
    ...
    var props = {
        label: "".concat(params.label || label || 'Component'),
        description: structure_1.Structure.elementDescription(component)
    };
...
function updateStructureComponent(a, b, oldParams, newParams, cache) {
    ...
    switch (newParams.type.name) {
        ...
        case 'bundle': {
            if (a === cache.source &&
                structure_1.StructureElement.Bundle.areEqual(oldParams.type.params, newParams.type.params)) {
                break;
            }
            cache.source = a;
