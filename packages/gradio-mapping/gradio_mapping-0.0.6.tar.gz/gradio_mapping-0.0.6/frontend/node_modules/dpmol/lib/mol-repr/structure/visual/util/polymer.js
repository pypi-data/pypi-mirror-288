...
(0, tslib_1.__exportStar)(require("./polymer/backbone"), exports);
(0, tslib_1.__exportStar)(require("./polymer/gap-iterator"), exports);
(0, tslib_1.__exportStar)(require("./polymer/trace-iterator"), exports);
(0, tslib_1.__exportStar)(require("./polymer/curve-segment"), exports);
...
function eachAtomicUnitTracedElement(offset, groupSize, elementsSelector, apply, e) {
    ...
    if (int_1.Interval.is(e.indices)) {
        if (int_1.Interval.start(e.indices) === 0 &&
            int_1.Interval.end(e.indices) === e.unit.elements.length) {
            // full unit here
            ...
            changed =
                tryApplyResidueInterval(offset, tracedElements, traceElementIndex, apply, r1, r2) || changed;
        }
    }
    else {
...
function eachPolymerElement(loci, structureGroup, apply) {
    ...
    for (var _a = 0, _b = loci.elements; _a < _b.length; _a++) {
        ...
        if (structure_1.Unit.isAtomic(e.unit)) {
            changed =
                eachAtomicUnitTracedElement(offset, groupCount, selectPolymerElements, apply, e) || changed;
        }
        else {
            if (int_1.Interval.is(e.indices)) {
                ...
                for (var i = 0, _i = e.indices.length; i < _i; i++) {
                    ...
                    var end = e.indices[i];
                    changed =
                        apply(int_1.Interval.ofRange(offset + start, offset + end)) || changed;
                }
            }
        }
    }
