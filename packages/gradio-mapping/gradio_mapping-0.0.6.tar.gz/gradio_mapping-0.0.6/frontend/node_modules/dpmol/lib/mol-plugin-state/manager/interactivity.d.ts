...
export declare type InteractivityFocusLociOptions = typeof DefaultInteractivityFocusOptions;
...
declare namespace InteractivityManager {
     ...
     * they can be applied.
     */
    type LociMarkProvider = (loci: Representation.Loci, action: MarkerAction, noRender?: boolean) => void;
    abstract class LociMarkManager {
        readonly ctx: PluginContext;
        protected providers: LociMarkProvider[];
        sel: StructureSelectionManager;
        ...
        protected normalizedLoci(reprLoci: Representation.Loci, applyGranularity: boolean, alwaysConvertBonds?: boolean): {
            loci: Loci;
            repr: Representation.Any | undefined;
        };
        mark(current: Representation.Loci, action: MarkerAction, noRender?: boolean): void;
    ...
    class LociHighlightManager extends LociMarkManager {
        ...
        markShape(current: Representation.Loci, action: MarkerAction): void;
        clearMarkShape(): void;
    }
    class LociSelectManager extends LociMarkManager {
        ...
        mark(current: Representation.Loci, action: MarkerAction.Select | MarkerAction.Deselect): void;
        private toggleSel;
    }
}
