...
(function (Mesh) {
    ...
    function createValuesSimple(mesh, props, colorValue, sizeValue, transform) {
        ...
        var p = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, param_definition_1.ParamDefinition.getDefaultValues(Mesh.Params)), props);
    ...
    function updateBoundingSphere(values, mesh) {
        var invariantBoundingSphere = geometry_1.Sphere3D.clone(mesh.boundingSphere);
        var boundingSphere = (0, util_3.calculateTransformBoundingSphere)(invariantBoundingSphere, values.aTransform.ref.value, values.instanceCount.ref.value);
