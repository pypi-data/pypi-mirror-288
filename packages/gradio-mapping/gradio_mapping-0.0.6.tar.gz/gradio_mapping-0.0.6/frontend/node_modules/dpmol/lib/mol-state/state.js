...
var State = /** @class */ (function () {
    function State(rootObject, params) {
        ...
        this.cells.set(root.ref, {
            ...
            obj: rootObject,
            status: 'ok',
            state: (0, tslib_1.__assign)({}, root.state),
            errorText: void 0,
            params: {
                definition: {},
                values: {}
    ...
    State.prototype.build = function () {
        return new builder_1.StateBuilder.Root(this.tree, this);
    };
    ...
    State.prototype.undo = function () {
        var _this = this;
        return mol_task_1.Task.create('Undo', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var e;
    ...
    State.prototype.updateCellState = function (ref, stateOrProvider) {
        ...
        if (!cell)
            return;
        var update = typeof stateOrProvider === 'function'
    ...
    State.prototype.transaction = function (edits, options) {
        var _this = this;
        return mol_task_1.Task.create('State Transaction', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
    ...
    State.prototype.updateTree = function (tree, options) {
        ...
        return mol_task_1.Task.create('Update Tree', function (taskCtx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ret = _a.sent();
                        revert = ((ret.ctx.hadError || ret.ctx.wasAborted) && options.revertOnError) ||
                            (ret.ctx.wasAborted && options.revertIfAborted);
                        if (!revert) return [3 /*break*/, 3];
                        this.reverted = true;
                        return [4 /*yield*/, this._updateTree(taskCtx, {
                                tree: old,
    ...
    State.prototype.updateTreeAndCreateCtx = function (tree, taskCtx, options) {
        ...
        var ctx = {
            ...
            spine: this.spine,
            results: [],
            options: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, StateUpdateDefaultOptions), options),
            changed: false,
            hadError: false,
            wasAborted: false,
            newCurrent: void 0,
...
function update(ctx) {
    var _a, _b, _c;
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        var fastTrack, deletes, deletedObjects, roots, current, hasCurrent, _i, deletes_1, d, newCurrent_1, i, cell, _d, deletes_2, d, cell, obj, init, _e, _f, cell, i, d, parent_1, _g, _h, cell, mergedRef, measureRef, _j, roots_1, root, _k, mergedRef_1, root, _l, measureRef_1, root, newCurrent, _m, _o, update_1, transform, current, currentCell;
        return (0, tslib_1.__generator)(this, function (_p) {
            switch (_p.label) {
                case 0:
                    fastTrack = !!(ctx.editInfo &&
                    ...
                    if (fastTrack) {
                        ...
                        for (_d = 0, deletes_2 = deletes; _d < deletes_2.length; _d++) {
                            d = deletes_2[_d];
                    ...
                    for (_e = 0, _f = init.added; _e < _f.length; _e++) {
                        cell = _f[_e];
                    ...
                    if (deletedObjects.length)
                        deletedObjects = [];
                    if (init.dependent) {
                        for (_g = 0, _h = init.dependent; _g < _h.length; _g++) {
                            cell = _h[_g];
                    ...
                    _p.label = 1;
                case 1:
                    if (!(_j < roots_1.length)) return [3 /*break*/, 4];
                    root = roots_1[_j];
                    if (((_a = ctx.cells.get(root)) === null || _a === void 0 ? void 0 : _a.transform.transformer.id) === 'ms-plugin.merge-structures') {
                        mergedRef.push(root);
                        return [3 /*break*/, 3];
                    }
                    if (((_b = ctx.cells.get(root)) === null || _b === void 0 ? void 0 : _b.transform.tags) && ((_c = ctx.cells.get(root)) === null || _c === void 0 ? void 0 : _c.transform.tags[0]) === 'measurement-group') {
                        measureRef.push(root);
                        return [3 /*break*/, 3];
                    }
                ...
                case 3:
                    ...
                    return [3 /*break*/, 1];
                case 4:
                    _k = 0, mergedRef_1 = mergedRef;
                    _p.label = 5;
                case 5:
                    if (!(_k < mergedRef_1.length)) return [3 /*break*/, 8];
                    root = mergedRef_1[_k];
                    return [4 /*yield*/, updateSubtree(ctx, root)];
                case 6:
                    _p.sent();
                ...
                case 7:
                    ...
                    return [3 /*break*/, 5];
                case 8:
                    _l = 0, measureRef_1 = measureRef;
                    _p.label = 9;
                case 9:
                    if (!(_l < measureRef_1.length)) return [3 /*break*/, 12];
                    root = measureRef_1[_l];
                    return [4 /*yield*/, updateSubtree(ctx, root)];
                case 10:
                    _p.sent();
                    _p.label = 11;
                ...
                case 12:
                    ...
                    for (_m = 0, _o = ctx.results; _m < _o.length; _m++) {
                        update_1 = _o[_m];
                    ...
                    if (newCurrent) {
                        ...
                        if (currentCell &&
                            (currentCell.obj === object_1.StateObject.Null ||
...
// CHANGED by cly
function addOrUpdateCellsVisitor(transform, _, _a) {
    var ctx = _a.ctx, added = _a.added, visited = _a.visited, updated = _a.updated;
    visited.add(transform.ref);
    if (ctx.cells.has(transform.ref)) {
        // CHANGED by cly
        var cell_1 = ctx.cells.get(transform.ref);
        if (!(0, array_1.arrayEqual)(cell_1 === null || cell_1 === void 0 ? void 0 : cell_1.dependencies.dependsOn.map(function (d) { return d.sourceRef; }), transform.dependsOn)) {
            cell_1.transform = transform;
            ctx.cells.set(transform.ref, cell_1);
            updated.push(cell_1);
        }
        return;
    }
    var cell = {
        ...
        sourceRef: void 0,
        status: 'pending',
        state: (0, tslib_1.__assign)({}, transform.state),
        errorText: void 0,
        params: void 0,
...
function initCells(ctx, roots) {
    ...
    for (var _i = 0, roots_3 = roots; _i < roots_3.length; _i++) {
        var root = roots_3[_i];
        tree_1.StateTree.doPreOrder(ctx.tree, ctx.tree.transforms.get(root), initCtx, 
        // CHANGED
        addOrUpdateCellsVisitor);
    }
    ...
    // CHANGED by cly
    for (var _c = 0, _d = initCtx.updated; _c < _d.length; _c++) {
        var cell = _d[_c];
        linkCells(cell, ctx);
    }
    var dependent;
...
function updateSubtree(ctx, root) {
    var _a, _b, _c;
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        var isNull, start, update_2, time, e_2, children, mergedRef, measureRef, next;
        return (0, tslib_1.__generator)(this, function (_d) {
            switch (_d.label) {
                ...
                case 5:
                    ...
                    next = children.next();
                    if (((_a = ctx.cells.get(next.value)) === null || _a === void 0 ? void 0 : _a.transform.transformer.id) === 'ms-plugin.merge-structures') {
                        mergedRef = next;
                        return [3 /*break*/, 5];
                    }
                    if (((_b = ctx.cells.get(next.value)) === null || _b === void 0 ? void 0 : _b.transform.params.label) === 'Measurements' && ((_c = ctx.cells.get(next.value)) === null || _c === void 0 ? void 0 : _c.transform.tags[0]) === 'measurement-group') {
                        measureRef = next;
                        return [3 /*break*/, 5];
                    }
                    if (next.done)
                ...
                case 9:
                    if (!(mergedRef && !mergedRef.done)) return [3 /*break*/, 11];
                    return [4 /*yield*/, updateSubtree(ctx, mergedRef.value)];
                case 10:
                    _d.sent();
                    _d.label = 11;
                case 11:
                    if (!(measureRef && !measureRef.done)) return [3 /*break*/, 13];
                    return [4 /*yield*/, updateSubtree(ctx, measureRef.value)];
                case 12:
                    _d.sent();
                    _d.label = 13;
...
function updateObject(ctx, cell, transformer, a, b, oldParams, newParams) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        return (0, tslib_1.__generator)(this, function (_a) {
            ...
            if (!cell.cache)
                cell.cache = Object.create(null);
            return [2 /*return*/, runTask(transformer.definition.update({
                    a: a,
                    oldParams: oldParams,
                    b: b,
                    newParams: newParams,
