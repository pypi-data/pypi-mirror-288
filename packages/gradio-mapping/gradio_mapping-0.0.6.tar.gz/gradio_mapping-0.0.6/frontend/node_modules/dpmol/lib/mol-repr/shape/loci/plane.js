...
var _PlaneParams = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, mesh_1.Mesh.Params), { color: param_definition_1.ParamDefinition.Color(names_1.ColorNames.orange), scaleFactor: param_definition_1.ParamDefinition.Numeric(1, { min: 0.1, max: 10, step: 0.1 }) });
var PlaneVisuals = {
    plane: function (ctx, getParams) { return (0, representation_1.ShapeRepresentation)(getPlaneShape, mesh_1.Mesh.Utils); }
};
exports.PlaneParams = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, _PlaneParams), { visuals: param_definition_1.ParamDefinition.MultiSelect(['plane'], param_definition_1.ParamDefinition.objectToOptions(PlaneVisuals)) });
//
