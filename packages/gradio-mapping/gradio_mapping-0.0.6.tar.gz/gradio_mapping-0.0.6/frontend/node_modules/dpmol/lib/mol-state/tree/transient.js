...
var TransientTree = /** @class */ (function () {
    ...
    Object.defineProperty(TransientTree.prototype, "root", {
        get: function () {
            return this.transforms.get(transform_1.StateTransform.RootRef);
        },
        enumerable: false,
        configurable: true
    });
    ...
    TransientTree.prototype.setParams = function (ref, params) {
        ...
        // Changed by cly
        if (params.dependsOn) {
            for (var _i = 0, _a = params.dependsOn; _i < _a.length; _i++) {
                var d = _a[_i];
                this.mutateDependency(d, ref, 'add');
            }
        }
            ...
            if (this.dependencies.has(n.ref)) {
                ...
                for (var _d = 0, deps_1 = deps; _d < deps_1.length; _d++) {
                    ...
                    if (!this.transforms.has(dep))
                        continue;
                    var depNode = this.transforms.get(dep);
                    if (depNode.transformer.id !== 'ms-plugin.merge-structures') {
    ...
    TransientTree.prototype.asImmutable = function () {
        ...
        return immutable_2.StateTree.create(this.changedNodes ? this.transforms.asImmutable() : this.transforms, this.changedChildren ? this.children.asImmutable() : this.children, this.changedDependencies
