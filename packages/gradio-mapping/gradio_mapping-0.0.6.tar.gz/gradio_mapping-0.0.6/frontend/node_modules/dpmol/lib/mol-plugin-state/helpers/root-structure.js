...
var CommonStructureParams = {
    dynamicBonds: param_definition_1.ParamDefinition.Optional(param_definition_1.ParamDefinition.Boolean(false, {
        description: 'Ensure bonds are recalculated upon model changes. Also enables calculation of inter-unit bonds in water molecules and ions.'
    }))
};
...
(function (RootStructureDefinition) {
    function getParams(model, defaultValue) {
        ...
        var assemblyIds = symmetry
            ? symmetry.assemblies.map(function (a) {
                return [a.id, "".concat(a.id, ": ").concat((0, string_1.stringToWords)(a.details))];
            })
            : [];
        var showSymm = !symmetry
            ? true
            : !geometry_1.SpacegroupCell.isZero(symmetry.spacegroup.cell);
        var operatorOptions = [];
        if (symmetry) {
            ...
            for (var i = 0, il = operators.length; i < il; i++) {
                operatorOptions.push([
                    i,
                    "".concat(i + 1, ": ").concat(geometry_1.Spacegroup.getOperatorXyz(operators[i]))
                ]);
            }
        }
        var asymIdsOptions = [];
        ...
        var modes = {
            ...
            assembly: param_definition_1.ParamDefinition.Group((0, tslib_1.__assign)({ id: param_definition_1.ParamDefinition.Optional(model
                    ...
                    : param_definition_1.ParamDefinition.Text('', {
                        label: 'Asm Id',
                        description: 'Assembly Id (use empty for the 1st assembly)'
                    })) }, CommonStructureParams), { isFlat: true }),
            'symmetry-mates': param_definition_1.ParamDefinition.Group((0, tslib_1.__assign)({ radius: param_definition_1.ParamDefinition.Numeric(5, { min: 0, max: 50, step: 1 }) }, CommonStructureParams), { isFlat: true }),
            symmetry: param_definition_1.ParamDefinition.Group((0, tslib_1.__assign)({ ijkMin: param_definition_1.ParamDefinition.Vec3(linear_algebra_1.Vec3.create(-1, -1, -1), { step: 1 }, { label: 'Min IJK', fieldLabels: { x: 'I', y: 'J', z: 'K' } }), ijkMax: param_definition_1.ParamDefinition.Vec3(linear_algebra_1.Vec3.create(1, 1, 1), { step: 1 }, { label: 'Max IJK', fieldLabels: { x: 'I', y: 'J', z: 'K' } }) }, CommonStructureParams), { isFlat: true }),
            'symmetry-assembly': param_definition_1.ParamDefinition.Group((0, tslib_1.__assign)({ generators: param_definition_1.ParamDefinition.ObjectList({
    ...
    function canAutoUpdate(oldParams, newParams) {
        if (newParams.name === 'symmetry-assembly' ||
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (!asm) {
                            label = {
                                label: 'Model',
                                description: structure_1.Structure.elementDescription(base)
                            };
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        s = _a.sent();
                        objProps = {
                            label: "Symmetry [".concat(ijkMin, "] to [").concat(ijkMax, "]"),
                            description: structure_1.Structure.elementDescription(s)
                        };
                        return [2 /*return*/, new objects_1.PluginStateObject.Molecule.Structure(s, objProps)];
                }
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                ...
                if (!symmetry || !params || params.name === 'model') {
                    ...
                    return [2 /*return*/, new objects_1.PluginStateObject.Molecule.Structure(s, {
                            label: 'Model',
                            description: structure_1.Structure.elementDescription(s)
                        })];
                }
