...
function includeSurroundings(query, params) {
    return function query_includeSurroundings(ctx) {
        ...
        if (params.elementRadius) {
            var prms = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, params), { elementRadius: params.elementRadius, elementRadiusClosure: createElementRadiusFn(ctx, params.elementRadius), sourceMaxRadius: findStructureRadius(ctx, params.elementRadius) });
            if (selection_1.StructureSelection.isSingleton(inner)) {
        ...
        while (stack.length > 0) {
            ...
            for (var _a = 0, _b = this.edges.get(a); _a < _b.length; _a++) {
                ...
                if (u.operator_name === v.operator_name) {
                    set.add((0, tslib_1.__assign)((0, tslib_1.__assign)({}, v), { operator_name: start.operator_name }));
                }
                else {
                    set.add(v);
                }
