...
function createMarkers(count, markerData) {
    ...
    if (markerData) {
        mol_util_1.ValueCell.updateIfChanged(markerData.uMarker, 0);
        mol_util_1.ValueCell.update(markerData.tMarker, markers);
        mol_util_1.ValueCell.update(markerData.uMarkerTexDim, linear_algebra_1.Vec2.create(markers.width, markers.height));
        mol_util_1.ValueCell.updateIfChanged(markerData.markerAverage, average);
        mol_util_1.ValueCell.updateIfChanged(markerData.markerStatus, status);
        return markerData;
    }
    else {
        return {
            uMarker: mol_util_1.ValueCell.create(0),
            tMarker: mol_util_1.ValueCell.create(markers),
            uMarkerTexDim: mol_util_1.ValueCell.create(linear_algebra_1.Vec2.create(markers.width, markers.height)),
            markerAverage: mol_util_1.ValueCell.create(average),
            markerStatus: mol_util_1.ValueCell.create(status)
        };
    }
}
...
function createEmptyMarkers(markerData) {
    if (markerData) {
        mol_util_1.ValueCell.updateIfChanged(markerData.uMarker, 0);
        mol_util_1.ValueCell.update(markerData.tMarker, emptyMarkerTexture);
        mol_util_1.ValueCell.update(markerData.uMarkerTexDim, linear_algebra_1.Vec2.create(1, 1));
        mol_util_1.ValueCell.updateIfChanged(markerData.markerAverage, 0);
        mol_util_1.ValueCell.updateIfChanged(markerData.markerStatus, 0);
        return markerData;
    }
    else {
        return {
            uMarker: mol_util_1.ValueCell.create(0),
            tMarker: mol_util_1.ValueCell.create(emptyMarkerTexture),
            uMarkerTexDim: mol_util_1.ValueCell.create(linear_algebra_1.Vec2.create(1, 1)),
            markerAverage: mol_util_1.ValueCell.create(0),
            markerStatus: mol_util_1.ValueCell.create(0)
        };
    }
}
