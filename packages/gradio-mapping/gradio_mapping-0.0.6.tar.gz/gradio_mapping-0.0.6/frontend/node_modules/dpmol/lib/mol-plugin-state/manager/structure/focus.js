...
var StructureFocusManager = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(StructureFocusManager, _super);
        ...
        plugin.state.data.events.object.updated.subscribe(function (_a) {
            ...
            if (action === 'in-place') {
                ...
                if (current && current.loci.structure === oldData) {
                    ...
                    _this.state.current = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, current), { loci: loci });
    ...
    StructureFocusManager.prototype.set = function (entry) {
        ...
        if (!this.state.current ||
            !structure_1.StructureElement.Loci.areEqual(this.state.current.loci, entry.loci)) {
    ...
    StructureFocusManager.prototype.setFromLoci = function (anyLoci) {
        ...
        if (!structure_1.StructureElement.Loci.is(loci) ||
            structure_1.StructureElement.Loci.isEmpty(loci)) {
            this.clear();
            return;
        }
        this.set({
            loci: loci,
            label: (0, label_1.lociLabel)(loci, {
                reverse: true,
                hidePrefix: true,
                htmlStyling: false
            })
    ...
    StructureFocusManager.prototype.addFromLoci = function (anyLoci) {
        var union = this.state.current &&
            structure_1.StructureElement.Loci.is(anyLoci) &&
