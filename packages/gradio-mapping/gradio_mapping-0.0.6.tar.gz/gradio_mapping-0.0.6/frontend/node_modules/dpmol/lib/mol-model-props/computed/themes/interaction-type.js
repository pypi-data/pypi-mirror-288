...
var InteractionTypeColors = (0, color_1.ColorMap)({
    HydrogenBond: 0xFF9C33,
    Hydrophobic: 0x808080,
    HalogenBond: 0x5DE8EA,
    Ionic: 0xF164F3,
    MetalCoordination: 0xB1B4D3,
    CationPi: 0x33C46D,
    PiStacking: 0x43B3F9,
    WeakHydrogenBond: 0xFFE89F
});
...
function InteractionTypeColorTheme(ctx, props) {
    var color;
    var interactions = ctx.structure
        ? interactions_1.InteractionsProvider.get(ctx.structure)
        : undefined;
    var contextHash = interactions
        ? (0, util_1.hash2)(interactions.id, interactions.version)
        : -1;
    ...
    ensureCustomProperties: {
        attach: function (ctx, data) {
            return data.structure
                ? interactions_1.InteractionsProvider.attach(ctx, data.structure, void 0, true)
                : Promise.resolve();
        },
        detach: function (data) {
            return data.structure && interactions_1.InteractionsProvider.ref(data.structure, false);
        }
    }
};
