...
export declare type DistinctColorsParams = typeof DistinctColorsParams;
export declare type DistinctColorsProps = PD.Values<typeof DistinctColorsParams>;
/**
 * Create a list of visually distinct colors
 */
export declare function distinctColors(count: number, props?: Partial<DistinctColorsProps>): import("./color").Color[];
