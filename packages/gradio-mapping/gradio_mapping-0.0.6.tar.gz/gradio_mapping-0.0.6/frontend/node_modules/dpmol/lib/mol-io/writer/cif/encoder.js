...
(function (Field) {
    ...
    Field.float = float;
    function index(name) {
        return int(name, function (e, d, i) { return i + 1; }, {
            typedArray: Int32Array,
            encoder: binary_cif_1.ArrayEncoding.by(binary_cif_1.ArrayEncoding.delta)
                .and(binary_cif_1.ArrayEncoding.runLength)
                .and(binary_cif_1.ArrayEncoding.integerPacking)
        });
    }
    Field.index = index;
                ...
                source: [
                    {
                        ...
                        keys: function () { return iterator_1.Iterator.Array(indices); }
                    }
                ]
            };
        }
    ...
    function writeDatabase(encoder, name, database) {
        ...
        var _loop_1 = function (table) {
            encoder.writeCategory({
                name: table,
                instance: function () { return Category.ofTable(database[table]); }
            });
        };
