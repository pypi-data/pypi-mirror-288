...
var AngleVisuals = {
    vectors: function (ctx, getParams) {
        return (0, representation_1.ShapeRepresentation)(getVectorsShape, lines_1.Lines.Utils, {
            modifyState: function (s) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, s), { pickable: false })); }
        });
    },
    ...
    text: function (ctx, getParams) {
        return (0, representation_1.ShapeRepresentation)(getTextShape, text_1.Text.Utils, {
            modifyState: function (s) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, s), { markerActions: marker_action_1.MarkerAction.None })); }
        });
    }
};
exports.AngleParams = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, VectorsParams), ArcParams), SectorParams), common_1.LociLabelTextParams), { visuals: param_definition_1.ParamDefinition.MultiSelect(['vectors', 'sector', 'text'], param_definition_1.ParamDefinition.objectToOptions(AngleVisuals)) });
//
...
function getAngleName(data) {
    return data.triples.length === 1
        ? "Angle ".concat((0, label_1.angleLabel)(data.triples[0], { measureOnly: true }))
        : "".concat(data.triples.length, " Angles");
}
//
