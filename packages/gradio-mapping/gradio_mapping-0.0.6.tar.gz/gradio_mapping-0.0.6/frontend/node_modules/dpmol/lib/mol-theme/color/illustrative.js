...
function IllustrativeColorTheme(ctx, props) {
    var _a = props.style.name === 'uniform'
        ? (0, uniform_1.UniformColorTheme)(ctx, props.style.params)
        : props.style.name === 'chain-id'
            ? (0, chain_id_1.ChainIdColorTheme)(ctx, props.style.params)
            : props.style.name === 'entity-id'
                ? (0, entity_id_1.EntityIdColorTheme)(ctx, props.style.params)
                : props.style.name === 'entity-source'
                    ? (0, entity_source_1.EntitySourceColorTheme)(ctx, props.style.params)
                    : props.style.name === 'molecule-type'
                        ? (0, molecule_type_1.MoleculeTypeColorTheme)(ctx, props.style.params)
    ...
    function illustrativeColor(location, typeSymbol) {
        ...
        return typeSymbol === 'C'
            ? color_1.Color.lighten(baseColor, props.carbonLightness)
            : baseColor;
    }
    function color(location) {
        if (structure_1.StructureElement.Location.is(location) &&
            structure_1.Unit.isAtomic(location.unit)) {
