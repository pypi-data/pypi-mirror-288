...
exports.VolumeFromDensityServerCif = exports.AssignColorVolume = exports.VolumeFromCube = exports.VolumeFromCcp4 = void 0;
...
var VolumeFromCcp4 = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a) {
        ...
        return mol_task_1.Task.create('Create volume from CCP4/MRC/MAP', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var volume, props;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, ccp4_1.volumeFromCcp4)(a.data, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, params), { label: a.data.name || a.label })).runInContext(ctx)];
                    case 1:
                        volume = _a.sent();
...
var VolumeFromCube = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Create volume from Cube', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var volume, props;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, cube_1.volumeFromCube)(a.data, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, params), { label: a.data.name || a.label })).runInContext(ctx)];
                    case 1:
                        volume = _a.sent();
...
var VolumeFromDensityServerCif = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Parse density-server CIF', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
...
var AssignColorVolume = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a) {
        ...
        return mol_task_1.Task.create('Assign Color Volume', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                ...
                volume = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, a.data), { colorVolume: colorVolume });
