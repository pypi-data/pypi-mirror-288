...
(function (Image) {
    ...
    Image.Params = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, base_1.BaseGeometry.Params), { interpolation: param_definition_1.ParamDefinition.Select('bspline', param_definition_1.ParamDefinition.objectToOptions(exports.InterpolationTypes)) });
    Image.Utils = {
        Params: Image.Params,
    ...
    function createValuesSimple(image, props, colorValue, sizeValue, transform) {
        ...
        var p = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, param_definition_1.ParamDefinition.getDefaultValues(Image.Params)), props);
