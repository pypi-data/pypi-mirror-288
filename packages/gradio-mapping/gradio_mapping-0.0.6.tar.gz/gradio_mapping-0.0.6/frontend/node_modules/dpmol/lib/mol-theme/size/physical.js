...
function PhysicalSizeTheme(ctx, props) {
    ...
    function size(location) {
        ...
        if (structure_1.StructureElement.Location.is(location)) {
            ...
            size =
                scale *
                    Math.min(getPhysicalRadius(location.aUnit, location.aUnit.elements[location.aIndex]), getPhysicalRadius(location.bUnit, location.bUnit.elements[location.bIndex]));
        }
        else {
