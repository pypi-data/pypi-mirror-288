...
exports.OperatorNameColorThemeParams = (0, tslib_1.__assign)({}, (0, palette_1.getPaletteParams)({ type: 'colors', colorList: DefaultList }));
...
function OperatorNameColorTheme(ctx, props) {
    ...
    if (ctx.structure) {
        ...
        var palette_2 = (0, palette_1.getPalette)(operatorNameSerialMap_1.size, props, {
