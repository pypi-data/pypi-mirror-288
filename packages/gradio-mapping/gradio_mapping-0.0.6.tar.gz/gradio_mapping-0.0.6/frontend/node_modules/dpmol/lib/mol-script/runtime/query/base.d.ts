...
export declare type ConstQuerySymbolFn<S extends MSymbol = MSymbol> = (ctx: QueryContext, args: QueryRuntimeArguments<S>) => any;
export declare type QuerySymbolFn<S extends MSymbol = MSymbol> = (ctx: QueryContext, args: QueryRuntimeArguments<S>) => any;
export declare type QueryCompiledSymbolRuntime = {
    kind: 'const';
    value: any;
} | {
    kind: 'dynamic';
...
export declare type CompiledQueryFn<T = any> = {
    isConst: boolean;
    fn: QueryFn;
};
...
export declare type QueryRuntimeArguments<S extends MSymbol> = {
    length?: number;
} & {
