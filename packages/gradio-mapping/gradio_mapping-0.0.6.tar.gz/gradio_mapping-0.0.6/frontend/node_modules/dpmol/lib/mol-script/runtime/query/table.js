...
var symbols = [
    // ============= TYPES =============
    C(symbol_table_1.MolScriptSymbolTable.core.type.bool, function core_type_bool(ctx, v) {
        return !!v[0](ctx);
    }),
    C(symbol_table_1.MolScriptSymbolTable.core.type.num, function core_type_num(ctx, v) {
        return +v[0](ctx);
    }),
    C(symbol_table_1.MolScriptSymbolTable.core.type.str, function core_type_str(ctx, v) {
        return '' + v[0](ctx);
    }),
    C(symbol_table_1.MolScriptSymbolTable.core.type.list, function core_type_list(ctx, xs) {
        return base_1.QueryRuntimeArguments.forEachEval(xs, ctx, function (v, i, list) { return (list[i] = v); }, []);
    }),
    C(symbol_table_1.MolScriptSymbolTable.core.type.set, function core_type_set(ctx, xs) {
        return base_1.QueryRuntimeArguments.forEachEval(xs, ctx, function core_type_set_argEval(v, i, set) {
            return set.add(v);
        }, new Set());
    }),
    C(symbol_table_1.MolScriptSymbolTable.core.type.regex, function core_type_regex(ctx, v) {
        return new RegExp(v[0](ctx), (v[1] && v[1](ctx)) || '');
    }),
    C(symbol_table_1.MolScriptSymbolTable.core.type.bitflags, function core_type_bitflags(ctx, v) {
        return +v[0](ctx);
    }),
    C(symbol_table_1.MolScriptSymbolTable.core.type.compositeKey, function core_type_compositeKey(ctx, xs) {
        return base_1.QueryRuntimeArguments.forEachEval(xs, ctx, function (v, i, list) { return (list[i] = '' + v); }, []).join('-');
    }),
    // ============= LOGIC ================
    ...
    // ============= SET ================
    C(symbol_table_1.MolScriptSymbolTable.core.set.has, function core_set_has(ctx, v) {
        return v[0](ctx).has(v[1](ctx));
    }),
    C(symbol_table_1.MolScriptSymbolTable.core.set.isSubset, function core_set_isSubset(ctx, v) {
        return set_1.SetUtils.isSuperset(v[1](ctx), v[0](ctx));
    }),
    // ============= FLAGS ================
    ...
    // Structure
    // ============= TYPES ================
    C(symbol_table_1.MolScriptSymbolTable.structureQuery.type.elementSymbol, function (ctx, v) {
        return (0, types_1.ElementSymbol)(v[0](ctx));
    }),
    C(symbol_table_1.MolScriptSymbolTable.structureQuery.type.atomName, function (ctx, v) {
        return (0, string_1.upperCaseAny)(v[0](ctx));
    }),
    ...
    C(symbol_table_1.MolScriptSymbolTable.structureQuery.type.ringFingerprint, function (ctx, xs) {
        return structure_1.UnitRing.elementFingerprint(getArray(ctx, xs));
    }),
    ...
    // ============= FILTERS ================
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.filter.pick, function (ctx, xs) {
        return structure_1.Queries.filters.pick(xs[0], xs['test'])(ctx);
    }),
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.filter.first, function (ctx, xs) {
        return structure_1.Queries.filters.first(xs[0])(ctx);
    }),
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.filter.withSameAtomProperties, function (ctx, xs) {
        return structure_1.Queries.filters.withSameAtomProperties(xs[0], xs['source'], xs['property'])(ctx);
    }),
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.filter.intersectedBy, function (ctx, xs) {
        return structure_1.Queries.filters.areIntersectedBy(xs[0], xs['by'])(ctx);
    }),
    ...
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.generator.all, function structureQuery_generator_all(ctx) {
        return structure_1.Queries.generators.all(ctx);
    }),
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.generator.empty, function structureQuery_generator_empty(ctx) {
        return structure_1.Queries.generators.none(ctx);
    }),
    ...
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.modifier.wholeResidues, function structureQuery_modifier_wholeResidues(ctx, xs) {
        return structure_1.Queries.modifiers.wholeResidues(xs[0])(ctx);
    }),
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.modifier.union, function structureQuery_modifier_union(ctx, xs) {
        return structure_1.Queries.modifiers.union(xs[0])(ctx);
    }),
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.modifier.expandProperty, function structureQuery_modifier_expandProperty(ctx, xs) {
        return structure_1.Queries.modifiers.expandProperty(xs[0], xs['property'])(ctx);
    }),
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.modifier.exceptBy, function structureQuery_modifier_exceptBy(ctx, xs) {
        return structure_1.Queries.modifiers.exceptBy(xs[0], xs['by'])(ctx);
    }),
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.modifier.intersectBy, function structureQuery_modifier_intersectBy(ctx, xs) {
        return structure_1.Queries.modifiers.intersectBy(xs[0], xs['by'])(ctx);
    }),
    ...
    // ============= COMBINATORS ================
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.combinator.merge, function (ctx, xs) {
        return structure_1.Queries.combinators.merge(xs)(ctx);
    }),
    // ============= ATOM PROPERTIES ================
    // ~~~ CORE ~~~
    ...
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.atomProperty.core.vdw, function (ctx, xs) {
        return (0, atomic_1.VdwRadius)(structure_1.StructureProperties.atom.type_symbol((xs && xs[0] && xs[0](ctx)) || ctx.element));
    }),
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.atomProperty.core.mass, function (ctx, xs) {
        return (0, atomic_1.AtomWeight)(structure_1.StructureProperties.atom.type_symbol((xs && xs[0] && xs[0](ctx)) || ctx.element));
    }),
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.atomProperty.core.atomicNumber, function (ctx, xs) {
        return (0, atomic_1.AtomNumber)(structure_1.StructureProperties.atom.type_symbol((xs && xs[0] && xs[0](ctx)) || ctx.element));
    }),
    ...
    // keys
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.atomProperty.macromolecular.residueKey, function (ctx, xs) {
        return structure_1.StructureElement.residueIndex((xs && xs[0] && xs[0](ctx)) || ctx.element);
    }),
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.atomProperty.macromolecular.chainKey, function (ctx, xs) {
        return structure_1.StructureElement.chainIndex((xs && xs[0] && xs[0](ctx)) || ctx.element);
    }),
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.atomProperty.macromolecular.entityKey, function (ctx, xs) {
        return structure_1.StructureElement.entityIndex((xs && xs[0] && xs[0](ctx)) || ctx.element);
    }),
    // mmCIF
    ...
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.atomProperty.macromolecular.isHet, function (ctx, xs) {
        return structure_1.StructureProperties.residue.group_PDB((xs && xs[0] && xs[0](ctx)) || ctx.element) !== 'ATOM';
    }),
    ...
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.atomProperty.macromolecular
        .secondaryStructureFlags, atomProp(structure_1.StructureProperties.residue.secondary_structure_type)),
    ...
    // Internal
    D(symbol_table_1.MolScriptSymbolTable.internal.generator.bundleElement, function internal_generator_bundleElement(ctx, xs) {
        return (0, internal_1.bundleElementImpl)(xs.groupedUnits(ctx), xs.ranges(ctx), xs.set(ctx));
    }),
    D(symbol_table_1.MolScriptSymbolTable.internal.generator.bundle, function internal_generator_bundle(ctx, xs) {
        return (0, internal_1.bundleGenerator)(xs.elements(ctx))(ctx);
    }),
    D(symbol_table_1.MolScriptSymbolTable.internal.generator.current, function internal_generator_current(ctx, xs) {
    ...
    switch (f.toLowerCase()) {
        ...
        case 'sheet':
            return (current |
                ...
                8388608 /* BetaSheet */);
        case 'turn':
            return current | 16 /* Turn */;
        case 'bend':
            return current | 8 /* Bend */;
        case 'coil':
            return current | 536870912 /* NA */;
        default:
            return current;
    }
}
