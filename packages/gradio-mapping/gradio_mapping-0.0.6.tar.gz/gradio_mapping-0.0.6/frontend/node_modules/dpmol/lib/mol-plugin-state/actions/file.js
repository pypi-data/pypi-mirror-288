...
exports.OpenFiles = mol_state_1.StateAction.build({
    ...
    params: function (a, ctx) {
        ...
        return {
            files: param_definition_1.ParamDefinition.FileList({
                accept: Array.from(extensions.values())
...
exports.DownloadFile = mol_state_1.StateAction.build({
    ...
    from: objects_1.PluginStateObject.Root,
    params: function (a, ctx) {
        var options = (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], ctx.dataFormats.options, true), [['zip', 'Zip']], false);
        return {
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, state
                            .transaction(function () { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
                            var data, zippedFiles, _i, _a, _b, fn, filedata, asset, provider, data, parsed, e_2;
                            var _c, _d;
                            return (0, tslib_1.__generator)(this, function (_e) {
                                switch (_e.label) {
                                    ...
                                    case 9:
                                        parsed = _e.sent();
                                        if (!params.visuals) return [3 /*break*/, 11];
