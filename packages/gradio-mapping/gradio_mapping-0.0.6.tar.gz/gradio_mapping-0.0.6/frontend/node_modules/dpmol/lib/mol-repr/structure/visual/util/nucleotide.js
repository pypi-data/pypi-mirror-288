...
(function (NucleotideLocationIterator) {
    function fromGroup(structureGroup) {
        ...
        var u = group.units[0];
        var nucleotideElementIndices = structure_1.Unit.isAtomic(u)
            ? u.nucleotideElements
            : [];
...
function eachNucleotideElement(loci, structureGroup, apply) {
    ...
    for (var _i = 0, _a = loci.elements; _i < _a.length; _i++) {
        ...
        if (structure_1.Unit.isAtomic(e.unit)) {
            changed =
                (0, polymer_1.eachAtomicUnitTracedElement)(intervalOffset, groupCount, selectNuclotideElements, apply, e) || changed;
        }
    }
    return changed;
}
