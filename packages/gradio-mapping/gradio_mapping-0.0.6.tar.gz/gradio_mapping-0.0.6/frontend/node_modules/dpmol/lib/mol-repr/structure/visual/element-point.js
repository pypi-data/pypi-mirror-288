...
function createElementPoint(ctx, unit, structure, theme, props, points) {
    ...
    var oldBoundingSphere = points
        ? geometry_1.Sphere3D.clone(points.boundingSphere)
        : undefined;
    ...
    if (oldBoundingSphere &&
        ...
        boundingSphere = geometry_1.Sphere3D.expand((0, geometry_1.Sphere3D)(), unit.boundary.sphere, 1);
    }
