    ...
    entries.push({
        source: method === 'em'
            ? {
                name: 'em',
                params: {
                    isoValue: volume_1.Volume.IsoValue.absolute(emDefaultContourLevel || 0)
                }
            }
            : { name: 'x-ray', params: {} },
        dataId: dataId
...
exports.InitVolumeStreaming = mol_state_1.StateAction.build({
    ...
    params: function (a, plugin) {
        ...
        return {
            method: param_definition_1.ParamDefinition.Select(method, [
                ['em', 'EM'],
                ['x-ray', 'X-Ray']
            ]),
            ...
            options: param_definition_1.ParamDefinition.Group({
                serverUrl: param_definition_1.ParamDefinition.Text(plugin.config.get(config_1.PluginConfig.VolumeStreaming.DefaultServer) ||
                    'https://ds.litemol.org'),
                behaviorRef: param_definition_1.ParamDefinition.Text('', { isHidden: true }),
                emContourProvider: param_definition_1.ParamDefinition.Select('emdb', [
                    ['emdb', 'EMDB'],
                    ['pdbe', 'PDBe']
                ], { isHidden: true }),
    ...
    isApplicable: function (a, _, plugin) {
        ...
        return (a.data.models.length === 1 &&
            structure_1.Model.probablyHasDensityMap(a.data.models[0]));
    }
})(function (_a, plugin) {
            ...
            switch (_a.label) {
                ...
                case 19:
                    ...
                    behTree = state
                        .build()
                        .to(infoTree.ref)
                        .apply(CreateVolumeStreamingBehavior, param_definition_1.ParamDefinition.getDefaultValues(behavior_1.VolumeStreaming.createParams({
                        data: infoObj.data,
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        e = params.entries[i];
                        dataId = e.dataId;
                        emDefaultContourLevel = e.source.name === 'em'
                            ? e.source.params.isoValue
                            : volume_1.Volume.IsoValue.relative(1);
                        return [4 /*yield*/, taskCtx.update('Getting server header...')];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, plugin
                                .fetch({
                                url: (0, url_1.urlCombine)(params.serverUrl, "".concat(e.source.name, "/").concat(dataId.toLocaleLowerCase())),
                                type: 'json'
                            })
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, new model_1.VolumeServerInfo(data, {
                                label: 'Volume Server',
                                description: "".concat(entries.map(function (e) { return e.dataId; }).join(', '))
                            })];
                }
            });
        }); });
        ...
        return mol_task_1.Task.create('Volume streaming', function (_) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, new behavior_1.VolumeStreaming(behavior, {
        ...
        return mol_task_1.Task.create('Update Volume Streaming', function (_) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                        ...
                        if (oldParams.entry.name !== newParams.entry.name) {
                            if ('em' in newParams.entry.params.channels) {
                                ...
                                if (emDefaultContourLevel) {
                                    newParams.entry.params.channels['em'].isoValue =
                    ...
                    case 1:
                        ret = (_a.sent())
                            ? mol_state_1.StateTransformer.UpdateResult.Updated
            ...
            return (0, tslib_1.__generator)(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        transform = (structure === null || structure === void 0 ? void 0 : structure.models.length) === 0
                            ? void 0
                            : global_transform_1.GlobalModelTransformInfo.get(structure === null || structure === void 0 ? void 0 : structure.models[0]);
                        return [4 /*yield*/, repr.createOrUpdate(props, channel.data).runInContext(ctx)];
                    case 1:
                        _c.sent();
                        if (transform)
                            repr.setState({ transform: transform });
                        return [2 /*return*/, new objects_1.PluginStateObject.Volume.Representation3D({ repr: repr, sourceData: channel.data }, {
                                label: "".concat(Math.round(channel.isoValue.relativeValue * 100) / 100, " \u03C3 [").concat(srcParams.channel, "]")
                            })];
                }
            });
        }); });
...
function createVolumeProps(streaming, channelName) {
    ...
    return representation_1.VolumeRepresentation3DHelpers.getDefaultParamsStatic(streaming.plugin, 'isosurface', {
