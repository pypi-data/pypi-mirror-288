...
function createValueSize(value, sizeData) {
    if (sizeData) {
        ...
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({ uSize: mol_util_1.ValueCell.create(value) }, createEmptySizeTexture()), { dSizeType: mol_util_1.ValueCell.create('uniform') });
    }
}
...
//# sourceMappingURL=size-data.js.map