        ...
        while (residueIt.hasNext) {
            ...
            if ((0, types_1.isNucleic)(moleculeType[residueIndex])) {
                ...
                if (!isPurine && !isPyrimidine) {
                    ...
                    if (idxC4 !== -1 &&
                        idxN9 !== -1 &&
                        linear_algebra_1.Vec3.distance(pos(idxC4, p1), pos(idxN9, p2)) < 1.6) {
                        isPurine = true;
                    }
                    else {
                        isPyrimidine = true;
...
exports.NucleotideBlockParams = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, units_visual_1.UnitsMeshParams), exports.NucleotideBlockMeshParams);
...
//# sourceMappingURL=nucleotide-block-mesh.js.map