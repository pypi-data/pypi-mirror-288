...
var DihedralVisuals = {
    vectors: function (ctx, getParams) {
        return (0, representation_1.ShapeRepresentation)(getVectorsShape, lines_1.Lines.Utils, {
            modifyState: function (s) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, s), { pickable: false, markerActions: marker_action_1.MarkerActions.All })); }
        });
    },
    extenders: function (ctx, getParams) {
        return (0, representation_1.ShapeRepresentation)(getExtendersShape, lines_1.Lines.Utils, {
            modifyState: function (s) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, s), { pickable: false, markerActions: marker_action_1.MarkerActions.All })); }
        });
    },
    connector: function (ctx, getParams) {
        return (0, representation_1.ShapeRepresentation)(getConnectorShape, lines_1.Lines.Utils, {
            modifyState: function (s) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, s), { pickable: false, markerActions: marker_action_1.MarkerActions.All })); }
        });
    },
    arms: function (ctx, getParams) {
        return (0, representation_1.ShapeRepresentation)(getArmsShape, lines_1.Lines.Utils, {
            modifyState: function (s) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, s), { pickable: false, markerActions: marker_action_1.MarkerActions.All })); }
        });
    },
    arc: function (ctx, getParams) {
        return (0, representation_1.ShapeRepresentation)(getArcShape, lines_1.Lines.Utils, {
            modifyState: function (s) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, s), { pickable: false, markerActions: marker_action_1.MarkerActions.All })); }
        });
    },
    sector: function (ctx, getParams) {
        return (0, representation_1.ShapeRepresentation)(getSectorShape, mesh_1.Mesh.Utils, {
            modifyProps: function (p) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, p), { alpha: p.sectorOpacity })); },
            modifyState: function (s) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, s), { markerActions: marker_action_1.MarkerActions.All })); }
        });
    },
...
function getDihedralName(data) {
    return data.quads.length === 1
        ? "Dihedral ".concat((0, label_1.dihedralLabel)(data.quads[0], { measureOnly: true }))
        : "".concat(data.quads.length, " Dihedrals");
}
//
...
function DihedralRepresentation(ctx, getParams) {
    var repr = representation_2.Representation.createMulti('Dihedral', ctx, getParams, representation_2.Representation.StateBuilder, DihedralVisuals);
