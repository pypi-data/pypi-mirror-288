...
export declare const enum SaccharideShape {
    FilledSphere = 0,
    FilledCube = 1,
    CrossedCube = 2,
    DividedDiamond = 3,
...
export declare const enum SaccharideType {
    Hexose = 0,
    HexNAc = 1,
    Hexosamine = 2,
    Hexuronate = 3,
...
export declare type SaccharideComponent = {
    abbr: string;
    name: string;
    color: Color;
    type: SaccharideType;
...
export declare const SaccharideCompIdMap: Map<string, SaccharideComponent>;
