...
export declare type StructureGroup = {
    structure: Structure;
...
export declare type CommonSurfaceProps = typeof DefaultCommonSurfaceProps;
...
export declare function getStructureConformationAndRadius(structure: Structure, sizeTheme: SizeTheme<any>, ignoreHydrogens: boolean, traceOnly: boolean): {
    position: {
