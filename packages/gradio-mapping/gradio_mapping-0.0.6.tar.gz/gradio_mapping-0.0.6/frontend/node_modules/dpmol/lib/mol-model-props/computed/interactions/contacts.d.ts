...
export declare type ContactsParams = typeof ContactsParams;
export declare type ContactsProps = PD.Values<ContactsParams>;
 ...
 */
export declare function addUnitContacts(structure: Structure, unit: Unit.Atomic, features: Features, builder: IntraContactsBuilder, testers: ReadonlyArray<ContactTester>, props: ContactsProps, filter?: (unitA: Unit, elementIdA: number, unitB: Unit, elementIdB: number) => boolean): void;
/**
 * Add all inter-unit contacts, i.e. pairs of features
 */
export declare function addStructureContacts(structure: Structure, unitA: Unit.Atomic, featuresA: Features, unitB: Unit.Atomic, featuresB: Features, builder: InterContactsBuilder, testers: ReadonlyArray<ContactTester>, props: ContactsProps, filter?: (unitA: Unit, elementIdA: number, unitB: Unit, elementIdB: number) => boolean): void;
