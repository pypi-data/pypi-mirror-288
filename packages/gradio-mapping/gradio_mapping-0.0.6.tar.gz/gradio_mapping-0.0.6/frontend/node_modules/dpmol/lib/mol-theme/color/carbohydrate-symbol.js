...
function CarbohydrateSymbolColorTheme(ctx, props) {
    ...
    if (ctx.structure) {
        ...
        var getColor_1 = function (unit, index) {
            ...
            return carbs.length > 0
                ? elements_1[carbs[0]].component.color
                : DefaultColor;
        };
...
exports.CarbohydrateSymbolColorThemeProvider = {
    ...
    isApplicable: function (ctx) {
        return (!!ctx.structure &&
            ctx.structure.models.some(function (m) { return structure_1.Model.hasCarbohydrate(m); }));
    }
};
//# sourceMappingURL=carbohydrate-symbol.js.map