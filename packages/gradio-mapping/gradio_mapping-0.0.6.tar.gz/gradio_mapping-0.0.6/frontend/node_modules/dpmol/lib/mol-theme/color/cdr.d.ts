...
export declare function CDRColorTheme(ctx: ThemeDataContext, props: PD.Values<ElementSymbolColorThemeParams>): ColorTheme<ElementSymbolColorThemeParams>;
export declare const CDRColorThemeProvider: ColorTheme.Provider<ElementSymbolColorThemeParams, 'cdr'>;
