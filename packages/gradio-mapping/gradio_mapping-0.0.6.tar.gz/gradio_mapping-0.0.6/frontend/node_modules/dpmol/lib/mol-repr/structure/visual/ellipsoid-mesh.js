...
exports.EllipsoidMeshParams = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, units_visual_1.UnitsMeshParams), { sizeFactor: param_definition_1.ParamDefinition.Numeric(1, { min: 0, max: 10, step: 0.1 }), detail: param_definition_1.ParamDefinition.Numeric(0, { min: 0, max: 3, step: 1 }, base_1.BaseGeometry.CustomQualityParamInfo), ignoreHydrogens: param_definition_1.ParamDefinition.Boolean(false) });
...
function createEllipsoidMesh(ctx, unit, structure, theme, props, mesh) {
    ...
    for (var i = 0; i < elementCount; i++) {
        ...
        if ((0, common_2.equalEps)(eigvals[0], eigvals[1], linear_algebra_1.EPSILON) &&
            (0, common_2.equalEps)(eigvals[1], eigvals[2], linear_algebra_1.EPSILON)) {
...
//# sourceMappingURL=ellipsoid-mesh.js.map