...
export declare type DensityServer_Header_Schema = typeof DensityServer_Header_Schema;
export interface DensityServer_Header_Database extends Database<DensityServer_Header_Schema> {
}
export declare type DensityServer_Data_Schema = typeof DensityServer_Data_Schema;
