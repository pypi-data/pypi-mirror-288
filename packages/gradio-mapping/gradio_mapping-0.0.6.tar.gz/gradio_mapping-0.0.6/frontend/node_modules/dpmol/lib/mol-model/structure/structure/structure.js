...
var Structure = /** @class */ (function () {
        ...
        get: function () {
            if (this.state.bondCount === -1) {
                this.state.bondCount =
                    this.interUnitBonds.edgeCount + bonds_1.Bond.getIntraUnitBondCount(this);
            }
    ...
    Object.defineProperty(Structure.prototype, "unitSymmetryGroups", {
        get: function () {
            ...
            this.state.unitSymmetryGroups =
                symmetry_1.StructureSymmetry.computeTransformGroups(this);
            return this.state.unitSymmetryGroups;
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(Structure.prototype, "unitSymmetryGroupsIndexMap", {
        ...
        get: function () {
            ...
            this.state.unitSymmetryGroupsIndexMap =
                unit_1.Unit.SymmetryGroup.getUnitSymmetryGroupsIndexMap(this.unitSymmetryGroups);
            return this.state.unitSymmetryGroupsIndexMap;
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(Structure.prototype, "serialMapping", {
         ...
         */
        get: function () {
            return (this.state.serialMapping ||
    ...
    Structure.prototype.asParent = function () {
        if (this._proxy)
            return this._proxy;
        if (this.parent) {
            var p = this.parent.coordinateSystem.isIdentity
                ? this.parent
                : Structure.transform(this.parent, this.parent.coordinateSystem.inverse);
            var s = this.coordinateSystem.isIdentity
                ? p
                : Structure.transform(p, this.coordinateSystem.matrix);
            this._proxy = new Structure(s.units, s.unitMap, s.unitIndexMap, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, s.state), { dynamicBonds: this.dynamicBonds }), { child: this, target: this.parent });
        }
        else {
            this._proxy = this;
        }
...
function getEntityIndices(structure) {
    ...
    for (var _a = 0, units_2 = units; _a < units_2.length; _a++) {
        var unit = units_2[_a];
        var prop = unit.kind === 0 /* Atomic */
            ? properties_1.StructureProperties.entity.key
            : properties_1.StructureProperties.coarse.entityKey;
        l.unit = unit;
...
function getSerialMapping(structure) {
    ...
    return {
        ...
        getSerialIndex: function (unit, element) {
            return (cumulativeUnitElementCount[unitIndexMap.get(unit.id)] +
                int_1.OrderedSet.indexOf(unit.elements, element));
        }
    };
}
(function (Structure) {
    ...
    function toStructureElementLoci(structure) {
        ...
        for (var _a = 0, _b = structure.units; _a < _b.length; _a++) {
            ...
            elements.push({
                unit: unit,
                indices: int_1.Interval.ofBounds(0, unit.elements.length)
            });
        }
    ...
    function ofModel(model, props) {
        ...
        var builder = new StructureBuilder((0, tslib_1.__assign)({ label: model.label }, props));
        for (var c = 0; c < chains.count; c++) {
            ...
            var singleAtomResidues = atomic_1.AtomicHierarchy.chainResidueCount(model.atomicHierarchy, c) ===
    ...
    function partitionAtomicUnitByAtom(model, indices, builder, multiChain, operator) {
        ...
        var traits = (multiChain ? 1 /* MultiChain */ : 0 /* None */) |
            (offset.length > 1 ? 2 /* Partitioned */ : 0 /* None */);
    ...
    function partitionAtomicUnitByResidue(model, indices, builder, multiChain, operator) {
        ...
        var position = {
            ...
            y: y,
            z: z,
            indices: int_1.SortedArray.ofSortedArray(startIndices)
        };
    ...
    var StructureBuilder = /** @class */ (function () {
        ...
        StructureBuilder.prototype.addUnit = function (kind, model, operator, elements, traits, invariantId) {
            ...
            var chainGroupId = this.inChainGroup
                ? this.chainGroupId
                : ++this.chainGroupId;
            // CHANGED by xh
            var unit = unit_1.Unit.create(invariantId, invariantId, chainGroupId, traits, kind, model, operator, elements);
    ...
    function validUnitPair(s, a, b) {
        // 在Merged Structure节点下，无需根据masterModel判断两个unit是否来自同一个structure
        return true;
    ...
    function eachUnitPair(structure, callback, props) {
        ...
        for (var _a = 0, _b = structure.units; _a < _b.length; _a++) {
            ...
            var closeUnits = lookup.findUnitIndices(imageCenter[0], imageCenter[1], imageCenter[2], bs.radius + maxRadius + 9999);
            for (var i = 0; i < closeUnits.count; i++) {
                var other = structure.units[closeUnits.indices[i]];
                if (!validUnit(other) ||
                    unit.id >= other.id ||
                    !validUnitPair(unit, other))
                    continue;
    ...
    function getSize(structure, thresholds, residueCountFactor) {
        ...
        var t = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, Structure.DefaultSizeThresholds), thresholds);
        if (structure.polymerResidueCount >=
        ...
        else if (structure.polymerResidueCount <
