...
exports.PolymerIdColorThemeParams = (0, tslib_1.__assign)({}, (0, palette_1.getPaletteParams)({ type: 'colors', colorList: DefaultList }));
function getPolymerIdColorThemeParams(ctx) {
    ...
    if (ctx.structure) {
        if (getPolymerAsymIdSerialMap(ctx.structure.root).size >
            lists_1.ColorLists[DefaultList].list.length) {
            params.palette.defaultValue.name = 'colors';
            params.palette.defaultValue.params = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, params.palette.defaultValue.params), { list: {
                    kind: 'interpolate',
                    colors: (0, lists_1.getColorListFromName)(DefaultList).list
                } });
        }
    }
    return params;
...
function PolymerIdColorTheme(ctx, props) {
    ...
    if (ctx.structure) {
        ...
        var palette_2 = (0, palette_1.getPalette)(polymerAsymIdSerialMap_1.size, props, {
...
//# sourceMappingURL=polymer-id.js.map