...
(function (Vec4) {
    ...
    function equals(a, b) {
        ...
        return (Math.abs(a0 - b0) <=
            common_1.EPSILON * Math.max(1.0, Math.abs(a0), Math.abs(b0)) &&
            Math.abs(a1 - b1) <=
                common_1.EPSILON * Math.max(1.0, Math.abs(a1), Math.abs(b1)) &&
            Math.abs(a2 - b2) <=
                common_1.EPSILON * Math.max(1.0, Math.abs(a2), Math.abs(b2)) &&
