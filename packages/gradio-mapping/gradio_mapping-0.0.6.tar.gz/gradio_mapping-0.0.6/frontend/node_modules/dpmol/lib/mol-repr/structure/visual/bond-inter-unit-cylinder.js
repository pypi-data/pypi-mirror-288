...
function getInterUnitBondCylinderBuilderProps(structure, theme, props) {
    ...
    if (props.includeParent && child) {
        stub = function (edgeIndex) {
            ...
            return (childUnitA &&
                sorted_array_1.SortedArray.has(childUnitA.elements, eA) &&
    ...
    return {
        ...
        style: function (edgeIndex) {
            ...
            if (types_1.BondType.is(f, 2 /* MetallicCoordination */) ||
                types_1.BondType.is(f, 4 /* HydrogenBond */)) {
...
//# sourceMappingURL=bond-inter-unit-cylinder.js.map