...
var StructureMeasurementManager = /** @class */ (function (_super) {
    ...
    StructureMeasurementManager.prototype.getGroup = function () {
        ...
        return builder
            .toRoot()
            .group(transforms_1.StateTransforms.Misc.CreateGroup, { label: "Measurements" }, { tags: exports.MeasurementGroupTag });
    };
    StructureMeasurementManager.prototype.setOptions = function (options) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            var update, _i, _a, cell, _b, _c, cell, _d, _e, cell, _f, _g, cell, _h, _j, cell;
            return (0, tslib_1.__generator)(this, function (_k) {
                switch (_k.label) {
                    case 0:
                        ...
                        for (_b = 0, _c = this.state.interactionLine; _b < _c.length; _b++) {
                            cell = _c[_b];
                            update.to(cell).update(function (old) {
                                old.unitLabel = options.distanceUnitLabel;
                                old.textColor = options.textColor;
                        ...
                        for (_d = 0, _e = this.state.labels; _d < _e.length; _d++) {
                            cell = _e[_d];
                            update.to(cell).update(function (old) {
                                old.textColor = options.textColor;
                            });
                        }
                        for (_f = 0, _g = this.state.angles; _f < _g.length; _f++) {
                            cell = _g[_f];
                            update.to(cell).update(function (old) {
                                old.textColor = options.textColor;
                            });
                        }
                        for (_h = 0, _j = this.state.dihedrals; _h < _j.length; _h++) {
                            cell = _j[_h];
                            update.to(cell).update(function (old) {
                                old.textColor = options.textColor;
                            });
    ...
    StructureMeasurementManager.prototype.findStructure = function (structure, needMerge) {
        ...
        var res = cells.filter(function (item) {
            ...
            return item.transform.parent ===
                ...
                ((_b = (_a = item.obj) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.models) && (structure === null || structure === void 0 ? void 0 : structure.models) &&
                ((_d = (_c = item.obj) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d.models[0]) === (structure === null || structure === void 0 ? void 0 : structure.models[0]);
        });
        return res[0];
    };
    StructureMeasurementManager.prototype.addDistance = function (a, b, options, params) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            var cellA, cellB, dependsOn, update, state;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        cellA = this.findStructure(a.structure);
                        cellB = this.findStructure(b.structure);
                        if (!cellA || !cellB)
                            return [2 /*return*/];
                            ...
                            selections: [
                                {
                                    ...
                                    expression: structure_1.StructureElement.Loci.toExpression(a)
                                },
                                {
                                    key: 'b',
                                    groupId: 'b',
                                    ref: cellB.transform.ref,
                                    expression: structure_1.StructureElement.Loci.toExpression(b)
                                }
                            ],
                            isTransitive: true,
                            label: 'Distance'
                        }, { dependsOn: dependsOn, tags: options === null || options === void 0 ? void 0 : options.selectionTags })
                            .apply(transforms_1.StateTransforms.Representation.StructureSelectionsDistance3D, (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({ customText: (options === null || options === void 0 ? void 0 : options.customText) || '', unitLabel: this.state.options.distanceUnitLabel, textColor: this.state.options.textColor }, options === null || options === void 0 ? void 0 : options.lineParams), options === null || options === void 0 ? void 0 : options.labelParams), options === null || options === void 0 ? void 0 : options.visualParams), params), { tags: options === null || options === void 0 ? void 0 : options.reprTags });
                        state = this.plugin.state.data;
                        return [4 /*yield*/, commands_1.PluginCommands.State.Update(this.plugin, {
                                state: state,
                                tree: update,
    ...
    StructureMeasurementManager.prototype.addInteractionLine = function (a, b, options, params) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            var cellA, cellB, dependsOn, update, res, state;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        cellA = this.findStructure(a.structure, false);
                        cellB = this.findStructure(b.structure, false);
                        if (!cellA || !cellB)
                            return [2 /*return*/];
                        dependsOn = [cellA.transform.ref];
                        (0, array_1.arraySetAdd)(dependsOn, cellB.transform.ref);
                        ...
                        return [4 /*yield*/, update
                                ...
                                .apply(transforms_1.StateTransforms.Representation.StructureSelectionsInteractionLine3D, (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({ customText: (options === null || options === void 0 ? void 0 : options.customText) || '', unitLabel: this.state.options.distanceUnitLabel, textColor: this.state.options.textColor }, options === null || options === void 0 ? void 0 : options.lineParams), options === null || options === void 0 ? void 0 : options.labelParams), options === null || options === void 0 ? void 0 : options.visualParams), params), { tags: options === null || options === void 0 ? void 0 : options.reprTags })];
                    case 1:
                        res = _a.sent();
                        state = this.plugin.state.data;
                        return [4 /*yield*/, commands_1.PluginCommands.State.Update(this.plugin, {
    ...
    StructureMeasurementManager.prototype.addAngle = function (a, b, c, options, params) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        cellA = this.findStructure(a.structure);
                        cellB = this.findStructure(b.structure);
                        cellC = this.findStructure(c.structure);
                        ...
                        update
                            ...
                            selections: [
                                ...
                                },
                                {
                                    ...
                                    expression: structure_1.StructureElement.Loci.toExpression(c)
                                }
                            ],
                            isTransitive: true,
                            label: 'Angle'
                        }, { dependsOn: dependsOn, tags: options === null || options === void 0 ? void 0 : options.selectionTags })
                            .apply(transforms_1.StateTransforms.Representation.StructureSelectionsAngle3D, (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({ customText: (options === null || options === void 0 ? void 0 : options.customText) || '', textColor: this.state.options.textColor }, options === null || options === void 0 ? void 0 : options.lineParams), options === null || options === void 0 ? void 0 : options.labelParams), options === null || options === void 0 ? void 0 : options.visualParams), params), { tags: options === null || options === void 0 ? void 0 : options.reprTags });
                        state = this.plugin.state.data;
                        return [4 /*yield*/, commands_1.PluginCommands.State.Update(this.plugin, {
                                state: state,
                                tree: update,
    ...
    StructureMeasurementManager.prototype.addDihedral = function (a, b, c, d, options, params) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        cellB = this.findStructure(b.structure);
                        cellC = this.findStructure(c.structure);
                        cellD = this.findStructure(d.structure);
                        ...
                        update
                            ...
                            selections: [
                                ...
                                },
                                {
                                    ...
                                    expression: structure_1.StructureElement.Loci.toExpression(d)
                                }
                            ],
                            isTransitive: true,
                            label: 'Dihedral'
    ...
    StructureMeasurementManager.prototype.addLabel = function (a, options, params, needMerge) {
        if (needMerge === void 0) { needMerge = true; }
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        cellA = this.findStructure(a.structure, needMerge);
                        if (!cellA)
                            return [2 /*return*/];
                        dependsOn = [cellA.transform.ref];
                        update = this.plugin.state.data.build().to(cellA.transform.ref);
                        update
                            .apply(transforms_1.StateTransforms.Model.MultiStructureSelectionFromExpression, {
                            selections: [
                                {
                            ...
                            .apply(transforms_1.StateTransforms.Representation.StructureSelectionsLabel3D, (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({ textColor: this.state.options.textColor }, options === null || options === void 0 ? void 0 : options.labelParams), options === null || options === void 0 ? void 0 : options.visualParams), params), { tags: options === null || options === void 0 ? void 0 : options.reprTags });
                        state = this.plugin.state.data;
                        return [4 /*yield*/, commands_1.PluginCommands.State.Update(this.plugin, {
                                state: state,
                                tree: update,
    ...
    StructureMeasurementManager.prototype.addLabels = function (infos, needMerge, options) {
        if (needMerge === void 0) { needMerge = true; }
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            var build, state;
            var _this = this;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        build = this.plugin.state.data.build();
                        infos.forEach(function (info) {
                            var loci = info.loci, params = info.params, expression = info.expression;
                            var cellA = _this.findStructure(loci.structure, needMerge);
                            if (cellA) {
                                var dependsOn = [cellA.transform.ref];
                                var update = build.to(cellA.transform.ref);
                                update
                                    .apply(transforms_1.StateTransforms.Model.MultiStructureSelectionFromExpression, {
                                    selections: [
                                        {
                                            key: 'a',
                                            ref: cellA.transform.ref,
                                            expression: expression || structure_1.StructureElement.Loci.toExpression(loci)
                                        }
                                    ],
                                    isTransitive: true,
                                    label: 'Label'
                                }, { dependsOn: dependsOn, tags: options === null || options === void 0 ? void 0 : options.selectionTags })
                                    .apply(transforms_1.StateTransforms.Representation.StructureSelectionsLabel3D, (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({ textColor: _this.state.options.textColor }, options === null || options === void 0 ? void 0 : options.labelParams), options === null || options === void 0 ? void 0 : options.visualParams), params), { tags: options === null || options === void 0 ? void 0 : options.reprTags });
                            }
                        });
                        state = this.plugin.state.data;
                        return [4 /*yield*/, commands_1.PluginCommands.State.Update(this.plugin, {
                    ...
                    case 0:
                        ...
                        for (i = 0, il = locis.length; i < il; ++i) {
                            ...
                            selections.push({
                                ...
                                expression: structure_1.StructureElement.Loci.toExpression(l)
                            });
                        }
                                ...
                                selections: [
                                    {
                                        key: 'a',
                                        ref: cell.transform.ref,
                                        expression: structure_1.StructureElement.Loci.toExpression(loci)
                                    }
                                ],
                                isTransitive: true,
                                label: 'Order'
