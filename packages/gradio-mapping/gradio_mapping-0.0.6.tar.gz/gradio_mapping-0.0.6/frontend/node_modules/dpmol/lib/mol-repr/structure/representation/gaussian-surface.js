...
var GaussianSurfaceVisuals = {
    'gaussian-surface-mesh': function (ctx, getParams) {
        return (0, units_representation_1.UnitsRepresentation)('Gaussian surface mesh', ctx, getParams, gaussian_surface_mesh_1.GaussianSurfaceVisual);
    },
    'structure-gaussian-surface-mesh': function (ctx, getParams) {
        return (0, representation_1.ComplexRepresentation)('Structure-Gaussian surface mesh', ctx, getParams, gaussian_surface_mesh_1.StructureGaussianSurfaceVisual);
    },
    'gaussian-surface-wireframe': function (ctx, getParams) {
        return (0, units_representation_1.UnitsRepresentation)('Gaussian surface wireframe', ctx, getParams, gaussian_surface_wireframe_1.GaussianWireframeVisual);
    }
};
exports.GaussianSurfaceParams = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, gaussian_surface_mesh_1.GaussianSurfaceMeshParams), gaussian_surface_wireframe_1.GaussianWireframeParams), { visuals: param_definition_1.ParamDefinition.MultiSelect(['gaussian-surface-mesh'], param_definition_1.ParamDefinition.objectToOptions(GaussianSurfaceVisuals)), bumpFrequency: param_definition_1.ParamDefinition.Numeric(1, { min: 0, max: 10, step: 0.1 }, base_1.BaseGeometry.ShadingCategory) });
function getGaussianSurfaceParams(ctx, structure) {
    return param_definition_1.ParamDefinition.clone(exports.GaussianSurfaceParams);
}
...
//# sourceMappingURL=gaussian-surface.js.map