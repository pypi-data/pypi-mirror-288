...
function createStandardModel(data, atom_site, sourceIndex, entities, properties, format, previous) {
    ...
    if (previous && atomic.sameAsPrevious) {
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, previous), { id: mol_util_1.UUID.create22(), modelNum: modelNum, atomicConformation: atomic.conformation, _dynamicPropertyData: Object.create(null) });
    }
                ...
                case 4:
                    ihm = {
                        ...
                        ihm_sphere_obj_site: sphere_sites.has(id)
                            ...
                            : db_1.Table.window(data.ihm_sphere_obj_site, data.ihm_sphere_obj_site._schema, 0, 0),
                        ihm_gaussian_obj_site: gauss_sites.has(id)
                            ? gauss_sites.get(id).table
                            : db_1.Table.window(data.ihm_gaussian_obj_site, data.ihm_gaussian_obj_site._schema, 0, 0)
                    };
