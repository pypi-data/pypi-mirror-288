...
(function (StateSelection) {
    ...
    function registerModifier(name, f) {
        BuilderPrototype[name] = function () {
            ...
            return f.call.apply(f, (0, tslib_1.__spreadArray)([void 0, this], args, false));
        };
    }
    ...
    var Generators;
    (function (Generators) {
        Generators.root = build(function () { return function (state) { return [
            state.cells.get(state.tree.root.ref)
        ]; }; });
        function byRef() {
            var refs = [];
            for (var _i = 0; _i < arguments.length; _i++) {
    ...
    function subtree(b) {
        return flatMap(b, function (n, s) {
            var nodes = [];
            tree_1.StateTree.doPreOrder(s.tree, s.tree.transforms.get(n.transform.ref), nodes, function (x, _, ctx) {
                ctx.push(x.ref);
            });
    ...
    function children(b) {
        return flatMap(b, function (n, s) {
            ...
            s.tree.children
                .get(n.transform.ref)
                .forEach(function (c) { return nodes.push(s.cells.get(c)); });
            return nodes;
        });
    }
    ...
    function ofType(b, t) {
        return filter(b, function (n) { return (n.obj ? n.obj.type === t.type : false); });
    }
    ...
    function withTransformer(b, t) {
        return filter(b, function (o) { return o.transform.transformer === t; });
    }
    StateSelection.withTransformer = withTransformer;
    registerModifier('root', root);
    function root(b, test) {
        return unique(mapObject(b, function (n, s) { return findRoot(s.tree, s.cells, n.transform.ref, test); }));
    }
