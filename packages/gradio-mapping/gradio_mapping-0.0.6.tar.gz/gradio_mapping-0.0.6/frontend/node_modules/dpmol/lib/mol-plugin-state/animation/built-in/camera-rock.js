...
exports.AnimateCameraRock = model_1.PluginStateAnimation.create({
    ...
    initialState: function (p, ctx) {
        return ({ snapshot: ctx.canvas3d.camera.getSnapshot() });
    },
    ...
    apply: function (animState, t, ctx) {
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_c) {
                ...
                angle = Math.sin(phase * ctx.params.speed * Math.PI * 2) *
                    (0, misc_1.degToRad)(ctx.params.angle);
                ...
                (_b = ctx.plugin.canvas3d) === null || _b === void 0 ? void 0 : _b.requestCameraReset({
                    snapshot: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, snapshot), { position: position }),
                    durationMs: 0
                });
                if (phase >= 0.99999) {
                    return [2 /*return*/, { kind: 'finished' }];
