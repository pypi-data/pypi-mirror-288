...
var MolecularSurfaceVisuals = {
    'molecular-surface-mesh': function (ctx, getParams) {
        return (0, units_representation_1.UnitsRepresentation)('Molecular surface mesh', ctx, getParams, molecular_surface_mesh_1.MolecularSurfaceMeshVisual);
    },
    'molecular-surface-wireframe': function (ctx, getParams) {
        return (0, units_representation_1.UnitsRepresentation)('Molecular surface wireframe', ctx, getParams, molecular_surface_wireframe_1.MolecularSurfaceWireframeVisual);
    }
};
exports.MolecularSurfaceParams = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, molecular_surface_mesh_1.MolecularSurfaceMeshParams), molecular_surface_wireframe_1.MolecularSurfaceWireframeParams), { visuals: param_definition_1.ParamDefinition.MultiSelect(['molecular-surface-mesh'], param_definition_1.ParamDefinition.objectToOptions(MolecularSurfaceVisuals)), bumpFrequency: param_definition_1.ParamDefinition.Numeric(1, { min: 0, max: 10, step: 0.1 }, base_1.BaseGeometry.ShadingCategory) });
function getMolecularSurfaceParams(ctx, structure) {
    return param_definition_1.ParamDefinition.clone(exports.MolecularSurfaceParams);
}
