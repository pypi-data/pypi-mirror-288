...
var PluginAnimationManager = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(PluginAnimationManager, _super);
    ...
    PluginAnimationManager.prototype.updateParams = function (newParams) {
        if (this.isEmpty)
            return;
        this.updateState({ params: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, this.state.params), newParams) });
    ...
    PluginAnimationManager.prototype.updateCurrentParams = function (values) {
        if (this.isEmpty)
            return;
        this._current.paramValues = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, this._current.paramValues), values);
        this.triggerUpdate();
    };
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._current.anim.apply(this._current.state, {
