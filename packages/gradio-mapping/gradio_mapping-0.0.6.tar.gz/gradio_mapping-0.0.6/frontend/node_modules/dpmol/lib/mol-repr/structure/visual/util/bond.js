...
exports.BondCylinderParams = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, link_1.LinkCylinderParams), exports.BondParams), { adjustCylinderLength: param_definition_1.ParamDefinition.Boolean(false, {
        description: 'Shorten cylinders to reduce overlap with spheres. Useful for for transparent bonds. Not working well with aromatic bonds.'
    }) });
exports.DefaultBondCylinderProps = param_definition_1.ParamDefinition.getDefaultValues(exports.BondCylinderParams);
exports.BondLineParams = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, link_1.LinkLineParams), exports.BondParams);
...
function makeIntraBondIgnoreTest(structure, unit, props) {
    ...
    return function (edgeIndex) {
        return ((!!childUnit &&
            !int_1.SortedArray.has(childUnit.elements, elements[a[edgeIndex]])) ||
            (ignoreHydrogens &&
                ((0, common_1.isH)(atomicNumber, elements[a[edgeIndex]]) ||
                    (0, common_1.isH)(atomicNumber, elements[b[edgeIndex]]))) ||
...
function makeInterBondIgnoreTest(structure, props) {
    ...
    return function (edgeIndex) {
        ...
        if (ignoreHydrogens) {
            ...
            if ((0, common_1.isHydrogen)(uA, uA.elements[b.indexA]) ||
                (0, common_1.isHydrogen)(uB, uB.elements[b.indexB]))
                return true;
        }
        if (!allBondTypes) {
                ...
                if (!isMarking || otherLociIndices) {
                    int_1.OrderedSet.forEach(e.indices, function (v) {
                        ...
                        b.getEdges(v).forEach(function (bi) {
                            if (!isMarking ||
                                (otherLociIndices &&
                                    int_1.OrderedSet.has(otherLociIndices, bi.indexB))) {
