...
exports.BallAndStickParams = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, element_sphere_1.ElementSphereParams), { traceOnly: param_definition_1.ParamDefinition.Boolean(false, { isHidden: true }) }), bond_intra_unit_cylinder_1.IntraUnitBondCylinderParams), bond_inter_unit_cylinder_1.InterUnitBondCylinderParams), { includeParent: param_definition_1.ParamDefinition.Boolean(false), unitKinds: (0, params_1.getUnitKindsParam)(['atomic']), sizeFactor: param_definition_1.ParamDefinition.Numeric(0.2, { min: 0.01, max: 10, step: 0.01 }), sizeAspectRatio: param_definition_1.ParamDefinition.Numeric(0.5, { min: 0.01, max: 3, step: 0.01 }), visuals: param_definition_1.ParamDefinition.MultiSelect(['element-sphere', 'intra-bond', 'inter-bond', 'charge-text'], param_definition_1.ParamDefinition.objectToOptions(BallAndStickVisuals)), bumpFrequency: param_definition_1.ParamDefinition.Numeric(0, { min: 0, max: 10, step: 0.1 }, base_1.BaseGeometry.ShadingCategory) });
...
//# sourceMappingURL=ball-and-stick.js.map