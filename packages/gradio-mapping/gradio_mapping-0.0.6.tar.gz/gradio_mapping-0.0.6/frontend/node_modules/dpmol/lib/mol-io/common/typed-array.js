...
function createTypedArrayBufferContext(size, type) {
    ...
    var valuesBuffer = simple_buffer_1.SimpleBuffer.IsNativeEndianLittle
        ? arrayBuffer
    ...
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    if (ctx.elementByteSize > 1 &&
                        ((littleEndian !== void 0 &&
                            littleEndian !== simple_buffer_1.SimpleBuffer.IsNativeEndianLittle) ||
                            !simple_buffer_1.SimpleBuffer.IsNativeEndianLittle)) {
                        // fix the endian
