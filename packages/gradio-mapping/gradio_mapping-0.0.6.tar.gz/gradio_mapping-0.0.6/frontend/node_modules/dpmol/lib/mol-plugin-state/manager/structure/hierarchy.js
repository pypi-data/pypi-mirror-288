...
var StructureHierarchyManager = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(StructureHierarchyManager, _super);
    ...
    StructureHierarchyManager.prototype.sync = function (notify) {
        ...
        if (this.state.syncedTree === this.dataState.tree) {
            if (notify && !this.state.notified) {
                ...
                this.behaviors.selection.next((0, tslib_1.__assign)({ hierarchy: this.state.hierarchy }, this.state.selection));
            }
            return;
        }
    ...
    StructureHierarchyManager.prototype.updateStructure = function (s, params) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.plugin.dataTransaction(function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                            var root, children;
                            return (0, tslib_1.__generator)(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
...
(function (StructureHierarchyManager) {
    ...
    function getSelectedStructuresDescription(plugin) {
        ...
        return sameTraj && t
            ? "".concat((_j = t.cell.obj) === null || _j === void 0 ? void 0 : _j.label, " | ").concat(structures.length, " structures")
            : "".concat(structures.length, " structures");
    }
