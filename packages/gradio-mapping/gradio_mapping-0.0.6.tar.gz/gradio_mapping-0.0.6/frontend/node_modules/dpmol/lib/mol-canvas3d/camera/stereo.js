...
exports.StereoCameraParams = {
    eyeSeparation: param_definition_1.ParamDefinition.Numeric(0.064, { min: 0.01, max: 0.5, step: 0.001 }),
    focus: param_definition_1.ParamDefinition.Numeric(10, { min: 1, max: 100, step: 0.01 }),
};
...
var StereoCamera = /** @class */ (function () {
    function StereoCamera(parent, props) {
        ...
        this.props = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, exports.DefaultStereoCameraProps), props);
    }
