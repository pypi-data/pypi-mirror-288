...
var GaussianDensitySchema = {
    ...
    tMinDistanceTex: (0, schema_1.TextureSpec)('texture', 'rgba', 'float', 'nearest'),
...
function getGaussianDensityRenderable(webgl, drawCount, positions, radii, groups, minDistanceTexture, box, gridDim, gridTexDim, gridTexScale, smoothness, resolution, radiusFactor) {
    ...
    if (webgl.namedComputeRenderables[GaussianDensityName]) {
        ...
        webgl.namedComputeRenderables[GaussianDensityName] =
            createGaussianDensityRenderable(webgl, drawCount, positions, radii, groups, minDistanceTexture, box, gridDim, gridTexDim, gridTexScale, smoothness, resolution, radiusFactor);
    }
