...
function ComplexRepresentation(label, ctx, getParams, visualCtor) {
    ...
    function createOrUpdate(props, structure) {
        ...
        return mol_task_1.Task.create('Creating or updating ComplexRepresentation', function (runtime) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
    ...
    function setState(state) {
        ...
        if (state.unitTransforms !== undefined && visual) {
            ...
            visual.setVisibility(_state.visible &&
...
//# sourceMappingURL=complex-representation.js.map