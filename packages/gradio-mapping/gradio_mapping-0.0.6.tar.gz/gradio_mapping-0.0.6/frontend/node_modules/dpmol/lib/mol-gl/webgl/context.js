...
function getGLContext(canvas, attribs) {
    ...
    var gl = ((attribs === null || attribs === void 0 ? void 0 : attribs.preferWebGl1) ? null : get('webgl2')) ||
        get('webgl') ||
...
function createContext(gl, props) {
    ...
    var parameters = {
        ...
        max3dTextureSize: (0, compat_1.isWebGL2)(gl)
            ? gl.getParameter(gl.MAX_3D_TEXTURE_SIZE)
            : 0,
        maxRenderbufferSize: gl.getParameter(gl.MAX_RENDERBUFFER_SIZE),
        maxDrawBuffers: extensions.drawBuffers
            ? gl.getParameter(extensions.drawBuffers.MAX_DRAW_BUFFERS)
            : 0,
