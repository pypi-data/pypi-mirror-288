...
import { INTERACTION_TYPE } from '../../../light-plugin/representation/interactions';
export { Interactions };
...
export declare const FeatureProviders: Features.Provider[];
export declare const ContactProviders: {
    ionic: import("./contacts").ContactProvider<{
        distanceMax: PD.Numeric;
    }>;
    'pi-stacking': import("./contacts").ContactProvider<{
        distanceMax: PD.Numeric;
        offsetMax: PD.Numeric;
        angleDevMax: PD.Numeric;
    }>;
    'cation-pi': import("./contacts").ContactProvider<{
        distanceMax: PD.Numeric;
        offsetMax: PD.Numeric;
    }>;
    'halogen-bonds': import("./contacts").ContactProvider<{
        distanceMax: PD.Numeric;
        angleMax: PD.Numeric;
    }>;
    'hydrogen-bonds': import("./contacts").ContactProvider<{
    ...
    'weak-hydrogen-bonds': import("./contacts").ContactProvider<{
        distanceMax: PD.Numeric;
        backbone: PD.BooleanParam;
        accAngleDevMax: PD.Numeric;
        donAngleDevMax: PD.Numeric;
    ...
    hydrophobic: import("./contacts").ContactProvider<{
        distanceMax: PD.Numeric;
    }>;
    'metal-coordination': import("./contacts").ContactProvider<{
        distanceMax: PD.Numeric;
    }>;
};
...
export declare const InteractionTypeInfo: {
    "ligand-receptor": {};
    "intra-ligand": {};
    "intra-receptor": {};
    all: {};
};
export declare type InteractionType = keyof typeof InteractionTypeInfo;
export declare const InteractionTypeNames: INTERACTION_TYPE[];
export declare const InteractionTypeOptions: [INTERACTION_TYPE, string][];
export declare const InteractionsParams: {
    ...
    type: PD.Select<INTERACTION_TYPE>;
    featuresList: PD.Value<Features[]>;
    filterKeys: PD.Value<string[] | undefined>;
};
export declare type InteractionsParams = typeof InteractionsParams;
export declare type InteractionsProps = PD.Values<InteractionsParams>;
...
export declare function findUnitFeatures(structure: Structure, unit: Unit, featureProviders: Features.Provider[]): Features;
