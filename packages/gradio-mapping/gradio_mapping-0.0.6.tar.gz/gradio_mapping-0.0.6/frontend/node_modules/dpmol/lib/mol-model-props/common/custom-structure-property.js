...
(function (CustomStructureProperty) {
        ...
        var get = function (data) {
            if (!(descriptorName in data[propertyDataName])) {
                data[propertyDataName][descriptorName] = {
                    props: (0, tslib_1.__assign)({}, param_definition_1.ParamDefinition.getDefaultValues(builder.getParams(data))),
    ...
    function createSimple(name, type, defaultValue) {
        ...
        return createProvider({
            ...
            obtain: function (ctx, data, props) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                return (0, tslib_1.__generator)(this, function (_a) {
                    return [2 /*return*/, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, param_definition_1.ParamDefinition.getDefaultValues(defaultParams)), props)];
                });
            }); }
        });
    }
