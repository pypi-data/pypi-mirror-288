...
function isAlkaliMetal(element) {
    return exports.AlkaliMetals.has(element);
}
exports.isAlkaliMetal = isAlkaliMetal;
exports.AlkalineEarthMetals = new Set([
    'BE',
    'MG',
    'CA',
    'SR',
...
function isAlkalineEarthMetal(element) {
    return exports.AlkalineEarthMetals.has(element);
}
exports.isAlkalineEarthMetal = isAlkalineEarthMetal;
exports.PolyatomicNonmetals = new Set([
    'C',
    'P',
    'S',
    'SE'
]);
function isPolyatomicNonmetal(element) {
    return exports.PolyatomicNonmetals.has(element);
}
exports.isPolyatomicNonmetal = isPolyatomicNonmetal;
exports.DiatomicNonmetals = new Set([
    'H',
    'N',
    'O',
    'F',
...
function isDiatomicNonmetal(element) {
    return exports.DiatomicNonmetals.has(element);
}
exports.isDiatomicNonmetal = isDiatomicNonmetal;
exports.NobleGases = new Set([
    'HE',
    'NE',
    'AR',
    'KR',
...
function isNobleGas(element) {
    return exports.NobleGases.has(element);
}
exports.isNobleGas = isNobleGas;
exports.PostTransitionMetals = new Set([
    'ZN',
    'GA',
    'CD',
    'IN',
...
function isPostTransitionMetal(element) {
    return exports.PostTransitionMetals.has(element);
}
exports.isPostTransitionMetal = isPostTransitionMetal;
exports.Metalloids = new Set([
    'B',
    'SI',
    'GE',
    'AS',
...
function isMetalloid(element) {
    return exports.Metalloids.has(element);
}
exports.isMetalloid = isMetalloid;
exports.Halogens = new Set([
    'F',
    'CL',
    'BR',
    'I',
...
function isHalogen(element) {
    return exports.Halogens.has(element);
}
