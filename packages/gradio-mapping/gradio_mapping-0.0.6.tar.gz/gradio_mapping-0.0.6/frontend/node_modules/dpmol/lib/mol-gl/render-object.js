...
function createRenderable(ctx, o, variants) {
    switch (o.type) {
        case 'mesh':
            return (0, mesh_1.MeshRenderable)(ctx, o.id, o.values, o.state, o.materialId, variants);
        case 'points':
            return (0, points_1.PointsRenderable)(ctx, o.id, o.values, o.state, o.materialId, variants);
        case 'spheres':
            return (0, spheres_1.SpheresRenderable)(ctx, o.id, o.values, o.state, o.materialId, variants);
        case 'cylinders':
            return (0, cylinders_1.CylindersRenderable)(ctx, o.id, o.values, o.state, o.materialId, variants);
        case 'text':
            return (0, text_1.TextRenderable)(ctx, o.id, o.values, o.state, o.materialId, variants);
        case 'lines':
            return (0, lines_1.LinesRenderable)(ctx, o.id, o.values, o.state, o.materialId, variants);
        case 'direct-volume':
            return (0, direct_volume_1.DirectVolumeRenderable)(ctx, o.id, o.values, o.state, o.materialId, variants);
        case 'image':
            return (0, image_1.ImageRenderable)(ctx, o.id, o.values, o.state, o.materialId, variants);
        case 'texture-mesh':
            return (0, texture_mesh_1.TextureMeshRenderable)(ctx, o.id, o.values, o.state, o.materialId, variants);
    }
