...
function TextureSpec(kind, format, dataType, filter) {
...
exports.GlobalUniformSchema = {
    ...
    // hermite 配体错误原子标识
    uInvalidColor: UniformSpec('v3'),
    uInvalidStrength: UniformSpec('f'),
};
...
exports.BaseSchema = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({ dGeometryType: DefineSpec('string', [
        'cylinders',
        'directVolume',
        'image',
        'lines',
