...
var StructureComponentManager = /** @class */ (function (_super) {
    ...
    function StructureComponentManager(plugin) {
        var _this = _super.call(this, {
            options: param_definition_1.ParamDefinition.getDefaultValues(StructureComponentManager.OptionsParams)
        }) || this;
        _this.plugin = plugin;
        _this.events = {
    ...
    StructureComponentManager.prototype.updateReprParams = function (update, component) {
        ...
        for (var _i = 0, _b = component.representations; _i < _b.length; _i++) {
            ...
            if (r.cell.transform.transformer !== representation_1.StructureRepresentation3D)
                continue;
            var params = r.cell.transform
                .params;
            if (!!params.type.params.ignoreHydrogens !== ignoreHydrogens ||
                params.type.params.quality !== quality ||
                params.type.params.ignoreLight !== ignoreLight ||
                !(0, mol_util_1.shallowEqual)(params.type.params.material, material) ||
                !param_definition_1.ParamDefinition.areEqual(clip_1.Clip.Params, params.type.params.clip, clip)) {
                ...
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        if (param_definition_1.ParamDefinition.areEqual(interactionParams, oldParams, this.state.options.interactions))
                            return [3 /*break*/, 5];
                        return [4 /*yield*/, this.dataState
                                .build()
                                .to(s.properties.cell)
                                .update(function (old) {
                                old.properties[interactions_1.InteractionsProvider.descriptor.name] =
                                    _this.state.options.interactions;
                            })
                                .commit()];
                    case 2:
                        _e.sent();
                    ...
                    case 3:
                        ...
                        if (param_definition_1.ParamDefinition.areEqual(interactionParams, params.properties[interactions_1.InteractionsProvider.descriptor.name], this.state.options.interactions))
                            return [3 /*break*/, 5];
                        params.properties[interactions_1.InteractionsProvider.descriptor.name] =
    ...
    StructureComponentManager.prototype.modifyByCurrentSelection = function (components, action) {
        var _this = this;
        return this.plugin.runTask(mol_task_1.Task.create('Modify Component', function (taskCtx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
    ...
    // CHANGED by xh
    StructureComponentManager.prototype.deleteByStructure = function (component, deleteComponent) {
        var _this = this;
        return this.plugin.runTask(mol_task_1.Task.create('Modify Component', function (taskCtx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var b;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        b = this.dataState.build();
                        if (!this.canBeModified(component))
                            return [2 /*return*/];
                        this.modifyComponent(b, component, deleteComponent, 'subtract');
                        return [4 /*yield*/, this.dataState.updateTree(b, { canUndo: 'Substract' }).runInContext(taskCtx)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    StructureComponentManager.prototype.updateRepresentationsTheme = function (components, paramsOrProvider) {
        ...
        for (var _i = 0, components_8 = components; _i < components_8.length; _i++) {
            ...
            var _loop_1 = function (repr) {
                ...
                var params = typeof paramsOrProvider === 'function'
    ...
    StructureComponentManager.prototype.tryFindComponent = function (structure, selection) {
        ...
        if (structure.components.length === 0)
            return;
        return this.plugin.runTask(mol_task_1.Task.create('Find Component', function (taskCtx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                                ...
                                case 3:
                                    ...
                                    return [4 /*yield*/, this.plugin.builders.structure.tryCreateComponentFromSelection(s.cell, params.selection, componentKey, {
                                            label: params.options.label ||
                                                (params.selection === structure_selection_query_1.StructureSelectionQueries.current
                                                    ? 'Custom Selection'
                                                    : '')
                                        })];
                                case 4:
    ...
    StructureComponentManager.prototype.applyTheme = function (params, structures) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            var _this = this;
            return (0, tslib_1.__generator)(this, function (_a) {
                return [2 /*return*/, this.plugin.dataTransaction(function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                        ...
                        return (0, tslib_1.__generator)(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    if (xs.length === 0)
                                        return [2 /*return*/];
                                    getLoci = function (s) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                                        var _a, _b;
    ...
    StructureComponentManager.prototype.modifyComponent = function (builder, component, by, action) {
        ...
        if (!structure)
            return;
        if ((action === 'subtract' || action === 'intersect') &&
            !(0, structure_set_1.structureAreIntersecting)(structure, by))
            return;
        ...
        // XXX 这里未来能不能去掉 if (component.cell.transform.transformer.id !== 'ms-plugin.SubStructure') 这个硬编码
        if (component.cell.transform.transformer.id !== 'ms-plugin.SubStructure') {
...
(function (StructureComponentManager) {
    StructureComponentManager.OptionsParams = {
        showHydrogens: param_definition_1.ParamDefinition.Boolean(true, {
            description: 'Toggle display of hydrogen atoms in representations'
        }),
        visualQuality: param_definition_1.ParamDefinition.Select('auto', base_1.VisualQualityOptions, {
        ...
        ignoreLight: param_definition_1.ParamDefinition.Boolean(false, {
            description: 'Ignore light for stylized rendering of representtions'
        }),
        materialStyle: material_1.Material.getParam(),
        clipObjects: param_definition_1.ParamDefinition.Group(clip_1.Clip.Params),
        interactions: param_definition_1.ParamDefinition.Group(interactions_1.InteractionsProvider.defaultParams, {
            label: 'Non-covalent Interactions'
        })
    };
    function getAddParams(plugin, params) {
        var options = plugin.query.structure.registry.options;
        params = (0, tslib_1.__assign)({ pivot: plugin.managers.structure.component.pivotStructure, allowNone: true, hideSelection: false, checkExisting: false }, params);
        return {
            selection: param_definition_1.ParamDefinition.Select(options[1][0], options, {
            ...
            options: param_definition_1.ParamDefinition.Group({
                ...
                checkExisting: param_definition_1.ParamDefinition.Boolean(!!(params === null || params === void 0 ? void 0 : params.checkExisting), {
    ...
    function getRepresentationTypesSelect(plugin, pivot, custom, label) {
        var types = (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], custom, true), getRepresentationTypes(plugin, pivot), true);
