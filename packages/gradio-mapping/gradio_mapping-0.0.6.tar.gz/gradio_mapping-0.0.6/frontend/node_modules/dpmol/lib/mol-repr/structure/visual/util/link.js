...
function createLinkCylinderMesh(ctx, linkBuilder, props, mesh) {
    ...
    for (var edgeIndex = 0, _eI = linkCount; edgeIndex < _eI; ++edgeIndex) {
        ...
        var _a = dirFlag
            ? [linkStub, linkCap]
            : [linkCap, linkStub], topCap = _a[0], bottomCap = _a[1];
        ...
        if (linkStyle === 0 /* Solid */) {
            ...
            cylinderProps.radiusTop = cylinderProps.radiusBottom =
                linkRadius * dashScale;
        ...
        else if (linkStyle === 2 /* Double */ ||
            linkStyle === 3 /* OffsetDouble */ ||
            linkStyle === 4 /* Triple */ ||
            linkStyle === 5 /* OffsetTriple */ ||
            linkStyle === 7 /* Aromatic */ ||
            linkStyle === 8 /* MirroredAromatic */) {
            var order = linkStyle === 2 /* Double */ || linkStyle === 3 /* OffsetDouble */
                ? 2
                : linkStyle === 4 /* Triple */ ||
                    linkStyle === 5 /* OffsetTriple */
                    ? 3
            ...
            cylinderProps.topCap = topCap;
            cylinderProps.bottomCap = bottomCap;
            if (linkStyle === 7 /* Aromatic */ ||
                linkStyle === 8 /* MirroredAromatic */) {
                cylinderProps.radiusTop = cylinderProps.radiusBottom = linkRadius;
                (0, cylinder_1.addCylinder)(builderState, va, vb, 0.5, cylinderProps);
                var aromaticOffset = linkRadius +
                    aromaticScale * linkRadius +
                    aromaticScale * linkRadius * aromaticSpacing;
                v3setMagnitude(tmpV12, v3sub(tmpV12, vb, va), linkRadius * 0.5);
                v3add(va, va, tmpV12);
                v3sub(vb, vb, tmpV12);
                cylinderProps.radiusTop = cylinderProps.radiusBottom =
                    linkRadius * aromaticScale;
                cylinderProps.topCap = cylinderProps.bottomCap = dashCap;
            ...
            else if (linkStyle === 3 /* OffsetDouble */ ||
                linkStyle === 5 /* OffsetTriple */) {
    ...
    var oldBoundingSphere = mesh
        ? sphere3d_1.Sphere3D.clone(mesh.boundingSphere)
        : undefined;
    ...
    if (oldBoundingSphere &&
        linear_algebra_1.Vec3.distance(center, oldBoundingSphere.center) / oldBoundingSphere.radius <
            1.0) {
...
function createLinkCylinderImpostors(ctx, linkBuilder, props, cylinders) {
    ...
    for (var edgeIndex = 0, _eI = linkCount; edgeIndex < _eI; ++edgeIndex) {
        ...
        if (linkStyle === 0 /* Solid */) {
            ...
            if (linkStyle === 7 /* Aromatic */ ||
                ...
                linkStyle === 5 /* OffsetTriple */) {
                var multipleOffset = linkRadius +
                    multiScale * linkRadius +
    ...
    var oldBoundingSphere = cylinders
        ? sphere3d_1.Sphere3D.clone(cylinders.boundingSphere)
        : undefined;
...
function createLinkLines(ctx, linkBuilder, props, lines) {
    ...
    var oldBoundingSphere = lines
        ? sphere3d_1.Sphere3D.clone(lines.boundingSphere)
        : undefined;
