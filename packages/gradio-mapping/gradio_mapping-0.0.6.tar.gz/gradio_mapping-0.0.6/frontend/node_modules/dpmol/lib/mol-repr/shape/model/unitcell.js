...
var CellParams = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, mesh_1.Mesh.Params), { cellColor: param_definition_1.ParamDefinition.Color(names_1.ColorNames.orange), cellScale: param_definition_1.ParamDefinition.Numeric(2, { min: 0.1, max: 5, step: 0.1 }), ref: param_definition_1.ParamDefinition.Select('model', param_definition_1.ParamDefinition.objectToOptions(CellRef), { isEssential: true }), attachment: param_definition_1.ParamDefinition.Select('corner', param_definition_1.ParamDefinition.objectToOptions(CellAttachment), {
        isEssential: true
    }) });
var UnitcellVisuals = {
    mesh: function (ctx, getParams) { return (0, representation_1.ShapeRepresentation)(getUnitcellShape, mesh_1.Mesh.Utils); }
};
exports.UnitcellParams = (0, tslib_1.__assign)({}, CellParams);
