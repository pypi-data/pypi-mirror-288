...
(function (IntClassifier) {
    ...
    function getInfo(data) {
        ...
        return signed
            ? { signed: signed, limit8: 0x7f, limit16: 0x7fff }
            : { signed: signed, limit8: 0xff, limit16: 0xffff };
    }
    function SizeInfo() {
    ...
    function packingSize(data, info) {
        ...
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, byteSize(size)), { kind: 'pack' });
    }
    function deltaSize(data, info) {
        ...
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, byteSize(size)), { kind: 'delta' });
    }
    function rleSize(data, info) {
        ...
        incSize(info, size, run);
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, byteSize(size)), { kind: 'rle' });
    }
    function deltaRleSize(data, info) {
        ...
        incSizeSigned(size, prevValue);
        incSizeSigned(size, run);
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, byteSize(size)), { kind: 'delta-rle' });
    }
    ...
    function classify(data) {
        ...
        switch (size.kind) {
            case 'pack':
                return array_encoder_1.ArrayEncoding.by(array_encoder_1.ArrayEncoding.integerPacking);
            case 'rle':
                return array_encoder_1.ArrayEncoding.by(array_encoder_1.ArrayEncoding.runLength).and(array_encoder_1.ArrayEncoding.integerPacking);
            case 'delta':
                return array_encoder_1.ArrayEncoding.by(array_encoder_1.ArrayEncoding.delta).and(array_encoder_1.ArrayEncoding.integerPacking);
            case 'delta-rle':
                return array_encoder_1.ArrayEncoding.by(array_encoder_1.ArrayEncoding.delta).and(array_encoder_1.ArrayEncoding.runLength).and(array_encoder_1.ArrayEncoding.integerPacking);
            default:
...
(function (FloatClassifier) {
    ...
    function classify(data) {
        ...
        switch (size.kind) {
            case 'pack':
                return fp.and(array_encoder_1.ArrayEncoding.integerPacking);
            case 'rle':
                return fp.and(array_encoder_1.ArrayEncoding.runLength).and(array_encoder_1.ArrayEncoding.integerPacking);
            case 'delta':
                return fp.and(array_encoder_1.ArrayEncoding.delta).and(array_encoder_1.ArrayEncoding.integerPacking);
            case 'delta-rle':
                return fp.and(array_encoder_1.ArrayEncoding.delta).and(array_encoder_1.ArrayEncoding.runLength).and(array_encoder_1.ArrayEncoding.integerPacking);
            default:
                (0, type_helpers_1.assertUnreachable)(size);
        }
    }
