            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (formalCharges.atomIdx.rowCount > 0) {
                        for (i = 0; i < formalCharges.atomIdx.rowCount; i++) {
                            computedFormalCharges[formalCharges.atomIdx.value(i) - 1] =
                                formalCharges.charge.value(i);
                        }
                    }
                    else {
                    ...
                    entityBuilder.setNames([['MOL', 'Ligand']]);
                ...
                case 1:
                    ...
                    if (models.frameCount > 0) {
                        ...
                        pairBonds = index_pair_1.IndexPairBonds.fromData({
                            pairs: { indexA: indexA, indexB: indexB, order: order },
                            count: atoms.count
                        });
