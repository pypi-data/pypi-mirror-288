...
exports.LazyVolume = exports.ParseJson = exports.ImportJson = exports.ImportString = exports.ParseCcp4 = exports.ParseCube = exports.ParseCif = exports.ParseBlob = exports.ReadFile = exports.RawData = exports.DownloadBlob = exports.Download = void 0;
var tslib_1 = require("tslib");
var CCP4 = (0, tslib_1.__importStar)(require("../../mol-io/reader/ccp4/parser"));
...
var parser_1 = require("../../mol-io/reader/cube/parser");
...
var Download = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a, plugin) {
        ...
        return mol_task_1.Task.create('Download', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var url, asset;
...
var DownloadBlob = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a, plugin) {
        ...
        return mol_task_1.Task.create('Download Blob', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
    ...
    dispose: function (_a, plugin) {
        ...
        if (!assets)
            return;
        for (var _c = 0, assets_2 = assets; _c < assets_2.length; _c++) {
            var a = assets_2[_c];
            a.dispose();
        }
    }
...
var RawData = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a) {
        var _this = this;
        var p = _a.params;
        return mol_task_1.Task.create('Raw Data', function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            return (0, tslib_1.__generator)(this, function (_a) {
...
var ReadFile = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var p = _a.params, cache = _a.cache;
        return mol_task_1.Task.create('Open File', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var asset, o;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
...
var ParseBlob = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a, plugin) {
        ...
        return mol_task_1.Task.create('Parse Blob', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
...
var ParseCif = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a) {
        ...
        return mol_task_1.Task.create('Parse CIF', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (objects_1.PluginStateObject.Data.String.is(a) ? cif_1.CIF.parse(a.data) : cif_1.CIF.parseBinary(a.data)).runInContext(ctx)];
                    case 1:
                        parsed = _a.sent();
                        if (parsed.isError)
...
var ParseCube = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a) {
        var _this = this;
        var a = _a.a;
        return mol_task_1.Task.create('Parse Cube', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var parsed;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, parser_1.parseCube)(a.data, a.label).runInContext(ctx)];
                    case 1:
                        parsed = _a.sent();
                        if (parsed.isError)
                            throw new Error(parsed.message);
...
var ParseJson = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a) {
        var _this = this;
        var a = _a.a;
        return mol_task_1.Task.create('Parse JSON', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var json;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
...
var LazyVolume = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Lazy Volume', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var entryId;
            return (0, tslib_1.__generator)(this, function (_a) {
