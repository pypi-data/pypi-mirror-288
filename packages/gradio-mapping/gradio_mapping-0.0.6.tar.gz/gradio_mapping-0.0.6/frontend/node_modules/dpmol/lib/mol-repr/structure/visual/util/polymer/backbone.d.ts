...
export declare type PolymerBackboneLinkCallback = (indexA: ElementIndex, indexB: ElementIndex, groupA: number, groupB: number, moleculeType: MoleculeType) => void;
export declare function eachPolymerBackboneLink(unit: Unit, callback: PolymerBackboneLinkCallback): void;
export declare type PolymerBackboneElementCallback = (index: ElementIndex, group: number) => void;
