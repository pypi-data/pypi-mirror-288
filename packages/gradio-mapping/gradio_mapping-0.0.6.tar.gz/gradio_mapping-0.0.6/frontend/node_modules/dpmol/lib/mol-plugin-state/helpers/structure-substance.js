...
function setStructureSubstance(plugin, components, material, lociGetter, types) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, eachRepr(plugin, components, function (update, repr, substanceCell) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                        ...
                        return (0, tslib_1.__generator)(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    if (substanceCell) {
                                        bundleLayers = (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], substanceCell.params.values.layers, true), [layer], false);
                                        ...
                                        update
                                            ...
                                            .SubstanceStructureRepresentation3DFromBundle, substance_1.Substance.toBundle(filtered), { tags: SubstanceManagerTag });
                                    }
                                    return [2 /*return*/];
                            }
                        });
        ...
        return (0, tslib_1.__generator)(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    r = _b[_a];
                    substance = state.select(mol_state_1.StateSelection.Generators.ofTransformer(transforms_1.StateTransforms.Representation
                        .SubstanceStructureRepresentation3DFromBundle, r.cell.transform.ref).withTag(SubstanceManagerTag));
...
//# sourceMappingURL=structure-substance.js.map