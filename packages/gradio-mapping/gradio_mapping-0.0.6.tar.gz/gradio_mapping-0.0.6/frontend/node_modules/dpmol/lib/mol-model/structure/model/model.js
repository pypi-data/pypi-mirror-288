...
(function (Model) {
    function _trajectoryFromModelAndCoordinates(model, coordinates) {
        ...
        var srcIndexArray = isIdentity
            ? void 0
            : srcIndex.toArray({ array: Int32Array });
        var coarseGrained = isCoarseGrained(model);
        for (var i = 0, il = frames.length; i < il; ++i) {
            var f = frames[i];
            var m = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, model), { id: mol_util_1.UUID.create22(), modelNum: i, atomicConformation: coordinates_1.Coordinates.getAtomicConformation(f, model.atomicConformation.atomId, srcIndexArray), 
    ...
    function areHierarchiesEqual(a, b) {
        return (a.atomicHierarchy === b.atomicHierarchy &&
