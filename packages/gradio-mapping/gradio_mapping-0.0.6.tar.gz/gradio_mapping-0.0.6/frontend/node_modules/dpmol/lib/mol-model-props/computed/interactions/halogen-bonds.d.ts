...
export declare const DefaultHalogenBondParams: PD.Values<{
    distanceMax: PD.Numeric;
    angleMax: PD.Numeric;
}>;
declare type HalogenBondsParams = typeof HalogenBondsParams;
export declare type HalogenBondsProps = PD.Values<HalogenBondsParams>;
