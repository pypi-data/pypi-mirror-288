...
function interpolate(str, params) {
    ...
    return new (Function.bind.apply(Function, (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([void 0], names, false), ["return `".concat(str, "`;")], false)))().apply(void 0, values);
}
