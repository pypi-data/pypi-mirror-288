...
function isHelixSS(ss) {
    return types_1.SecondaryStructureType.is(ss, 2 /* Helix */);
}
function isSheetSS(ss) {
    return types_1.SecondaryStructureType.is(ss, 4 /* Beta */);
}
/**
...
var SecStrucTypeNA = types_1.SecondaryStructureType.create(536870912 /* NA */);
function createPolymerTraceElement(structure, unit) {
    return {
        ...
        p0: (0, linear_algebra_1.Vec3)(),
        p1: (0, linear_algebra_1.Vec3)(),
        p2: (0, linear_algebra_1.Vec3)(),
        p3: (0, linear_algebra_1.Vec3)(),
        p4: (0, linear_algebra_1.Vec3)(),
        d12: (0, linear_algebra_1.Vec3)(),
        d23: (0, linear_algebra_1.Vec3)()
    };
}
...
var AtomicPolymerTraceIterator = /** @class */ (function () {
    function AtomicPolymerTraceIterator(unit, structure, options) {
        ...
        this.traceElementIndex = unit.model.atomicHierarchy.derived.residue
            .traceElementIndex; // can assume it won't be -1 for polymer residues
    ...
    AtomicPolymerTraceIterator.prototype.setFromToVector = function (out, residueIndex, ss) {
        if (this.value.isCoarseBackbone ||
            (this.helixOrientationCenters && isHelixSS(ss))) {
...
//# sourceMappingURL=trace-iterator.js.map