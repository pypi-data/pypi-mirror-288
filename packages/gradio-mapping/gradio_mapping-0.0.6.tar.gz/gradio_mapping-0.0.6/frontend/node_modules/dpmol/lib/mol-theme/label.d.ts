...
export declare type LabelGranularity = 'element' | 'conformation' | 'residue' | 'chain' | 'structure';
...
export declare type LabelOptions = typeof DefaultLabelOptions;
...
export declare function elementLabel(location: StructureElement.Location, options?: Partial<LabelOptions>, forLoci?: boolean): string;
