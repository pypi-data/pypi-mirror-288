...
exports.MolecularSurfaceMeshVisual = exports.MolecularSurfaceMeshParams = void 0;
...
exports.MolecularSurfaceMeshParams = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, units_visual_1.UnitsMeshParams), molecular_surface_1.MolecularSurfaceCalculationParams), common_1.CommonSurfaceParams), base_1.ColorSmoothingParams);
//
...
function MolecularSurfaceMeshVisual(materialId) {
    return (0, units_visual_1.UnitsMeshVisual)({
        ...
        setUpdateState: function (state, newProps, currentProps) {
            ...
            else if (newProps.smoothColors.name === 'on' &&
                currentProps.smoothColors.name === 'on') {
                if (newProps.smoothColors.params.resolutionFactor !==
                    currentProps.smoothColors.params.resolutionFactor)
                    state.updateColor = true;
                if (newProps.smoothColors.params.sampleStride !==
...
//# sourceMappingURL=molecular-surface-mesh.js.map