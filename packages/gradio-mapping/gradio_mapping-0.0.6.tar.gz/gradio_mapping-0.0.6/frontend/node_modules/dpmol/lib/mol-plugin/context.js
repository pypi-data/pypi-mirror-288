...
var immer_1 = (0, tslib_1.__importStar)(require("immer"));
...
var grid_pocket_1 = require("../mol-plugin-state/manager/structure/grid-pocket");
var interaction_line_1 = require("../mol-plugin-state/manager/structure/interaction-line");
var pharmacophore_1 = require("../mol-plugin-state/manager/structure/pharmacophore");
var rotate_arrow_1 = require("../mol-plugin-state/manager/structure/rotate-arrow");
...
var PluginContext = /** @class */ (function () {
    function PluginContext(spec) {
        ...
        this.behaviors = {
            ...
            interaction: {
                hover: this.ev.behavior({
                    current: representation_1.Representation.Loci.Empty,
                    modifiers: input_observer_1.ModifiersKeys.None,
                    buttons: 0,
                    button: 0
                }),
                ...
                drag: this.ev.behavior({
                    ...
                    buttons: 0,
                    button: 0,
                    pageStart: (0, linear_algebra_1.Vec2)(),
                    pageEnd: (0, linear_algebra_1.Vec2)()
                }),
        ...
        this.managers = {
            structure: {
                ...
                gridPocket: new grid_pocket_1.StructureGridPocketManager(this),
                interactionLine: new interaction_line_1.StructureInteractionLineManager(this),
                pharmacophore: new pharmacophore_1.PharmacophoreManager(this),
                rotateArrow: new rotate_arrow_1.RotateArrowManager(this),
            },
            volume: {
    ...
    PluginContext.prototype.initViewer = function (canvas, container, canvas3dContext) {
        ...
        try {
            ...
            if (canvas3dContext) {
                ...
                this.canvas3dContext = canvas3d_1.Canvas3DContext.fromCanvas(canvas, {
                    antialias: antialias,
            ...
            var backgroundColor_1 = (0, color_2.Color)(0xf2f5fa);
            if (!props) {
            ...
            this.helpers.viewportScreenshot =
                new viewport_screenshot_1.ViewportScreenshotHelper(this);
            ...
            this.subs.push(this.layout.events.updated.subscribe(function () {
                return requestAnimationFrame(function () { return _this.handleResize(); });
            }));
            this.handleResize();
            return true;
        }
    ...
    Object.defineProperty(PluginContext.prototype, "isBusy", {
        ...
        get: function () {
            return (this.behaviors.state.isAnimating.value ||
    ...
    Object.defineProperty(PluginContext.prototype, "isEditing", {
        get: function () {
            var _a;
            return !!((_a = this.canvas3d) === null || _a === void 0 ? void 0 : _a.controls.isEditing);
        },
        set: function (state) {
            var _a;
            (_a = this.canvas3d) === null || _a === void 0 ? void 0 : _a.controls.setEditState(state);
            if (!state) {
                var builder_1 = this.state.data.build();
                var removeCrefs_1 = [];
                this.state.data.cells.forEach(function (cell) {
                    var _a, _b;
                    if (((_b = (_a = cell === null || cell === void 0 ? void 0 : cell.transform) === null || _a === void 0 ? void 0 : _a.tags) === null || _b === void 0 ? void 0 : _b.length) && cell.transform.tags[0] === 'Rotate-Arrow-group') {
                        removeCrefs_1.push(cell.transform.ref);
                    }
                });
                if (removeCrefs_1.length) {
                    removeCrefs_1.forEach(function (ref) { return builder_1.delete(ref); });
                    builder_1.commit();
                }
            }
        },
    ...
    Object.defineProperty(PluginContext.prototype, "disabledInteraction", {
        get: function () {
            var _a;
            return ((_a = this.canvas3d) === null || _a === void 0 ? void 0 : _a.controls.disabledInteraction) || [];
        },
        set: function (state) {
            var _a;
            (_a = this.canvas3d) === null || _a === void 0 ? void 0 : _a.controls.setDisabledInteractionState(state);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(PluginContext.prototype, "isLockCamera", {
        get: function () {
            var _a;
            return !!((_a = this.canvas3d) === null || _a === void 0 ? void 0 : _a.controls.isLockCamera);
        },
        set: function (state) {
            var _a;
            (_a = this.canvas3d) === null || _a === void 0 ? void 0 : _a.controls.setLockCameraState(state);
        },
        enumerable: false,
        configurable: true
    });
    ...
    PluginContext.prototype.clear = function (resetViewportSettings) {
        ...
        return commands_1.PluginCommands.State.RemoveObject(this, {
            state: this.state.data,
            ref: mol_state_1.StateTransform.RootRef
        });
    };
    PluginContext.prototype.dispose = function (options) {
        ...
        (0, object_1.objectForEach)(this.managers, function (m) { var _a, _b; return (_b = (_a = m) === null || _a === void 0 ? void 0 : _a.dispose) === null || _b === void 0 ? void 0 : _b.call(_a); });
        (0, object_1.objectForEach)(this.managers.structure, function (m) { var _a, _b; return (_b = (_a = m) === null || _a === void 0 ? void 0 : _a.dispose) === null || _b === void 0 ? void 0 : _b.call(_a); });
        this.disposed = true;
    };
                ...
                switch (_f.label) {
                    case 0:
                        ...
                        for (_i = 0, _a = Object.keys(behavior_2.PluginBehavior.Categories); _i < _a.length; _i++) {
                            ...
                            tree
                                .toRoot()
                                .apply(behavior_2.PluginBehavior.CreateCategory, { label: behavior_2.PluginBehavior.Categories[cat] }, { ref: cat, state: { isLocked: true } });
                        }
                        ...
                        for (_b = 0, _c = this.spec.behaviors; _b < _c.length; _b++) {
                            ...
                            if (cat !== 'custom-props')
                                continue;
                            tree
                                .to(behavior_2.PluginBehavior.getCategoryId(b.transformer))
                                .apply(b.transformer, b.defaultParams, { ref: b.transformer.id });
                        }
                        return [4 /*yield*/, this.runTask(this.state.behaviors.updateTree(tree, {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.managers.interactivity =
                            new interactivity_1.InteractivityManager(this);
