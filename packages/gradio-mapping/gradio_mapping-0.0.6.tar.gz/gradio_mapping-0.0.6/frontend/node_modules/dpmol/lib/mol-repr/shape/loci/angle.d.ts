...
export declare type AngleParams = typeof AngleParams;
export declare type AngleProps = PD.Values<AngleParams>;
export declare type AngleRepresentation = Representation<AngleData, AngleParams>;
