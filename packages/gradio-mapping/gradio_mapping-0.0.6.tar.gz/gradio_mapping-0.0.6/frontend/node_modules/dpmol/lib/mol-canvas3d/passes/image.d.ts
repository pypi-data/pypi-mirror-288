...
export declare type ImageProps = PD.Values<typeof ImageParams>;
export declare class ImagePass {
    ...
    get width(): number;
    get height(): number;
    constructor(webgl: WebGLContext, renderer: Renderer, scene: Scene, camera: Camera, helper: Helper, enableWboit: boolean, props: Partial<ImageProps>);
