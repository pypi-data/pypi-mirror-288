    ...
    function createMulti(label, ctx, getParams, stateBuilder, reprDefs) {
        ...
        return {
            ...
            createOrUpdate: function (props, data) {
                ...
                var visuals = currentProps.visuals;
                return mol_task_1.Task.create("Creating or updating '".concat(label, "' representation"), function (runtime) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                    var i, il;
                    return (0, tslib_1.__generator)(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, reprList[i]
                                        .createOrUpdate(currentProps, currentData)
    ...
    function fromRenderObject(label, renderObject) {
        ...
        return {
            ...
            createOrUpdate: function (props) {
                ...
                Object.assign(currentProps, props, qualityProps);
                return mol_task_1.Task.create("Updating '".concat(label, "' representation"), function (runtime) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                    return (0, tslib_1.__generator)(this, function (_a) {
                        // TODO
