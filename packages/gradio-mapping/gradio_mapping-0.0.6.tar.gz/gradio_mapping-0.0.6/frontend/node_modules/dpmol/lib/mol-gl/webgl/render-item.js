...
function createProgramVariant(ctx, variant, defineValues, shaderCode, schema) {
    ...
    if (schema.dRenderVariant === undefined) {
        Object.defineProperty(schema, 'dRenderVariant', {
            value: (0, schema_1.DefineSpec)('string')
        });
    }
...
function createRenderItem(ctx, drawMode, shaderCode, schema, values, materialId, renderVariants) {
    ...
    var _b = (0, schema_1.splitValues)(schema, values), attributeValues = _b.attributeValues, defineValues = _b.defineValues, textureValues = _b.textureValues, uniformValues = _b.uniformValues, materialUniformValues = _b.materialUniformValues, bufferedUniformValues = _b.bufferedUniformValues;
    ...
    return {
        ...
        update: function () {
            ...
            if (values.drawCount.ref.version !== versions.drawCount) {
                ...
                stats.instancedDrawCount +=
                    instanceCount * values.drawCount.ref.value - instanceCount * drawCount;
            ...
            if (values.instanceCount.ref.version !== versions.instanceCount) {
                ...
                stats.instancedDrawCount +=
                    values.instanceCount.ref.value * drawCount - instanceCount * drawCount;
            ...
            if (valueChanges.attributes ||
                valueChanges.defines ||
                valueChanges.elements) {
