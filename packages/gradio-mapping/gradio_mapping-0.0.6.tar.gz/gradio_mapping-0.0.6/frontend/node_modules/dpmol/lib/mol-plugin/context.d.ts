...
import { StructureGridPocketManager } from '../mol-plugin-state/manager/structure/grid-pocket';
import { StructureInteractionLineManager } from '../mol-plugin-state/manager/structure/interaction-line';
import { PharmacophoreManager } from '../mol-plugin-state/manager/structure/pharmacophore';
import { RotateArrowManager } from '../mol-plugin-state/manager/structure/rotate-arrow';
...
export declare class PluginContext {
    ...
    readonly managers: {
        readonly structure: {
            ...
            readonly gridPocket: StructureGridPocketManager;
            readonly interactionLine: StructureInteractionLineManager;
            readonly pharmacophore: PharmacophoreManager;
            readonly rotateArrow: RotateArrowManager;
        };
        readonly volume: {};
