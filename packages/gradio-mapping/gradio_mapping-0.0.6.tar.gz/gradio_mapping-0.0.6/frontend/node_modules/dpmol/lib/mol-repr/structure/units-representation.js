...
function UnitsRepresentation(label, ctx, getParams, visualCtor) {
    ...
    function createOrUpdate(props, structure) {
        ...
        return mol_task_1.Task.create('Creating or updating UnitsRepresentation', function (runtime) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 8:
                        if (!(structure &&
                            (!structure_1.Structure.areUnitIdsAndIndicesEqual(structure, _structure) ||
                                structure.child !== _structure.child))) return [3 /*break*/, 22];
                    ...
                    case 22:
                        if (!(structure &&
                            ...
                            structure_1.Structure.areUnitIdsAndIndicesEqual(structure, _structure))) return [3 /*break*/, 34];
                    ...
                    case 34:
                        visualsList_1 = [] // TODO avoid allocation
                        ;
    ...
    function mark(loci, action) {
        ...
        if (!marker_action_1.MarkerActions.is(_state.markerActions, action))
            return false;
        if (structure_1.Structure.isLoci(loci) ||
            structure_1.StructureElement.Loci.is(loci) ||
            structure_1.Bond.isLoci(loci)) {
            ...
            if (structure_1.Structure.isLoci(loci) ||
                (structure_1.StructureElement.Loci.is(loci) &&
                    structure_1.StructureElement.Loci.isWholeStructure(loci))) {
    ...
    function setState(state) {
        ...
        if (transform !== undefined &&
            !linear_algebra_1.Mat4.areEqual(transform, _state.transform, linear_algebra_1.EPSILON)) {
            newState.transform = transform;
        }
        if (unitTransforms !== _state.unitTransforms ||
            (unitTransforms === null || unitTransforms === void 0 ? void 0 : unitTransforms.version) !== state.unitTransformsVersion) {
            newState.unitTransforms = unitTransforms;
            _state.unitTransformsVersion = unitTransforms
                ? unitTransforms === null || unitTransforms === void 0 ? void 0 : unitTransforms.version
                : -1;
        }
...
//# sourceMappingURL=units-representation.js.map