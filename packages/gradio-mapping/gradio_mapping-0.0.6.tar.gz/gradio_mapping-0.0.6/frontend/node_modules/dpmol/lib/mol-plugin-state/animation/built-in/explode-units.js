...
exports.AnimateUnitsExplode = model_1.PluginStateAnimation.create({
    ...
    teardown: function (_, __, plugin) {
        ...
        var reprs = state.select(mol_state_1.StateSelection.Generators.ofType(objects_1.PluginStateObject.Molecule.Structure.Representation3DState).withTag('animate-units-explode'));
        if (reprs.length === 0)
            return;
