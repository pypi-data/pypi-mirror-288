...
function createResources(gl, state, stats, extensions) {
    ...
    var shaderCache = (0, reference_cache_1.createReferenceCache)(function (props) { return JSON.stringify(props); }, function (props) { return wrap('shader', (0, shader_1.createShader)(gl, props)); }, function (shader) {
        shader.destroy();
    });
    ...
    var programCache = (0, reference_cache_1.createReferenceCache)(function (props) {
        ...
        return wrap('program', (0, program_1.createProgram)(gl, state, extensions, getShader, props));
    }, function (program) {
        program.destroy();
    });
    return {
