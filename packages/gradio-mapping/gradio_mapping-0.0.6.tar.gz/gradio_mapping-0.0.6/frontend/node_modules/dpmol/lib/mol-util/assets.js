...
var AssetManager = /** @class */ (function () {
    ...
    AssetManager.prototype.resolve = function (asset, type, store) {
        ...
        if (Asset.isUrl(asset)) {
            return mol_task_1.Task.create("Download ".concat(asset.title || asset.url), function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            ...
            return mol_task_1.Task.create("Read ".concat(asset.name), function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
