...
(function (Unit) {
    function isAtomic(u) {
        return u.kind === 0 /* Atomic */;
    }
    Unit.isAtomic = isAtomic;
    function isCoarse(u) {
        return u.kind === 1 /* Spheres */ || u.kind === 2 /* Gaussians */;
    }
    Unit.isCoarse = isCoarse;
    function isSpheres(u) {
        return u.kind === 1 /* Spheres */;
    }
    Unit.isSpheres = isSpheres;
    function isGaussians(u) {
        return u.kind === 2 /* Gaussians */;
    }
    Unit.isGaussians = isGaussians;
    function create(id, invariantId, chainGroupId, traits, kind, model, operator, elements, props) {
        switch (kind) {
            case 0 /* Atomic */:
                return new Atomic(id, invariantId, chainGroupId, traits, model, elements, symmetry_operator_1.SymmetryOperator.createMapping(operator, model.atomicConformation, void 0), props !== null && props !== void 0 ? props : AtomicProperties());
            case 1 /* Spheres */:
                return createCoarse(id, invariantId, chainGroupId, traits, model, 1 /* Spheres */, elements, symmetry_operator_1.SymmetryOperator.createMapping(operator, model.coarseConformation.spheres, getSphereRadiusFunc(model)), props !== null && props !== void 0 ? props : CoarseProperties());
            case 2 /* Gaussians */:
                return createCoarse(id, invariantId, chainGroupId, traits, model, 2 /* Gaussians */, elements, symmetry_operator_1.SymmetryOperator.createMapping(operator, model.coarseConformation.gaussians, getGaussianRadiusFunc(model)), props !== null && props !== void 0 ? props : CoarseProperties());
        }
    }
    Unit.create = create;
    ...
    var Atomic = /** @class */ (function () {
        ...
        Atomic.prototype.applyOperator = function (id, operator, dontCompose) {
            ...
            var op = dontCompose
                ? operator
                : symmetry_operator_1.SymmetryOperator.compose(this.conformation.operator, operator);
        ...
        Atomic.prototype.remapModel = function (model, dynamicBonds, props) {
            var _a, _b;
            if (!props) {
                props = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, this.props), { bonds: dynamicBonds && !((_b = (_a = this.props.bonds) === null || _a === void 0 ? void 0 : _a.props) === null || _b === void 0 ? void 0 : _b.canRemap)
                        ? undefined
            ...
            if (operator.spgrOp !== -1 &&
                symmetry &&
                symmetry !== symmetry_1.ModelSymmetry.Provider.get(this.model)) {
            ...
            var conformation = this.model.atomicConformation !== model.atomicConformation ||
        ...
        Object.defineProperty(Atomic.prototype, "boundary", {
            get: function () {
                ...
                this.props.boundary = (0, boundary_1.getBoundary)({ x: x, y: y, z: z, indices: this.elements });
                return this.props.boundary;
            },
            enumerable: false,
            configurable: true
    ...
    var Coarse = /** @class */ (function () {
        function Coarse(id, invariantId, chainGroupId, traits, model, kind, elements, conformation, props) {
            ...
            this.coarseConformation = (kind === 1 /* Spheres */
        ...
        Coarse.prototype.remapModel = function (model, dynamicBonds, props) {
            ...
            if (!props) {
                props = (0, tslib_1.__assign)({}, this.props);
                if (!Unit.isSameConformation(this, model)) {
    ...
    var Spheres = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(Spheres, _super);
        function Spheres() {
    ...
    var Gaussians = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(Gaussians, _super);
        function Gaussians() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        return Gaussians;
