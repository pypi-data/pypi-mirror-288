...
exports.StructureSelectionsPlane3D = exports.StructureSelectionsOrientation3D = exports.StructureSelectionsLabel3D = exports.StructureSelectionsDihedral3D = exports.StructureSelectionsAngle3D = exports.StructureSelectionsInteractionLine3D = exports.StructureSelectionsDistance3D = exports.StructureBoundingBox3D = exports.StructureGridPocket3D = exports.ModelUnitcell3D = exports.ShapeRepresentation3D = exports.VolumeRepresentation3DHelpers = exports.RotateArrow3D = exports.Pharmacophore3D = exports.VolumeRepresentation3D = exports.ClippingStructureRepresentation3DFromBundle = exports.ClippingStructureRepresentation3DFromScript = exports.SubstanceStructureRepresentation3DFromBundle = exports.SubstanceStructureRepresentation3DFromScript = exports.TransparencyStructureRepresentation3DFromBundle = exports.TransparencyStructureRepresentation3DFromScript = exports.OverpaintStructureRepresentation3DFromCref = exports.OverpaintStructureRepresentation3DFromBundle = exports.OverpaintStructureRepresentation3DFromScript = exports.UnwindStructureAssemblyRepresentation3D = exports.SpinStructureRepresentation3D = exports.ExplodeStructureRepresentation3D = exports.StructureRepresentation3D = void 0;
...
var grid_pocket_1 = require("../../mol-repr/shape/loci/grid-pocket");
...
var pharmacophore_1 = require("../../mol-repr/shape/loci/pharmacophore");
var rotate_arrow_1 = require("../../mol-repr/shape/loci/rotate-arrow");
var StructureRepresentation3D = objects_1.PluginStateTransform.BuiltIn({
    ...
    params: function (a, ctx) {
        ...
        if (!a) {
            ...
            return {
                type: param_definition_1.ParamDefinition.Mapped(registry.default.name, registry.types, function (name) {
                    return param_definition_1.ParamDefinition.Group(registry.get(name).getParams(themeCtx, structure_1.Structure.Empty));
                }),
                colorTheme: param_definition_1.ParamDefinition.Mapped(type.defaultColorTheme.name, themeCtx.colorThemeRegistry.types, function (name) {
                    return param_definition_1.ParamDefinition.Group(themeCtx.colorThemeRegistry
                        .get(name)
                        .getParams({ structure: structure_1.Structure.Empty }));
                }, colorThemeInfo_1),
                sizeTheme: param_definition_1.ParamDefinition.Mapped(type.defaultSizeTheme.name, themeCtx.sizeThemeRegistry.types, function (name) {
                    return param_definition_1.ParamDefinition.Group(themeCtx.sizeThemeRegistry
                        .get(name)
                        .getParams({ structure: structure_1.Structure.Empty }));
                })
            };
        ...
        return {
            ...
            colorTheme: param_definition_1.ParamDefinition.Mapped(type.defaultColorTheme.name, themeCtx.colorThemeRegistry.getApplicableTypes(dataCtx), function (name) {
                return param_definition_1.ParamDefinition.Group(themeCtx.colorThemeRegistry.get(name).getParams(dataCtx));
            }, colorThemeInfo),
            sizeTheme: param_definition_1.ParamDefinition.Mapped(type.defaultSizeTheme.name, themeCtx.sizeThemeRegistry.getApplicableTypes(dataCtx), function (name) {
                return param_definition_1.ParamDefinition.Group(themeCtx.sizeThemeRegistry.get(name).getParams(dataCtx));
            })
        };
    }
})({
    ...
    interpolate: function (src, tar, t) {
        if (src.colorTheme.name !== 'uniform' ||
            tar.colorTheme.name !== 'uniform') {
...
var UnwindStructureAssemblyRepresentation3D = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a) {
        ...
        return new objects_1.PluginStateObject.Molecule.Structure.Representation3DState({
            ...
            initialState: {
                unitTransforms: new unit_transforms_1.StructureUnitTransforms(structure)
            },
            info: structure,
            repr: a.data.repr
...
var OverpaintStructureRepresentation3DFromScript = objects_1.PluginStateTransform.BuiltIn({
    ...
    update: function (_a) {
        ...
        if (newGeometryVersion !== info.geometryVersion &&
            (0, base_1.hasColorSmoothingProp)(a.data.repr.props))
            return mol_state_1.StateTransformer.UpdateResult.Unchanged;
...
var getLociByCRef = function (structure, elementIds, cRef) {
    var units = [];
    ...
    var loci = structure_1.StructureElement.Loci(structure, units);
    return loci;
};
var OverpaintStructureRepresentation3DFromCref = objects_1.PluginStateTransform.BuiltIn({
    name: 'overpaint-structure-representation-3d-from-cRef',
    display: 'Overpaint 3D Representation',
    from: objects_1.PluginStateObject.Molecule.Structure.Representation3D,
    to: objects_1.PluginStateObject.Molecule.Structure.Representation3DState,
    params: function () { return ({
        layers: param_definition_1.ParamDefinition.ObjectList({
            cRef: param_definition_1.ParamDefinition.Value(''),
            elementIds: param_definition_1.ParamDefinition.Value([]),
            color: param_definition_1.ParamDefinition.Color(names_1.ColorNames.blueviolet),
            clear: param_definition_1.ParamDefinition.Boolean(false)
        }, function (e) { return "".concat(e.clear ? 'Clear' : color_1.Color.toRgbString(e.color)); }, {
            defaultValue: [
    ...
    apply: function (_a) {
        ...
        var geometryVersion = a.data.repr.geometryVersion;
        var layers = [];
        for (var i = 0, il = params.layers.length; i < il; ++i) {
            var _b = params.layers[i], cRef = _b.cRef, elementIds = _b.elementIds, color = _b.color, clear = _b.clear;
            var loci = getLociByCRef(structure, elementIds, cRef);
            layers.push({ loci: loci, color: color, clear: clear });
        }
        var overpaint = { layers: layers };
        return new objects_1.PluginStateObject.Molecule.Structure.Representation3DState({
            state: { overpaint: overpaint },
            initialState: { overpaint: overpaint_1.Overpaint.Empty },
            info: { structure: structure, geometryVersion: geometryVersion },
    ...
    update: function (_a) {
        ...
        var oldOverpaint = b.data.state.overpaint;
        var layers = [];
        for (var i = 0, il = newParams.layers.length; i < il; ++i) {
            var _b = newParams.layers[i], cRef = _b.cRef, elementIds = _b.elementIds, color = _b.color, clear = _b.clear;
            var loci = getLociByCRef(newStructure, elementIds, cRef);
            layers.push({ loci: loci, color: color, clear: clear });
        }
        var newOverpaint = { layers: layers };
        if (overpaint_1.Overpaint.areEqual(oldOverpaint, newOverpaint))
            return mol_state_1.StateTransformer.UpdateResult.Unchanged;
        info.geometryVersion = newGeometryVersion;
        b.data.state.overpaint = newOverpaint;
...
exports.OverpaintStructureRepresentation3DFromCref = OverpaintStructureRepresentation3DFromCref;
...
(function (VolumeRepresentation3DHelpers) {
    function getDefaultParams(ctx, name, volume, volumeParams) {
        ...
        var colorParams = ctx.representation.volume.themes.colorThemeRegistry
            .get(type.defaultColorTheme.name)
            .getParams(themeDataCtx);
        var sizeParams = ctx.representation.volume.themes.sizeThemeRegistry
            .get(type.defaultSizeTheme.name)
            .getParams(themeDataCtx);
        ...
        return {
            type: {
                name: name,
                params: volumeParams
                    ? (0, tslib_1.__assign)((0, tslib_1.__assign)({}, volumeDefaultParams), volumeParams) : volumeDefaultParams
            },
            colorTheme: {
                name: type.defaultColorTheme.name,
                params: param_definition_1.ParamDefinition.getDefaultValues(colorParams)
            },
            sizeTheme: {
                name: type.defaultSizeTheme.name,
                params: param_definition_1.ParamDefinition.getDefaultValues(sizeParams)
            }
        };
    }
    ...
    function getDefaultParamsStatic(ctx, name, volumeParams, colorName, colorParams, sizeName, sizeParams) {
        ...
        return {
            type: {
                name: name,
                params: volumeParams
                    ? (0, tslib_1.__assign)((0, tslib_1.__assign)({}, type.defaultValues), volumeParams) : type.defaultValues
            },
            colorTheme: {
                name: type.defaultColorTheme.name,
                params: colorParams
                    ? (0, tslib_1.__assign)((0, tslib_1.__assign)({}, colorType.defaultValues), colorParams) : colorType.defaultValues
            },
            sizeTheme: {
                name: type.defaultSizeTheme.name,
                params: sizeParams
                    ? (0, tslib_1.__assign)((0, tslib_1.__assign)({}, sizeType.defaultValues), sizeParams) : sizeType.defaultValues
            }
        };
    }
...
var VolumeRepresentation3D = objects_1.PluginStateTransform.BuiltIn({
    ...
    params: function (a, ctx) {
        ...
        if (!a) {
            return {
                type: param_definition_1.ParamDefinition.Mapped(registry.default.name, registry.types, function (name) {
                    return param_definition_1.ParamDefinition.Group(registry.get(name).getParams(themeCtx, volume_1.Volume.One));
                }),
                colorTheme: param_definition_1.ParamDefinition.Mapped(type.defaultColorTheme.name, themeCtx.colorThemeRegistry.types, function (name) {
                    return param_definition_1.ParamDefinition.Group(themeCtx.colorThemeRegistry
                        .get(name)
                        .getParams({ volume: volume_1.Volume.One }));
                }),
                sizeTheme: param_definition_1.ParamDefinition.Mapped(type.defaultSizeTheme.name, themeCtx.sizeThemeRegistry.types, function (name) {
                    return param_definition_1.ParamDefinition.Group(themeCtx.sizeThemeRegistry
                        .get(name)
        ...
        return {
            type: param_definition_1.ParamDefinition.Mapped(registry.default.name, registry.types, function (name) {
                return param_definition_1.ParamDefinition.Group(registry.get(name).getParams(themeCtx, a.data));
            }),
            colorTheme: param_definition_1.ParamDefinition.Mapped(type.defaultColorTheme.name, themeCtx.colorThemeRegistry.getApplicableTypes(dataCtx), function (name) {
                return param_definition_1.ParamDefinition.Group(themeCtx.colorThemeRegistry.get(name).getParams(dataCtx));
            }),
        ...
        return mol_task_1.Task.create('Volume Representation', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.sent();
                        return [2 /*return*/, new objects_1.PluginStateObject.Volume.Representation3D({ repr: repr, sourceData: a.data }, {
...
var StructureGridPocket3D = objects_1.PluginStateTransform.BuiltIn({
    name: 'model-grid-pocket-3d',
    display: 'Model Grid Pocket',
    from: objects_1.PluginStateObject.Molecule.Structure.Selections,
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: function () { return ((0, tslib_1.__assign)({}, grid_pocket_1.GridPocketParams)); }
})({
    ...
    apply: function (_a, plugin) {
        ...
        return mol_task_1.Task.create('Grid Pocket', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var x, y, z, center, data, repr;
            var _a;
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        x = params.x, y = params.y, z = params.z, center = params.center;
                        data = (0, grid_pocket_1.getGridPocketData)(x, y, z, center);
                        repr = (0, grid_pocket_1.GridPocketRepresentation)((0, tslib_1.__assign)({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl }, plugin.representation.structure.themes), function () { return grid_pocket_1.GridPocketParams; });
                        return [4 /*yield*/, repr.createOrUpdate(params, data).runInContext(ctx)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/, new objects_1.PluginStateObject.Shape.Representation3D({ repr: repr, sourceData: data }, { label: "Grid Pocket", description: "Grid Pocket" })];
                }
            });
        }); });
    },
    update: function (_a) {
        ...
        var a = _a.a, b = _a.b, newParams = _a.newParams;
        return mol_task_1.Task.create('Grid Pocket', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var props, x, y, z, center, data;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        props = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, b.data.repr.props), newParams);
                        x = newParams.x, y = newParams.y, z = newParams.z, center = newParams.center;
                        data = (0, grid_pocket_1.getGridPocketData)(x, y, z, center);
                        return [4 /*yield*/, b.data.repr.createOrUpdate(props, data).runInContext(ctx)];
                    case 1:
                        _a.sent();
...
exports.StructureGridPocket3D = StructureGridPocket3D;
var StructureBoundingBox3D = objects_1.PluginStateTransform.BuiltIn({
    name: 'structure-bounding-box-3d',
    display: 'Bounding Box',
    from: objects_1.PluginStateObject.Molecule.Structure,
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: (0, tslib_1.__assign)({ radius: param_definition_1.ParamDefinition.Numeric(0.05, { min: 0.01, max: 4, step: 0.01 }, { isEssential: true }), color: param_definition_1.ParamDefinition.Color(names_1.ColorNames.red, { isEssential: true }) }, mesh_1.Mesh.Params)
})({
    canAutoUpdate: function () {
        return true;
    },
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Bounding Box', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var repr;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    update: function (_a, plugin) {
        ...
        return mol_task_1.Task.create('Bounding Box', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, b.data.repr
                            .createOrUpdate(newParams, {
                            box: a.data.boundary.box,
...
var StructureSelectionsDistance3D = objects_1.PluginStateTransform.BuiltIn({
    ...
    from: objects_1.PluginStateObject.Molecule.Structure.Selections,
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: function () { return ((0, tslib_1.__assign)({}, distance_1.DistanceParams)); }
})({
    canAutoUpdate: function (_a) {
        var oldParams = _a.oldParams, newParams = _a.newParams;
        return true;
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Structure Distance', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var data, repr;
            var _a;
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        repr = (0, distance_1.DistanceRepresentation)((0, tslib_1.__assign)({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl }, plugin.representation.structure.themes), function () { return distance_1.DistanceParams; });
                        return [4 /*yield*/, repr.createOrUpdate(params, data).runInContext(ctx)];
                    case 1:
                        _b.sent();
...
var StructureSelectionsInteractionLine3D = objects_1.PluginStateTransform.BuiltIn({
    name: 'structure-selections-interaction-line-3d',
    display: '3D Interaction Line',
    from: objects_1.PluginStateObject.Molecule.Structure.Selections,
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: function () { return ((0, tslib_1.__assign)({}, interaction_line_1.InteractionLineParams)); }
})({
    canAutoUpdate: function (_a) {
        var oldParams = _a.oldParams, newParams = _a.newParams;
        return true;
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Structure Interaction Line', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var data, repr;
            var _a;
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        data = (0, helpers_2.getDistanceDataFromStructureSelections)(a.data);
                        repr = (0, interaction_line_1.InteractionLineRepresentation)((0, tslib_1.__assign)({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl }, plugin.representation.structure.themes), function () { return interaction_line_1.InteractionLineParams; });
                        return [4 /*yield*/, repr.createOrUpdate(params, data).runInContext(ctx)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/, new objects_1.PluginStateObject.Shape.Representation3D({ repr: repr, sourceData: data }, { label: "Interaction Line" })];
                }
            });
        }); });
    },
...
exports.StructureSelectionsInteractionLine3D = StructureSelectionsInteractionLine3D;
var StructureSelectionsAngle3D = objects_1.PluginStateTransform.BuiltIn({
    name: 'structure-selections-angle-3d',
    display: '3D Angle',
    from: objects_1.PluginStateObject.Molecule.Structure.Selections,
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: function () { return ((0, tslib_1.__assign)({}, angle_1.AngleParams)); }
})({
    canAutoUpdate: function (_a) {
        var oldParams = _a.oldParams, newParams = _a.newParams;
        return true;
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Structure Angle', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var data, repr;
            var _a;
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        repr = (0, angle_1.AngleRepresentation)((0, tslib_1.__assign)({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl }, plugin.representation.structure.themes), function () { return angle_1.AngleParams; });
                        return [4 /*yield*/, repr.createOrUpdate(params, data).runInContext(ctx)];
                    case 1:
                        _b.sent();
...
var StructureSelectionsDihedral3D = objects_1.PluginStateTransform.BuiltIn({
    ...
    from: objects_1.PluginStateObject.Molecule.Structure.Selections,
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: function () { return ((0, tslib_1.__assign)({}, dihedral_1.DihedralParams)); }
})({
    canAutoUpdate: function (_a) {
        var oldParams = _a.oldParams, newParams = _a.newParams;
        return true;
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Structure Dihedral', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var data, repr;
            var _a;
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        repr = (0, dihedral_1.DihedralRepresentation)((0, tslib_1.__assign)({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl }, plugin.representation.structure.themes), function () { return dihedral_1.DihedralParams; });
                        return [4 /*yield*/, repr.createOrUpdate(params, data).runInContext(ctx)];
                    case 1:
                        _b.sent();
...
var StructureSelectionsLabel3D = objects_1.PluginStateTransform.BuiltIn({
    ...
    from: objects_1.PluginStateObject.Molecule.Structure.Selections,
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: function () { return ((0, tslib_1.__assign)({}, label_1.LabelParams)); }
})({
    canAutoUpdate: function (_a) {
        var oldParams = _a.oldParams, newParams = _a.newParams;
        return true;
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Structure Label', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var data, repr;
            var _a;
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        repr = (0, label_1.LabelRepresentation)((0, tslib_1.__assign)({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl }, plugin.representation.structure.themes), function () { return label_1.LabelParams; });
                        return [4 /*yield*/, repr.createOrUpdate(params, data).runInContext(ctx)];
                    case 1:
                        _b.sent();
...
var StructureSelectionsOrientation3D = objects_1.PluginStateTransform.BuiltIn({
    ...
    from: objects_1.PluginStateObject.Molecule.Structure.Selections,
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: function () { return ((0, tslib_1.__assign)({}, orientation_1.OrientationParams)); }
})({
    canAutoUpdate: function (_a) {
        var oldParams = _a.oldParams, newParams = _a.newParams;
        return true;
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Structure Orientation', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var data, repr;
            var _a;
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        repr = (0, orientation_1.OrientationRepresentation)((0, tslib_1.__assign)({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl }, plugin.representation.structure.themes), function () { return orientation_1.OrientationParams; });
                        return [4 /*yield*/, repr.createOrUpdate(params, data).runInContext(ctx)];
                    case 1:
                        _b.sent();
...
var StructureSelectionsPlane3D = objects_1.PluginStateTransform.BuiltIn({
    ...
    from: objects_1.PluginStateObject.Molecule.Structure.Selections,
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: function () { return ((0, tslib_1.__assign)({}, plane_1.PlaneParams)); }
})({
    canAutoUpdate: function (_a) {
        var oldParams = _a.oldParams, newParams = _a.newParams;
        return true;
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Structure Plane', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var data, repr;
            var _a;
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        repr = (0, plane_1.PlaneRepresentation)((0, tslib_1.__assign)({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl }, plugin.representation.structure.themes), function () { return plane_1.PlaneParams; });
                        return [4 /*yield*/, repr.createOrUpdate(params, data).runInContext(ctx)];
                    case 1:
                        _b.sent();
...
var Pharmacophore3D = objects_1.PluginStateTransform.BuiltIn({
    name: 'pharmacophore-3d',
    display: 'pharmacophore',
    from: objects_1.PluginStateObject.Molecule.Structure.Selections,
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: function () { return ((0, tslib_1.__assign)({}, pharmacophore_1.PharmacophoreParams)); }
})({
    canAutoUpdate: function (_a) {
        var oldParams = _a.oldParams, newParams = _a.newParams;
        return false;
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var params = _a.params;
        return mol_task_1.Task.create('Pharmacophore 3D', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var repr;
            var _a;
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        repr = (0, pharmacophore_1.PharmacophoreRepresentation)((0, tslib_1.__assign)({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl }, plugin.representation.structure.themes), function () { return pharmacophore_1.PharmacophoreParams; });
                        return [4 /*yield*/, repr.createOrUpdate(params, params).runInContext(ctx)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/, new objects_1.PluginStateObject.Shape.Representation3D({ repr: repr, sourceData: params }, { label: "Pharmacophore 3D" })];
                }
            });
        }); });
    },
        ...
        return mol_task_1.Task.create('Pharmacophore 3D', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        props = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, b.data.repr.props), newParams);
                        return [4 /*yield*/, b.data.repr.createOrUpdate(props, newParams).runInContext(ctx)];
                    case 1:
                        _a.sent();
...
exports.Pharmacophore3D = Pharmacophore3D;
var RotateArrow3D = objects_1.PluginStateTransform.BuiltIn({
    name: 'rotate-arrow-3d',
    display: 'rotate-arrow',
    from: objects_1.PluginStateObject.Molecule.Structure.Selections,
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: function () { return ((0, tslib_1.__assign)({}, rotate_arrow_1.RotateArrowParams)); }
})({
    canAutoUpdate: function (_a) {
        var oldParams = _a.oldParams, newParams = _a.newParams;
        return false;
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var params = _a.params;
        return mol_task_1.Task.create('Rotate Arrow', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var repr;
            var _a;
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        repr = (0, rotate_arrow_1.RotateArrowRepresentation)((0, tslib_1.__assign)({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl }, plugin.representation.structure.themes), function () { return rotate_arrow_1.RotateArrowParams; });
                        return [4 /*yield*/, repr.createOrUpdate(params, params).runInContext(ctx)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/, new objects_1.PluginStateObject.Shape.Representation3D({ repr: repr, sourceData: params }, { label: "Rotate Arrow" })];
                }
            });
        }); });
    },
...
exports.RotateArrow3D = RotateArrow3D;
