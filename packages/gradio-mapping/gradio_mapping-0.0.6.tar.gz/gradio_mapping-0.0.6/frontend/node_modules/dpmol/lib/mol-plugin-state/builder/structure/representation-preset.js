...
(function (StructureRepresentationPresetProvider) {
    StructureRepresentationPresetProvider.CommonParams = {
        ...
        theme: param_definition_1.ParamDefinition.Optional(param_definition_1.ParamDefinition.Group({
            ...
            carbonColor: param_definition_1.ParamDefinition.Optional(param_definition_1.ParamDefinition.Select('chain-id', param_definition_1.ParamDefinition.arrayToOptions([
                'chain-id',
                'operator-name',
                'element-symbol'
            ]))),
    ...
    function reprBuilder(plugin, params, structure) {
        ...
        var color = ((_a = params.theme) === null || _a === void 0 ? void 0 : _a.globalName)
            ? (_b = params.theme) === null || _b === void 0 ? void 0 : _b.globalName
            : void 0;
        ...
        var symmetryColor = structure && ((_e = params.theme) === null || _e === void 0 ? void 0 : _e.symmetryColor)
            ? isSymmetry(structure)
                ? (_f = params.theme) === null || _f === void 0 ? void 0 : _f.symmetryColor
                : color
            : color;
        return {
            update: update,
...
var auto = StructureRepresentationPresetProvider({
    ...
    apply: function (ref, params, plugin) {
        ...
        if (!structure)
            return {};
        var thresholds = plugin.config.get(config_1.PluginConfig.Structure.SizeThresholds) ||
            structure_1.Structure.DefaultSizeThresholds;
            ...
            return (0, tslib_1.__generator)(this, function (_o) {
                switch (_o.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, presetStaticComponent(plugin, structureCell, 'branched', {
                                label: 'Carbohydrate'
                            })];
                    case 4:
                        _m.branched = _o.sent();
                    ...
                    case 8:
                        ...
                        waterType = (((_c = (_b = (_a = components.water) === null || _a === void 0 ? void 0 : _a.obj) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.elementCount) || 0) > 50000
                            ? 'line'
                            : 'ball-and-stick';
                        lipidType = (((_f = (_e = (_d = components.lipid) === null || _d === void 0 ? void 0 : _d.obj) === null || _e === void 0 ? void 0 : _e.data) === null || _f === void 0 ? void 0 : _f.elementCount) || 0) > 20000
                            ? 'line'
                            : 'ball-and-stick';
                        ...
                        representations = {
                            polymer: builder.buildRepresentation(update, components.polymer, {
                                type: 'cartoon',
                                typeParams: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, typeParams), cartoonProps),
                                color: symmetryColor
                            }, { tag: 'polymer' }),
                            ...
                            branchedBallAndStick: builder.buildRepresentation(update, components.branched, {
                                type: 'ball-and-stick',
                                typeParams: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, typeParams), { alpha: 0.3 }),
                                color: color,
                                colorParams: ballAndStickColor
                            ...
                            water: builder.buildRepresentation(update, components.water, {
                                type: waterType,
                                typeParams: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, typeParams), { alpha: 0.6, visuals: waterType === 'line' ? ['intra-bond', 'element-point'] : undefined }),
                                color: color,
                            ...
                            lipid: builder.buildRepresentation(update, components.lipid, {
                                type: lipidType,
                                typeParams: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, typeParams), { alpha: 0.6, visuals: lipidType === 'line' ? ['intra-bond'] : undefined }),
                                color: color,
                                colorParams: { carbonColor: { name: 'element-symbol', params: {} } }
                            }, { tag: 'lipid' }),
                    ...
                    case 2:
                        ...
                        representations = {
                            ...
                            nucleic: builder.buildRepresentation(update, components.nucleic, {
                                ...
                                typeParams: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, typeParams), gaussianProps),
                                color: symmetryColor
                            }, { tag: 'nucleic' })
                        };
...
var atomicDetail = StructureRepresentationPresetProvider({
    ...
    apply: function (ref, params, plugin) {
        var _a, _b, _c, _d, _e, _f;
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            var structureCell, components, structure, highElementCount, lowResidueElementRatio, m, bondsGiven, atomicType, showCarbohydrateSymbol, _g, _h, _j, _k, update, builder, typeParams, color, ballAndStickColor, colorParams, representations;
            var _l, _m;
            return (0, tslib_1.__generator)(this, function (_o) {
                switch (_o.label) {
                    case 0:
                    ...
                    case 1:
                        components = (_l.all = _o.sent(),
                            ...
                            _l);
                        structure = structureCell.obj.data;
                        highElementCount = structure.elementCount > 100000 // TODO make configurable
                        ;
                        ...
                        showCarbohydrateSymbol = params.showCarbohydrateSymbol &&
                            !highElementCount &&
                    ...
                    case 2:
                        ...
                        _o.label = 3;
                    case 3:
                        _k = reprBuilder(plugin, params, structure), update = _k.update, builder = _k.builder, typeParams = _k.typeParams, color = _k.color, ballAndStickColor = _k.ballAndStickColor;
                        ...
                        if (showCarbohydrateSymbol) {
                            Object.assign(representations, {
                                snfg3d: builder.buildRepresentation(update, components.branched, {
                                    type: 'carbohydrate',
                                    typeParams: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, typeParams), { alpha: 0.4, visuals: ['carbohydrate-symbol'] }),
                                    color: color
                                }, { tag: 'snfg-3d' })
                            });
                        }
                    ...
                    case 1:
                        ...
                        representations = {
                            all: builder.buildRepresentation(update, components.all, {
                                type: 'spacefill',
                                typeParams: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, typeParams), { ignoreLight: true }),
                                color: 'illustrative'
                            }, { tag: 'all' })
                        };
                        return [4 /*yield*/, update.commit({ revertOnError: true })];
