...
export declare type SecondaryStructureParams = typeof SecondaryStructureParams;
export declare type SecondaryStructureProps = PD.Values<SecondaryStructureParams>;
/** Maps `unit.id` to `SecondaryStructure` */
export declare type SecondaryStructureValue = Map<number, SecondaryStructure>;
