...
export declare const InteractionsParams: {
    ...
    type: PD.Select<import("../../light-plugin/representation").INTERACTION_TYPE>;
    featuresList: PD.Value<import("./interactions/features").Features[]>;
...
export declare type InteractionsValue = Interactions;
