...
exports.EntitySourceColorThemeParams = (0, tslib_1.__assign)({}, (0, palette_1.getPaletteParams)({ type: 'colors', colorList: DefaultList }));
function getEntitySourceColorThemeParams(ctx) {
    ...
    if (ctx.structure) {
        if (getMaps(ctx.structure.root.models).srcKeySerialMap.size >
...
function addSrc(seqToSrcByModelEntity, srcKeySerialMap, modelIndex, model, entity_src, scientific_name, plasmid_name, gene_src_gene) {
    ...
    for (var j = 0, jl = entity_src._rowCount; j < jl; ++j) {
        ...
        var beg = pdbx_beg_seq_num.valueKind(j) === 0 /* Present */
            ? pdbx_beg_seq_num.value(j)
            : 1;
        var end = pdbx_end_seq_num.valueKind(j) === 0 /* Present */
