...
var CentroidHelper = /** @class */ (function () {
    ...
    CentroidHelper.prototype.includeStep = function (p) {
        vec3_1.Vec3.add(this.center, this.center, p);
        this.count++;
    };
    ...
    CentroidHelper.prototype.radiusStep = function (p) {
        var d = vec3_1.Vec3.squaredDistance(p, this.center);
        if (d > this.radiusSq)
            this.radiusSq = d;
    };
    CentroidHelper.prototype.radiusSphereStep = function (center, radius) {
        var _d = vec3_1.Vec3.distance(center, this.center) + radius;
        var d = _d * _d;
        if (d > this.radiusSq)
            this.radiusSq = d;
    };
...
exports.CentroidHelper = CentroidHelper;
//# sourceMappingURL=centroid-helper.js.map