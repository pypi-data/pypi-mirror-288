...
exports.PolymerIndexColorThemeParams = (0, tslib_1.__assign)({}, (0, palette_1.getPaletteParams)({ type: 'colors', colorList: DefaultList }));
function getPolymerIndexColorThemeParams(ctx) {
    ...
    if (ctx.structure) {
        if (getPolymerChainCount(ctx.structure.root) >
