...
export declare const BallAndStickParams: {
    ...
    visuals: PD.MultiSelect<"element-sphere" | "intra-bond" | "inter-bond" | "charge-text">;
...
export declare type BallAndStickRepresentation = StructureRepresentation<BallAndStickParams>;
