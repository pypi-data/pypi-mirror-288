...
exports.SecondaryStructureProvider = custom_structure_property_1.CustomStructureProperty.createProvider({
    ...
    obtain: function (ctx, data, props) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_d) {
            switch (_d.label) {
                case 0:
                    p = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, param_definition_1.ParamDefinition.getDefaultValues(exports.SecondaryStructureParams)), props);
                    _a = p.type.name;
                    switch (_a) {
...
function computeModel(structure) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        var map, i, il, u, secondaryStructure, secondaryStructure;
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0:
                    map = new Map();
                ...
                case 1:
                    ...
                    u = structure.unitSymmetryGroups[i].units[0];
                    if (!structure_1.Unit.isAtomic(u)) return [3 /*break*/, 4];
                    if (!!(model_1.Model.isFromPdbArchive(u.model) || model_1.Model.hasSecondaryStructure(u.model))) return [3 /*break*/, 3];
                    return [4 /*yield*/, (0, dssp_1.computeUnitDSSP)(u, {
                            oldDefinition: true,
                            oldOrdering: true,
                        })];
                case 2:
