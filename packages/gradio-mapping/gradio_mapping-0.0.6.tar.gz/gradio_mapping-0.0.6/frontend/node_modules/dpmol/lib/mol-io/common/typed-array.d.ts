...
export declare type TypedArrayValueType = 'float32' | 'int8' | 'int16' | 'uint16';
...
export declare type TypedArrayValueArray = Float32Array | Int8Array | Int16Array | Uint16Array;
