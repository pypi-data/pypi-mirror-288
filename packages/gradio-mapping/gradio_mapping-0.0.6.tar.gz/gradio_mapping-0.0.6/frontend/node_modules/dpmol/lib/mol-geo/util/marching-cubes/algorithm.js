...
function getInputParams(params) {
    return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, params), { bottomLeft: (0, mol_util_1.defaults)(params.bottomLeft, [0, 0, 0]), topRight: (0, mol_util_1.defaults)(params.topRight, params.scalarField.space.dimensions) });
}
...
function computeMarchingCubesMesh(params, mesh) {
    var _this = this;
    return mol_task_1.Task.create('Marching Cubes Mesh', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
...
function computeMarchingCubesLines(params, lines) {
    var _this = this;
    return mol_task_1.Task.create('Marching Cubes Lines', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
        var inputParams, _a, dX, dY, dZ, vertexChunkSize, builder;
        return (0, tslib_1.__generator)(this, function (_b) {
            switch (_b.label) {
                case 0:
