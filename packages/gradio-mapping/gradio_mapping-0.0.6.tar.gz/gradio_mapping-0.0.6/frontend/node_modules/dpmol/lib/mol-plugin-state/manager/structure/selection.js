...
var StructureSelectionManager = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(StructureSelectionManager, _super);
    ...
    StructureSelectionManager.prototype.add = function (loci, repr) {
        if (!structure_1.StructureElement.Loci.is(loci))
            return false;
        if ((repr === null || repr === void 0 ? void 0 : repr.label) === 'Molecular Surface') {
            this.events.loci.add.next({ loci: loci, repr: repr });
            return false;
        }
        ...
        this.events.loci.add.next({ loci: loci });
        return !structure_1.StructureElement.Loci.areEqual(sel, entry.selection);
    };
    StructureSelectionManager.prototype.remove = function (loci, repr) {
        if (!structure_1.StructureElement.Loci.is(loci))
            return false;
        if ((repr === null || repr === void 0 ? void 0 : repr.label) === 'Molecular Surface') {
            this.events.loci.remove.next({ loci: loci, repr: repr });
            return false;
        }
        var entry = this.getEntry(loci.structure);
        if (!entry)
        ...
        this.referenceLoci = loci;
        this.events.loci.remove.next({ loci: loci });
        return !structure_1.StructureElement.Loci.areEqual(sel, entry.selection);
    };
    ...
    StructureSelectionManager.prototype.modify = function (modifier, loci, repr) {
        var changed = false;
        switch (modifier) {
            case 'add':
                changed = this.add(loci, repr);
                break;
            case 'remove':
                changed = this.remove(loci, repr);
                break;
            case 'intersect':
    ...
    StructureSelectionManager.prototype.fromSelectionQuery = function (modifier, query, applyGranularity) {
        var _this = this;
        if (applyGranularity === void 0) { applyGranularity = true; }
        this.plugin.runTask(mol_task_1.Task.create('Structure Selection', function (runtime) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var _i, _a, s, loci;
