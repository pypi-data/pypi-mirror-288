...
var atom = {
    ...
    cdr: p(function (l) { return !unit_1.Unit.isAtomic(l.unit) ? notAtomic() : l.unit.model.atomicHierarchy.atoms.cdr.value(l.element); }),
    em_confidence: p(function (l) { return !unit_1.Unit.isAtomic(l.unit) ? notAtomic() : l.unit.model.atomicHierarchy.atoms.em_confidence.value(l.element); }),
};
function compId(l) {
