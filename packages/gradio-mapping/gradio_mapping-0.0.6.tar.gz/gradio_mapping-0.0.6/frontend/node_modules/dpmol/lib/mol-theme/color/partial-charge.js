...
function PartialChargeColorTheme(ctx, props) {
    ...
    function color(location) {
        if (structure_1.StructureElement.Location.is(location)) {
            ...
            return q !== undefined && !Number.isNaN(q) ? scale.color(q) : DefaultPartialChargeColor;
        }
...
exports.PartialChargeColorThemeProvider = {
    ...
    isApplicable: function (ctx) {
        return !!ctx.structure &&
            ctx.structure.models.some(function (m) { return partial_charge_1.AtomPartialCharge.Provider.get(m) !== undefined; });
    }
};
