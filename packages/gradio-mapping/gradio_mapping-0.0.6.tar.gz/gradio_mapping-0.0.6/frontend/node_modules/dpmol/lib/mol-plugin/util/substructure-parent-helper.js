...
var SubstructureParentHelper = /** @class */ (function () {
    ...
    SubstructureParentHelper.prototype.addMapping = function (state, ref, obj) {
        ...
        if (this.root.has(obj.data)) {
            ...
            var parent_1 = state.select(mol_state_1.StateSelection.Generators.byRef(ref).rootOfType([
                objects_1.PluginStateObject.Molecule.Structure
            ]))[0];
            if (!parent_1) {
...
//# sourceMappingURL=substructure-parent-helper.js.map