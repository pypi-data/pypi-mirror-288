...
var InteractivityManager = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(InteractivityManager, _super);
    function InteractivityManager(plugin, props) {
        if (props === void 0) { props = {}; }
        var _this = _super.call(this, {
            props: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, param_definition_1.ParamDefinition.getDefaultValues(InteractivityManager.Params)), props)
        }) || this;
        _this.plugin = plugin;
    ...
    Object.defineProperty(InteractivityManager.prototype, "props", {
        get: function () {
            return (0, tslib_1.__assign)({}, this.state.props);
        },
        enumerable: false,
        configurable: true
    });
    InteractivityManager.prototype.setProps = function (props) {
        var old = this.props;
        var _new = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, this.state.props), props);
...
(function (InteractivityManager) {
    InteractivityManager.Params = {
        granularity: param_definition_1.ParamDefinition.Select('residue', loci_1.Loci.GranularityOptions, {
            label: 'Picking Level',
    ...
    var LociMarkManager = /** @class */ (function () {
        ...
        LociMarkManager.prototype.normalizedLoci = function (reprLoci, applyGranularity, alwaysConvertBonds) {
            ...
            return {
                loci: loci_1.Loci.normalize(loci, granularity, alwaysConvertBonds),
                repr: repr
            };
        };
    ...
    var LociHighlightManager = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(LociHighlightManager, _super);
        ...
        LociHighlightManager.prototype.markShape = function (current, action) {
            this.mark(current, action);
            this.shapePrev.push(current);
        };
        LociHighlightManager.prototype.clearMarkShape = function () {
            for (var _i = 0, _a = this.shapePrev; _i < _a.length; _i++) {
                var p = _a[_i];
                this.mark(p, marker_action_1.MarkerAction.Deselect);
            }
            this.shapePrev.length = 0;
        };
    ...
    var LociSelectManager = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(LociSelectManager, _super);
        ...
        LociSelectManager.prototype.selectOnly = function (current, applyGranularity) {
            ...
            if (structure_1.StructureElement.Loci.is(normalized.loci)) {
                ...
                this.deselect({
                    loci: structure_1.Structure.toStructureElementLoci(normalized.loci.structure),
                    repr: normalized.repr
                }, false);
        ...
        LociSelectManager.prototype.mark = function (current, action) {
            ...
            if (!loci_1.Loci.isEmpty(loci)) {
                if (structure_1.StructureElement.Loci.is(loci)) {
                    ...
                    if (selLoci.kind !== 'empty-loci' && selLoci.structure !== loci.structure) {
                        selLoci = structure_1.StructureElement.Loci.remap(selLoci, loci.structure);
                    }
                    ...
                    _super.prototype.mark.call(this, { loci: selLoci, repr: current.repr }, marker_action_1.MarkerAction.Select);
                }
                else {
        ...
        LociSelectManager.prototype.toggleSel = function (current) {
            if (this.sel.has(current.loci)) {
                this.sel.modify('remove', current.loci, current.repr);
                this.mark(current, marker_action_1.MarkerAction.Deselect);
            }
            else {
                this.sel.modify('add', current.loci, current.repr);
