...
exports.LabelTextParams = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, complex_visual_1.ComplexTextParams), { background: param_definition_1.ParamDefinition.Boolean(false), backgroundMargin: param_definition_1.ParamDefinition.Numeric(0, { min: 0, max: 1, step: 0.01 }), backgroundColor: param_definition_1.ParamDefinition.Color(names_1.ColorNames.black), backgroundOpacity: param_definition_1.ParamDefinition.Numeric(0.5, { min: 0, max: 1, step: 0.01 }), borderWidth: param_definition_1.ParamDefinition.Numeric(0.25, { min: 0, max: 0.5, step: 0.01 }), level: param_definition_1.ParamDefinition.Select('element', [
        ['chain', 'Chain'],
        ['residue', 'Residue'],
        ['element', 'Element']
    ], { isEssential: true }), chainScale: param_definition_1.ParamDefinition.Numeric(10, { min: 0, max: 20, step: 0.1 }), residueScale: param_definition_1.ParamDefinition.Numeric(1, { min: 0, max: 20, step: 0.1 }), elementScale: param_definition_1.ParamDefinition.Numeric(0.5, { min: 0, max: 20, step: 0.1 }) });
        ...
        setUpdateState: function (state, newProps, currentProps) {
            state.createGeometry =
                newProps.level !== currentProps.level ||
                    (newProps.level === 'chain' &&
                        newProps.chainScale !== currentProps.chainScale) ||
...
function createElementText(ctx, structure, theme, props, text) {
    var l = structure_1.StructureElement.Location.create(structure);
    var units = structure.units, serialMapping = structure.serialMapping;
    var id = structure_1.StructureProperties.atom.id;
    var cumulativeUnitElementCount = serialMapping.cumulativeUnitElementCount;
