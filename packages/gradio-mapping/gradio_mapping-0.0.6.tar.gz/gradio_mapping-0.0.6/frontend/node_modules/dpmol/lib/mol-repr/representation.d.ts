...
export declare type RepresentationProps = {
    [k: string]: any;
};
...
export declare type RepresentationParamsGetter<D, P extends PD.Params> = (ctx: ThemeRegistryContext, data: D) => P;
export declare type RepresentationFactory<D, P extends PD.Params, S extends Representation.State> = (ctx: RepresentationContext, getParams: RepresentationParamsGetter<D, P>) => Representation<D, P, S>;
...
export declare type AnyRepresentationProvider = RepresentationProvider<any, {}, Representation.State>;
...
declare namespace Representation {
    ...
    type Any = Representation<any, any, any>;
    const Empty: Any;
    type Def<D, P extends PD.Params = {}, S extends State = State> = {
    ...
    function createMulti<D, P extends PD.Params = {}, S extends State = State>(label: string, ctx: RepresentationContext, getParams: RepresentationParamsGetter<D, P>, stateBuilder: StateBuilder<S>, reprDefs: Def<D, P>): Representation<D, P, S>;
