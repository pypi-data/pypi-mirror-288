    ...
    return (0, complex_visual_1.ComplexMeshVisual)({
        ...
        setUpdateState: function (state, newProps, currentProps) {
            state.createGeometry =
                newProps.terminalLinkSizeFactor !==
                    currentProps.terminalLinkSizeFactor ||
...
function CarbohydrateTerminalLinkIterator(structure) {
    ...
    var getLocation = function (groupIndex) {
        ...
        if (terminalLink.fromCarbohydrate) {
            ...
            location.element =
                terminalLink.elementUnit.elements[terminalLink.elementIndex];
        }
        return location;
    };
...
//# sourceMappingURL=carbohydrate-terminal-link-cylinder.js.map