...
var atom_site_fields = function () {
    return cif_1.CifWriter.fields()
        ...
        .float('occupancy', structure_1.StructureProperties.atom.occupancy, {
        digitCount: 2,
        encoder: E.fixedPoint2
    })
        .float('B_iso_or_equiv', structure_1.StructureProperties.atom.B_iso_or_equiv, {
        digitCount: 2,
        encoder: E.fixedPoint2
    })
        ...
        return {
            ...
            source: structures.map(function (s) { return ({
                data: {
                    ...
                    atom_site: mmcif_1.MmcifFormat.is(s.model.sourceData)
...
function entityIdFields(getLocation, options) {
    var prefix = options && options.prefix;
    var ret = CifField.build().str(prepostfixed(prefix, "label_entity_id"), mappedProp(getLocation, structure_1.StructureProperties.chain.label_entity_id));
    addModelNum(ret, getLocation, options);
    return ret.getFields();
}
