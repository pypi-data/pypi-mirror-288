...
(function (Visual) {
    ...
    function setOverpaint(renderObject, overpaint, lociApply, clear, smoothing) {
        ...
        mol_util_1.ValueCell.updateIfChanged(dOverpaintType, 'groupInstance');
    ...
    function setTransparency(renderObject, transparency, lociApply, clear, smoothing) {
        ...
        mol_util_1.ValueCell.updateIfChanged(dTransparencyType, 'groupInstance');
    ...
    function setSubstance(renderObject, substance, lociApply, clear, smoothing) {
        ...
        var count = uGroupCount.ref.value * instanceCount.ref.value;
        // ensure texture has right size
        (0, substance_data_1.createSubstance)(substance.layers.length ? count : 0, renderObject.values);
        ...
        mol_util_1.ValueCell.updateIfChanged(dSubstanceType, 'groupInstance');
    ...
    function setClipping(renderObject, clipping, lociApply, clear) {
        ...
        // ensure texture has right size
        (0, clipping_data_1.createClipping)(layers.length ? count : 0, renderObject.values);
