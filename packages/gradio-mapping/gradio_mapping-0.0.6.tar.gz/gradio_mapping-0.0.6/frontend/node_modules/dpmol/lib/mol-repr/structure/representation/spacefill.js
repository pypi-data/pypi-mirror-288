...
exports.SpacefillParams = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, element_sphere_1.ElementSphereParams), { bumpFrequency: param_definition_1.ParamDefinition.Numeric(1, { min: 0, max: 10, step: 0.1 }, base_1.BaseGeometry.ShadingCategory) });
function getSpacefillParams(ctx, structure) {
    var params = param_definition_1.ParamDefinition.clone(exports.SpacefillParams);
