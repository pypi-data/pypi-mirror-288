...
function getPaletteParams(props) {
    ...
    var p = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, DefaultGetPaletteProps), props);
    return {
        palette: param_definition_1.ParamDefinition.MappedStatic(p.type, {
            ...
            generate: param_definition_1.ParamDefinition.Group((0, tslib_1.__assign)((0, tslib_1.__assign)({}, distinct_1.DistinctColorsParams), { maxCount: param_definition_1.ParamDefinition.Numeric(75, { min: 1, max: 250, step: 1 }) }), { isFlat: true })
        }, {
            options: [
                ['colors', 'Color List'],
...
function getPalette(count, props, labelOptions) {
    ...
    if (props.palette.name === 'colors' && props.palette.params.list.kind === 'interpolate') {
        ...
        var _b = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, DefaultLabelOptions), labelOptions), minLabel = _b.minLabel, maxLabel = _b.maxLabel;
