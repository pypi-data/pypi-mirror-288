...
export declare type StructureSelectionModifier = 'add' | 'remove' | 'intersect' | 'set';
export declare class StructureSelectionManager extends StatefulPluginComponent<StructureSelectionManagerState> {
    ...
    readonly events: {
        ...
        loci: {
            add: import("rxjs").Subject<{
                loci: StructureElement.Loci;
                repr?: any;
            }>;
            remove: import("rxjs").Subject<{
                loci: StructureElement.Loci;
                repr?: any;
            }>;
            clear: import("rxjs").Subject<undefined>;
            addCellItems: import("rxjs").Subject<{
                cRef: string;
                elements: number[];
            }>;
        };
    ...
    private getEntry;
    private calcStats;
    add(loci: Loci, repr?: any): boolean;
    remove(loci: Loci, repr?: any): boolean;
    private intersect;
    private set;
    ...
    modify(modifier: StructureSelectionModifier, loci: Loci, repr?: any): void;
