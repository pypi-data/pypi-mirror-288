...
var PluginState = /** @class */ (function (_super) {
    ...
    function PluginState(plugin) {
        ...
        _this.plugin = plugin;
        _this.data = mol_state_1.State.create(new objects_1.PluginStateObject.Root({}), {
            runTask: _this.plugin.runTask,
            globalContext: _this.plugin,
            historyCapacity: _this.plugin.config.get(config_1.PluginConfig.State.HistoryCapacity)
        });
        _this.behaviors = mol_state_1.State.create(new behavior_1.PluginBehavior.Root({}), {
            runTask: _this.plugin.runTask,
            globalContext: _this.plugin,
    ...
    PluginState.prototype.getSnapshot = function (params) {
        ...
        return {
            ...
            camera: p.camera && ((_a = this.plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.camera)
                ? {
                    current: this.plugin.canvas3d.camera.getSnapshot(),
                    transitionStyle: p.cameraTransition.name,
                    transitionDurationInMs: ((_b = p === null || p === void 0 ? void 0 : p.cameraTransition) === null || _b === void 0 ? void 0 : _b.name) === 'animate'
    ...
    PluginState.prototype.updateBehavior = function (behavior, params) {
        ...
        if (!this.behaviors.tree.transforms.has(behavior.id)) {
            ...
            tree
                .to(behavior_1.PluginBehavior.getCategoryId(behavior))
                .apply(behavior, (0, immer_1.produce)(defaultParams, params), {
                ref: behavior.id
            });
        }
        else {
