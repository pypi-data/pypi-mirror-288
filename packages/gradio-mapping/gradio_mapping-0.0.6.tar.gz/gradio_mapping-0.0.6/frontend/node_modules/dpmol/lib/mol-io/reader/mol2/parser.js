            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    ret = {
                        ...
                        atom_type: columnCount > 5
                            ? (0, token_1.TokenColumnProvider)(atom_typeTokens)(db_1.Column.Schema.str)
                            : undefStr,
                        subst_id: columnCount > 6
                            ? (0, token_1.TokenColumnProvider)(subst_idTokens)(db_1.Column.Schema.int)
                            : undefInt,
                        subst_name: columnCount > 7
                            ? (0, token_1.TokenColumnProvider)(subst_nameTokens)(db_1.Column.Schema.str)
                            : undefStr,
                        charge: columnCount > 8
                            ? (0, token_1.TokenColumnProvider)(chargeTokens)(db_1.Column.Schema.float)
                            : undefFloat,
                        status_bit: columnCount > 9
