...
var MonadicParser = /** @class */ (function () {
    ...
    MonadicParser.prototype.atLeast = function (n) {
        return MonadicParser.seq(this.times(n), this.many()).map(function (r) { return (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], r[0], true), r[1], true); });
    };
    ;
...
(function (MonadicParser) {
    ...
    function sepBy1(parser, separator) {
        ...
        return seq(parser, pairs).map(function (r) { return (0, tslib_1.__spreadArray)([r[0]], r[1], true); });
    }
...
//# sourceMappingURL=monadic-parser.js.map