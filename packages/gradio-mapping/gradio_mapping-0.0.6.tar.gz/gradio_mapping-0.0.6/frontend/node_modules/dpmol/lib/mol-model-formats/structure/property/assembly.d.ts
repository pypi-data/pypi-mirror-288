...
declare type StructAssembly = Table<mmCIF_Schema['pdbx_struct_assembly']>;
declare type StructAssemblyGen = Table<mmCIF_Schema['pdbx_struct_assembly_gen']>;
declare type StructOperList = Table<mmCIF_Schema['pdbx_struct_oper_list']>;
