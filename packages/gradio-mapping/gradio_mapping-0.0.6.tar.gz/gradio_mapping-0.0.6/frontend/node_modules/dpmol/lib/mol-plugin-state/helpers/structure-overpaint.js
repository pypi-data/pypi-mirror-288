...
exports.getFilteredBundle = exports.clearStructureOverpaint = exports.setStructureOverpaint = void 0;
...
function setStructureOverpaint(plugin, components, color, lociGetter, types) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, eachRepr(plugin, components, function (update, repr, overpaintCell) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                        ...
                        return (0, tslib_1.__generator)(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    if (overpaintCell) {
                                        bundleLayers = (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], overpaintCell.params.values.layers, true), [layer], false);
                                        ...
                                        update
                                            ...
                                            .apply(transforms_1.StateTransforms.Representation
                                            .OverpaintStructureRepresentation3DFromBundle, overpaint_1.Overpaint.toBundle(filtered), { tags: OverpaintManagerTag });
                                    }
                                    return [2 /*return*/];
                            }
                        });
        ...
        return (0, tslib_1.__generator)(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    r = _b[_a];
                    overpaint = state.select(mol_state_1.StateSelection.Generators.ofTransformer(transforms_1.StateTransforms.Representation
                        .OverpaintStructureRepresentation3DFromBundle, r.cell.transform.ref).withTag(OverpaintManagerTag));
...
exports.getFilteredBundle = getFilteredBundle;
//# sourceMappingURL=structure-overpaint.js.map