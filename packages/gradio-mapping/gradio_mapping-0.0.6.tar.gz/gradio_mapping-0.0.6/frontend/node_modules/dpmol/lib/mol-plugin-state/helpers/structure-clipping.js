...
function setStructureClipping(plugin, components, groups, lociGetter, types) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, eachRepr(plugin, components, function (update, repr, clippingCell) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                        ...
                        return (0, tslib_1.__generator)(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    if (clippingCell) {
                                        bundleLayers = (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], clippingCell.params.values.layers, true), [layer], false);
                                        ...
                                        update
                                            ...
                                            .ClippingStructureRepresentation3DFromBundle, clipping_1.Clipping.toBundle(filtered), { tags: ClippingManagerTag });
                                    }
                                    return [2 /*return*/];
                            }
                        });
        ...
        return (0, tslib_1.__generator)(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    r = _b[_a];
                    clipping = state.select(mol_state_1.StateSelection.Generators.ofTransformer(transforms_1.StateTransforms.Representation
                        .ClippingStructureRepresentation3DFromBundle, r.cell.transform.ref).withTag(ClippingManagerTag));
...
//# sourceMappingURL=structure-clipping.js.map