...
var ViewportScreenshotHelper = /** @class */ (function (_super) {
    ...
    ViewportScreenshotHelper.prototype.createParams = function () {
        var max = Math.min(this.plugin.canvas3d
            ? this.plugin.canvas3d.webgl.maxRenderbufferSize
            : 4096, 4096);
        return {
            resolution: param_definition_1.ParamDefinition.MappedStatic('ultra-hd', {
    ...
    ViewportScreenshotHelper.prototype.createPass = function (mutlisample) {
        ...
        return c.getImagePass({
            ...
            postprocessing: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, c.props.postprocessing), { occlusion: aoProps.name === 'on'
                    ? {
                        name: 'on',
                        params: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, aoProps.params), { samples: 128, resolutionScale: 1 })
                    }
                    : aoProps }),
    ...
    ViewportScreenshotHelper.prototype.getFilename = function (extension) {
        ...
        var models = this.plugin.state.data
            .select(mol_state_1.StateSelection.Generators.rootsOfType(objects_1.PluginStateObject.Molecule.Model))
            .map(function (s) { return s.obj.data; });
    ...
    Object.defineProperty(ViewportScreenshotHelper.prototype, "isFullFrame", {
        get: function () {
            ...
            return ((0, common_1.equalEps)(crop.x, 0, 1e-5) &&
                (0, common_1.equalEps)(crop.y, 0, 1e-5) &&
                (0, common_1.equalEps)(crop.width, 1, 1e-5) &&
                (0, common_1.equalEps)(crop.height, 1, 1e-5));
        },
        enumerable: false,
        configurable: true
    });
