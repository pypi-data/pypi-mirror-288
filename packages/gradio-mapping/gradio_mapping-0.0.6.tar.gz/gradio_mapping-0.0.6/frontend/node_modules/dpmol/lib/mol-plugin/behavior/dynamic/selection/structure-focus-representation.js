...
var label_1 = require("../../../../mol-repr/structure/representation/label");
var StructureFocusRepresentationParams = function (plugin) {
    var reprParams = transforms_1.StateTransforms.Representation.StructureRepresentation3D
    ...
    return {
        ...
        labelParams: param_definition_1.ParamDefinition.Group(reprParams, {
            label: 'Label',
            customDefault: (0, structure_representation_params_1.createStructureRepresentationParams)(plugin, void 0, {
                type: label_1.LabelRepresentationProvider,
                color: interaction_type_1.InteractionTypeColorThemeProvider,
                size: size_1.SizeTheme.BuiltIn.uniform
            })
        }),
        ...
        excludeTargetFromSurroundings: param_definition_1.ParamDefinition.Boolean(true, {
...
var StructureFocusRepresentationBehavior = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(StructureFocusRepresentationBehavior, _super);
    ...
    Object.defineProperty(StructureFocusRepresentationBehavior.prototype, "surrLabel", {
        get: function () {
            return "[Focus] Surroundings (".concat(this.params.expandRadius, " \u00C5)");
        },
        enumerable: false,
        configurable: true
    });
    ...
    StructureFocusRepresentationBehavior.prototype.ensureShape = function (cell) {
        ...
        // Representations
        if (components.indexOf('target') >= 0 &&
            !refs[StructureFocusRepresentationTags.TargetRepr]) {
        ...
        if (components.indexOf('surroundings') >= 0 &&
        ...
        if (components.indexOf('interactions') >= 0 &&
            !refs[StructureFocusRepresentationTags.SurrNciRepr] &&
            cell.obj &&
            interactions_1.InteractionsRepresentationProvider.isApplicable((_a = cell.obj) === null || _a === void 0 ? void 0 : _a.data)) {
    ...
    StructureFocusRepresentationBehavior.prototype.clear = function (root) {
        ...
        var foci = state.select(mol_state_1.StateSelection.Generators.byRef(root)
            .subtree()
            .withTag(StructureFocusRepresentationTags.TargetSel));
        var surrs = state.select(mol_state_1.StateSelection.Generators.byRef(root)
            .subtree()
            .withTag(StructureFocusRepresentationTags.SurrSel));
        ...
        for (var _i = 0, foci_1 = foci; _i < foci_1.length; _i++) {
            ...
            update
                .to(f)
                .update(transforms_1.StateTransforms.Model.StructureSelectionFromBundle, function (old) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, old), { bundle: bundle })); });
        }
        ...
        for (var _a = 0, surrs_1 = surrs; _a < surrs_1.length; _a++) {
            ...
            update
                .to(s)
                .update(transforms_1.StateTransforms.Model.StructureSelectionFromExpression, function (old) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, old), { expression: expression })); });
        }
        return commands_1.PluginCommands.State.Update(this.plugin, {
            state: state,
            tree: update,
            ...
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        builder
                            .to(refs[StructureFocusRepresentationTags.TargetSel])
                            .update(transforms_1.StateTransforms.Model.StructureSelectionFromBundle, function (old) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, old), { bundle: residueBundle })); });
                        builder
                            .to(refs[StructureFocusRepresentationTags.SurrSel])
                            .update(transforms_1.StateTransforms.Model.StructureSelectionFromExpression, function (old) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, old), { expression: surroundings, label: _this.surrLabel })); });
                        // builder
                        //   .to(refs[StructureFocusRepresentationTags.SurrSel]!)
                        //   .apply(StateTransforms.Representation.StructureRepresentation3D, this.getReprParams(this.params.labelParams))
                    ...
                    case 0:
                        ...
                        for (_b = 0, _c = state.select(all.withTag(StructureFocusRepresentationTags.SurrRepr)); _b < _c.length; _b++) {
                            ...
                            if (!hasComponent)
                                ...
                                builder
                                    .to(repr)
                                    .update(this.getReprParams(this.params.surroundingsParams));
                        }
