...
export declare namespace Types {
    ...
    const Fn: <T extends Type<any>>(t?: T | undefined, alias?: string | undefined) => Type.Container<(env: any) => T["@type"]>;
    const Flags: <T extends Type<any>>(t: T, alias?: string | undefined) => Type.Container<number>;
...
export declare const SymbolList: MSymbol<Arguments<{}>, Type<any>>[];
export declare const SymbolMap: {
    [id: string]: MSymbol<Arguments<{}>, Type<any>> | undefined;
};
