...
exports.OperatorHklColorThemeParams = (0, tslib_1.__assign)({}, (0, palette_1.getPaletteParams)({ type: 'colors', colorList: DefaultList }));
function getOperatorHklColorThemeParams(ctx) {
    ...
    if (ctx.structure) {
        if (getOperatorHklSerialMap(ctx.structure.root).map.size >
...
//# sourceMappingURL=operator-hkl.js.map