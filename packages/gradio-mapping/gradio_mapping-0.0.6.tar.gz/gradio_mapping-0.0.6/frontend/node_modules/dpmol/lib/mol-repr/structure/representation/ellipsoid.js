...
exports.EllipsoidRepresentationProvider = (0, representation_2.StructureRepresentationProvider)({
    ...
    isApplicable: function (structure) {
        return structure.elementCount > 0 &&
            structure.models.some(function (m) { return anisotropic_1.AtomSiteAnisotrop.Provider.isApplicable(m); });
    },
