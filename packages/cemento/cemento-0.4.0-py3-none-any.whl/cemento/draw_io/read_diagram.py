        ...
        for row_idx, row in rels.iterrows():
            ...
            for col_idx, term in enumerate(terms):
                ...
                if f"{term_parser_titles['name_title']}:" in term:
                    ...
                    # rename the row with the cleaned name
                    rels.at[row_idx, cols[col_idx]] = entries[self.get_diagram_ref().get_term_parser_title('name_title')]
