...
print('--------------------------------')
print(__file__)
print(File('README.md').abspath, File('README.md').abspath.exists)
print(File('requirements.txt').abspath, File('requirements.txt').abspath.exists)
...
setuptools.setup(
    ...
    packages=[i.__name__],
    python_requires='>=3.8',
    install_requires=['exceptionx>=4.0,<5.0'],
    classifiers=[
