...
class GoogleChatSyncMessenger(metaclass=SingletonMeta):
    def __init__(self, service_name: str, g_chat_webhook: str, environ: str, log_enabled: Optional[list] = None,
    ...
    def send_message(self, text_message: str, message_type: int = None):
        ...
        try:
            ...
            if self.environ.lower() not in self.log_enabled:
                return
...
def setup_google_chat_messenger(service_name: str, g_chat_webhook: str, environ: str, async_mode: bool = False,
                                log_enabled: Optional[list] = None, logger: Optional[logging.Logger] = None) -> Union[
    GoogleChatSyncMessenger, GoogleChatAsyncMessenger]:
    if async_mode:
        return GoogleChatAsyncMessenger(service_name, g_chat_webhook, environ, log_enabled, logger)
    else:
        return GoogleChatSyncMessenger(service_name, g_chat_webhook, environ, log_enabled, logger)
