...
class CompoundMessageVerification:
    ...
    def __init__(self, limit=100):
        self.message_crud = GenericCRUD(default_schema_name="message")
        self.question_crud = GenericCRUD(
            default_schema_name="question", default_table_name="question_ml_table"
        )
        self.profile_ml_crud = GenericCRUD(
            default_schema_name="profile", default_table_name="profile_ml_table"
        )
        self.profile_crud = GenericCRUD(default_schema_name="profile")
        self.user_crud = GenericCRUD(default_schema_name="user")
        self.limit = limit
        self.message_template_text_block_ml_table = GenericCRUD(
