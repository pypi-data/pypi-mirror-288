...
class RTPSender:
    def __init__(self, ip_address, port, frame_size, open_log=False):
    ...
    def send_video_rtp_from_img(self, img):
        ...
        img_frame = av.VideoFrame.from_ndarray(img, format='rgb24')
        # img_frame_copy = copy.deepcopy(img_frame)
...
if __name__ == '__main__':
    ...
    rtpSender = RTPSender(ip_address, port, frame_size, open_log=True)
