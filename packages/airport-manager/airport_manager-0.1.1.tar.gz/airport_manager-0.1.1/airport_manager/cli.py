...
from airport_manager.config import ENV, BASE_URL
from airport_manager.auth.routes import authenticate  # Correct import
...
def get_token():
    ...
    try:
        ...
        console.print(
            "[red]Error: Token file not found. Please login first.[/red]")
        return None
...
def database_menu(ctx, raw):
    while True:
        ...
        handle_database_menu(choice, token, raw)
