...
class PartFabrication(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["add", b"add", "bent", b"bent", "cots", b"cots", "extents", b"extents", "flat", b"flat", "geom_id", b"geom_id", "geom_name", b"geom_name", "manual", b"manual", "mill", b"mill", "outcome", b"outcome", "roll", b"roll", "turn", b"turn"]) -> None: ...
