...
class Machine(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["work_rate", b"work_rate"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["address_id", b"address_id", "extents", b"extents", "label", b"label", "machine_id", b"machine_id", "materials", b"materials", "method_id", b"method_id", "models", b"models", "rapids", b"rapids", "setups", b"setups", "shop_id", b"shop_id", "work_rate", b"work_rate"]) -> None: ...
