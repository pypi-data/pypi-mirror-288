...
class FabricationSettings(google.protobuf.message.Message):
    ...
    @property
    def bent(self) -> global___BendSettings:
    ...
    def __init__(
        ...
        *,
        ...
        bent: global___BendSettings | None = ...,
...
@typing_extensions.final
class BendSettings(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___BendSettings = BendSettings
