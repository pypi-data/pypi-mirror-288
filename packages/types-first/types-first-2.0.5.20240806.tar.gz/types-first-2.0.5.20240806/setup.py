...
type stub package for the [`first`](https://github.com/hynek/first) package.
...
This version of `types-first` aims to provide accurate annotations
for `first==2.0.*`.
...
setup(name=name,
      ...
      package_data={'first-stubs': ['__init__.pyi', 'METADATA.toml', 'py.typed']},
      license="Apache-2.0",
      python_requires=">=3.8",
      classifiers=[
