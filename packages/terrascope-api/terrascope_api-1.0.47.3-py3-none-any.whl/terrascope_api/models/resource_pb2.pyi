...
class ResourceListRequest(_message.Message):
    __slots__ = ("type", "permission_types", "parent")
    TYPE_FIELD_NUMBER: _ClassVar[int]
    ...
    parent: Resource
    def __init__(self, type: _Optional[_Union[Resource.Type, str]] = ..., permission_types: _Optional[_Iterable[int]] = ..., parent: _Optional[_Union[Resource, _Mapping]] = ...) -> None: ...
