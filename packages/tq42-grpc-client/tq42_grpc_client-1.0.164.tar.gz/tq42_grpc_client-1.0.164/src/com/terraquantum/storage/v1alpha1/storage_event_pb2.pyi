...
class UploadUrlRequestedProto(_message.Message):
    __slots__ = ("hash_md5", "file_name", "project_id", "created_by", "request_id")
    HASH_MD5_FIELD_NUMBER: _ClassVar[int]
    ...
    created_by: str
    request_id: str
    def __init__(self, hash_md5: _Optional[str] = ..., file_name: _Optional[str] = ..., project_id: _Optional[str] = ..., created_by: _Optional[str] = ..., request_id: _Optional[str] = ...) -> None: ...
