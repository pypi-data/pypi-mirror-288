        ...
        with open(path) as fd:
            ...
            for i in range(len(image_list)):
                ...
                for j in range(len(img["Pixels"]["TiffData"])):
                    ...
                    species_code = file_path.split("\\")[-4].split("_")[2]
                    species_name = species_dict[species_code]["species_name"]
                    species_gram = species_dict[species_code]["gram"]
                    species_shape = species_dict[species_code]["shape"]
                    species_shotname = species_name[0].upper() + "." + species_name.split(" ")[-1].capitalize()
                    ...
                    files[file_path] = dict(file_name=file_name,
                                            ...
                                            species_shortname = species_shotname,
                                            species_gram = species_gram,
                                            species_shape = species_gram,
...
# file_directory = r"D:\Complete Gram Stain"
