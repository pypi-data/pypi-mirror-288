# -*- coding: utf-8 -*-
"""
Created on Wed Oct 19 14:41:34 2022
...
def get_filename_meta(file_name, folder, image_content = None, user_initial = None):
    ...
    image_content ={'MG1655LAB':'E.Coli MG1655','MG1655':'E.Coli MG1655','MG':'E.Coli MG1655',
                ...
                'L27336':'E.Coli Clinical'}
    antibiotic = {'CIP':'Ciprofloxacin','RIF':'Rifampin','KAN':'Kanamycin',
    ...
    repeat = {"220816": 2, "220907":3, "220912":4, "220913":5, "220914":6, "220920":7, "220926":8,
              "220802A": 1, "220802B": 2, "220802C": 3}
...
def read_directory(file_paths):
    ...
    for i in range(len(file_paths)):
        ...
        if data_folder=="DFP-CIP":
            
            meta["user_initial"] = "CF"
            meta["mount"] = 'Agarose Pads'
            meta["protocol"] = 'AMRv1'
            meta["treatmenttime"] = "30"
            meta["abxconcentration"] = "1XEUCAST"
            date = file_name.split("_")[0][:-1]
            file_repeat = file_name.split("_")[0][-1]
...
def upload_data(dat):
    ...
    for j in range(len(channels)):
        ...
        meta["usermeta1"] = "Direct From Plate"
        meta["usermeta2"] = None
        meta["usermeta3"] = None
...
user_metadata_path = r"\\physics\dfs\DAQ\CondensedMatterGroups\AKGroup\Piers\AKSEG\Images\CF\CF_file_metadata.txt"
user_metadata = pd.read_csv(user_metadata_path, sep=",", low_memory=False)


# image_directory = r"D:\Data_for_Piers\DFP-CIP\All_images"
# mask_directory = r"D:\Data_for_Piers\DFP-CIP\All_segmentations"
...
user_metadata = user_metadata.drop_duplicates(subset=['akseg_hash'])
