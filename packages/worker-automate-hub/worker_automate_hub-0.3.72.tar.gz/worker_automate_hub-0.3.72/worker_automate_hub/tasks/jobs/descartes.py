...
async def descartes(task):
    try:
        ...
        screenshot_path = take_sreenshot()
        window_seleciona_endereco_position = take_target_position(screenshot_path, "Selecionar Endereço")
        ...
        #Abre Menu itens
        menu_itens = find_target_position(screenshot_path, "Itens", 0, 0, attempts=15)
        ...
        for item in itens:
            ...
            button_incluir = find_target_position(screenshot_path, "Incluir", 0, 0, attempts=15)
       ...
       #Verifica mensagem de "Pré-Venda incluida com número: xxxxx"
        included_pre_venda = find_target_position(screenshot_path, "incluida", 15)
        if included_pre_venda is not None:
            ...
            button_ok = find_target_position(screenshot_path, "Ok", 15)
        ...
        message_prevenda = find_target_position(screenshot_path, "Deseja", 15)
        if message_prevenda is not None:
            button_yes = find_target_position(screenshot_path, "Yes", 15)
        ...
        button_confirma_transferencia = find_target_position(screenshot_path, "confirma", 15)
        ...
        #TODO Partir daqui
        message_confirma_transferencia = find_target_position(screenshot_path, "confirmar", 15)
        ...
        screenshot_path = take_sreenshot()
        #Clica em Faturar
        button_faturar = find_target_position(screenshot_path, "Faturar", 15)
        ...
        message_recalcular = find_target_position(screenshot_path, "recalcular", 15)
        #Se existir clica em nao
        if message_recalcular is not None:
            button_no = find_target_position(screenshot_path, "No", 15)
        ...
        warning_substituicao_trib = take_target_position(screenshot_path + "tributária", 15)
        if warning_substituicao_trib is not None:
            console.log("Vai clicar em não")
            button_no = find_target_position(screenshot_path,"Não", 15)
            pyautogui.click(button_no)
        ...
        model_selected = find_target_position(screenshot_path, "077", 15)
        if model_selected is None:
            ...
            if field_modelo_faturamento is not None:
                ...
                pyautogui.keyUp('up')
                screenshot_path = take_sreenshot()                 
                model_to_select = find_target_position(screenshot_path + "077", 15)
        ...
        field_total_nota = find_target_position(ASSETS_BASE_PATH + "field_total_nota.png", (1067, 767, 306, 98), 15)
        ...
        button_verde = find_target_position(screenshot_path + "Ok", 15)
        ...
        faturar_pre_venda = find_target_position(screenshot_path, "faturar", 15)
        ...
        screenshot_path = take_sreenshot()
        nota_fiscal_gerada = find_target_position(screenshot_path, "gerada", 15)
        ...
        #Transmitir a nota
        transmitir = find_target_position(screenshot_path + "transmitir", 15)
        ...
        transmitir_fechar = find_target_position(screenshot_path + "fechar", 15)
