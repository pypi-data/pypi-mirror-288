...
class MbTablePartition:
    def __init__(self, partition_path: str):
        ...
        if not self.is_twin:
            ...
            self.text_file_name_list = [file for file in os.listdir(text_path) if file != "_SUCCESS"]
            self.image_file_name_list = [file for file in os.listdir(image_path) if file != "_SUCCESS"]
