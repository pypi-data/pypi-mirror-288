    ...
    def iter_bytes(self, *, response_dump_file: Path | None) -> Iterator[bytes]:
        ...
        for attempt in self._retrying:
            if response_dump_file is not None:
                # TODO include relative path (after source-data) to .debug to avoid naming conflicts
                # TODO fix badly named file, e.g. source-data/.debug/mq5.attempt_3.attempt_2.attempt_1.csv.response.txt
