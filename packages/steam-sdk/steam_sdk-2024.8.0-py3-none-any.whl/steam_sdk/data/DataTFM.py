...
class BS:
    ...
    L_A: np.ndarray = field(default_factory=lambda: np.array([]))
    R_A: np.ndarray = field(default_factory=lambda: np.array([]))
    M_A: np.ndarray = field(default_factory=lambda: np.array([]))
    I_A: np.ndarray = field(default_factory=lambda: np.array([]))
    P_A: np.ndarray = field(default_factory=lambda: np.array([]))
    tau_A: np.ndarray = field(default_factory=lambda: np.array([]))
    L_B: np.ndarray = field(default_factory=lambda: np.array([]))
    R_B: np.ndarray = field(default_factory=lambda: np.array([]))
    M_B: np.ndarray = field(default_factory=lambda: np.array([]))
    I_B: np.ndarray = field(default_factory=lambda: np.array([]))
    P_B: np.ndarray = field(default_factory=lambda: np.array([]))
    tau_B: np.ndarray = field(default_factory=lambda: np.array([]))
