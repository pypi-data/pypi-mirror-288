...
from .helpers.get_db_session import get_db_session, get_db_session_factory
...
class BaseRepository(Generic[T]):
  ...
  def __init__(self, session: AsyncSession = Depends(get_db_session), session_factory: Callable[[], AsyncSession] = Depends(get_db_session_factory), ):
