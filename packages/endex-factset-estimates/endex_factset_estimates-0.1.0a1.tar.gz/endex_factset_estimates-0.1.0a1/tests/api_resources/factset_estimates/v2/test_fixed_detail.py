...
class TestFixedDetail:
    parametrize = pytest.mark.parametrize("client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    def test_method_create(self, client: EndexFactsetEstimates) -> None:
        fixed_detail = client.factset_estimates.v2.fixed_detail.create(
            ids=["FDS-US"],
            metrics=["SALES"],
        )
        assert_matches_type(DetailResponse, fixed_detail, path=["response"])
    ...
    def test_raw_response_create(self, client: EndexFactsetEstimates) -> None:
        response = client.factset_estimates.v2.fixed_detail.with_raw_response.create(
            ids=["FDS-US"],
            metrics=["SALES"],
        )
        ...
        fixed_detail = response.parse()
        assert_matches_type(DetailResponse, fixed_detail, path=["response"])

    @parametrize
    def test_streaming_response_create(self, client: EndexFactsetEstimates) -> None:
        with client.factset_estimates.v2.fixed_detail.with_streaming_response.create(
            ids=["FDS-US"],
            metrics=["SALES"],
        ) as response:
    ...
    def test_method_list(self, client: EndexFactsetEstimates) -> None:
        fixed_detail = client.factset_estimates.v2.fixed_detail.list(
            ids=["string"],
            metrics=["SALES"],
        )
        assert_matches_type(DetailResponse, fixed_detail, path=["response"])
    ...
    def test_raw_response_list(self, client: EndexFactsetEstimates) -> None:
        response = client.factset_estimates.v2.fixed_detail.with_raw_response.list(
            ids=["string"],
            metrics=["SALES"],
        )
    ...
    def test_streaming_response_list(self, client: EndexFactsetEstimates) -> None:
        with client.factset_estimates.v2.fixed_detail.with_streaming_response.list(
            ids=["string"],
            metrics=["SALES"],
        ) as response:
            assert not response.is_closed
...
class TestAsyncFixedDetail:
    parametrize = pytest.mark.parametrize("async_client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    async def test_method_create(self, async_client: AsyncEndexFactsetEstimates) -> None:
        fixed_detail = await async_client.factset_estimates.v2.fixed_detail.create(
            ids=["FDS-US"],
            metrics=["SALES"],
        )
        assert_matches_type(DetailResponse, fixed_detail, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncEndexFactsetEstimates) -> None:
        response = await async_client.factset_estimates.v2.fixed_detail.with_raw_response.create(
            ids=["FDS-US"],
            metrics=["SALES"],
        )
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        fixed_detail = await response.parse()
        assert_matches_type(DetailResponse, fixed_detail, path=["response"])

    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncEndexFactsetEstimates) -> None:
        async with async_client.factset_estimates.v2.fixed_detail.with_streaming_response.create(
            ids=["FDS-US"],
            metrics=["SALES"],
        ) as response:
            assert not response.is_closed
    ...
    async def test_method_list(self, async_client: AsyncEndexFactsetEstimates) -> None:
        fixed_detail = await async_client.factset_estimates.v2.fixed_detail.list(
            ids=["string"],
            metrics=["SALES"],
        )
        assert_matches_type(DetailResponse, fixed_detail, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncEndexFactsetEstimates) -> None:
        response = await async_client.factset_estimates.v2.fixed_detail.with_raw_response.list(
            ids=["string"],
            metrics=["SALES"],
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncEndexFactsetEstimates) -> None:
        async with async_client.factset_estimates.v2.fixed_detail.with_streaming_response.list(
            ids=["string"],
            metrics=["SALES"],
        ) as response:
            assert not response.is_closed
