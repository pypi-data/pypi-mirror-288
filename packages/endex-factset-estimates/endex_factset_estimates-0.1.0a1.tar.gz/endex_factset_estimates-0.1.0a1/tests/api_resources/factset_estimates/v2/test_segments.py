...
class TestSegments:
    ...
    def test_method_create(self, client: EndexFactsetEstimates) -> None:
        segment = client.factset_estimates.v2.segments.create(
            ids=["FDS-US"],
            metrics=["SALES"],
        )
    ...
    def test_raw_response_create(self, client: EndexFactsetEstimates) -> None:
        response = client.factset_estimates.v2.segments.with_raw_response.create(
            ids=["FDS-US"],
            metrics=["SALES"],
        )
    ...
    def test_streaming_response_create(self, client: EndexFactsetEstimates) -> None:
        with client.factset_estimates.v2.segments.with_streaming_response.create(
            ids=["FDS-US"],
            metrics=["SALES"],
        ) as response:
    ...
    def test_method_retrieve(self, client: EndexFactsetEstimates) -> None:
        segment = client.factset_estimates.v2.segments.retrieve(
            ids=["string"],
            metrics=["SALES"],
            segment_type="BUS",
        )
    ...
    def test_raw_response_retrieve(self, client: EndexFactsetEstimates) -> None:
        response = client.factset_estimates.v2.segments.with_raw_response.retrieve(
            ids=["string"],
            metrics=["SALES"],
            segment_type="BUS",
        )
    ...
    def test_streaming_response_retrieve(self, client: EndexFactsetEstimates) -> None:
        with client.factset_estimates.v2.segments.with_streaming_response.retrieve(
            ids=["string"],
            metrics=["SALES"],
            segment_type="BUS",
        ) as response:
...
class TestAsyncSegments:
    ...
    async def test_method_create(self, async_client: AsyncEndexFactsetEstimates) -> None:
        segment = await async_client.factset_estimates.v2.segments.create(
            ids=["FDS-US"],
            metrics=["SALES"],
        )
        assert_matches_type(SegmentsResponse, segment, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncEndexFactsetEstimates) -> None:
        response = await async_client.factset_estimates.v2.segments.with_raw_response.create(
            ids=["FDS-US"],
            metrics=["SALES"],
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncEndexFactsetEstimates) -> None:
        async with async_client.factset_estimates.v2.segments.with_streaming_response.create(
            ids=["FDS-US"],
            metrics=["SALES"],
        ) as response:
            assert not response.is_closed
    ...
    async def test_method_retrieve(self, async_client: AsyncEndexFactsetEstimates) -> None:
        segment = await async_client.factset_estimates.v2.segments.retrieve(
            ids=["string"],
            metrics=["SALES"],
            segment_type="BUS",
        )
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncEndexFactsetEstimates) -> None:
        response = await async_client.factset_estimates.v2.segments.with_raw_response.retrieve(
            ids=["string"],
            metrics=["SALES"],
            segment_type="BUS",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncEndexFactsetEstimates) -> None:
        async with async_client.factset_estimates.v2.segments.with_streaming_response.retrieve(
            ids=["string"],
            metrics=["SALES"],
            segment_type="BUS",
        ) as response:
