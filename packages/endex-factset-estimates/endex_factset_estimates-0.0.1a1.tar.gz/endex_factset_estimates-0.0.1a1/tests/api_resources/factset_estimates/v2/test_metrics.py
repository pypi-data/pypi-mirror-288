...
class TestMetrics:
    ...
    def test_method_create(self, client: EndexFactsetEstimates) -> None:
        metric = client.factset_estimates.v2.metrics.create()
    ...
    def test_raw_response_create(self, client: EndexFactsetEstimates) -> None:
        response = client.factset_estimates.v2.metrics.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: EndexFactsetEstimates) -> None:
        with client.factset_estimates.v2.metrics.with_streaming_response.create() as response:
    ...
    def test_method_list(self, client: EndexFactsetEstimates) -> None:
        metric = client.factset_estimates.v2.metrics.list()
        assert_matches_type(MetricsResponse, metric, path=["response"])
    ...
    def test_raw_response_list(self, client: EndexFactsetEstimates) -> None:
        response = client.factset_estimates.v2.metrics.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: EndexFactsetEstimates) -> None:
        with client.factset_estimates.v2.metrics.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncMetrics:
    ...
    async def test_method_create(self, async_client: AsyncEndexFactsetEstimates) -> None:
        metric = await async_client.factset_estimates.v2.metrics.create()
        assert_matches_type(MetricsResponse, metric, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncEndexFactsetEstimates) -> None:
        response = await async_client.factset_estimates.v2.metrics.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncEndexFactsetEstimates) -> None:
        async with async_client.factset_estimates.v2.metrics.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list(self, async_client: AsyncEndexFactsetEstimates) -> None:
        metric = await async_client.factset_estimates.v2.metrics.list()
        assert_matches_type(MetricsResponse, metric, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncEndexFactsetEstimates) -> None:
        response = await async_client.factset_estimates.v2.metrics.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncEndexFactsetEstimates) -> None:
        async with async_client.factset_estimates.v2.metrics.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
