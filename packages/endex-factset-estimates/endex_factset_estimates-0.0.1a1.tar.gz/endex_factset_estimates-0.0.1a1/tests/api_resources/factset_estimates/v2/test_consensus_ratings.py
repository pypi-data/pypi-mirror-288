...
class TestConsensusRatings:
    parametrize = pytest.mark.parametrize("client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    def test_method_create(self, client: EndexFactsetEstimates) -> None:
        consensus_rating = client.factset_estimates.v2.consensus_ratings.create(
            ids=["FDS-US"],
        )
        assert_matches_type(ConsensusRatingsResponse, consensus_rating, path=["response"])
    ...
    def test_raw_response_create(self, client: EndexFactsetEstimates) -> None:
        response = client.factset_estimates.v2.consensus_ratings.with_raw_response.create(
            ids=["FDS-US"],
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        consensus_rating = response.parse()
        assert_matches_type(ConsensusRatingsResponse, consensus_rating, path=["response"])

    @parametrize
    def test_streaming_response_create(self, client: EndexFactsetEstimates) -> None:
        with client.factset_estimates.v2.consensus_ratings.with_streaming_response.create(
            ids=["FDS-US"],
        ) as response:
    ...
    def test_method_list(self, client: EndexFactsetEstimates) -> None:
        consensus_rating = client.factset_estimates.v2.consensus_ratings.list(
            ids=["string"],
        )
        assert_matches_type(ConsensusRatingsResponse, consensus_rating, path=["response"])
    ...
    def test_raw_response_list(self, client: EndexFactsetEstimates) -> None:
        response = client.factset_estimates.v2.consensus_ratings.with_raw_response.list(
            ids=["string"],
        )
    ...
    def test_streaming_response_list(self, client: EndexFactsetEstimates) -> None:
        with client.factset_estimates.v2.consensus_ratings.with_streaming_response.list(
            ids=["string"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncConsensusRatings:
    parametrize = pytest.mark.parametrize("async_client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    async def test_method_create(self, async_client: AsyncEndexFactsetEstimates) -> None:
        consensus_rating = await async_client.factset_estimates.v2.consensus_ratings.create(
            ids=["FDS-US"],
        )
        assert_matches_type(ConsensusRatingsResponse, consensus_rating, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncEndexFactsetEstimates) -> None:
        response = await async_client.factset_estimates.v2.consensus_ratings.with_raw_response.create(
            ids=["FDS-US"],
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        consensus_rating = await response.parse()
        assert_matches_type(ConsensusRatingsResponse, consensus_rating, path=["response"])

    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncEndexFactsetEstimates) -> None:
        async with async_client.factset_estimates.v2.consensus_ratings.with_streaming_response.create(
            ids=["FDS-US"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list(self, async_client: AsyncEndexFactsetEstimates) -> None:
        consensus_rating = await async_client.factset_estimates.v2.consensus_ratings.list(
            ids=["string"],
        )
        assert_matches_type(ConsensusRatingsResponse, consensus_rating, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncEndexFactsetEstimates) -> None:
        response = await async_client.factset_estimates.v2.consensus_ratings.with_raw_response.list(
            ids=["string"],
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncEndexFactsetEstimates) -> None:
        async with async_client.factset_estimates.v2.consensus_ratings.with_streaming_response.list(
            ids=["string"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
