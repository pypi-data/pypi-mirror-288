...
class SegmentCreateParams(TypedDict, total=False):
    ...
    Permanent Ids. _ Make Note - id limit of 50 for defaults, otherwise the service
    is limited to a 30 second duration. This can be reached when increasing total
    number of metrics requested and depth of history. _
    """
    ...
    periodicity: Literal["ANN", "QTR", "SEMI", "LTMA", "NTMA"]
    """
