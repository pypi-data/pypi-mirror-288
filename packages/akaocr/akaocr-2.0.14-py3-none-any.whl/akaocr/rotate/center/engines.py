    ...
    def __call__(self, img_list):
        ...
        for beg_img_no in range(0, img_num, batch_num):
            ...
            for ino in range(beg_img_no, end_img_no):
                norm_img = self.resize_image(img_list[indices[ino]])
...
def prepare_inference_session(device='cpu', num_workers=4):
...
def create_predictor(model_path=None, device='cpu', num_workers=4):
