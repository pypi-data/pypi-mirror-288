...
class JsonFileUtils(FileUtils):
    def read(self, file_path) -> Dict[Any, Any]:
...
class YamlFileUtils(FileUtils):
    def read(self, file_path) -> Union[List[Any], Dict[Any, Any]]:
        with open(file_path, 'r', encoding='utf-8') as f:
...
class ExcelFileUtils(FileUtils):
    def read(self, file_path) -> List[List]:
...
class IniFileUtils(FileUtils):
    ...
    def write(self, file_path, content: Dict[Any, Dict[Any, Any]], mode='w'):
