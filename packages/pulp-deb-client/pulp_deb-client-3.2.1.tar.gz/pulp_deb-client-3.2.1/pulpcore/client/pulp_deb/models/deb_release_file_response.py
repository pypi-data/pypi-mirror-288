...
class DebReleaseFileResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, pulp_last_updated=None, artifacts=None, codename=None, suite=None, distribution=None, relative_path=None, local_vars_configuration=None):  # noqa: E501
