...
class Strategy(_Strategy):
    ...
    def send_account_summary_to_discord(self):
        ...
        if not should_send_account_summary:
            ...
            self.logger.info("Not sending account summary to Discord because should_send_account_summary_to_discord() returned False")
            return
    ...
    def should_send_account_summary_to_discord(self):
        ...
        if not self.should_send_summary_to_discord:
            # Log that we are not sending the account summary to Discord
            self.logger.info("Not sending account summary to Discord because should_send_summary_to_discord is False or not set. The value is: {self.should_send_summary_to_discord}")
            return False
        ...
        # Log that we are not sending the account summary to Discord
        self.logger.info("Not sending account summary to Discord because it has not been at least 24 hours since the last account summary")
