...
class PyFlash:
    ...
    def get_state(self, state_variables, variable_idxs, idxs, mole_fractions, comp_in_dims,
                  concentrations: dict = None, concentration_unit: ConcentrationUnits = ConcentrationUnits.MOLALITY):
        # Get state
        j = 0
    ...
    def evaluate_full_space(self, state_spec: dict, compositions: dict, evaluate, output_arrays: dict, mole_fractions: bool = True,
                            dims_order: list = None, concentrations: dict = None, concentration_unit: ConcentrationUnits = ConcentrationUnits.MOLALITY):
        """
    ...
    def evaluate_flash_1c(self, state_spec: dict, compositions: dict, dims_order: list = None):
        ...
        return self.evaluate_full_space(state_spec=state_spec, compositions=compositions, evaluate=evaluate,
                                        output_arrays=output_arrays, dims_order=dims_order)
    ...
    def evaluate_properties_of_mixing(self, state_spec: dict, compositions: dict, mole_fractions: bool,
        ...
        return self.evaluate_full_space(state_spec, compositions, mole_fractions, evaluate,
    ...
    def evaluate_stationary_points(self, state_spec: dict, compositions: dict, mole_fractions: bool, dims_order: list = None,
        ...
        return self.evaluate_full_space(state_spec, compositions, mole_fractions, evaluate, output_arrays,
