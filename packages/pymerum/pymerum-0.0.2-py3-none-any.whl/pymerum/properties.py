...
class Configurations:
    ...
    jisyo_marburu_hira = "marburuharu3.db"
    jisyo_passport_hira = "passportharu3.db"
    jisyo_kunrei_hira = "kunreiharu3.db"
    jisyo_itaiji = "itaijidict4.db"
    jisyo_kanwa = "kanwadict4.db"
    jisyo_marburu = "marburudict3.db"
    jisyo_passport = "passportdict3.db"
    jisyo_kunrei = "kunreidict3.db"
    jisyo_halfhor = "halfhor3.db"
...
class Convert_Tables:
    ...
    based on Original MERUM's EUC_JP - alphabet converter table
    --------------------------------------------------------------------------
     a1 a0 | 　 、 。 ， ． ・ ： ； ？ ！ ゛ ゜ ´ ｀ ¨
             " ",",",".",",",".",".",":",";","?",
             "!","\"","(maru)","'","`","..",
