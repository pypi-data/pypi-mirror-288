...
from endex_factset_mergers_and_acquisitions._models import BaseModel, FinalRequestOptions
from endex_factset_mergers_and_acquisitions._constants import RAW_RESPONSE_HEADER
from endex_factset_mergers_and_acquisitions._exceptions import (
    APIStatusError,
    APITimeoutError,
    APIResponseValidationError,
)
from endex_factset_mergers_and_acquisitions._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: EndexFactsetMergersAndAcquisitions | AsyncEndexFactsetMergersAndAcquisitions) -> int:
...
class TestEndexFactsetMergersAndAcquisitions:
    client = EndexFactsetMergersAndAcquisitions(base_url=base_url, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "endex_factset_mergers_and_acquisitions/_legacy_response.py",
                        "endex_factset_mergers_and_acquisitions/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "endex_factset_mergers_and_acquisitions/_compat.py",
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = EndexFactsetMergersAndAcquisitions(
            base_url=base_url,
    ...
    def test_multipart_repeating_array(self, client: EndexFactsetMergersAndAcquisitions) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_MERGERS_AND_ACQUISITIONS_BASE_URL="http://localhost:5000/from/env"):
            client = EndexFactsetMergersAndAcquisitions(_strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: EndexFactsetMergersAndAcquisitions) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: EndexFactsetMergersAndAcquisitions) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: EndexFactsetMergersAndAcquisitions) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = EndexFactsetMergersAndAcquisitions(base_url=base_url, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = EndexFactsetMergersAndAcquisitions(base_url=base_url, _strict_response_validation=False)
    ...
    @mock.patch(
        "endex_factset_mergers_and_acquisitions._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout
    )
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/deals/details").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.post(
                "/deals/details",
                body=cast(object, dict(data={"deal_ids": ["4143886MM"]})),
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/deals/details").mock(return_value=httpx.Response(500))
...
class TestAsyncEndexFactsetMergersAndAcquisitions:
    client = AsyncEndexFactsetMergersAndAcquisitions(base_url=base_url, _strict_response_validation=True)
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = AsyncEndexFactsetMergersAndAcquisitions(
            base_url=base_url,
            _strict_response_validation=True,
            default_headers={
                "X-Foo": "stainless",
    ...
    def test_multipart_repeating_array(self, async_client: AsyncEndexFactsetMergersAndAcquisitions) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_MERGERS_AND_ACQUISITIONS_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncEndexFactsetMergersAndAcquisitions(_strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncEndexFactsetMergersAndAcquisitions) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncEndexFactsetMergersAndAcquisitions) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncEndexFactsetMergersAndAcquisitions) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncEndexFactsetMergersAndAcquisitions(base_url=base_url, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncEndexFactsetMergersAndAcquisitions(base_url=base_url, _strict_response_validation=False)
