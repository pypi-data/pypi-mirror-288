...
from endex_factset_mergers_and_acquisitions._streaming import Stream, AsyncStream, ServerSentEvent


@pytest.mark.asyncio
@pytest.mark.parametrize("sync", [True, False], ids=["sync", "async"])
async def test_basic(
    sync: bool, client: EndexFactsetMergersAndAcquisitions, async_client: AsyncEndexFactsetMergersAndAcquisitions
) -> None:
...
async def test_special_new_line_character(
    ...
    async_client: AsyncEndexFactsetMergersAndAcquisitions,
) -> None:
    def body() -> Iterator[bytes]:
