...
class LakGatewayInputHabitatActionUpgradeBuildings(betterproto.Message):
    ...
    habitat_ids_to_building_primary_keys: Dict[
        int, "LakGatewayInputHabitatActionUpgradeBuildingsLakPrimaryKeys"
    ] = betterproto.map_field(3, betterproto.TYPE_INT32, betterproto.TYPE_MESSAGE)


@dataclass
class LakGatewayInputHabitatActionUpgradeBuildingsLakPrimaryKeys(betterproto.Message):
...
class LakGatewayInputHabitatActionBatchUnitOrder(betterproto.Message):
    metadata: "LakGatewayInputMetadata" = betterproto.message_field(1)
    payment_amount: int = betterproto.int32_field(2)
    habitat_ids_to_unit_id_to_count: Dict[
        int, "LakGatewayInputHabitatActionBatchUnitOrderLakUnitIdToCount"
    ] = betterproto.map_field(3, betterproto.TYPE_INT32, betterproto.TYPE_MESSAGE)


@dataclass
class LakGatewayInputHabitatActionBatchUnitOrderLakUnitIdToCount(betterproto.Message):
...
class LakGatewayInputMarketActionTradeResourcesForHabitatDictionary(
    ...
    habitat_ids_to_resource_and_units: Dict[
        int,
        "LakGatewayInputMarketActionTradeResourcesForHabitatDictionaryLakResourcesAndUnits",
    ] = betterproto.map_field(3, betterproto.TYPE_INT32, betterproto.TYPE_MESSAGE)


@dataclass
class LakGatewayInputMarketActionTradeResourcesForHabitatDictionaryLakResourcesAndUnits(
    betterproto.Message
):
...
class LakGatewayServiceStub(betterproto.ServiceStub):
    ...
    async def habitat_action__upgrade_buildings(
        ...
        *,
        ...
        habitat_ids_to_building_primary_keys: Optional[
            Dict[int, "LakGatewayInputHabitatActionUpgradeBuildingsLakPrimaryKeys"]
        ] = None,
    ) -> AsyncGenerator[LakGatewayStatus, None]:
    ...
    async def habitat_action__batch_unit_order(
        ...
        *,
        metadata: Optional["LakGatewayInputMetadata"] = None,
        payment_amount: int = 0,
        habitat_ids_to_unit_id_to_count: Optional[
            Dict[int, "LakGatewayInputHabitatActionBatchUnitOrderLakUnitIdToCount"]
        ] = None,
    ) -> AsyncGenerator[LakGatewayStatus, None]:
