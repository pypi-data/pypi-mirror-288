...
class TestDataForm(forms.ModelForm):
    ...
    departamentos2 = forms.ChoiceField(choices=(("Lima", "Lima"), ("Cajamarca", "Cajamarca")), required=False)
    departamentos3 = forms.MultipleChoiceField(choices=(("Lima", "Lima"), ("Cajamarca", "Cajamarca")), required=False)
