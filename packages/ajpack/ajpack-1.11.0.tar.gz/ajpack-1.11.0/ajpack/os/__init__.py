...
from .win import read_data

__all__ = ["drives", "list_processes", "kill_process", "get_system_resources", "get_disk_info", "get_battery_status", "get_base_path", "get_paths", "parent_folder", "read_data"]