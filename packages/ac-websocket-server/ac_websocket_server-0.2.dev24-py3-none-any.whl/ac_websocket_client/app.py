...
from ac_websocket_client.entry_list import EntryList
...
class App(tk.Tk):
    ...
    def _create_ui(self):
        ...
        # Extra windows
        self.entry_list_window = EntryList(self)
                ...
                if success_msg := input_line.get('data', None):
                    ...
                    if server_msg := success_msg.get('server', None):
                        ...
                        if entries := server_msg.get('entries'):
                            ...
                            self.entry_list_window.update_entries(_entries)
                        # self._show_entries()
    ...
    async def _toggle_connection(self, url=None):
        ...
        try:
            async with websockets.connect(url) as websocket:
                ...
                self.entry_list_window.websocket = websocket
                ...
                self.websocket = None
                self.entry_list_window.websocket = None
