...
def _Particles_delta_vector(self, a, b, cell, return_pbcvec=False):
    ...
    :param bool return_pbcvec: If true, lets the method also return the vector :math:`n`, which specifies how often the computed particle-to-particle vector crosses the cell's face.
