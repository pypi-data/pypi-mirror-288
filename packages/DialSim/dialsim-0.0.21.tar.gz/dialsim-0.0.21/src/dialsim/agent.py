...
class Agent(BaseAgent):
    ...
    def __init__(
        ...
        if self.history_type == "session-summary":
            self.sum_prompt_template = open_file(f'{self.prompt_root}/data/chatgpt_summarize_prompt.txt')
        if self.ret_method == "no_ret":
            self.answer_prompt_template = open_file(f'{self.prompt_root}/data/naive_llm_inference.txt')
        else:
            self.answer_prompt_template = open_file(f'{self.prompt_root}/data/RAG_qa_prompt.txt')
