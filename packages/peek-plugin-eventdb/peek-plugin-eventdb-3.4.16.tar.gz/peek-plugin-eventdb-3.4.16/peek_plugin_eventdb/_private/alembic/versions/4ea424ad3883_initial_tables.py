...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["modelSetId"], ["pl_eventdb.EventDBModelSet.id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["propertyId"], ["pl_eventdb.EventDBProperty.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="pl_eventdb",
    )
...
def downgrade():
    ...
    op.drop_index(
        "idx_EventDBProp_value", table_name="EventDBProperty", schema="pl_eventdb"
    )
    op.drop_index(
        "idx_EventDBProp_name", table_name="EventDBProperty", schema="pl_eventdb"
    )
    op.drop_table("EventDBProperty", schema="pl_eventdb")
    op.drop_index(
        "idx_EventDBEvent_modelSetId", table_name="EventDBEvent", schema="pl_eventdb"
    )
    op.drop_index(
