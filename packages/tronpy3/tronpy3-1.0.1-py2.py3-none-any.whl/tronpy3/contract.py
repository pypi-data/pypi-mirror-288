...
import tronpy3
from tronpy3.abi import trx_abi
from tronpy3.exceptions import DoubleSpending
from tronpy3.keys import to_hex_address
...
class Contract:
    ...
    def update_user_resource_percent(self, percent: int) -> "tronpy3.tron.TransactionBuilder":
    ...
    def update_origin_energy_limit(self, limit: int) -> "tronpy3.tron.TransactionBuilder":
    ...
    def clear_abi(self) -> "tronpy3.tron.TransactionBuilder":
        """Clear contract ABI."""
        if self.origin_address != self.owner_address:
            raise RuntimeError("origin address and owner address mismatch")
...
class ContractMethod:
    ...
    def with_owner(self, addr: str) -> "ContractMethod":
        ...
        Can also be changed through :meth:`TransactionBuilder.with_owner() <tronpy3.tron.TransactionBuilder.with_owner>`.
        """
    ...
    def call(self, *args, **kwargs) -> "tronpy3.tron.TransactionBuilder":
    ...
    def __call__(self, *args, **kwargs) -> "tronpy3.tron.TransactionBuilder":
        """Call the contract method."""
        parameter = self._prepare_parameter(*args, **kwargs)
        return self._trigger_contract(parameter)

    def _prepare_parameter(self, *args, **kwargs) -> "tronpy3.tron.TransactionBuilder":
        """Prepare parameter."""
        parameter = ""
...
class ShieldedTRC20:
    ...
    def mint(self, taddr: str, zaddr: str, amount: int, memo: str = "") -> "tronpy3.tron.TransactionBuilder":
    ...
    ) -> "tronpy3.tron.TransactionBuilder":
