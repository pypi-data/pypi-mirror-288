...
import base64
from tronpy3 import keys
from tronpy3.abi import tron_abi
from tronpy3.contract import Contract, ContractMethod, ShieldedTRC20
from tronpy3.defaults import conf_for_name
from tronpy3.exceptions import (
    AddressNotFound,
    ApiError,
    AssetNotFound,
    BadHash,
...
from tronpy3.hdwallet import TRON_DEFAULT_PATH, generate_mnemonic, key_from_seed, seed_from_mnemonic
from tronpy3.keys import PrivateKey
from tronpy3.providers import HTTPProvider
...
class Trx:
    ...
    def account_permission_update(self, owner: TAddress, perm: dict) -> "TransactionBuilder":
        ...
        :param owner:
        :param perm: Permission dict from :meth:`~tronpy3.Tron.get_account_permission`
        """
    ...
    def unfreeze_balance(self, owner: TAddress, resource: str = "ENERGY", *,
                         unfreeze_balance: int) -> "TransactionBuilder":
...
class Tron:
    ...
    :param provider: An :class:`~tronpy3.providers.HTTPProvider` object, can be configured to use private node
    ...
    def generate_address_from_mnemonic(self, mnemonic: str, passphrase: str = "",
                                       account_path: str = TRON_DEFAULT_PATH):
        """
    ...
    def generate_address_with_mnemonic(
        self, passphrase: str = "", num_words: int = 12, language: str = "english",
        account_path: str = TRON_DEFAULT_PATH
    ):
        r"""
    ...
    def get_account(self, addr: TAddress) -> dict:
        ...
        ret = self.provider.make_request("wallet/getaccount",
