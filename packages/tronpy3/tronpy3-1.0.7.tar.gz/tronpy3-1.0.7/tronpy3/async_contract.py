...
from tronpy3.contract import Contract, ContractFunctions, ContractMethod, ShieldedTRC20
...
class AsyncContractMethod(ContractMethod):
    async def call(self, *args, **kwargs) -> "tronpy3.async_tron.AsyncTransactionBuilder":
        """Call the contract method."""
        return await self.__call__(*args, **kwargs)

    async def __call__(self, *args, **kwargs) -> "tronpy3.async_tron.AsyncTransactionBuilder":
        """Call the contract method."""
...
class AsyncShieldedTRC20(ShieldedTRC20):
    ...
    async def mint(self, taddr: str, zaddr: str, amount: int, memo: str = "") -> "tronpy3.async_tron.AsyncTransactionBuilder":
    ...
    ) -> "tronpy3.async_tron.AsyncTransactionBuilder":
