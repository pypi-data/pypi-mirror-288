...
class LifelongDPOExaminee(ExamineeBase):
    ...
    def run(self, judge: JudgeBase) -> Iterable:
        if isinstance(judge, PredictJudge):
            warnings.warn("LifelongDPOExaminee is not designed for PredictJudge, and the result on PredictJudge should only be seen as a trivial baseline. Use ExtrapolativeDPOExaminee instead.")
