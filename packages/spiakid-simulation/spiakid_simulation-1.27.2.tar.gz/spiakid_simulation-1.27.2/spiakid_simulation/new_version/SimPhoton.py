...
from spiakid_simulation.new_version.fun.Phase.phase_conversion import read_csv, photon2phase, exp_adding, PhaseNoise, exp_adding_calib, PhaseNoiseCalib, ConversionTab
...
class Simulation():
    ...
    class Detector():
        ...
        def Calib(self,):
                ...
                tab = ConversionTab(self.photondetectcalib[0], conversion)
                print('wv 0',flush = True) 
                phaseconvcalib0 = photon2phase(self.photondetectcalib[0], tab, nphase)
                ...
                phaseconvcalib1 = photon2phase(self.photondetectcalib[1], tab, nphase)
                ...
                phaseconvcalib2 = photon2phase(self.photondetectcalib[2], tab, nphase)
            ...
            try: DATA['Phase']
                ...
                for k in range(pxnbr):
                    for l in range(pxnbr):
                        ...
                        h5file['Calibration/'+str(0)+'/'+str(k)+'_'+str(l)] = self.detect.phaseconvcalib0[k,l]
                        h5file['Calibration/'+str(1)+'/'+str(k)+'_'+str(l)] = self.detect.phaseconvcalib1[k,l]
                        h5file['Calibration/'+str(2)+'/'+str(k)+'_'+str(l)] = self.detect.phaseconvcalib2[k,l]
