...
class ProjectResponse(BaseModel):
    ...
    project_description: Optional[StrictStr] = Field(default=None, alias="projectDescription")
    task: TaskEnum
    created_at: datetime = Field(alias="createdAt")
    updated_at: datetime = Field(alias="updatedAt")
    image_count: Optional[StrictInt] = None
    ontology: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["projectId", "projectName", "projectDescription", "task", "createdAt", "updatedAt", "image_count", "ontology"]
