...
class ImageResponse(BaseModel):
    ...
    filename: StrictStr
    status: StrictStr
    annotations_count: StrictInt = Field(alias="annotationsCount")
    annotations: Dict[str, Any]
    created_at: StrictStr = Field(alias="createdAt")
    updated_at: StrictStr = Field(alias="updatedAt")
    presigned_url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["imageId", "projectId", "userId", "filename", "status", "annotationsCount", "annotations", "createdAt", "updatedAt", "presigned_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "annotationsCount": obj.get("annotationsCount"),
