...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {"headline_text": ("SKZ expands regulatory training of plastics selection with intensive course",)},
            {
                "category": "compliance-regulatory",
            },
        ),
        (
            {"headline_text": ("How governance plays a role in HP’s award-winning ESG reporting",)},
            {
                "category": "corporate-governance",
            },
        ),
        (
            {"headline_text": ("Pantheon International outlines next phase of its corporate strategy",)},
            {
                "category": "corporate-strategy",
            },
        ),
        (
            {"headline_text": ("TGC-14 plans to pay dividends for the first half of the year for 619.47 million rubles",)},
            {
                "category": "dividends",
            },
        ),
        (
            {"headline_text": ("U.S heading for a recession? Here are all the key indicators that point towards it",)},
            {
        ...
        (
            {"headline_text": ("Scott Russell and Julia White to Leave SAP Executive Board",)},
            {
                "category": "executive-changes",
            },
        ),
        (
            {"headline_text": ("Inaugural Forum of the Global Coalition for Social Justice",)},
            {
        ...
        (
            {"headline_text": ("Economie - Les innovations du Clermontois Carbios intéressent de la Chine à la Turquie",)},
            {
                "category": "innovations",
            },
        ),
        (
            {"headline_text": ("Swiss Life AM debuts equity and bond index range for institutional investors",)},
            {
                "category": "institutional-indices",
            },
        ),
        (
            {"headline_text": ("Steamboat Springs to consider joining Kroger opioid settlement",)},
            {
        ...
        (
            {"headline_text": ("Driving Policy Change - Update on FCDO Donor Dialogue on Localisation process and follow-up",)},
            {
                "category": "policy-change",
            },
        ),
        (
            {"headline_text": ("Analysts reboot Amazon stock price targets after earnings",)},
            {
                "category": "price-targets",
            },
        ),
        (
            {"headline_text": ("Eviden launches Digital Passport Solution for products and goods",)},
            {
                "category": "product-launches",
            },
        ),
        (
            {"headline_text": ("Nestle recalling Gerber baby cereal in Canada after testing finds Cronobacter",)},
            {
                "category": "product-recalls",
            },
        ),
        (
            {"headline_text": ("Can Morocco's phosphate wealth put it at the centre of the global battery supply chain?",)},
            {
...
def test_classify_headline_category(headline_input, expected):
    assert (
        classify_headline_category(**headline_input) == expected["category"]
    )
