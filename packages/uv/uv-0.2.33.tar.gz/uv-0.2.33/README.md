...
[![image](https://img.shields.io/pypi/v/uv/0.2.33.svg)](https://pypi.python.org/pypi/uv)
[![image](https://img.shields.io/pypi/l/uv/0.2.33.svg)](https://pypi.python.org/pypi/uv)
[![image](https://img.shields.io/pypi/pyversions/uv/0.2.33.svg)](https://pypi.python.org/pypi/uv)
...
- 🧰 Advanced features such as [dependency version overrides](https://github.com/astral-sh/uv/blob/0.2.33/README.md#dependency-overrides) and
  [alternative resolution strategies](https://github.com/astral-sh/uv/blob/0.2.33/README.md#resolution-strategy).
...
For details, see our [`pip` compatibility guide](https://github.com/astral-sh/uv/blob/0.2.33/PIP_COMPATIBILITY.md).
...
See the [`pip` compatibility guide](https://github.com/astral-sh/uv/blob/0.2.33/PIP_COMPATIBILITY.md#registry-authentication) for details on differences from
`pip`.
...
For more, see ["Pre-release compatibility"](https://github.com/astral-sh/uv/blob/0.2.33/PIP_COMPATIBILITY.md#pre-release-compatibility)
...
- Apache License, Version 2.0, ([LICENSE-APACHE](https://github.com/astral-sh/uv/blob/0.2.33/LICENSE-APACHE) or https://www.apache.org/licenses/LICENSE-2.0)
- MIT license ([LICENSE-MIT](https://github.com/astral-sh/uv/blob/0.2.33/LICENSE-MIT) or https://opensource.org/licenses/MIT)
