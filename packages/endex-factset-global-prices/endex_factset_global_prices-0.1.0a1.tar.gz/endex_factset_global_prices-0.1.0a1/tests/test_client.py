...
from endex_factset_global_prices import (
    EndexFactsetGlobalPrices,
    APIResponseValidationError,
    AsyncEndexFactsetGlobalPrices,
)
from endex_factset_global_prices._models import BaseModel, FinalRequestOptions
from endex_factset_global_prices._constants import RAW_RESPONSE_HEADER
from endex_factset_global_prices._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from endex_factset_global_prices._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: EndexFactsetGlobalPrices | AsyncEndexFactsetGlobalPrices) -> int:
...
class TestEndexFactsetGlobalPrices:
    client = EndexFactsetGlobalPrices(base_url=base_url, access_token=access_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "endex_factset_global_prices/_legacy_response.py",
                        "endex_factset_global_prices/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "endex_factset_global_prices/_compat.py",
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = EndexFactsetGlobalPrices(
            base_url=base_url,
            access_token=access_token,
            _strict_response_validation=True,
            default_headers={
    ...
    def test_multipart_repeating_array(self, client: EndexFactsetGlobalPrices) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_GLOBAL_PRICES_BASE_URL="http://localhost:5000/from/env"):
            client = EndexFactsetGlobalPrices(access_token=access_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: EndexFactsetGlobalPrices) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: EndexFactsetGlobalPrices) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: EndexFactsetGlobalPrices) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = EndexFactsetGlobalPrices(
            base_url=base_url, access_token=access_token, _strict_response_validation=True
        )
    ...
    @mock.patch("endex_factset_global_prices._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/factset-global-prices/v1/prices").mock(
        ...
        with pytest.raises(APITimeoutError):
            self.client.post(
                ...
                body=cast(object, dict(ids=["FDS-US"], start_date="2020-06-30")),
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/factset-global-prices/v1/prices").mock(return_value=httpx.Response(500))
...
class TestAsyncEndexFactsetGlobalPrices:
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = AsyncEndexFactsetGlobalPrices(
            base_url=base_url,
            access_token=access_token,
            _strict_response_validation=True,
            default_headers={
    ...
    def test_multipart_repeating_array(self, async_client: AsyncEndexFactsetGlobalPrices) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_GLOBAL_PRICES_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncEndexFactsetGlobalPrices(access_token=access_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncEndexFactsetGlobalPrices) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncEndexFactsetGlobalPrices) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncEndexFactsetGlobalPrices) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncEndexFactsetGlobalPrices(
            base_url=base_url, access_token=access_token, _strict_response_validation=True
        )
