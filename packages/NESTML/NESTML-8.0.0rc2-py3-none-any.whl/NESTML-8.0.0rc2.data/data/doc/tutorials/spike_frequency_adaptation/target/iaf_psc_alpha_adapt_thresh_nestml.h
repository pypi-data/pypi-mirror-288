...
/**
 *  iaf_psc_alpha_adapt_thresh_nestml.h
 *
 ...
 *
 *  Generated from NESTML at time: 2024-04-04 08:48:52.370309
**/
#ifndef IAF_PSC_ALPHA_ADAPT_THRESH_NESTML
#define IAF_PSC_ALPHA_ADAPT_THRESH_NESTML
...
namespace nest
{
namespace iaf_psc_alpha_adapt_thresh_nestml_names
{
    const Name _r( "r" );
    const Name _V_m( "V_m" );
...
/* BeginDocumentation
  Name: iaf_psc_alpha_adapt_thresh_nestml

  Description:

    """
  iaf_psc_alpha_adapt_thresh - Leaky integrate-and-fire neuron model#################################################################

  Description
  +++++++++++

  This model augments iaf_psc_alpha with threshold adaptation.
...
void register_iaf_psc_alpha_adapt_thresh_nestml( const std::string& name );

class iaf_psc_alpha_adapt_thresh_nestml : public nest::StructuralPlasticityNode
{
public:
  /**
  ...
  **/
  iaf_psc_alpha_adapt_thresh_nestml(const iaf_psc_alpha_adapt_thresh_nestml &);

  /**
   * Destructor.
  **/
  ~iaf_psc_alpha_adapt_thresh_nestml() override;
...
static std::vector< std::tuple< int, int > > rport_to_nestml_buffer_idx;
  ...
  **/
  ...
  friend class nest::RecordablesMap<iaf_psc_alpha_adapt_thresh_nestml>;
  friend class nest::UniversalDataLogger<iaf_psc_alpha_adapt_thresh_nestml>;
  ...
  **/
  struct Buffers_
  {
    Buffers_(iaf_psc_alpha_adapt_thresh_nestml &);
    Buffers_(const Buffers_ &, iaf_psc_alpha_adapt_thresh_nestml &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<iaf_psc_alpha_adapt_thresh_nestml> logger_;
...
double I_stim_grid_sum_;
  ...
  {
    return (S_.I_kernel_exc__X__exc_spikes - S_.I_kernel_inh__X__inh_spikes) * 1.0 + P_.I_e + B_.I_stim_grid_sum_;
  }
...
inline nest::RingBuffer& get_I_stim() {
  ...
  static nest::RecordablesMap<iaf_psc_alpha_adapt_thresh_nestml> recordablesMap_;

}; /* neuron iaf_psc_alpha_adapt_thresh_nestml */

inline nest_port_t iaf_psc_alpha_adapt_thresh_nestml::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t iaf_psc_alpha_adapt_thresh_nestml::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
    // You should usually not change the code in this function.
...
inline nest_port_t iaf_psc_alpha_adapt_thresh_nestml::handles_test_event(nest::CurrentEvent&, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest_port_t iaf_psc_alpha_adapt_thresh_nestml::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void iaf_psc_alpha_adapt_thresh_nestml::get_status(DictionaryDatum &__d) const
{
  // parameters
  def<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_C_m, get_C_m());
  def<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_tau_m, get_tau_m());
  def<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_tau_syn_inh, get_tau_syn_inh());
  def<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_tau_syn_exc, get_tau_syn_exc());
  def<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_t_ref, get_t_ref());
  def<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_E_L, get_E_L());
  def<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_V_reset, get_V_reset());
  def<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_Theta_init, get_Theta_init());
  def<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_tau_Theta, get_tau_Theta());
  def<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_Delta_Theta, get_Delta_Theta());
  def<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_I_e, get_I_e());

  // initial values for state variables in ODE or kernel
  def<long>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_r, get_r());
  def<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_V_m, get_V_m());
  def<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_Theta, get_Theta());
  def<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_I_kernel_inh__X__inh_spikes, get_I_kernel_inh__X__inh_spikes());
  def<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_I_kernel_inh__X__inh_spikes__d, get_I_kernel_inh__X__inh_spikes__d());
  def<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_I_kernel_exc__X__exc_spikes, get_I_kernel_exc__X__exc_spikes());
  def<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_I_kernel_exc__X__exc_spikes__d, get_I_kernel_exc__X__exc_spikes__d());
...
inline void iaf_psc_alpha_adapt_thresh_nestml::set_status(const DictionaryDatum &__d)
{
  // parameters
  double tmp_C_m = get_C_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_C_m, tmp_C_m, this);
  double tmp_tau_m = get_tau_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_tau_m, tmp_tau_m, this);
  double tmp_tau_syn_inh = get_tau_syn_inh();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_tau_syn_inh, tmp_tau_syn_inh, this);
  double tmp_tau_syn_exc = get_tau_syn_exc();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_tau_syn_exc, tmp_tau_syn_exc, this);
  double tmp_t_ref = get_t_ref();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_t_ref, tmp_t_ref, this);
  double tmp_E_L = get_E_L();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_E_L, tmp_E_L, this);
  double tmp_V_reset = get_V_reset();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_V_reset, tmp_V_reset, this);
  double tmp_Theta_init = get_Theta_init();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_Theta_init, tmp_Theta_init, this);
  double tmp_tau_Theta = get_tau_Theta();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_tau_Theta, tmp_tau_Theta, this);
  double tmp_Delta_Theta = get_Delta_Theta();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_Delta_Theta, tmp_Delta_Theta, this);
  double tmp_I_e = get_I_e();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_I_e, tmp_I_e, this);

  // initial values for state variables in ODE or kernel
  long tmp_r = get_r();
  nest::updateValueParam<long>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_r, tmp_r, this);
  double tmp_V_m = get_V_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_V_m, tmp_V_m, this);
  double tmp_Theta = get_Theta();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_Theta, tmp_Theta, this);
  double tmp_I_kernel_inh__X__inh_spikes = get_I_kernel_inh__X__inh_spikes();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_I_kernel_inh__X__inh_spikes, tmp_I_kernel_inh__X__inh_spikes, this);
  double tmp_I_kernel_inh__X__inh_spikes__d = get_I_kernel_inh__X__inh_spikes__d();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_I_kernel_inh__X__inh_spikes__d, tmp_I_kernel_inh__X__inh_spikes__d, this);
  double tmp_I_kernel_exc__X__exc_spikes = get_I_kernel_exc__X__exc_spikes();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_I_kernel_exc__X__exc_spikes, tmp_I_kernel_exc__X__exc_spikes, this);
  double tmp_I_kernel_exc__X__exc_spikes__d = get_I_kernel_exc__X__exc_spikes__d();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_thresh_nestml_names::_I_kernel_exc__X__exc_spikes__d, tmp_I_kernel_exc__X__exc_spikes__d, this);
...
#endif /* #ifndef IAF_PSC_ALPHA_ADAPT_THRESH_NESTML */
