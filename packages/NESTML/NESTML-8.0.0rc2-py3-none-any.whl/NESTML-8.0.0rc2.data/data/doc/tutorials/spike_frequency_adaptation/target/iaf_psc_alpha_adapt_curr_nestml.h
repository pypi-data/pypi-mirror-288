...
/**
 *  iaf_psc_alpha_adapt_curr_nestml.h
 *
 ...
 *
 *  Generated from NESTML at time: 2024-04-04 08:48:24.986499
**/
#ifndef IAF_PSC_ALPHA_ADAPT_CURR_NESTML
#define IAF_PSC_ALPHA_ADAPT_CURR_NESTML
...
namespace nest
{
namespace iaf_psc_alpha_adapt_curr_nestml_names
{
    const Name _r( "r" );
    const Name _V_m( "V_m" );
    const Name _I_sfa( "I_sfa" );
    ...
    const Name _tau_sfa( "tau_sfa" );
    const Name _Delta_I_sfa( "Delta_I_sfa" );
    const Name _I_e( "I_e" );
}
}
...
/* BeginDocumentation
  Name: iaf_psc_alpha_adapt_curr_nestml
...
tau_sfa [ms]  Adaptation current time constant
Delta_I_sfa [pA]  Adaptation current increment upon spiking
...
void register_iaf_psc_alpha_adapt_curr_nestml( const std::string& name );

class iaf_psc_alpha_adapt_curr_nestml : public nest::StructuralPlasticityNode
{
public:
  /**
   * The constructor is only used to create the model prototype in the model manager.
  **/
  iaf_psc_alpha_adapt_curr_nestml();
  ...
  **/
  iaf_psc_alpha_adapt_curr_nestml(const iaf_psc_alpha_adapt_curr_nestml &);

  /**
   * Destructor.
  **/
  ~iaf_psc_alpha_adapt_curr_nestml() override;
  ...
  **/
  ...
  inline double get_I_sfa() const
  {
    return S_.I_sfa;
  }

  inline void set_I_sfa(const double __v)
  {
    S_.I_sfa = __v;
  }
  ...
  inline double get_tau_sfa() const
  {
    return P_.tau_sfa;
  }

  inline void set_tau_sfa(const double __v)
  {
    P_.tau_sfa = __v;
  }

  inline double get_Delta_I_sfa() const
  {
    return P_.Delta_I_sfa;
  }

  inline void set_Delta_I_sfa(const double __v)
  {
    P_.Delta_I_sfa = __v;
  }
  ...
  inline double get___P__V_m__I_sfa() const
  {
    return V_.__P__V_m__I_sfa;
  }

  inline void set___P__V_m__I_sfa(const double __v)
  {
    V_.__P__V_m__I_sfa = __v;
  }
  ...
  inline double get___P__I_sfa__I_sfa() const
  {
    return V_.__P__I_sfa__I_sfa;
  }

  inline void set___P__I_sfa__I_sfa(const double __v)
  {
    V_.__P__I_sfa__I_sfa = __v;
  }
...
static std::vector< std::tuple< int, int > > rport_to_nestml_buffer_idx;
  ...
  **/
  ...
  friend class nest::RecordablesMap<iaf_psc_alpha_adapt_curr_nestml>;
  friend class nest::UniversalDataLogger<iaf_psc_alpha_adapt_curr_nestml>;
  ...
  **/
  ...
  {    
    ...
    double tau_sfa;
    //!  Adaptation current increment upon spiking
    double Delta_I_sfa;
  ...
  **/
  struct Buffers_
  {
    Buffers_(iaf_psc_alpha_adapt_curr_nestml &);
    Buffers_(const Buffers_ &, iaf_psc_alpha_adapt_curr_nestml &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<iaf_psc_alpha_adapt_curr_nestml> logger_;
...
double I_stim_grid_sum_;
  ...
  {
    return (S_.I_kernel_exc__X__exc_spikes - S_.I_kernel_inh__X__inh_spikes) * 1.0 - S_.I_sfa + P_.I_e + B_.I_stim_grid_sum_;
  }
...
inline nest::RingBuffer& get_I_stim() {
  ...
  static nest::RecordablesMap<iaf_psc_alpha_adapt_curr_nestml> recordablesMap_;

}; /* neuron iaf_psc_alpha_adapt_curr_nestml */

inline nest_port_t iaf_psc_alpha_adapt_curr_nestml::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t iaf_psc_alpha_adapt_curr_nestml::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
    // You should usually not change the code in this function.
...
inline nest_port_t iaf_psc_alpha_adapt_curr_nestml::handles_test_event(nest::CurrentEvent&, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest_port_t iaf_psc_alpha_adapt_curr_nestml::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void iaf_psc_alpha_adapt_curr_nestml::get_status(DictionaryDatum &__d) const
{
  // parameters
  def<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_C_m, get_C_m());
  def<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_tau_m, get_tau_m());
  def<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_tau_syn_inh, get_tau_syn_inh());
  def<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_tau_syn_exc, get_tau_syn_exc());
  def<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_t_ref, get_t_ref());
  def<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_E_L, get_E_L());
  def<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_V_reset, get_V_reset());
  def<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_V_th, get_V_th());
  def<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_tau_sfa, get_tau_sfa());
  def<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_Delta_I_sfa, get_Delta_I_sfa());
  def<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_I_e, get_I_e());

  // initial values for state variables in ODE or kernel
  def<long>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_r, get_r());
  def<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_V_m, get_V_m());
  def<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_I_sfa, get_I_sfa());
  def<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_I_kernel_exc__X__exc_spikes, get_I_kernel_exc__X__exc_spikes());
  def<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_I_kernel_exc__X__exc_spikes__d, get_I_kernel_exc__X__exc_spikes__d());
  def<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_I_kernel_inh__X__inh_spikes, get_I_kernel_inh__X__inh_spikes());
  def<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_I_kernel_inh__X__inh_spikes__d, get_I_kernel_inh__X__inh_spikes__d());
...
inline void iaf_psc_alpha_adapt_curr_nestml::set_status(const DictionaryDatum &__d)
{
  // parameters
  double tmp_C_m = get_C_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_C_m, tmp_C_m, this);
  double tmp_tau_m = get_tau_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_tau_m, tmp_tau_m, this);
  double tmp_tau_syn_inh = get_tau_syn_inh();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_tau_syn_inh, tmp_tau_syn_inh, this);
  double tmp_tau_syn_exc = get_tau_syn_exc();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_tau_syn_exc, tmp_tau_syn_exc, this);
  double tmp_t_ref = get_t_ref();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_t_ref, tmp_t_ref, this);
  double tmp_E_L = get_E_L();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_E_L, tmp_E_L, this);
  double tmp_V_reset = get_V_reset();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_V_reset, tmp_V_reset, this);
  double tmp_V_th = get_V_th();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_V_th, tmp_V_th, this);
  double tmp_tau_sfa = get_tau_sfa();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_tau_sfa, tmp_tau_sfa, this);
  double tmp_Delta_I_sfa = get_Delta_I_sfa();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_Delta_I_sfa, tmp_Delta_I_sfa, this);
  double tmp_I_e = get_I_e();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_I_e, tmp_I_e, this);

  // initial values for state variables in ODE or kernel
  long tmp_r = get_r();
  nest::updateValueParam<long>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_r, tmp_r, this);
  double tmp_V_m = get_V_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_V_m, tmp_V_m, this);
  double tmp_I_sfa = get_I_sfa();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_I_sfa, tmp_I_sfa, this);
  double tmp_I_kernel_exc__X__exc_spikes = get_I_kernel_exc__X__exc_spikes();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_I_kernel_exc__X__exc_spikes, tmp_I_kernel_exc__X__exc_spikes, this);
  double tmp_I_kernel_exc__X__exc_spikes__d = get_I_kernel_exc__X__exc_spikes__d();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_I_kernel_exc__X__exc_spikes__d, tmp_I_kernel_exc__X__exc_spikes__d, this);
  double tmp_I_kernel_inh__X__inh_spikes = get_I_kernel_inh__X__inh_spikes();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_I_kernel_inh__X__inh_spikes, tmp_I_kernel_inh__X__inh_spikes, this);
  double tmp_I_kernel_inh__X__inh_spikes__d = get_I_kernel_inh__X__inh_spikes__d();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_adapt_curr_nestml_names::_I_kernel_inh__X__inh_spikes__d, tmp_I_kernel_inh__X__inh_spikes__d, this);
  ...
  set_V_th(tmp_V_th);
  set_tau_sfa(tmp_tau_sfa);
  set_Delta_I_sfa(tmp_Delta_I_sfa);
  set_I_e(tmp_I_e);
  set_r(tmp_r);
  set_V_m(tmp_V_m);
  set_I_sfa(tmp_I_sfa);
...
#endif /* #ifndef IAF_PSC_ALPHA_ADAPT_CURR_NESTML */
