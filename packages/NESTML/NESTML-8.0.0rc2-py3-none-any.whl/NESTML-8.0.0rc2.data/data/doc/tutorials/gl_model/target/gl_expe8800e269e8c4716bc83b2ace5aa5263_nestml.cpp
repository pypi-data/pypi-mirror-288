// #define DEBUG 1
/*
 *  gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml.cpp
 *
...
#include "gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml.h"

// ---------------------------------------------------------------------------
//   Recordables map
// ---------------------------------------------------------------------------
nest::RecordablesMap<gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml> gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::recordablesMap_;
namespace nest
{

  // Override the create() method with one call to RecordablesMap::insert_()
  // for each quantity to be recorded.
template <> void RecordablesMap<gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml>::create()
  {
    // add state variables to recordables map
   insert_(gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml_names::_refr_spikes_buffer, &gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::get_refr_spikes_buffer);
   insert_(gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml_names::_V_m, &gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::get_V_m);
...
//   is a part of gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml's constructor.
// ---------------------------------------------------------------------------

gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::Parameters_::Parameters_()
{
}

gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::State_::State_()
{
}
...
gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::Buffers_::Buffers_(gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml &n):
  logger_(n)
...
gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::Buffers_::Buffers_(const Buffers_ &, gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml &n):
  logger_(n)
  , spike_inputs_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
  , spike_inputs_grid_sum_( std::vector< double >( NUM_SPIKE_RECEPTORS ) )
{
...
gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml():StructuralPlasticityNode(), P_(), S_(), B_(*this)
{
...
gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml(const gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml& __n):
...
gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::~gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml()
{
}
...
// ---------------------------------------------------------------------------
void gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::calibrate_time( const nest::TimeConverter& tc )
{
  LOG( nest::M_WARNING,
...
void gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::init_state_internal_()
{
#ifdef DEBUG
  std::cout << "gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::init_state_internal_()" << std::endl;
#endif
...
void gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::init_buffers_()
{
#ifdef DEBUG
  std::cout << "gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::init_buffers_()" << std::endl;
#endif
  // spike input buffers
...
void gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::recompute_internal_variables(bool exclude_timestep) {
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
void gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::pre_run_hook() {
  B_.logger_.init();
...
//
double gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::phi ( double V_m) const
{  
...
void gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::update(nest::Time const & origin,const long from, const long to)
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
void gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::handle(nest::DataLoggingRequest& e)
{
  B_.logger_.handle(e);
}


void gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::handle(nest::SpikeEvent &e)
{
...
void gl_expe8800e269e8c4716bc83b2ace5aa5263_nestml::handle(nest::CurrentEvent& e)
{
  assert(e.get_delay_steps() > 0);
