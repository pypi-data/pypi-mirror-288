...
/**
 *  gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml.h
 *
 ...
 *
 *  Generated from NESTML at time: 2024-02-22 12:54:34.505686
**/
#ifndef GL_EXPF63DC1278F7B473CA66E84E1FBFCA8EE_NESTML
#define GL_EXPF63DC1278F7B473CA66E84E1FBFCA8EE_NESTML
...
namespace nest
{
namespace gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names
{
...
/* BeginDocumentation
  Name: gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml
...
*/
class gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml : public nest::StructuralPlasticityNode
{
public:
  /**
   * The constructor is only used to create the model prototype in the model manager.
  **/
  gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml();
  ...
  **/
  gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml(const gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml &);

  /**
   * Destructor.
  **/
  ~gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml() override;
...
private:
  ...
  **/
  ...
  friend class nest::RecordablesMap<gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml>;
  friend class nest::UniversalDataLogger<gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml>;
  ...
  **/
  struct Buffers_
  {
    Buffers_(gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml &);
    Buffers_(const Buffers_ &, gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml> logger_;
...
inline nest::RingBuffer& get_I_stim() {
  ...
  static nest::RecordablesMap<gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml> recordablesMap_;

}; /* neuron gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml */

inline nest_port_t gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
    // You should usually not change the code in this function.
...
inline nest_port_t gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml::handles_test_event(nest::CurrentEvent&, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest_port_t gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml::get_status(DictionaryDatum &__d) const
{
  // parameters
  def<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_tau_m, get_tau_m());
  def<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_C_m, get_C_m());
  def<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_t_ref, get_t_ref());
  def<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_tau_syn, get_tau_syn());
  def<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_V_r, get_V_r());
  def<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_V_reset, get_V_reset());
  def<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_b, get_b());
  def<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_a, get_a());
  def<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_V_b, get_V_b());
  def<bool>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_with_refr_input, get_with_refr_input());
  def<bool>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_reset_after_spike, get_reset_after_spike());
  def<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_I_e, get_I_e());

  // initial values for state variables in ODE or kernel
  def<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_refr_spikes_buffer, get_refr_spikes_buffer());
  def<long>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_refr_tick, get_refr_tick());
  def<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_V_m, get_V_m());
...
inline void gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml::set_status(const DictionaryDatum &__d)
{
  // parameters
  double tmp_tau_m = get_tau_m();
  nest::updateValueParam<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_tau_m, tmp_tau_m, this);
  double tmp_C_m = get_C_m();
  nest::updateValueParam<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_C_m, tmp_C_m, this);
  double tmp_t_ref = get_t_ref();
  nest::updateValueParam<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_t_ref, tmp_t_ref, this);
  double tmp_tau_syn = get_tau_syn();
  nest::updateValueParam<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_tau_syn, tmp_tau_syn, this);
  double tmp_V_r = get_V_r();
  nest::updateValueParam<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_V_r, tmp_V_r, this);
  double tmp_V_reset = get_V_reset();
  nest::updateValueParam<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_V_reset, tmp_V_reset, this);
  double tmp_b = get_b();
  nest::updateValueParam<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_b, tmp_b, this);
  double tmp_a = get_a();
  nest::updateValueParam<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_a, tmp_a, this);
  double tmp_V_b = get_V_b();
  nest::updateValueParam<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_V_b, tmp_V_b, this);
  bool tmp_with_refr_input = get_with_refr_input();
  nest::updateValueParam<bool>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_with_refr_input, tmp_with_refr_input, this);
  bool tmp_reset_after_spike = get_reset_after_spike();
  nest::updateValueParam<bool>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_reset_after_spike, tmp_reset_after_spike, this);
  double tmp_I_e = get_I_e();
  nest::updateValueParam<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_I_e, tmp_I_e, this);

  // initial values for state variables in ODE or kernel
  double tmp_refr_spikes_buffer = get_refr_spikes_buffer();
  nest::updateValueParam<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_refr_spikes_buffer, tmp_refr_spikes_buffer, this);
  long tmp_refr_tick = get_refr_tick();
  nest::updateValueParam<long>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_refr_tick, tmp_refr_tick, this);
  double tmp_V_m = get_V_m();
  nest::updateValueParam<double>(__d, nest::gl_expf63dc1278f7b473ca66e84e1fbfca8ee_nestml_names::_V_m, tmp_V_m, this);
...
#endif /* #ifndef GL_EXPF63DC1278F7B473CA66E84E1FBFCA8EE_NESTML */
