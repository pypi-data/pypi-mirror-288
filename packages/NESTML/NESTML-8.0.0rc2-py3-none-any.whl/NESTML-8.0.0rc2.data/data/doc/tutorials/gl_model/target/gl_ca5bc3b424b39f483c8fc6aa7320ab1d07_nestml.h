...
/**
 *  gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml.h
 *
...
**/
#ifndef GL_CA5BC3B424B39F483C8FC6AA7320AB1D07_NESTML
#define GL_CA5BC3B424B39F483C8FC6AA7320AB1D07_NESTML
...
namespace nest
{
namespace gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml_names
{
    const Name _U( "U" );
    const Name _a( "a" );
...
/* BeginDocumentation
  Name: gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml
...
*/
class gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml : public nest::StructuralPlasticityNode
{
public:
  /**
  ...
  **/
  gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml(const gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml &);

  /**
   * Destructor.
  **/
  ~gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml() override;
...
private:
  ...
  **/
  ...
  friend class nest::RecordablesMap<gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml>;
  friend class nest::UniversalDataLogger<gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml>;
  ...
  **/
  struct Buffers_
  {
    Buffers_(gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml &);
    Buffers_(const Buffers_ &, gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml> logger_;
...
inline std::vector< double >& get_spike_inputs_grid_sum_()
{
  ...
  static nest::RecordablesMap<gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml> recordablesMap_;

}; /* neuron gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml */

inline nest_port_t gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
    // You should usually not change the code in this function.
...
inline nest_port_t gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml::get_status(DictionaryDatum &__d) const
{
  // parameters
  def<double>(__d, nest::gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml_names::_a, get_a());
  def<double>(__d, nest::gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml_names::_alpha_over_N, get_alpha_over_N());
  def<double>(__d, nest::gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml_names::_beta, get_beta());
  def<bool>(__d, nest::gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml_names::_reset_after_spike, get_reset_after_spike());

  // initial values for state variables in ODE or kernel
  def<double>(__d, nest::gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml_names::_U, get_U());
...
inline void gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml::set_status(const DictionaryDatum &__d)
{
  // parameters
  double tmp_a = get_a();
  nest::updateValueParam<double>(__d, nest::gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml_names::_a, tmp_a, this);
  double tmp_alpha_over_N = get_alpha_over_N();
  nest::updateValueParam<double>(__d, nest::gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml_names::_alpha_over_N, tmp_alpha_over_N, this);
  double tmp_beta = get_beta();
  nest::updateValueParam<double>(__d, nest::gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml_names::_beta, tmp_beta, this);
  bool tmp_reset_after_spike = get_reset_after_spike();
  nest::updateValueParam<bool>(__d, nest::gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml_names::_reset_after_spike, tmp_reset_after_spike, this);

  // initial values for state variables in ODE or kernel
  double tmp_U = get_U();
  nest::updateValueParam<double>(__d, nest::gl_ca5bc3b424b39f483c8fc6aa7320ab1d07_nestml_names::_U, tmp_U, this);
...
#endif /* #ifndef GL_CA5BC3B424B39F483C8FC6AA7320AB1D07_NESTML */
