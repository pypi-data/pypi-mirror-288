...
**/
#ifndef IZHIKEVICH_TUTORIAL_NESTML
#define IZHIKEVICH_TUTORIAL_NESTML
...
namespace nest
{
namespace izhikevich_tutorial_nestml_names
{
    const Name _v( "v" );
    const Name _u( "u" );
    const Name _a( "a" );
...
**/
extern "C" inline int izhikevich_tutorial_nestml_dynamics( double, const double y[], double f[], void* pnode );
...
/* BeginDocumentation
  Name: izhikevich_tutorial_nestml
...
void register_izhikevich_tutorial_nestml( const std::string& name );

class izhikevich_tutorial_nestml : public nest::StructuralPlasticityNode
{
public:
  /**
  ...
  **/
  izhikevich_tutorial_nestml(const izhikevich_tutorial_nestml &);

  /**
   * Destructor.
  **/
  ~izhikevich_tutorial_nestml() override;
...
private:
  ...
  **/
  ...
  friend class nest::RecordablesMap<izhikevich_tutorial_nestml>;
  friend class nest::UniversalDataLogger<izhikevich_tutorial_nestml>;
  ...
  **/
  struct Buffers_
  {
    Buffers_(izhikevich_tutorial_nestml &);
    Buffers_(const Buffers_ &, izhikevich_tutorial_nestml &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<izhikevich_tutorial_nestml> logger_;
...
inline nest::RingBuffer& get_I_e() {
  ...
  static nest::RecordablesMap<izhikevich_tutorial_nestml> recordablesMap_;
  friend int izhikevich_tutorial_nestml_dynamics( double, const double y[], double f[], void* pnode );


}; /* neuron izhikevich_tutorial_nestml */

inline nest_port_t izhikevich_tutorial_nestml::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t izhikevich_tutorial_nestml::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
    // You should usually not change the code in this function.
...
inline nest_port_t izhikevich_tutorial_nestml::handles_test_event(nest::CurrentEvent&, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest_port_t izhikevich_tutorial_nestml::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void izhikevich_tutorial_nestml::get_status(DictionaryDatum &__d) const
{
  // parameters
  def<double>(__d, nest::izhikevich_tutorial_nestml_names::_a, get_a());
  def<double>(__d, nest::izhikevich_tutorial_nestml_names::_b, get_b());
  def<double>(__d, nest::izhikevich_tutorial_nestml_names::_c, get_c());
  def<double>(__d, nest::izhikevich_tutorial_nestml_names::_d, get_d());

  // initial values for state variables in ODE or kernel
  def<double>(__d, nest::izhikevich_tutorial_nestml_names::_v, get_v());
  def<double>(__d, nest::izhikevich_tutorial_nestml_names::_u, get_u());
...
inline void izhikevich_tutorial_nestml::set_status(const DictionaryDatum &__d)
{
  // parameters
  double tmp_a = get_a();
  nest::updateValueParam<double>(__d, nest::izhikevich_tutorial_nestml_names::_a, tmp_a, this);
  double tmp_b = get_b();
  nest::updateValueParam<double>(__d, nest::izhikevich_tutorial_nestml_names::_b, tmp_b, this);
  double tmp_c = get_c();
  nest::updateValueParam<double>(__d, nest::izhikevich_tutorial_nestml_names::_c, tmp_c, this);
  double tmp_d = get_d();
  nest::updateValueParam<double>(__d, nest::izhikevich_tutorial_nestml_names::_d, tmp_d, this);

  // initial values for state variables in ODE or kernel
  double tmp_v = get_v();
  nest::updateValueParam<double>(__d, nest::izhikevich_tutorial_nestml_names::_v, tmp_v, this);
  double tmp_u = get_u();
  nest::updateValueParam<double>(__d, nest::izhikevich_tutorial_nestml_names::_u, tmp_u, this);
...
#endif /* #ifndef IZHIKEVICH_TUTORIAL_NESTML */
