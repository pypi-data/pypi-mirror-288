/**
 *  stdp_vogels_nestml__with_iaf_psc_delta_nestml.h
 *
 ...
 *
 *  Generated from NESTML at time: 2024-04-04 10:38:45.007917
**/

#ifndef STDP_VOGELS_NESTML__WITH_IAF_PSC_DELTA_NESTML_H
#define STDP_VOGELS_NESTML__WITH_IAF_PSC_DELTA_NESTML_H
...
void register_stdp_vogels_nestml__with_iaf_psc_delta_nestml( const std::string& name );

namespace stdp_vogels_nestml__with_iaf_psc_delta_nestml_names
{
    const Name _w( "w" );
...
class stdp_vogels_nestml__with_iaf_psc_delta_nestmlCommonSynapseProperties : public CommonSynapseProperties {
public:

    stdp_vogels_nestml__with_iaf_psc_delta_nestmlCommonSynapseProperties()
...
class stdp_vogels_nestml__with_iaf_psc_delta_nestml : public Connection< targetidentifierT >
{
  typedef iaf_psc_delta_nestml__with_stdp_vogels_nestml post_neuron_t;
...
private:
  ...
  **/
  inline void
  update_internal_state_(double t_start, double timestep, const stdp_vogels_nestml__with_iaf_psc_delta_nestmlCommonSynapseProperties& cp);

  void recompute_internal_variables();

public:
  // this line determines which common properties to use
  typedef stdp_vogels_nestml__with_iaf_psc_delta_nestmlCommonSynapseProperties CommonPropertiesType;
  ...
  */
  stdp_vogels_nestml__with_iaf_psc_delta_nestml();
  ...
  */
  stdp_vogels_nestml__with_iaf_psc_delta_nestml( const stdp_vogels_nestml__with_iaf_psc_delta_nestml& rhs );
  ...
  **/
    ...
    const CommonPropertiesType& cp )
  {
    ...
    try {
      dynamic_cast<iaf_psc_delta_nestml__with_stdp_vogels_nestml&>(t);
    }
    catch (std::bad_cast &exp) {
      std::cout << "wrong type of neuron connected! Synapse 'stdp_vogels_nestml__with_iaf_psc_delta_nestml' will only work with neuron 'iaf_psc_delta_nestml__with_stdp_vogels_nestml'.\n";
      exit(1);
    }
  ...
  bool
  send( Event& e, const size_t tid, const stdp_vogels_nestml__with_iaf_psc_delta_nestmlCommonSynapseProperties& cp )
  {
...
#ifdef DEBUG
    std::cout << "stdp_vogels_nestml__with_iaf_psc_delta_nestml::send(): handling pre spike at t = " << __t_spike << std::endl;
#endif
    // use accessor functions (inherited from Connection< >) to obtain delay and target
    iaf_psc_delta_nestml__with_stdp_vogels_nestml* __target = static_cast<iaf_psc_delta_nestml__with_stdp_vogels_nestml*>(get_target(tid));
    assert(__target);
...

    {
      ...
      **/
      S_.w += P_.lambda * (get_pre_trace() + ((post_neuron_t*)(__target))->get_post_trace__for_stdp_vogels_nestml(_tr_t));
    ...
    **/
...

    {
        ...
        **/
        S_.w += P_.lambda * (get_pre_trace() + ((post_neuron_t*)(__target))->get_post_trace__for_stdp_vogels_nestml(_tr_t) - P_.offset);
...
void
register_stdp_vogels_nestml__with_iaf_psc_delta_nestml( const std::string& name )
{
  nest::register_connection_model< stdp_vogels_nestml__with_iaf_psc_delta_nestml >( name );
}
template < typename targetidentifierT >
constexpr ConnectionModelProperties stdp_vogels_nestml__with_iaf_psc_delta_nestml< targetidentifierT >::properties;


template < typename targetidentifierT >
void
stdp_vogels_nestml__with_iaf_psc_delta_nestml< targetidentifierT >::get_status( DictionaryDatum& __d ) const
{
  ...
  def<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_lambda, get_lambda());  
  def<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_offset, get_offset());  
  def<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_tau_tr_pre, get_tau_tr_pre());  
  def<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_tau_tr_post, get_tau_tr_post());  
  def<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_alpha, get_alpha());  
  def<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_mu_plus, get_mu_plus());  
  def<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_mu_minus, get_mu_minus());  
  def<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_Wmax, get_Wmax());  
  def<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_Wmin, get_Wmin());

  // initial values for state variables in ODE or kernel  
  def<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_w, get_w());
  def<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_pre_trace_kernel__X__pre_spikes, get_pre_trace_kernel__X__pre_spikes());
}

template < typename targetidentifierT >
void
stdp_vogels_nestml__with_iaf_psc_delta_nestml< targetidentifierT >::set_status( const DictionaryDatum& __d,
  ConnectorModel& cm )
{
  // parameters  
  double tmp_d = get_d();
  updateValue<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_d, tmp_d);  
  double tmp_lambda = get_lambda();
  updateValue<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_lambda, tmp_lambda);  
  double tmp_offset = get_offset();
  updateValue<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_offset, tmp_offset);  
  double tmp_tau_tr_pre = get_tau_tr_pre();
  updateValue<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_tau_tr_pre, tmp_tau_tr_pre);  
  double tmp_tau_tr_post = get_tau_tr_post();
  updateValue<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_tau_tr_post, tmp_tau_tr_post);  
  double tmp_alpha = get_alpha();
  updateValue<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_alpha, tmp_alpha);  
  double tmp_mu_plus = get_mu_plus();
  updateValue<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_mu_plus, tmp_mu_plus);  
  double tmp_mu_minus = get_mu_minus();
  updateValue<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_mu_minus, tmp_mu_minus);  
  double tmp_Wmax = get_Wmax();
  updateValue<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_Wmax, tmp_Wmax);  
  double tmp_Wmin = get_Wmin();
  updateValue<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_Wmin, tmp_Wmin);

  // initial values for state variables in ODE or kernel  
  double tmp_w = get_w();
  updateValue<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_w, tmp_w);
  double tmp_pre_trace_kernel__X__pre_spikes = get_pre_trace_kernel__X__pre_spikes();
  updateValue<double>(__d, nest::stdp_vogels_nestml__with_iaf_psc_delta_nestml_names::_pre_trace_kernel__X__pre_spikes, tmp_pre_trace_kernel__X__pre_spikes);
...
**/
template < typename targetidentifierT >
void stdp_vogels_nestml__with_iaf_psc_delta_nestml< targetidentifierT >::recompute_internal_variables()
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
**/
template < typename targetidentifierT >
stdp_vogels_nestml__with_iaf_psc_delta_nestml< targetidentifierT >::stdp_vogels_nestml__with_iaf_psc_delta_nestml() : ConnectionBase()
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
**/
template < typename targetidentifierT >
stdp_vogels_nestml__with_iaf_psc_delta_nestml< targetidentifierT >::stdp_vogels_nestml__with_iaf_psc_delta_nestml( const stdp_vogels_nestml__with_iaf_psc_delta_nestml< targetidentifierT >& rhs )
: ConnectionBase( rhs )
{
    P_.d = rhs.P_.d;
    P_.lambda = rhs.P_.lambda;
    P_.offset = rhs.P_.offset;
...
template < typename targetidentifierT >
inline void
stdp_vogels_nestml__with_iaf_psc_delta_nestml< targetidentifierT >::update_internal_state_(double t_start, double timestep, const stdp_vogels_nestml__with_iaf_psc_delta_nestmlCommonSynapseProperties& cp)
{
  if (timestep < 1E-12)
  {
#ifdef DEBUG
...
#endif /* #ifndef STDP_VOGELS_NESTML__WITH_IAF_PSC_DELTA_NESTML_H */