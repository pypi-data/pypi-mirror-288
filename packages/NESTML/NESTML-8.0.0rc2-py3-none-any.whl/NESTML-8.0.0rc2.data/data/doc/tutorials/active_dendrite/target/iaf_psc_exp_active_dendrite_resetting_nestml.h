...
/**
 *  iaf_psc_exp_active_dendrite_resetting_nestml.h
 *
...
**/
#ifndef IAF_PSC_EXP_ACTIVE_DENDRITE_RESETTING_NESTML
#define IAF_PSC_EXP_ACTIVE_DENDRITE_RESETTING_NESTML
...
namespace nest
{
namespace iaf_psc_exp_active_dendrite_resetting_nestml_names
{
    const Name _V_m( "V_m" );
...
/* BeginDocumentation
  Name: iaf_psc_exp_active_dendrite_resetting_nestml
...
void register_iaf_psc_exp_active_dendrite_resetting_nestml( const std::string& name );

class iaf_psc_exp_active_dendrite_resetting_nestml : public nest::StructuralPlasticityNode
{
public:
  /**
  ...
  **/
  iaf_psc_exp_active_dendrite_resetting_nestml(const iaf_psc_exp_active_dendrite_resetting_nestml &);

  /**
   * Destructor.
  **/
  ~iaf_psc_exp_active_dendrite_resetting_nestml() override;
...
private:
  ...
  **/
  ...
  friend class nest::RecordablesMap<iaf_psc_exp_active_dendrite_resetting_nestml>;
  friend class nest::UniversalDataLogger<iaf_psc_exp_active_dendrite_resetting_nestml>;
  ...
  **/
  struct Buffers_
  {
    Buffers_(iaf_psc_exp_active_dendrite_resetting_nestml &);
    Buffers_(const Buffers_ &, iaf_psc_exp_active_dendrite_resetting_nestml &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<iaf_psc_exp_active_dendrite_resetting_nestml> logger_;
...
inline std::vector< double >& get_spike_inputs_grid_sum_()
{
  ...
  static nest::RecordablesMap<iaf_psc_exp_active_dendrite_resetting_nestml> recordablesMap_;

}; /* neuron iaf_psc_exp_active_dendrite_resetting_nestml */

inline nest_port_t iaf_psc_exp_active_dendrite_resetting_nestml::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t iaf_psc_exp_active_dendrite_resetting_nestml::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
    // You should usually not change the code in this function.
...
inline nest_port_t iaf_psc_exp_active_dendrite_resetting_nestml::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void iaf_psc_exp_active_dendrite_resetting_nestml::get_status(DictionaryDatum &__d) const
{
  // parameters
  def<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_C_m, get_C_m());
  def<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_tau_m, get_tau_m());
  def<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_tau_syn, get_tau_syn());
  def<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_V_th, get_V_th());
  def<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_V_reset, get_V_reset());
  def<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_I_e, get_I_e());
  def<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_E_L, get_E_L());
  def<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_I_th, get_I_th());
  def<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_I_dAP_peak, get_I_dAP_peak());
  def<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_T_dAP, get_T_dAP());

  // initial values for state variables in ODE or kernel
  def<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_V_m, get_V_m());
  def<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_t_dAP, get_t_dAP());
  def<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_I_dAP, get_I_dAP());
  def<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_enable_I_syn, get_enable_I_syn());
  def<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_syn_kernel__X__spikes_in, get_syn_kernel__X__spikes_in());
  def<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_syn_kernel__X__spikes_in__d, get_syn_kernel__X__spikes_in__d());
...
inline void iaf_psc_exp_active_dendrite_resetting_nestml::set_status(const DictionaryDatum &__d)
{
  // parameters
  double tmp_C_m = get_C_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_C_m, tmp_C_m, this);
  double tmp_tau_m = get_tau_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_tau_m, tmp_tau_m, this);
  double tmp_tau_syn = get_tau_syn();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_tau_syn, tmp_tau_syn, this);
  double tmp_V_th = get_V_th();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_V_th, tmp_V_th, this);
  double tmp_V_reset = get_V_reset();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_V_reset, tmp_V_reset, this);
  double tmp_I_e = get_I_e();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_I_e, tmp_I_e, this);
  double tmp_E_L = get_E_L();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_E_L, tmp_E_L, this);
  double tmp_I_th = get_I_th();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_I_th, tmp_I_th, this);
  double tmp_I_dAP_peak = get_I_dAP_peak();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_I_dAP_peak, tmp_I_dAP_peak, this);
  double tmp_T_dAP = get_T_dAP();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_T_dAP, tmp_T_dAP, this);

  // initial values for state variables in ODE or kernel
  double tmp_V_m = get_V_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_V_m, tmp_V_m, this);
  double tmp_t_dAP = get_t_dAP();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_t_dAP, tmp_t_dAP, this);
  double tmp_I_dAP = get_I_dAP();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_I_dAP, tmp_I_dAP, this);
  double tmp_enable_I_syn = get_enable_I_syn();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_enable_I_syn, tmp_enable_I_syn, this);
  double tmp_syn_kernel__X__spikes_in = get_syn_kernel__X__spikes_in();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_syn_kernel__X__spikes_in, tmp_syn_kernel__X__spikes_in, this);
  double tmp_syn_kernel__X__spikes_in__d = get_syn_kernel__X__spikes_in__d();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_active_dendrite_resetting_nestml_names::_syn_kernel__X__spikes_in__d, tmp_syn_kernel__X__spikes_in__d, this);
...
#endif /* #ifndef IAF_PSC_EXP_ACTIVE_DENDRITE_RESETTING_NESTML */
