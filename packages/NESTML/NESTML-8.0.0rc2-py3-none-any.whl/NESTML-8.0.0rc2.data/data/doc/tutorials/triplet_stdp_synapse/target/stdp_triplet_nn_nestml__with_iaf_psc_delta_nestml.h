/**
 *  stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml.h
 *
 ...
 *
 *  Generated from NESTML at time: 2024-04-04 09:02:26.460360
**/

#ifndef STDP_TRIPLET_NN_NESTML__WITH_IAF_PSC_DELTA_NESTML_H
#define STDP_TRIPLET_NN_NESTML__WITH_IAF_PSC_DELTA_NESTML_H
...
void register_stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml( const std::string& name );

namespace stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names
{
    const Name _w( "w" );
...
class stdp_triplet_nn_nestml__with_iaf_psc_delta_nestmlCommonSynapseProperties : public CommonSynapseProperties {
public:

    stdp_triplet_nn_nestml__with_iaf_psc_delta_nestmlCommonSynapseProperties()
...
class stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml : public Connection< targetidentifierT >
{
  typedef iaf_psc_delta_nestml__with_stdp_triplet_nn_nestml post_neuron_t;
...
private:
  ...
  **/
  inline void
  update_internal_state_(double t_start, double timestep, const stdp_triplet_nn_nestml__with_iaf_psc_delta_nestmlCommonSynapseProperties& cp);

  void recompute_internal_variables();

public:
  // this line determines which common properties to use
  typedef stdp_triplet_nn_nestml__with_iaf_psc_delta_nestmlCommonSynapseProperties CommonPropertiesType;
  ...
  */
  stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml();
  ...
  */
  stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml( const stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml& rhs );
  ...
  **/
    ...
    const CommonPropertiesType& cp )
  {
    ...
    try {
      dynamic_cast<iaf_psc_delta_nestml__with_stdp_triplet_nn_nestml&>(t);
    }
    catch (std::bad_cast &exp) {
      std::cout << "wrong type of neuron connected! Synapse 'stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml' will only work with neuron 'iaf_psc_delta_nestml__with_stdp_triplet_nn_nestml'.\n";
      exit(1);
    }
  ...
  bool
  send( Event& e, const size_t tid, const stdp_triplet_nn_nestml__with_iaf_psc_delta_nestmlCommonSynapseProperties& cp )
  {
...
#ifdef DEBUG
    std::cout << "stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml::send(): handling pre spike at t = " << __t_spike << std::endl;
#endif
    // use accessor functions (inherited from Connection< >) to obtain delay and target
    iaf_psc_delta_nestml__with_stdp_triplet_nn_nestml* __target = static_cast<iaf_psc_delta_nestml__with_stdp_triplet_nn_nestml*>(get_target(tid));
    assert(__target);
...

    {
      ...
      **/
      double w_ = S_.w + S_.tr_r1 * (P_.A2_plus + P_.A3_plus * ((post_neuron_t*)(__target))->get_tr_o2__for_stdp_triplet_nn_nestml(_tr_t));
    ...
    **/
...

    {
        ...
        **/
        S_.tr_r1 = 1;
        S_.tr_r2 = 1;
        double w_ = S_.w - ((post_neuron_t*)(__target))->get_tr_o1__for_stdp_triplet_nn_nestml(_tr_t) * (P_.A2_minus + P_.A3_minus * S_.tr_r2);
...
void
register_stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml( const std::string& name )
{
  nest::register_connection_model< stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml >( name );
}
template < typename targetidentifierT >
constexpr ConnectionModelProperties stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml< targetidentifierT >::properties;


template < typename targetidentifierT >
void
stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml< targetidentifierT >::get_status( DictionaryDatum& __d ) const
{
  ...
  def<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_tau_plus, get_tau_plus());  
  def<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_tau_x, get_tau_x());  
  def<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_tau_minus, get_tau_minus());  
  def<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_tau_y, get_tau_y());  
  def<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_A2_plus, get_A2_plus());  
  def<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_A3_plus, get_A3_plus());  
  def<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_A2_minus, get_A2_minus());  
  def<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_A3_minus, get_A3_minus());  
  def<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_Wmax, get_Wmax());  
  def<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_Wmin, get_Wmin());

  // initial values for state variables in ODE or kernel  
  def<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_w, get_w());
  def<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_tr_r1, get_tr_r1());
  def<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_tr_r2, get_tr_r2());
}

template < typename targetidentifierT >
void
stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml< targetidentifierT >::set_status( const DictionaryDatum& __d,
  ConnectorModel& cm )
{
  // parameters  
  double tmp_d = get_d();
  updateValue<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_d, tmp_d);  
  double tmp_tau_plus = get_tau_plus();
  updateValue<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_tau_plus, tmp_tau_plus);  
  double tmp_tau_x = get_tau_x();
  updateValue<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_tau_x, tmp_tau_x);  
  double tmp_tau_minus = get_tau_minus();
  updateValue<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_tau_minus, tmp_tau_minus);  
  double tmp_tau_y = get_tau_y();
  updateValue<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_tau_y, tmp_tau_y);  
  double tmp_A2_plus = get_A2_plus();
  updateValue<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_A2_plus, tmp_A2_plus);  
  double tmp_A3_plus = get_A3_plus();
  updateValue<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_A3_plus, tmp_A3_plus);  
  double tmp_A2_minus = get_A2_minus();
  updateValue<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_A2_minus, tmp_A2_minus);  
  double tmp_A3_minus = get_A3_minus();
  updateValue<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_A3_minus, tmp_A3_minus);  
  double tmp_Wmax = get_Wmax();
  updateValue<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_Wmax, tmp_Wmax);  
  double tmp_Wmin = get_Wmin();
  updateValue<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_Wmin, tmp_Wmin);

  // initial values for state variables in ODE or kernel  
  double tmp_w = get_w();
  updateValue<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_w, tmp_w);
  double tmp_tr_r1 = get_tr_r1();
  updateValue<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_tr_r1, tmp_tr_r1);
  double tmp_tr_r2 = get_tr_r2();
  updateValue<double>(__d, nest::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml_names::_tr_r2, tmp_tr_r2);
...
**/
template < typename targetidentifierT >
void stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml< targetidentifierT >::recompute_internal_variables()
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
**/
template < typename targetidentifierT >
stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml< targetidentifierT >::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml() : ConnectionBase()
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
**/
template < typename targetidentifierT >
stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml< targetidentifierT >::stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml( const stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml< targetidentifierT >& rhs )
: ConnectionBase( rhs )
{
    P_.d = rhs.P_.d;
...
template < typename targetidentifierT >
inline void
stdp_triplet_nn_nestml__with_iaf_psc_delta_nestml< targetidentifierT >::update_internal_state_(double t_start, double timestep, const stdp_triplet_nn_nestml__with_iaf_psc_delta_nestmlCommonSynapseProperties& cp)
{
  if (timestep < 1E-12)
  {
#ifdef DEBUG
...
#endif /* #ifndef STDP_TRIPLET_NN_NESTML__WITH_IAF_PSC_DELTA_NESTML_H */