...
inline nest_port_t iaf_psc_exp_nestml::handles_test_event(nest::CurrentEvent&, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void iaf_psc_exp_nestml::get_status(DictionaryDatum &__d) const
{
  ...
  def<double>(__d, nest::iaf_psc_exp_nestml_names::_tau_syn_inh, get_tau_syn_inh());
  def<double>(__d, nest::iaf_psc_exp_nestml_names::_tau_syn_exc, get_tau_syn_exc());
  def<double>(__d, nest::iaf_psc_exp_nestml_names::_t_ref, get_t_ref());
  def<double>(__d, nest::iaf_psc_exp_nestml_names::_E_L, get_E_L());
  def<double>(__d, nest::iaf_psc_exp_nestml_names::_V_reset, get_V_reset());
  def<double>(__d, nest::iaf_psc_exp_nestml_names::_V_th, get_V_th());
  def<double>(__d, nest::iaf_psc_exp_nestml_names::_I_e, get_I_e());

  // initial values for state variables in ODE or kernel
  def<long>(__d, nest::iaf_psc_exp_nestml_names::_r, get_r());
  def<double>(__d, nest::iaf_psc_exp_nestml_names::_V_m, get_V_m());
  def<double>(__d, nest::iaf_psc_exp_nestml_names::_I_kernel_exc__X__exc_spikes, get_I_kernel_exc__X__exc_spikes());
  def<double>(__d, nest::iaf_psc_exp_nestml_names::_I_kernel_inh__X__inh_spikes, get_I_kernel_inh__X__inh_spikes());
...
inline void iaf_psc_exp_nestml::set_status(const DictionaryDatum &__d)
{
  ...
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_nestml_names::_tau_syn_inh, tmp_tau_syn_inh, this);
  double tmp_tau_syn_exc = get_tau_syn_exc();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_nestml_names::_tau_syn_exc, tmp_tau_syn_exc, this);
  double tmp_t_ref = get_t_ref();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_nestml_names::_t_ref, tmp_t_ref, this);
  ...
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_nestml_names::_V_reset, tmp_V_reset, this);
  double tmp_V_th = get_V_th();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_nestml_names::_V_th, tmp_V_th, this);
  double tmp_I_e = get_I_e();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_nestml_names::_I_e, tmp_I_e, this);

  // initial values for state variables in ODE or kernel
  long tmp_r = get_r();
  nest::updateValueParam<long>(__d, nest::iaf_psc_exp_nestml_names::_r, tmp_r, this);
  ...
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_nestml_names::_I_kernel_exc__X__exc_spikes, tmp_I_kernel_exc__X__exc_spikes, this);
  double tmp_I_kernel_inh__X__inh_spikes = get_I_kernel_inh__X__inh_spikes();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_nestml_names::_I_kernel_inh__X__inh_spikes, tmp_I_kernel_inh__X__inh_spikes, this);
