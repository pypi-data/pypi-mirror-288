...
**/
#ifndef IAF_PSC_DELTA_NEURON_NESTML
#define IAF_PSC_DELTA_NEURON_NESTML
...
namespace nest
{
namespace iaf_psc_delta_neuron_nestml_names
{
    const Name _V_m( "V_m" );
...
/* BeginDocumentation
  Name: iaf_psc_delta_neuron_nestml
...
void register_iaf_psc_delta_neuron_nestml( const std::string& name );

class iaf_psc_delta_neuron_nestml : public nest::StructuralPlasticityNode
{
public:
  /**
  ...
  **/
  iaf_psc_delta_neuron_nestml(const iaf_psc_delta_neuron_nestml &);

  /**
   * Destructor.
  **/
  ~iaf_psc_delta_neuron_nestml() override;
...
private:
  ...
  **/
  ...
  friend class nest::RecordablesMap<iaf_psc_delta_neuron_nestml>;
  friend class nest::UniversalDataLogger<iaf_psc_delta_neuron_nestml>;
  ...
  **/
  struct Buffers_
  {
    Buffers_(iaf_psc_delta_neuron_nestml &);
    Buffers_(const Buffers_ &, iaf_psc_delta_neuron_nestml &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<iaf_psc_delta_neuron_nestml> logger_;
...
inline nest::RingBuffer& get_I_stim() {
  ...
  static nest::RecordablesMap<iaf_psc_delta_neuron_nestml> recordablesMap_;

}; /* neuron iaf_psc_delta_neuron_nestml */

inline nest_port_t iaf_psc_delta_neuron_nestml::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t iaf_psc_delta_neuron_nestml::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
    // You should usually not change the code in this function.
...
inline nest_port_t iaf_psc_delta_neuron_nestml::handles_test_event(nest::CurrentEvent&, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest_port_t iaf_psc_delta_neuron_nestml::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void iaf_psc_delta_neuron_nestml::get_status(DictionaryDatum &__d) const
{
  // parameters
  def<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_tau_m, get_tau_m());
  def<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_C_m, get_C_m());
  def<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_refr_T, get_refr_T());
  def<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_tau_syn, get_tau_syn());
  def<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_E_L, get_E_L());
  def<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_V_reset, get_V_reset());
  def<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_V_th, get_V_th());
  def<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_V_min, get_V_min());
  def<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_I_e, get_I_e());

  // initial values for state variables in ODE or kernel
  def<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_V_m, get_V_m());
  def<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_refr_t, get_refr_t());
  def<bool>(__d, nest::iaf_psc_delta_neuron_nestml_names::_is_refractory, get_is_refractory());
...
inline void iaf_psc_delta_neuron_nestml::set_status(const DictionaryDatum &__d)
{
  // parameters
  double tmp_tau_m = get_tau_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_tau_m, tmp_tau_m, this);
  double tmp_C_m = get_C_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_C_m, tmp_C_m, this);
  double tmp_refr_T = get_refr_T();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_refr_T, tmp_refr_T, this);
  double tmp_tau_syn = get_tau_syn();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_tau_syn, tmp_tau_syn, this);
  double tmp_E_L = get_E_L();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_E_L, tmp_E_L, this);
  double tmp_V_reset = get_V_reset();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_V_reset, tmp_V_reset, this);
  double tmp_V_th = get_V_th();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_V_th, tmp_V_th, this);
  double tmp_V_min = get_V_min();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_V_min, tmp_V_min, this);
  double tmp_I_e = get_I_e();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_I_e, tmp_I_e, this);

  // initial values for state variables in ODE or kernel
  double tmp_V_m = get_V_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_V_m, tmp_V_m, this);
  double tmp_refr_t = get_refr_t();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_neuron_nestml_names::_refr_t, tmp_refr_t, this);
  bool tmp_is_refractory = get_is_refractory();
  nest::updateValueParam<bool>(__d, nest::iaf_psc_delta_neuron_nestml_names::_is_refractory, tmp_is_refractory, this);
...
#endif /* #ifndef IAF_PSC_DELTA_NEURON_NESTML */
