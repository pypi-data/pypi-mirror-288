...
/**
 *  iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml.h
 *
...
**/
#ifndef IAF_PSC_DELTA_NESTML__WITH_NEUROMODULATED_STDP_NESTML
#define IAF_PSC_DELTA_NESTML__WITH_NEUROMODULATED_STDP_NESTML
...
namespace nest
{
namespace iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names
{
...
class histentry__iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml
{
public:
  histentry__iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml( double t,
...
/* BeginDocumentation
  Name: iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml
...
void register_iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml( const std::string& name );

class iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml : public nest::StructuralPlasticityNode
{
public:
  /**
  ...
  **/
  iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml(const iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml &);

  /**
   * Destructor.
  **/
  ~iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml() override;
...
private:
  ...
  std::deque< histentry__iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml > history_;
...
private:
  ...
  **/
  ...
  friend class nest::RecordablesMap<iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml>;
  friend class nest::UniversalDataLogger<iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml>;
  ...
  **/
  struct Buffers_
  {
    Buffers_(iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml &);
    Buffers_(const Buffers_ &, iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml> logger_;
...
inline nest::RingBuffer& get_I_stim() {
  ...
  static nest::RecordablesMap<iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml> recordablesMap_;

}; /* neuron iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml */

inline nest_port_t iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
    // You should usually not change the code in this function.
...
inline nest_port_t iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml::handles_test_event(nest::CurrentEvent&, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest_port_t iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml::get_status(DictionaryDatum &__d) const
{
  // parameters
  def<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_tau_m, get_tau_m());
  def<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_C_m, get_C_m());
  def<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_t_ref, get_t_ref());
  def<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_tau_syn, get_tau_syn());
  def<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_E_L, get_E_L());
  def<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_V_reset, get_V_reset());
  def<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_V_th, get_V_th());
  def<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_V_min, get_V_min());
  def<bool>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_with_refr_input, get_with_refr_input());
  def<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_I_e, get_I_e());
  def<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_tau_tr_post__for_neuromodulated_stdp_nestml, get_tau_tr_post__for_neuromodulated_stdp_nestml());

  // initial values for state variables in ODE or kernel
  def<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_refr_spikes_buffer, get_refr_spikes_buffer());
  def<long>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_r, get_r());
  def<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_V_m, get_V_m());
  def<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_post_tr__for_neuromodulated_stdp_nestml, get_post_tr__for_neuromodulated_stdp_nestml());
...
inline void iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml::set_status(const DictionaryDatum &__d)
{
  // parameters
  double tmp_tau_m = get_tau_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_tau_m, tmp_tau_m, this);
  double tmp_C_m = get_C_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_C_m, tmp_C_m, this);
  double tmp_t_ref = get_t_ref();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_t_ref, tmp_t_ref, this);
  double tmp_tau_syn = get_tau_syn();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_tau_syn, tmp_tau_syn, this);
  double tmp_E_L = get_E_L();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_E_L, tmp_E_L, this);
  double tmp_V_reset = get_V_reset();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_V_reset, tmp_V_reset, this);
  double tmp_V_th = get_V_th();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_V_th, tmp_V_th, this);
  double tmp_V_min = get_V_min();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_V_min, tmp_V_min, this);
  bool tmp_with_refr_input = get_with_refr_input();
  nest::updateValueParam<bool>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_with_refr_input, tmp_with_refr_input, this);
  double tmp_I_e = get_I_e();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_I_e, tmp_I_e, this);
  double tmp_tau_tr_post__for_neuromodulated_stdp_nestml = get_tau_tr_post__for_neuromodulated_stdp_nestml();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_tau_tr_post__for_neuromodulated_stdp_nestml, tmp_tau_tr_post__for_neuromodulated_stdp_nestml, this);

  // initial values for state variables in ODE or kernel
  double tmp_refr_spikes_buffer = get_refr_spikes_buffer();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_refr_spikes_buffer, tmp_refr_spikes_buffer, this);
  long tmp_r = get_r();
  nest::updateValueParam<long>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_r, tmp_r, this);
  double tmp_V_m = get_V_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_V_m, tmp_V_m, this);
  double tmp_post_tr__for_neuromodulated_stdp_nestml = get_post_tr__for_neuromodulated_stdp_nestml();
  nest::updateValueParam<double>(__d, nest::iaf_psc_delta_nestml__with_neuromodulated_stdp_nestml_names::_post_tr__for_neuromodulated_stdp_nestml, tmp_post_tr__for_neuromodulated_stdp_nestml, this);
...
#endif /* #ifndef IAF_PSC_DELTA_NESTML__WITH_NEUROMODULATED_STDP_NESTML */
