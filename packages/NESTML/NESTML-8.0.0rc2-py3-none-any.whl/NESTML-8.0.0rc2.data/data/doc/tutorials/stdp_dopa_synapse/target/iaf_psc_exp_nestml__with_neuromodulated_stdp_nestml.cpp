// #define DEBUG 1
/*
 *  iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml.cpp
 *
...
void
register_iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml( const std::string& name )
{
  nest::register_node_model< iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml >( name );
}

// ---------------------------------------------------------------------------
//   Recordables map
// ---------------------------------------------------------------------------
nest::RecordablesMap<iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml> iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::recordablesMap_;
namespace nest
{

  // Override the create() method with one call to RecordablesMap::insert_()
  // for each quantity to be recorded.
template <> void RecordablesMap<iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml>::create()
  {
    // add state variables to recordables map
   insert_(iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml_names::_V_m, &iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::get_V_m);
   insert_(iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml_names::_post_tr__for_neuromodulated_stdp_nestml, &iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::get_post_tr__for_neuromodulated_stdp_nestml);
   insert_(iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml_names::_I_kernel_inh__X__inh_spikes, &iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::get_I_kernel_inh__X__inh_spikes);
   insert_(iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml_names::_I_kernel_exc__X__exc_spikes, &iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::get_I_kernel_exc__X__exc_spikes);

    // Add vector variables  
  }
}
std::vector< std::tuple< int, int > > iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::rport_to_nestml_buffer_idx =
{
  
  { iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::EXC_SPIKES, iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::INH_SPIKES },
};

// ---------------------------------------------------------------------------
//   Default constructors defining default parameters and state
//   Note: the implementation is empty. The initialization is of variables
//   is a part of iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml's constructor.
// ---------------------------------------------------------------------------

iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::Parameters_::Parameters_()
{
}

iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::State_::State_()
{
}
...
iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::Buffers_::Buffers_(iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml &n):
  logger_(n)
...
iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::Buffers_::Buffers_(const Buffers_ &, iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml &n):
  logger_(n)
  , spike_inputs_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
  , spike_inputs_grid_sum_( std::vector< double >( NUM_SPIKE_RECEPTORS ) )
{
...
iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml():StructuralPlasticityNode(), P_(), S_(), B_(*this)
{
...
iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml(const iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml& __n):
...
iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::~iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml()
{
}
...
// ---------------------------------------------------------------------------
void iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::calibrate_time( const nest::TimeConverter& tc )
{
  LOG( nest::M_WARNING,
...
void iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::init_state_internal_()
{
#ifdef DEBUG
  std::cout << "iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::init_state_internal_()" << std::endl;
#endif
...
void iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::init_buffers_()
{
#ifdef DEBUG
  std::cout << "iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::init_buffers_()" << std::endl;
#endif
  // spike input buffers
...
void iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::recompute_internal_variables(bool exclude_timestep) {
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
  ...
  if (exclude_timestep) {    
      ...
      V_.__P__post_tr__for_neuromodulated_stdp_nestml__post_tr__for_neuromodulated_stdp_nestml = 1.0 * std::exp((-V_.__h) / P_.tau_tr_post__for_neuromodulated_stdp_nestml); // as real
...
void iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::pre_run_hook() {
  B_.logger_.init();
...
void iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::update(nest::Time const & origin,const long from, const long to)
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
void iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::handle(nest::DataLoggingRequest& e)
{
  B_.logger_.handle(e);
}


void iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::handle(nest::SpikeEvent &e)
{
  ...
  else
  {
    ...
    if ( nestml_buffer_idx == iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::PORT_NOT_AVAILABLE )
    {
      nestml_buffer_idx = std::get<0>(rport_to_nestml_buffer_idx[e.get_rport()]);
    }
    weight = -weight;
...
void iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::handle(nest::CurrentEvent& e)
{
  assert(e.get_delay_steps() > 0);
...
inline double
iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::get_spiketime_ms() const
{
  return last_spike_;
}
...
void
iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::register_stdp_connection( double t_first_read, double delay )
{
  ...
  for ( std::deque< histentry__iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml >::iterator runner = history_.begin();
...
void
iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::get_history__( double t1,
  double t2,
  ...
  std::deque< histentry__iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml >::iterator* finish )
{
  *finish = history_.end();
  ...
  std::deque< histentry__iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml >::reverse_iterator runner = history_.rbegin();
...
void
iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::set_spiketime( nest::Time const& t_sp, double offset )
{
    ...
    last_spike_ = t_sp_ms;
    history_.push_back( histentry__iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml( last_spike_
...
void
iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::clear_history()
{
  last_spike_ = -1.0;
  history_.clear();
}
...
double
iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::get_post_tr__for_neuromodulated_stdp_nestml( double t, const bool before_increment )
{
#ifdef DEBUG
  std::cout << "iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::get_post_tr__for_neuromodulated_stdp_nestml: getting value at t = " << t << std::endl;
#endif
  ...
  {
#ifdef DEBUG
    std::cout << "iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::get_post_tr__for_neuromodulated_stdp_nestml: \thistory empty, returning initial value = " << post_tr__for_neuromodulated_stdp_nestml__iv << std::endl;
#endif
  ...
  while ( i >= 0 )
  {
    ...
    {
#ifdef DEBUG
      std::cout<<"iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::get_post_tr__for_neuromodulated_stdp_nestml: \tspike occurred at history[i].t_ = " << history_[i].t_ << std::endl;
#endif
...
#ifdef DEBUG
      std::cout << "iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::get_post_tr__for_neuromodulated_stdp_nestml: \treturning " << S_.post_tr__for_neuromodulated_stdp_nestml << std::endl;
#endif
...
#ifdef DEBUG
    std::cout << "iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::get_post_tr__for_neuromodulated_stdp_nestml: \ttrace requested at exact time of history entry 0, returning " << S_.post_tr__for_neuromodulated_stdp_nestml << std::endl;
#endif
...
#ifdef DEBUG
  std::cout << "iaf_psc_exp_nestml__with_neuromodulated_stdp_nestml::get_post_tr__for_neuromodulated_stdp_nestml: \tfall-through, returning initial value = " << post_tr__for_neuromodulated_stdp_nestml__iv << std::endl;
#endif
