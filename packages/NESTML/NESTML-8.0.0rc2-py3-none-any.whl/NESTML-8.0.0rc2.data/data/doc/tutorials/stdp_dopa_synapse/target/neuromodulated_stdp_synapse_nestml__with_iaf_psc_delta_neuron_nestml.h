/**
 *  neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml.h
 *
 ...
 *
 *  Generated from NESTML at time: 2024-06-03 15:14:04.474638
**/

#ifndef NEUROMODULATED_STDP_SYNAPSE_NESTML__WITH_IAF_PSC_DELTA_NEURON_NESTML_H
#define NEUROMODULATED_STDP_SYNAPSE_NESTML__WITH_IAF_PSC_DELTA_NEURON_NESTML_H
...
void register_neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml( const std::string& name );

namespace neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names
{
    const Name _w( "w" );
    const Name _n( "n" );
    const Name _c( "c" );
...
class neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestmlCommonSynapseProperties : public CommonSynapseProperties {
public:

    neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestmlCommonSynapseProperties()
...
class neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml : public Connection< targetidentifierT >
{
  typedef iaf_psc_delta_neuron_nestml__with_neuromodulated_stdp_synapse_nestml post_neuron_t;
...
public:
  void trigger_update_weight( size_t t,
    ...
    double t_trig,
    const neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestmlCommonSynapseProperties& cp );
private:
  double t_lastspike_;
  ...
  **/
  inline void
  update_internal_state_(double t_start, double timestep, const neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestmlCommonSynapseProperties& cp);

  void recompute_internal_variables();

public:
  // this line determines which common properties to use
  typedef neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestmlCommonSynapseProperties CommonPropertiesType;
  ...
  */
  neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml();
  ...
  */
  neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml( const neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml& rhs );
  ...
  **/
    ...
    const CommonPropertiesType& cp )
  {
    ...
    try {
      dynamic_cast<iaf_psc_delta_neuron_nestml__with_neuromodulated_stdp_synapse_nestml&>(t);
    }
    catch (std::bad_cast &exp) {
      std::cout << "wrong type of neuron connected! Synapse 'neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml' will only work with neuron 'iaf_psc_delta_neuron_nestml__with_neuromodulated_stdp_synapse_nestml'.\n";
      exit(1);
    }
  ...
  bool
  send( Event& e, const size_t tid, const neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestmlCommonSynapseProperties& cp )
  {
...
#ifdef DEBUG
    std::cout << "neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml::send(): handling pre spike at t = " << __t_spike << std::endl;
#endif
  ...
  const std::vector< spikecounter >& vt_spikes = cp.vt_->deliver_spikes();
    ...
    iaf_psc_delta_neuron_nestml__with_neuromodulated_stdp_synapse_nestml* __target = static_cast<iaf_psc_delta_neuron_nestml__with_neuromodulated_stdp_synapse_nestml*>(get_target(tid));
    assert(__target);
...
void
register_neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml( const std::string& name )
{
  nest::register_connection_model< neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml >( name );
}
template < typename targetidentifierT >
constexpr ConnectionModelProperties neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml< targetidentifierT >::properties;
template < typename targetidentifierT >
void
neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml< targetidentifierT >::process_mod_spikes_spikes_( const std::vector< spikecounter >& vt_spikes,
    double t0,
    double t1,
    const neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestmlCommonSynapseProperties& cp )
{
...
template < typename targetidentifierT >
void
neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml< targetidentifierT >::get_status( DictionaryDatum& __d ) const
{
  ...
  def<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_tau_tr_pre, get_tau_tr_pre());  
  def<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_tau_tr_post, get_tau_tr_post());  
  def<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_tau_c, get_tau_c());  
  def<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_tau_n, get_tau_n());  
  def<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_b, get_b());  
  def<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_Wmax, get_Wmax());  
  def<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_Wmin, get_Wmin());  
  def<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_A_plus, get_A_plus());  
  def<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_A_minus, get_A_minus());  
  def<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_A_vt, get_A_vt());

  // initial values for state variables in ODE or kernel  
  def<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_w, get_w());
  def<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_n, get_n());
  def<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_c, get_c());
  def<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_pre_tr, get_pre_tr());
}

template < typename targetidentifierT >
void
neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml< targetidentifierT >::set_status( const DictionaryDatum& __d,
  ConnectorModel& cm )
{
  // parameters  
  double tmp_d = get_d();
  updateValue<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_d, tmp_d);  
  double tmp_tau_tr_pre = get_tau_tr_pre();
  updateValue<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_tau_tr_pre, tmp_tau_tr_pre);  
  double tmp_tau_tr_post = get_tau_tr_post();
  updateValue<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_tau_tr_post, tmp_tau_tr_post);  
  double tmp_tau_c = get_tau_c();
  updateValue<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_tau_c, tmp_tau_c);  
  double tmp_tau_n = get_tau_n();
  updateValue<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_tau_n, tmp_tau_n);  
  double tmp_b = get_b();
  updateValue<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_b, tmp_b);  
  double tmp_Wmax = get_Wmax();
  updateValue<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_Wmax, tmp_Wmax);  
  double tmp_Wmin = get_Wmin();
  updateValue<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_Wmin, tmp_Wmin);  
  double tmp_A_plus = get_A_plus();
  updateValue<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_A_plus, tmp_A_plus);  
  double tmp_A_minus = get_A_minus();
  updateValue<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_A_minus, tmp_A_minus);  
  double tmp_A_vt = get_A_vt();
  updateValue<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_A_vt, tmp_A_vt);

  // initial values for state variables in ODE or kernel  
  double tmp_w = get_w();
  updateValue<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_w, tmp_w);
  double tmp_n = get_n();
  updateValue<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_n, tmp_n);
  double tmp_c = get_c();
  updateValue<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_c, tmp_c);
  double tmp_pre_tr = get_pre_tr();
  updateValue<double>(__d, nest::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml_names::_pre_tr, tmp_pre_tr);
...
**/
template < typename targetidentifierT >
void neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml< targetidentifierT >::recompute_internal_variables()
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
**/
template < typename targetidentifierT >
neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml< targetidentifierT >::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml() : ConnectionBase()
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
P_.d = 1; // as ms
...
**/
template < typename targetidentifierT >
neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml< targetidentifierT >::neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml( const neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml< targetidentifierT >& rhs )
: ConnectionBase( rhs )
{
    P_.d = rhs.P_.d;
...
template < typename targetidentifierT >
inline void
neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml< targetidentifierT >::update_internal_state_(double t_start, double timestep, const neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestmlCommonSynapseProperties& cp)
{
    if (timestep < 1E-12)
    {
#ifdef DEBUG
...
template < typename targetidentifierT >
inline void
neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml< targetidentifierT >::trigger_update_weight( size_t t,
  const std::vector< spikecounter >& vt_spikes,
  const double t_trig,
  const CommonPropertiesType& cp )
{
...
#ifdef DEBUG
    std::cout << "\nneuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml::trigger_update_weight(): t = " << t_trig << std::endl;
#endif
  ...
  std::deque< histentry__iaf_psc_delta_neuron_nestml__with_neuromodulated_stdp_synapse_nestml >::iterator start;
  std::deque< histentry__iaf_psc_delta_neuron_nestml__with_neuromodulated_stdp_synapse_nestml >::iterator finish;
  static_cast<iaf_psc_delta_neuron_nestml__with_neuromodulated_stdp_synapse_nestml*>(get_target(t))->get_history__( t_last_update_ - dendritic_delay, t_trig - dendritic_delay, &start, &finish );
...
#ifdef DEBUG
    //std::cout << "neuromodulated_stdp_synapse_nestml__with_iaf_psc_delta_neuron_nestml::trigger_update_weight(): \tupdating from " << t_lastspike_ << " to " << t_trig + dendritic_delay << std::endl;
#endif
...
#endif /* #ifndef NEUROMODULATED_STDP_SYNAPSE_NESTML__WITH_IAF_PSC_DELTA_NEURON_NESTML_H */