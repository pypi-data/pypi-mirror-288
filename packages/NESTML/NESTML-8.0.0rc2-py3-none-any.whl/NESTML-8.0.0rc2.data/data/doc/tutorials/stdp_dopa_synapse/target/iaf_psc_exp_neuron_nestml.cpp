 ...
 *
 *  Generated from NESTML at time: 2024-06-03 15:14:29.522498
**/
...
void
register_iaf_psc_exp_neuron_nestml( const std::string& name )
{
  nest::register_node_model< iaf_psc_exp_neuron_nestml >( name );
}
...
iaf_psc_exp_neuron_nestml::iaf_psc_exp_neuron_nestml():StructuralPlasticityNode(), P_(), S_(), B_(*this)
{
