...
/**
 *  iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml.h
 *
...
**/
#ifndef IAF_PSC_EXP_NEURON_NESTML__WITH_NEUROMODULATED_STDP_SYNAPSE_NESTML
#define IAF_PSC_EXP_NEURON_NESTML__WITH_NEUROMODULATED_STDP_SYNAPSE_NESTML
...
namespace nest
{
namespace iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names
{
    const Name _V_m( "V_m" );
...
class histentry__iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml
{
public:
  histentry__iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml( double t,
...
/* BeginDocumentation
  Name: iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml
...
void register_iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml( const std::string& name );

class iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml : public nest::StructuralPlasticityNode
{
public:
  /**
  ...
  **/
  iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml(const iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml &);

  /**
   * Destructor.
  **/
  ~iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml() override;
...
private:
  ...
  std::deque< histentry__iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml > history_;
...
static std::vector< std::tuple< int, int > > rport_to_nestml_buffer_idx;
  ...
  **/
  ...
  friend class nest::RecordablesMap<iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml>;
  friend class nest::UniversalDataLogger<iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml>;
  ...
  **/
  struct Buffers_
  {
    Buffers_(iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml &);
    Buffers_(const Buffers_ &, iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml> logger_;
...
inline nest::RingBuffer& get_I_stim() {
  ...
  static nest::RecordablesMap<iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml> recordablesMap_;

}; /* neuron iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml */

inline nest_port_t iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
    // You should usually not change the code in this function.
...
inline nest_port_t iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml::handles_test_event(nest::CurrentEvent&, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest_port_t iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml::get_status(DictionaryDatum &__d) const
{
  // parameters
  def<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_C_m, get_C_m());
  def<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_tau_m, get_tau_m());
  def<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_tau_syn_inh, get_tau_syn_inh());
  def<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_tau_syn_exc, get_tau_syn_exc());
  def<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_refr_T, get_refr_T());
  def<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_E_L, get_E_L());
  def<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_V_reset, get_V_reset());
  def<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_V_th, get_V_th());
  def<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_I_e, get_I_e());
  def<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_tau_tr_post__for_neuromodulated_stdp_synapse_nestml, get_tau_tr_post__for_neuromodulated_stdp_synapse_nestml());

  // initial values for state variables in ODE or kernel
  def<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_V_m, get_V_m());
  def<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_refr_t, get_refr_t());
  def<bool>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_is_refractory, get_is_refractory());
  def<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_I_syn_exc, get_I_syn_exc());
  def<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_I_syn_inh, get_I_syn_inh());
  def<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_post_tr__for_neuromodulated_stdp_synapse_nestml, get_post_tr__for_neuromodulated_stdp_synapse_nestml());
...
inline void iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml::set_status(const DictionaryDatum &__d)
{
  // parameters
  double tmp_C_m = get_C_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_C_m, tmp_C_m, this);
  double tmp_tau_m = get_tau_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_tau_m, tmp_tau_m, this);
  double tmp_tau_syn_inh = get_tau_syn_inh();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_tau_syn_inh, tmp_tau_syn_inh, this);
  double tmp_tau_syn_exc = get_tau_syn_exc();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_tau_syn_exc, tmp_tau_syn_exc, this);
  double tmp_refr_T = get_refr_T();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_refr_T, tmp_refr_T, this);
  double tmp_E_L = get_E_L();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_E_L, tmp_E_L, this);
  double tmp_V_reset = get_V_reset();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_V_reset, tmp_V_reset, this);
  double tmp_V_th = get_V_th();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_V_th, tmp_V_th, this);
  double tmp_I_e = get_I_e();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_I_e, tmp_I_e, this);
  double tmp_tau_tr_post__for_neuromodulated_stdp_synapse_nestml = get_tau_tr_post__for_neuromodulated_stdp_synapse_nestml();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_tau_tr_post__for_neuromodulated_stdp_synapse_nestml, tmp_tau_tr_post__for_neuromodulated_stdp_synapse_nestml, this);

  // initial values for state variables in ODE or kernel
  double tmp_V_m = get_V_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_V_m, tmp_V_m, this);
  double tmp_refr_t = get_refr_t();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_refr_t, tmp_refr_t, this);
  bool tmp_is_refractory = get_is_refractory();
  nest::updateValueParam<bool>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_is_refractory, tmp_is_refractory, this);
  double tmp_I_syn_exc = get_I_syn_exc();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_I_syn_exc, tmp_I_syn_exc, this);
  double tmp_I_syn_inh = get_I_syn_inh();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_I_syn_inh, tmp_I_syn_inh, this);
  double tmp_post_tr__for_neuromodulated_stdp_synapse_nestml = get_post_tr__for_neuromodulated_stdp_synapse_nestml();
  nest::updateValueParam<double>(__d, nest::iaf_psc_exp_neuron_nestml__with_neuromodulated_stdp_synapse_nestml_names::_post_tr__for_neuromodulated_stdp_synapse_nestml, tmp_post_tr__for_neuromodulated_stdp_synapse_nestml, this);
...
#endif /* #ifndef IAF_PSC_EXP_NEURON_NESTML__WITH_NEUROMODULATED_STDP_SYNAPSE_NESTML */
