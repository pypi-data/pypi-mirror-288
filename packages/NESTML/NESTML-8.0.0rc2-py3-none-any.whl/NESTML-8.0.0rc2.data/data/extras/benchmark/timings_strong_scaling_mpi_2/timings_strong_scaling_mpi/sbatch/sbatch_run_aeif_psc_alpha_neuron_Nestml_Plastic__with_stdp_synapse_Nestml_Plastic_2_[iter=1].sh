...
export PROGRAM="python3 examples/brunel_alpha_nest.py --simulated_neuron aeif_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic --network_scale 20000 --nodes 2 --threads 128  --iteration 1 --benchmarkPath /p/project1/cslns/babu1/nestml/extras/benchmark/Running/../Output_MPI/aeif_psc_alpha/timings_strong_scaling_mpi --rng_seed 117092755"
srun $PROGRAM