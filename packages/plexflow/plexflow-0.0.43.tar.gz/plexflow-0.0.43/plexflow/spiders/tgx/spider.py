...
class TgxSpider(scrapy.Spider): 
    ...
    def __init__(self, host='https://torrentgalaxy.to', pages=None, start_page=None, num_pages=None, tag: str = str(uuid4()), dump_folder: str='.'):
    ...
    def start_requests(self):
        for page_id in self.pages:
            yield scrapy.Request(
                ...
                meta={'id': page_id},
                cookies={
                    "PHPSESSID": "p51g5llgbfad4t211i2k8pnuh3",
                })
