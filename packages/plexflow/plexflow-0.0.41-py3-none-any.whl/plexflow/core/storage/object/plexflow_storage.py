...
class PlexflowObjectStore:
    ...
    def __init__(self, run_id: str, host: str = os.getenv('REDIS_HOST', 'localhost'), port: int = int(os.getenv('REDIS_PORT', 6379)), db: int = 0, default_ttl: int = 3600, root_key: Union[str, Path] = "@plexflow"):
