...
class FundRequestStatus(ABC):
    ...
    def from_json(js: str):
        value = json.loads(js)
        return FundRequestStatus.from_remote_dict(value)
    ...
    def from_remote_dict(d: Dict[str, any]):
        ...
        else: raise ValueError("Invalid dict submitted for creating 'FundRequestStatus'" + " Unexpected '_type' = " + ty)
...
class WaitingToStart(FundRequestStatus):
    def __init__(self):
...
class Starting(FundRequestStatus):
    def __init__(self):
        self._type = "Starting" 
        super()
...
class Started(FundRequestStatus):
    def __init__(self):
        self._type = "Started" 
        super()
...
class Processing(FundRequestStatus):
...
class Failure(FundRequestStatus):
...
class Successful(FundRequestStatus):
    def __init__(self):
