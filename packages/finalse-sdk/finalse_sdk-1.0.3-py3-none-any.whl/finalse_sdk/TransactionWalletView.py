...
from finalse_sdk.TransactionBeforeAfter import TransactionBeforeAfter
...
class TransactionWalletView:
    def __init__(self,
                 ...
                 main_pocket: Pocket,
                 man: Man,
                 before: TransactionBeforeAfter,
                 after: TransactionBeforeAfter):
        self._type = "TransactionWalletView" 
        self.id = id
        self.url = url
    ...
    def from_json(js: str):
        value = json.loads(js)
        return TransactionWalletView.from_remote_dict(value)
    ...
    def __to_remote_dict(self):
        tuples = [
            ...
            ('before', self.before.__to_remote_dict()),
            ('after', self.after.__to_remote_dict())
        ]
    ...
    def from_remote_dict(d: Dict[str, any]):
        return TransactionWalletView(d["id"],
                                     d["url"],
                                     ...
                                     TransactionBeforeAfter.from_remote_dict(d["before"]),
                                     TransactionBeforeAfter.from_remote_dict(d["after"]))
    ...
    def from_dict(d: Dict[str, any]):
        return TransactionWalletView(d["id"],
                                     ...
                                     Man.from_dict(d["man"]),
                                     TransactionBeforeAfter.from_dict(d["before"]),
                                     TransactionBeforeAfter.from_dict(d["after"]))
    ...
    def __repr__(self):
        return ("TransactionWalletView(id=" + self.id + 
                                      ", url=" + self.url + 
