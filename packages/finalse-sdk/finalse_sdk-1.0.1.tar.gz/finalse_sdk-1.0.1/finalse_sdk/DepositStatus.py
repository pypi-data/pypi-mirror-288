...
class DepositStatus(ABC):
    ...
    def from_json(js: str):
        value = json.loads(js)
        return DepositStatus.from_remote_dict(value)
    ...
    def from_remote_dict(d: Dict[str, any]):
        ...
        else: raise ValueError("Invalid dict submitted for creating 'DepositStatus'" + " Unexpected '_type' = " + ty)
...
class WaitingToStart(DepositStatus):
    def __init__(self):
...
class Processing(DepositStatus):
...
class Completing(DepositStatus):
    def __init__(self):
...
class Successful(DepositStatus):
    def __init__(self):
