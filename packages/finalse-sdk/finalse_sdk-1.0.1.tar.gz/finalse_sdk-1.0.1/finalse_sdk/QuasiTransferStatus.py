...
class QuasiTransferStatus(ABC):
    ...
    def from_json(js: str):
        value = json.loads(js)
        return QuasiTransferStatus.from_remote_dict(value)
    ...
    def from_remote_dict(d: Dict[str, any]):
        ...
        else: raise ValueError("Invalid dict submitted for creating 'QuasiTransferStatus'" + " Unexpected '_type' = " + ty)
...
class WaitingToStart(QuasiTransferStatus):
    def __init__(self):
...
class Starting(QuasiTransferStatus):
    def __init__(self):
        self._type = "Starting" 
        super()
...
class Started(QuasiTransferStatus):
    def __init__(self):
        self._type = "Started" 
        super()
...
class Processing(QuasiTransferStatus):
...
class Failure(QuasiTransferStatus):
...
class Successful(QuasiTransferStatus):
    def __init__(self):
