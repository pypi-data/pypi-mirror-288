...
class Destination(ABC):
    ...
    def from_json(js: str):
        value = json.loads(js)
        return Destination.from_remote_dict(value)
    ...
    def from_remote_dict(d: Dict[str, any]):
        ...
        else: raise ValueError("Invalid dict submitted for creating 'Destination'" + " Unexpected '_type' = " + ty)
