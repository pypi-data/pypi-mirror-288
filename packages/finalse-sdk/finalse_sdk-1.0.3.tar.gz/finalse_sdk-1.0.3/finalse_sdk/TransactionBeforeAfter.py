...
class TransactionBeforeAfter:
    def __init__(self, balance: Balance, volume: Volume):
        self._type = "TransactionBeforeAfter" 
    ...
    def from_json(js: str):
        value = json.loads(js)
        return TransactionBeforeAfter.from_remote_dict(value)
    ...
    def from_remote_dict(d: Dict[str, any]):
        return TransactionBeforeAfter(Balance.from_remote_dict(d["balance"]),
                                      Volume.from_remote_dict(d["volume"]))

    @staticmethod
    def from_dict(d: Dict[str, any]):
        return TransactionBeforeAfter(Balance.from_dict(d["balance"]),
    ...
    def __repr__(self):
        return ("TransactionBeforeAfter(balance=" + repr(self.balance) + 
