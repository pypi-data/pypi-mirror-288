...
def solve(
    ...
    Args:
        ...
        var_pts (dict, optional): simulation mesh specified by the following parameters in dictionary (if none or only subset is provided, default values will be used instead):

            * 'x_n' - Number of nodes in the electrolyte (negative electrode). Default is 20.
            * 'x_s' - Number of nodes in the electrolyte (separator). Default is 20.
            * 'x_p' - Number of nodes in the electrolyte (positive electrode). Default is 20.
            * 'r_n' - Number of nodes in particles (negative electrode). Default is 20.
            * 'r_p' - Number of nodes in particles (positive electrode). Default is 20.
