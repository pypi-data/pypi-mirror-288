This is a fork of the Feast project. Specifically of version 0.39. You can see the Readme for that version [here](https://github.com/feast-dev/feast/tree/v0.39-branch).
