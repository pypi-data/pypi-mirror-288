...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_LOGMETRIC_LABELEXTRACTORSENTRY']._options = None
  _globals['_LOGMETRIC_LABELEXTRACTORSENTRY']._serialized_options = b'8\001'
  _globals['_LOGMETRIC'].fields_by_name['name']._options = None
  _globals['_LOGMETRIC'].fields_by_name['name']._serialized_options = b'\342A\001\002'
  _globals['_LOGMETRIC'].fields_by_name['description']._options = None
  _globals['_LOGMETRIC'].fields_by_name['description']._serialized_options = b'\342A\001\001'
  _globals['_LOGMETRIC'].fields_by_name['filter']._options = None
  _globals['_LOGMETRIC'].fields_by_name['filter']._serialized_options = b'\342A\001\002'
  _globals['_LOGMETRIC'].fields_by_name['metric_descriptor']._options = None
  _globals['_LOGMETRIC'].fields_by_name['metric_descriptor']._serialized_options = b'\342A\001\001'
  _globals['_LOGMETRIC'].fields_by_name['value_extractor']._options = None
  _globals['_LOGMETRIC'].fields_by_name['value_extractor']._serialized_options = b'\342A\001\001'
  _globals['_LOGMETRIC'].fields_by_name['label_extractors']._options = None
  _globals['_LOGMETRIC'].fields_by_name['label_extractors']._serialized_options = b'\342A\001\001'
  _globals['_LOGMETRIC'].fields_by_name['bucket_options']._options = None
  _globals['_LOGMETRIC'].fields_by_name['bucket_options']._serialized_options = b'\342A\001\001'
  _globals['_LOGMETRIC'].fields_by_name['create_time']._options = None
  _globals['_LOGMETRIC'].fields_by_name['create_time']._serialized_options = b'\342A\001\003'
  _globals['_LOGMETRIC'].fields_by_name['update_time']._options = None
  _globals['_LOGMETRIC'].fields_by_name['update_time']._serialized_options = b'\342A\001\003'
  _globals['_LOGMETRIC'].fields_by_name['version']._options = None
  _globals['_LOGMETRIC'].fields_by_name['version']._serialized_options = b'\030\001'
  _globals['_LOGMETRIC']._options = None
  _globals['_LOGMETRIC']._serialized_options = b'\352AG\n logging.googleapis.com/LogMetric\022#projects/{project}/metrics/{metric}'
  _globals['_LISTLOGMETRICSREQUEST'].fields_by_name['parent']._options = None
  _globals['_LISTLOGMETRICSREQUEST'].fields_by_name['parent']._serialized_options = b'\342A\001\002\372A-\n+cloudresourcemanager.googleapis.com/Project'
  _globals['_LISTLOGMETRICSREQUEST'].fields_by_name['page_token']._options = None
  _globals['_LISTLOGMETRICSREQUEST'].fields_by_name['page_token']._serialized_options = b'\342A\001\001'
  _globals['_LISTLOGMETRICSREQUEST'].fields_by_name['page_size']._options = None
  _globals['_LISTLOGMETRICSREQUEST'].fields_by_name['page_size']._serialized_options = b'\342A\001\001'
  _globals['_GETLOGMETRICREQUEST'].fields_by_name['metric_name']._options = None
  _globals['_GETLOGMETRICREQUEST'].fields_by_name['metric_name']._serialized_options = b'\342A\001\002\372A\"\n logging.googleapis.com/LogMetric'
  _globals['_CREATELOGMETRICREQUEST'].fields_by_name['parent']._options = None
  _globals['_CREATELOGMETRICREQUEST'].fields_by_name['parent']._serialized_options = b'\342A\001\002\372A\"\022 logging.googleapis.com/LogMetric'
  _globals['_CREATELOGMETRICREQUEST'].fields_by_name['metric']._options = None
  _globals['_CREATELOGMETRICREQUEST'].fields_by_name['metric']._serialized_options = b'\342A\001\002'
  _globals['_UPDATELOGMETRICREQUEST'].fields_by_name['metric_name']._options = None
  _globals['_UPDATELOGMETRICREQUEST'].fields_by_name['metric_name']._serialized_options = b'\342A\001\002\372A\"\n logging.googleapis.com/LogMetric'
  _globals['_UPDATELOGMETRICREQUEST'].fields_by_name['metric']._options = None
  _globals['_UPDATELOGMETRICREQUEST'].fields_by_name['metric']._serialized_options = b'\342A\001\002'
  _globals['_DELETELOGMETRICREQUEST'].fields_by_name['metric_name']._options = None
  _globals['_DELETELOGMETRICREQUEST'].fields_by_name['metric_name']._serialized_options = b'\342A\001\002\372A\"\n logging.googleapis.com/LogMetric'
  _globals['_METRICSSERVICEV2']._options = None
  ...
  _globals['_METRICSSERVICEV2'].methods_by_name['ListLogMetrics']._options = None
  ...
  _globals['_METRICSSERVICEV2'].methods_by_name['GetLogMetric']._options = None
  ...
  _globals['_METRICSSERVICEV2'].methods_by_name['CreateLogMetric']._options = None
  ...
  _globals['_METRICSSERVICEV2'].methods_by_name['UpdateLogMetric']._options = None
  ...
  _globals['_METRICSSERVICEV2'].methods_by_name['DeleteLogMetric']._options = None
