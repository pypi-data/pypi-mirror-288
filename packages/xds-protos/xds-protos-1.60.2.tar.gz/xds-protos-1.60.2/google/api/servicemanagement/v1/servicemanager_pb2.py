...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_LISTSERVICESREQUEST'].fields_by_name['consumer_id']._options = None
  _globals['_LISTSERVICESREQUEST'].fields_by_name['consumer_id']._serialized_options = b'\030\001'
  _globals['_GETSERVICEREQUEST'].fields_by_name['service_name']._options = None
  _globals['_GETSERVICEREQUEST'].fields_by_name['service_name']._serialized_options = b'\342A\001\002'
  _globals['_CREATESERVICEREQUEST'].fields_by_name['service']._options = None
  _globals['_CREATESERVICEREQUEST'].fields_by_name['service']._serialized_options = b'\342A\001\002'
  _globals['_DELETESERVICEREQUEST'].fields_by_name['service_name']._options = None
  _globals['_DELETESERVICEREQUEST'].fields_by_name['service_name']._serialized_options = b'\342A\001\002'
  _globals['_UNDELETESERVICEREQUEST'].fields_by_name['service_name']._options = None
  _globals['_UNDELETESERVICEREQUEST'].fields_by_name['service_name']._serialized_options = b'\342A\001\002'
  _globals['_GETSERVICECONFIGREQUEST'].fields_by_name['service_name']._options = None
  _globals['_GETSERVICECONFIGREQUEST'].fields_by_name['service_name']._serialized_options = b'\342A\001\002'
  _globals['_GETSERVICECONFIGREQUEST'].fields_by_name['config_id']._options = None
  _globals['_GETSERVICECONFIGREQUEST'].fields_by_name['config_id']._serialized_options = b'\342A\001\002'
  _globals['_LISTSERVICECONFIGSREQUEST'].fields_by_name['service_name']._options = None
  _globals['_LISTSERVICECONFIGSREQUEST'].fields_by_name['service_name']._serialized_options = b'\342A\001\002'
  _globals['_CREATESERVICECONFIGREQUEST'].fields_by_name['service_name']._options = None
  _globals['_CREATESERVICECONFIGREQUEST'].fields_by_name['service_name']._serialized_options = b'\342A\001\002'
  _globals['_CREATESERVICECONFIGREQUEST'].fields_by_name['service_config']._options = None
  _globals['_CREATESERVICECONFIGREQUEST'].fields_by_name['service_config']._serialized_options = b'\342A\001\002'
  _globals['_SUBMITCONFIGSOURCEREQUEST'].fields_by_name['service_name']._options = None
  _globals['_SUBMITCONFIGSOURCEREQUEST'].fields_by_name['service_name']._serialized_options = b'\342A\001\002'
  _globals['_SUBMITCONFIGSOURCEREQUEST'].fields_by_name['config_source']._options = None
  _globals['_SUBMITCONFIGSOURCEREQUEST'].fields_by_name['config_source']._serialized_options = b'\342A\001\002'
  _globals['_SUBMITCONFIGSOURCEREQUEST'].fields_by_name['validate_only']._options = None
  _globals['_SUBMITCONFIGSOURCEREQUEST'].fields_by_name['validate_only']._serialized_options = b'\342A\001\001'
  _globals['_CREATESERVICEROLLOUTREQUEST'].fields_by_name['service_name']._options = None
  _globals['_CREATESERVICEROLLOUTREQUEST'].fields_by_name['service_name']._serialized_options = b'\342A\001\002'
  _globals['_CREATESERVICEROLLOUTREQUEST'].fields_by_name['rollout']._options = None
  _globals['_CREATESERVICEROLLOUTREQUEST'].fields_by_name['rollout']._serialized_options = b'\342A\001\002'
  _globals['_LISTSERVICEROLLOUTSREQUEST'].fields_by_name['service_name']._options = None
  _globals['_LISTSERVICEROLLOUTSREQUEST'].fields_by_name['service_name']._serialized_options = b'\342A\001\002'
  _globals['_LISTSERVICEROLLOUTSREQUEST'].fields_by_name['filter']._options = None
  _globals['_LISTSERVICEROLLOUTSREQUEST'].fields_by_name['filter']._serialized_options = b'\342A\001\002'
  _globals['_GETSERVICEROLLOUTREQUEST'].fields_by_name['service_name']._options = None
  _globals['_GETSERVICEROLLOUTREQUEST'].fields_by_name['service_name']._serialized_options = b'\342A\001\002'
  _globals['_GETSERVICEROLLOUTREQUEST'].fields_by_name['rollout_id']._options = None
  _globals['_GETSERVICEROLLOUTREQUEST'].fields_by_name['rollout_id']._serialized_options = b'\342A\001\002'
  _globals['_ENABLESERVICEREQUEST'].fields_by_name['service_name']._options = None
  _globals['_ENABLESERVICEREQUEST'].fields_by_name['service_name']._serialized_options = b'\342A\001\002'
  _globals['_ENABLESERVICEREQUEST'].fields_by_name['consumer_id']._options = None
  _globals['_ENABLESERVICEREQUEST'].fields_by_name['consumer_id']._serialized_options = b'\342A\001\002'
  _globals['_DISABLESERVICEREQUEST'].fields_by_name['service_name']._options = None
  _globals['_DISABLESERVICEREQUEST'].fields_by_name['service_name']._serialized_options = b'\342A\001\002'
  _globals['_DISABLESERVICEREQUEST'].fields_by_name['consumer_id']._options = None
  _globals['_DISABLESERVICEREQUEST'].fields_by_name['consumer_id']._serialized_options = b'\342A\001\002'
  _globals['_GENERATECONFIGREPORTREQUEST'].fields_by_name['new_config']._options = None
  _globals['_GENERATECONFIGREPORTREQUEST'].fields_by_name['new_config']._serialized_options = b'\342A\001\002'
  _globals['_GENERATECONFIGREPORTREQUEST'].fields_by_name['old_config']._options = None
  _globals['_GENERATECONFIGREPORTREQUEST'].fields_by_name['old_config']._serialized_options = b'\342A\001\001'
  _globals['_SERVICEMANAGER']._options = None
  ...
  _globals['_SERVICEMANAGER'].methods_by_name['ListServices']._options = None
  ...
  _globals['_SERVICEMANAGER'].methods_by_name['GetService']._options = None
  ...
  _globals['_SERVICEMANAGER'].methods_by_name['CreateService']._options = None
  ...
  _globals['_SERVICEMANAGER'].methods_by_name['DeleteService']._options = None
  ...
  _globals['_SERVICEMANAGER'].methods_by_name['UndeleteService']._options = None
  ...
  _globals['_SERVICEMANAGER'].methods_by_name['ListServiceConfigs']._options = None
  ...
  _globals['_SERVICEMANAGER'].methods_by_name['GetServiceConfig']._options = None
  ...
  _globals['_SERVICEMANAGER'].methods_by_name['CreateServiceConfig']._options = None
  ...
  _globals['_SERVICEMANAGER'].methods_by_name['SubmitConfigSource']._options = None
  ...
  _globals['_SERVICEMANAGER'].methods_by_name['ListServiceRollouts']._options = None
  ...
  _globals['_SERVICEMANAGER'].methods_by_name['GetServiceRollout']._options = None
  ...
  _globals['_SERVICEMANAGER'].methods_by_name['CreateServiceRollout']._options = None
  ...
  _globals['_SERVICEMANAGER'].methods_by_name['GenerateConfigReport']._options = None
