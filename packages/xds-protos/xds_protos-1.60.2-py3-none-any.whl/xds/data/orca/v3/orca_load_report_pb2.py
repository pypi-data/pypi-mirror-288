...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_ORCALOADREPORT_REQUESTCOSTENTRY']._options = None
  _globals['_ORCALOADREPORT_REQUESTCOSTENTRY']._serialized_options = b'8\001'
  _globals['_ORCALOADREPORT_UTILIZATIONENTRY']._options = None
  _globals['_ORCALOADREPORT_UTILIZATIONENTRY']._serialized_options = b'8\001'
  _globals['_ORCALOADREPORT_NAMEDMETRICSENTRY']._options = None
  _globals['_ORCALOADREPORT_NAMEDMETRICSENTRY']._serialized_options = b'8\001'
  _globals['_ORCALOADREPORT'].fields_by_name['cpu_utilization']._options = None
  ...
  _globals['_ORCALOADREPORT'].fields_by_name['mem_utilization']._options = None
  ...
  _globals['_ORCALOADREPORT'].fields_by_name['rps']._options = None
  _globals['_ORCALOADREPORT'].fields_by_name['rps']._serialized_options = b'\030\001'
  _globals['_ORCALOADREPORT'].fields_by_name['utilization']._options = None
  ...
  _globals['_ORCALOADREPORT'].fields_by_name['rps_fractional']._options = None
  ...
  _globals['_ORCALOADREPORT'].fields_by_name['eps']._options = None
  _globals['_ORCALOADREPORT'].fields_by_name['eps']._serialized_options = b'\372B\013\022\t)\000\000\000\000\000\000\000\000'
  _globals['_ORCALOADREPORT'].fields_by_name['application_utilization']._options = None
