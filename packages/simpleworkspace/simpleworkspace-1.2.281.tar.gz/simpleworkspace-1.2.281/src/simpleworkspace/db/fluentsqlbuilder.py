...
class _FluentSqlBuilderExecuteResults:
    ...
    def LastRowId(self):
        ...
        if not(hasattr(self._executed_statement, 'lastrowid')):
            raise RuntimeError(f"cursor of type {type(self._executed_statement)} does not support lastrowid")
        return self._executed_statement.lastrowid
