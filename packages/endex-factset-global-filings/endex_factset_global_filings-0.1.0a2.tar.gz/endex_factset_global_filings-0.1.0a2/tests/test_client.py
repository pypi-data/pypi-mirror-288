...
class TestEndexFactsetGlobalFilings:
    client = EndexFactsetGlobalFilings(base_url=base_url, access_token=access_token, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_GLOBAL_FILINGS_BASE_URL="http://localhost:5000/from/env"):
            client = EndexFactsetGlobalFilings(access_token=access_token, _strict_response_validation=True)
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = EndexFactsetGlobalFilings(
            base_url=base_url, access_token=access_token, _strict_response_validation=True
        )
...
class TestAsyncEndexFactsetGlobalFilings:
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_GLOBAL_FILINGS_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncEndexFactsetGlobalFilings(access_token=access_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncEndexFactsetGlobalFilings(
            base_url=base_url, access_token=access_token, _strict_response_validation=True
        )
