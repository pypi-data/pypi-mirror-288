...
from endex_factset_global_filings import (
    EndexFactsetGlobalFilings,
    APIResponseValidationError,
    AsyncEndexFactsetGlobalFilings,
)
from endex_factset_global_filings._models import BaseModel, FinalRequestOptions
from endex_factset_global_filings._constants import RAW_RESPONSE_HEADER
from endex_factset_global_filings._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from endex_factset_global_filings._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: EndexFactsetGlobalFilings | AsyncEndexFactsetGlobalFilings) -> int:
...
class TestEndexFactsetGlobalFilings:
    client = EndexFactsetGlobalFilings(base_url=base_url, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "endex_factset_global_filings/_legacy_response.py",
                        "endex_factset_global_filings/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "endex_factset_global_filings/_compat.py",
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = EndexFactsetGlobalFilings(
            base_url=base_url,
    ...
    def test_multipart_repeating_array(self, client: EndexFactsetGlobalFilings) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = EndexFactsetGlobalFilings(base_url="https://example.com/from_init", _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_GLOBAL_FILINGS_BASE_URL="http://localhost:5000/from/env"):
            client = EndexFactsetGlobalFilings(_strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            EndexFactsetGlobalFilings(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True),
            EndexFactsetGlobalFilings(
    ...
    def test_base_url_trailing_slash(self, client: EndexFactsetGlobalFilings) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: EndexFactsetGlobalFilings) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: EndexFactsetGlobalFilings) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            EndexFactsetGlobalFilings(base_url=base_url, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = EndexFactsetGlobalFilings(base_url=base_url, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = EndexFactsetGlobalFilings(base_url=base_url, _strict_response_validation=False)
    ...
    @mock.patch("endex_factset_global_filings._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
...
class TestAsyncEndexFactsetGlobalFilings:
    client = AsyncEndexFactsetGlobalFilings(base_url=base_url, _strict_response_validation=True)
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = AsyncEndexFactsetGlobalFilings(
            base_url=base_url,
            _strict_response_validation=True,
            default_headers={
                "X-Foo": "stainless",
    ...
    def test_multipart_repeating_array(self, async_client: AsyncEndexFactsetGlobalFilings) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_GLOBAL_FILINGS_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncEndexFactsetGlobalFilings(_strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncEndexFactsetGlobalFilings) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncEndexFactsetGlobalFilings) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncEndexFactsetGlobalFilings) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncEndexFactsetGlobalFilings(base_url=base_url, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncEndexFactsetGlobalFilings(base_url=base_url, _strict_response_validation=False)
