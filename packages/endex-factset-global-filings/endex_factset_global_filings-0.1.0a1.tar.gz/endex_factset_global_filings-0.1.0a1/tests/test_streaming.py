...
from endex_factset_global_filings._streaming import Stream, AsyncStream, ServerSentEvent


@pytest.mark.asyncio
@pytest.mark.parametrize("sync", [True, False], ids=["sync", "async"])
async def test_basic(
    sync: bool, client: EndexFactsetGlobalFilings, async_client: AsyncEndexFactsetGlobalFilings
) -> None:
...
async def test_special_new_line_character(
    ...
    async_client: AsyncEndexFactsetGlobalFilings,
) -> None:
    def body() -> Iterator[bytes]:
