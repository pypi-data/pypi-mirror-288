...
class TranslatorAR:
    """
    TranslatorAR handles translation between Arabic, English, and French using Hugging Face's translation models.
    It supports text and PDF file translation with readable formatting.
    """
    def __init__(self):
        """
    ...
    def translate(self, text, src_lang, tgt_lang):
        ...
        :return: Translated text with readable formatting
    ...
    def _format_text(self, text):
        ...
        """
        text = re.sub(r'(?<!\n)([\.\!\?])\s+', r'\1\n', text)  # Ensure punctuation followed by space ends with a newline
    ...
    def _extract_text_from_pdf(self, pdf_path):
        ...
        text = ''.join(page.get_text() for page in tqdm(document, desc="Extracting pages"))
        return text
    ...
    def print_translation(self, src_text, translated_text, src_lang, tgt_lang):
        ...
        :param tgt_lang: Target language code
        """
        print(f"\n--- Translation from {src_lang} to {tgt_lang} ---")
...
if __name__ == "__main__":
    ...
    PDF_FILE_PATH = "../tests/arabic-text.pdf"
    ...
    translator.print_pdf_translation_results(PDF_FILE_PATH, "ar", "en", '../tests/translated_to_english.txt')

    # Example 2.bis: Translate Arabic PDF to French
    translator.print_pdf_translation_results(PDF_FILE_PATH, "ar", "fr", '../tests/translated_to_french.txt')
