...
class TranslatorAR:
    def __init__(self):
        ...
        self.translators = {
            ("ar", "en"): pipeline("translation", model="Helsinki-NLP/opus-mt-ar-en", device=self.device),
            ("en", "ar"): pipeline("translation", model="Helsinki-NLP/opus-mt-en-ar", device=self.device),
            ...
            ("ar", "fr"): pipeline("translation", model="Helsinki-NLP/opus-mt-ar-fr", device=self.device),
            ("fr", "ar"): pipeline("translation", model="Helsinki-NLP/opus-mt-fr-ar", device=self.device),
        }
