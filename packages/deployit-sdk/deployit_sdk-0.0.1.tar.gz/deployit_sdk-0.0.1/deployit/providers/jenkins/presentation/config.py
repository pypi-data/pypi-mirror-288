...
class PresentationConfig:
    ...
    def __init__(self):
        ...
        """
        self.use_rich_presentation = os.getenv('USE_RICH_PRESENTATION', True).lower() in ('true', '1', 't')
        self.use_simple_logging = os.getenv('USE_SIMPLE_LOGGING', False).lower() in ('true', '1', 't')
        self.use_rich_logging = os.getenv('USE_RICH_LOGGING', False).lower() in ('true', '1', 't')
