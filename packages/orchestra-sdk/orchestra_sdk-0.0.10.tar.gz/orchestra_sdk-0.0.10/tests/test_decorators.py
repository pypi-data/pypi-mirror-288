...
from src.orchestra_sdk.decorators import orchestra_run
...
class TestEnvVarsNotValid:
    ...
    def test_missing_env_vars(self, mocker, caplog):
        ...
        assert caplog.record_tuples[1] == EXPECTED_TASK_FUNC_LOG_TUPLE
