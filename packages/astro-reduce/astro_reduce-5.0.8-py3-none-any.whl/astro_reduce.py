        ...
        for fimg in listfits:
            ...
            while keeptrying:
                try:
                    ...
                    try:
                        click.secho(' *** TimeoutError: Trying again {}'.format(fimg),nl=True, fg='magenta')
                        submission_id = e.args[1]
                        click.secho('submission_id: {}'.format(submission_id),nl=True, fg='magenta')
                    except:
...
#            try:
#                click.secho('Separation : {}'.format(skycoo_f.separation(skycoo_i).to('arcmin')),fg='green')
#            except:
