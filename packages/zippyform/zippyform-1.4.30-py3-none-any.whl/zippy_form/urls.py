...
from zippy_form.views import form_list, create_form, update_form, delete_form, \
    ...
    map_gsheet_fields, get_form_settings_details, update_form_settings_details, delete_mapped_gsheet_field
...
urlpatterns = [
    ...
    path('builder/google_sheet/map_fields/<uuid:gsheet_map_field_id>', delete_mapped_gsheet_field),
