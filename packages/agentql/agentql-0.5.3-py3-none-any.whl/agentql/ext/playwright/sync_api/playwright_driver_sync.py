...
def add_event_listeners_for_page_monitor_shared(page: Page, monitor: PageActivityMonitor):
    if not monitor:
...
def remove_event_listeners_for_page_monitor_shared(page: Page, monitor: PageActivityMonitor):
    if not monitor:
        raise PageMonitorNotInitializedError()
