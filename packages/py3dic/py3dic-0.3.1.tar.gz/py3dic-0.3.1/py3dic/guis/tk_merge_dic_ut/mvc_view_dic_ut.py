...
class ViewMergeDicUT:
    ...
    def create_widgets(self):
        self.master.title("DIC and UT merging tool")
        ...
        # sync plot tk.fram
        self.sync_plot_frame = TkFrSyncGraph(self.master)
        self.sync_plot_frame.grid(row=0, column=3,rowspan=3, padx=10, pady=10, sticky="nsew")
