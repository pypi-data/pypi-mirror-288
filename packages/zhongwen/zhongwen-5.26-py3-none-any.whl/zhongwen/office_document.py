...
def 設定環境():
    ...
    import sys
    設定微軟辦公室軟體共用範本()
    cmd = f'{sys.executable} -m zhongwen.office_document --docx2pdf "%1"' 
    增加所有檔案右鍵選單之功能('2pdf', cmd)
...
if __name__ == '__main__':
    ...
    parser.add_argument("docx2pdf", nargs='?', help="轉 PDF 格式。")
