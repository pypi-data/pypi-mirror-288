...
from ._constants import FourthDimensionAI_DEFAULT_MAX_RETRIES, FourthDimensionAI_DEFAULT_LIMITS, FourthDimensionAI_DEFAULT_TIMEOUT, \
...
class HttpClient(spin):
    ...
    def __init__(
            ...
            *,
            ...
            base_url: URL,
            _strict_response_validation: bool,
            max_retries: int = FourthDimensionAI_DEFAULT_MAX_RETRIES,
            timeout: Union[float, Timeout, None],
        ...
        return \
            {
                "Accept": "application/json",
                "Content-Type": "application/json; charset=UTF-8",
                "FourthDimensionAI-SDK-Ver": self._version,
                "source_type": "FourthDimension-sdk-python",
                "x-request-sdk": "FourthDimension-sdk-python",
                **self.auth_headers,
