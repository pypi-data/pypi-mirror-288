...
class ClassifyApi(object):
    ...
    @validate_arguments
    def get_classify_metrics_all_variants(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], impulse_id : Annotated[Optional[StrictInt], Field(description="Impulse ID. If this is unset then the default impulse is used.")] = None, **kwargs) -> MetricsAllVariantsResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._get_classify_metrics_all_variants_with_http_info(project_id, impulse_id, **kwargs)  # noqa: E501

    @validate_arguments
    def _get_classify_metrics_all_variants_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], impulse_id : Annotated[Optional[StrictInt], Field(description="Impulse ID. If this is unset then the default impulse is used.")] = None, **kwargs):  # noqa: E501
        """Get metrics for all available model variants 
