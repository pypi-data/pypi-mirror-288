...
class WhitelabelsApi(object):
    ...
    @validate_arguments
    def update_whitelabel(self, whitelabel_identifier : Annotated[StrictInt, Field(..., description="Whitelabel ID")], update_whitelabel_internal_request : UpdateWhitelabelInternalRequest, **kwargs) -> GenericApiResponse:  # noqa: E501
        """Update white label
        ...
        :param whitelabel_identifier: Whitelabel ID (required)
        :type whitelabel_identifier: int
        :param update_whitelabel_internal_request: (required)
        :type update_whitelabel_internal_request: UpdateWhitelabelInternalRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._update_whitelabel_with_http_info(whitelabel_identifier, update_whitelabel_internal_request, **kwargs)  # noqa: E501

    @validate_arguments
    def _update_whitelabel_with_http_info(self, whitelabel_identifier : Annotated[StrictInt, Field(..., description="Whitelabel ID")], update_whitelabel_internal_request : UpdateWhitelabelInternalRequest, **kwargs):  # noqa: E501
        """Update white label 
        ...
        _all_params = [
            'whitelabel_identifier',
            'update_whitelabel_internal_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_whitelabel" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['update_whitelabel_internal_request']:
            _body_params = _params['update_whitelabel_internal_request']
        ...
        return self.api_client.call_api(
            '/api/whitelabel/{whitelabelIdentifier}', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
