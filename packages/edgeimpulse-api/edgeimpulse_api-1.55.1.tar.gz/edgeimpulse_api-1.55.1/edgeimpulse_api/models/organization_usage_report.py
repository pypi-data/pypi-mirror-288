...
class OrganizationUsageReport(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrganizationUsageReport:
        """Create an instance of OrganizationUsageReport from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrganizationUsageReport:
        """Create an instance of OrganizationUsageReport from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return OrganizationUsageReport.construct(**obj)

        _obj = OrganizationUsageReport.construct(**{
            "id": obj.get("id"),
