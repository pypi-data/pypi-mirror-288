...
class ImpulseApi(object):
    ...
    @validate_arguments
    def set_legacy_impulse_state_internal(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], zip : StrictStr, impulse : StrictStr, config : StrictStr, **kwargs) -> GenericApiResponse:  # noqa: E501
        """Set legacy impulse
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._set_legacy_impulse_state_internal_with_http_info(project_id, zip, impulse, config, **kwargs)  # noqa: E501

    @validate_arguments
    def _set_legacy_impulse_state_internal_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], zip : StrictStr, impulse : StrictStr, config : StrictStr, **kwargs):  # noqa: E501
        """Set legacy impulse 
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method set_legacy_impulse_state_internal" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params['impulse']:
            _files['impulse'] = _params['impulse']
        if _params['config']:
            _files['config'] = _params['config']
        ...
        return self.api_client.call_api(
            '/api/{projectId}/impulse/legacy-set-impulse', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
