...
def GetMolHash(all_layers, hash_scheme: HashScheme = ...) -> str:
    ...
    """
def GetMolLayers(original_molecule: rdkit.Chem.rdchem.Mol, data_field_names: typing.Union[typing.Iterable, NoneType] = None, escape: typing.Union[str, NoneType] = None, cxflag = 1089, enable_tautomer_hash_v2 = False) -> {<HashLayer.ESCAPE: 2>, <HashLayer.TAUTOMER_HASH: 7>, <HashLayer.NO_STEREO_TAUTOMER_HASH: 5>, <HashLayer.FORMULA: 3>, <HashLayer.NO_STEREO_SMILES: 4>, <HashLayer.SGROUP_DATA: 6>, <HashLayer.CANONICAL_SMILES: 1>}:
    """
