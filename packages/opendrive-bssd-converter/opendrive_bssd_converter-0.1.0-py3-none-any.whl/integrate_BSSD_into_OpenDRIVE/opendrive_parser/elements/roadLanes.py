...
class Lanes:
    ...
    ##Moritz B.: Adapt function --> laneSections are searched based on s-coordinate
...
class Lane:
    ...
    laneTypes = [
        ...
        ##Moritz B.: Add elements for OpenDRIVE-version 1.5/1.6/1.7 (Original code was developed for 1.4)
        "curb",
        "connectingRamp",
        "bus",
        "taxi",
    ...
    ##Moritz B.: Added attribute "speeds" for storing all <speed>-Elements of one <lane>-element in a list
    @property
    def speeds(self):
        """ """
...
##Moritz B.: Added object "LaneSpeed" for storing a <speed>-Element in an object
class LaneSpeed:

    ##Moritz B.: <speed>-Element has attributes "sOffset", "max" (= maximum allowed velocity), and "unit" (optional)
    def __init__(self):
        self._sOffset = None
        self._vMax = None
        self._unit = None
