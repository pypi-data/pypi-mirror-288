...
# ---------------------------------------------------------------------------------------------------------------------------------------
	...
	def doAddApi(self):
		try:			
			...
			api1 = self.newApi("assistant-get", callback=self.onGet, input=EAssistantQuery, output=EAssistant )
			...
			api3 = self.newApi("assistant-query", callback=self.onQuery, input=EAssistantQuery, output=EAssistantMap )
