...
class RthFlag(Enum):
    PRE_RTH = 'PRE_RTH' # 盘前
    RTH = 'RTH' # 盘中
    POST_RTH = 'POST_RTH' # 盘后
    NIGHT = 'NIGHT' # 夜盘

class RthTime(Enum):
    # 美股时间
    US_EQUITY_PRE_RTH_START = time(4, 0, 0, 0)
    US_EQUITY_PRE_RTH_END = time(9, 30, 0, 0)
    US_EQUITY_RTH_START = time(9, 30, 0, 0)
    US_EQUITY_RTH_END = time(16, 0, 0, 0)
    US_EQUITY_POST_RTH_START = time(16, 0, 0, 0)
    US_EQUITY_POST_RTH_END = time(20, 0, 0, 0)
    US_EQUITY_NIGHT_START = time(20, 0, 0, 0)
    US_EQUITY_NIGHT_END = time(4, 0, 0, 0)
