...
class GenerativevalidationStartTestRequest(object):
    ...
    def __init__(self, url=None, http_headers=None, endpoint_payload_template=None, response_json_path=None, http_auth_integration_id=None, name=None, mutual_tls_integration_id=None, system_prompt=None, aws_integration_id=None, model_id=None, body=None, filters=None, workspace_id=None, agent_id=None):  # noqa: E501
