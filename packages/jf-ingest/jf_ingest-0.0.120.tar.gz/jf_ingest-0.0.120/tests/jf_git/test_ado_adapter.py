...
def test_get_users():
    ...
    with patch(
        ...
        for raw_user, standard_user in zip(raw_users, users):
...
def test_get_teams():
    ...
    with patch(
        ...
        for raw_team, standard_team in zip(raw_teams, teams):
            ...
            for raw_user, member in zip(raw_users, standard_team.members):
                assert raw_user['mailAddress'] == member.id
                assert raw_user['principalName'] == member.login
                assert raw_user['displayName'] == member.name
                assert raw_user['mailAddress'] == member.email
                assert raw_user['url'] == member.url
