...
def _create_pipeline_with_step(sdk: BaseCraftAiSdk, pipeline_name: str, step_name: str):
    ...
    return remove_keys_from_dict(sdk._post(url, json=body), {"is_archived"})
...
def create_pipeline(
    ...
    **kwargs,
    ...
    if response.status_code != 206:
        ...
        return remove_keys_from_dict(created_pipeline, {"is_archived"})
...
def get_pipeline(sdk: BaseCraftAiSdk, pipeline_name):
    ...
    return remove_keys_from_dict(pipeline, {"is_archived"})
