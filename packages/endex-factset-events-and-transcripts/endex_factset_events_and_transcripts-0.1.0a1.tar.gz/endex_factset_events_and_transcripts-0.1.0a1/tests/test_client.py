...
class TestEndexFactsetEventsAndTranscripts:
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_EVENTS_AND_TRANSCRIPTS_BASE_URL="http://localhost:5000/from/env"):
            client = EndexFactsetEventsAndTranscripts(access_token=access_token, _strict_response_validation=True)
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = EndexFactsetEventsAndTranscripts(
            base_url=base_url, access_token=access_token, _strict_response_validation=True
        )
...
class TestAsyncEndexFactsetEventsAndTranscripts:
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_EVENTS_AND_TRANSCRIPTS_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncEndexFactsetEventsAndTranscripts(access_token=access_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncEndexFactsetEventsAndTranscripts(
            base_url=base_url, access_token=access_token, _strict_response_validation=True
        )
