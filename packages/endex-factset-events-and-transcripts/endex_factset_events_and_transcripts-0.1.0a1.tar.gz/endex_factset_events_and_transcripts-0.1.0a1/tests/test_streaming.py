...
from endex_factset_events_and_transcripts._streaming import Stream, AsyncStream, ServerSentEvent


@pytest.mark.asyncio
@pytest.mark.parametrize("sync", [True, False], ids=["sync", "async"])
async def test_basic(
    sync: bool, client: EndexFactsetEventsAndTranscripts, async_client: AsyncEndexFactsetEventsAndTranscripts
) -> None:
...
async def test_special_new_line_character(
    ...
    async_client: AsyncEndexFactsetEventsAndTranscripts,
) -> None:
    def body() -> Iterator[bytes]:
