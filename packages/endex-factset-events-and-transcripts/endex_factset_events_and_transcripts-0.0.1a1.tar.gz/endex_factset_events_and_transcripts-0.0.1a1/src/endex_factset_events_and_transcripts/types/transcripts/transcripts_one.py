...
__all__ = ["TranscriptsOne", "Data", "Meta", "MetaPagination"]
...
class Data(BaseModel):
    ...
    search_id: Optional[str] = FieldInfo(alias="searchId", default=None)
    """Returns IDs used in the ids parameter.
    ...
    """
    Refers to either the date and time of the story, when it is available in
    workstation (in the specified timezone) or the date and time FactSet received it
    from the vendor.
    """
...
class TranscriptsOne(BaseModel):
