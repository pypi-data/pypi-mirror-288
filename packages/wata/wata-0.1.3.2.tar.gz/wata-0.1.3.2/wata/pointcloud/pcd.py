...
class PointCloudProcess:
    ...
    @staticmethod
    def show_pcd(path:str|Path, point_size:float=1, background_color:list=None, pcd_range:list=None, bin_num_features:int=None,
    ...
    @staticmethod
    def points_to_o3d_model(points:ndarray, point_colors:list|None=None):
        '''
    ...
    @staticmethod
    def save_o3d_camera_parameters(points:ndarray, save_file_path:str|Path='camera_parameters.json', window_size:list=[1200, 800]):
        '''
    ...
    @staticmethod
    def show_pcd_from_points(points:ndarray|list, point_size:float=1, background_color:list=None, colors:int|list=None, create_coordinate=True,
    ...
    @staticmethod
    def get_points(path:str, num_features:int|None=None):
        '''
        **功能描述**: 读取点云文件获取点
    ...
    @staticmethod
    def add_boxes(points:ndarray|list, gt_boxes:ndarray|None=None, gt_labels:list|None=None, pred_boxes:ndarray|None=None, pred_labels:list|None=None, pred_scores:list|None=None,
                  point_size:int=1,
                  background_color:list=None, create_plane:bool=False, point_colors:list|None=None, create_coordinate=True, type='open3d',
    ...
    @staticmethod
    def pcd2bin(pcd_dir:str|Path, bin_dir:str|Path, num_features=4):
        '''
        **功能描述**: pcd格式点云转bin格式  
    ...
    def move_pcd_with_xyzrpy(points:ndarray, xyz_rpy, degrees=False):
        '''
        **功能描述**: 用 dx, dy, dz, roll, pitch, yaw 旋转平移点云  
    ...
    @staticmethod
    def cartesian_to_spherical(points:ndarray):
        '''
        **功能描述**: 直角坐标系转笛卡尔坐标系  
