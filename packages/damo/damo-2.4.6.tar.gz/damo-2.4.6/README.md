...
![masim stairs heatmap in ascii](https://raw.githubusercontent.com/awslabs/damo/v2.4.6/images/masim_stairs_heatmap_ascii.png)
...
For more detailed usage, please refer to [USAGE.md](https://github.com/awslabs/damo/blob/v2.4.6/USAGE.md) file.
...
Why some features are not documented on [USAGE.md](https://github.com/awslabs/damo/blob/v2.4.6/USAGE.md) file?
------------------------------------------------------------------
