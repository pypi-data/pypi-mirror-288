...
from archon.utils import generate_with_references, inject_references_to_messages
...
class Fuser:
    ...
    def initialize_fuser(self):
        ...
        self.fuser = Model(config=self.config)
    ...
    def fuse(self, init_conv, contexts, critiques=None):
        ...
        if len(contexts) > 0:
            ...
            messages = inject_references_to_messages(messages, contexts, critiques)
