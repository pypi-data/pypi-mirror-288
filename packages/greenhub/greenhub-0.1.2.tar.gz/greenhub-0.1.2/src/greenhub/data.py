...
from .utilities.feature_data_renamings import vi_data_renaming, climate_data_renaming, soil_data_renaming, \
    forecast_data_renaming
from .initialize import get_fdc, get_user_api_key, initialize
...
def get_180d_forecast_data(
    ...
    By default, the forecast data is aggregated at the country level and on a monthly basis,
    but with the `spatial_resolution` parameter, one can choose between 'country', 'state', and 'municipality'
