...
class Client:
    ...
    def prepare_token_request(
        self, token_url, authorization_response=None, redirect_url=None, state=None, body='', **kwargs
    ):
    ...
    def prepare_refresh_body(self, body='', refresh_token=None, scope=None, **kwargs):
        ...
        return prepare_token_request(
            self.refresh_token_key, body=body, scope=scope, refresh_token=refresh_token, **kwargs
        )
    ...
    def _add_mac_token(
        self, uri, http_method='GET', body=None, headers=None, token_placement=AUTH_HEADER, ext=None, **kwargs
    ):
