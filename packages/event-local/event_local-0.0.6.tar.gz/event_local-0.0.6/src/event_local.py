...
class EventsLocal(GenericCRUDML, metaclass=MetaLogger, object=EVENTS_LOCAL_CODE_LOGGER_OBJECT):
    ...
    # TODO: test
    def select_all_events(self, lang_code_str: lang_code.LangCode, limit: int = None) -> list:
...
# Utilities 
    def merge_event_ml_entities(self, entity_id1: int, entity_id2: int, main_entity_ml_id: int):
        super().merge_ml_entities(entity_id1=entity_id1, entity_id2=entity_id2, main_entity_ml_id=main_entity_ml_id)

    def merge_event_entities(self, entity_id1: int, entity_id2: int,):
