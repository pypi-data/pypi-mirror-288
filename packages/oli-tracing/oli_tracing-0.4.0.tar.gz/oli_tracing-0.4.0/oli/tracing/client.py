...
class OliTracing:
    ...
    def __init__(self,
        ...
        self._session.base_url = self.endpoint_url
    ...
    def tracing_endpoint_url(self):
        return self.endpoint_url + "v1/traces"

    def is_available(self):
        response = self._session.get("/arize_phoenix_version")
    ...
    def setup_collector(self,
                        ...
                        use_batch_processor: bool = True) -> TracingCollector:
