...
from typing import Union, Tuple, TypedDict, TypeVar
...
ValueDict = TypedDict("ValueDict", {"type": str, "id": str}, total=True)
...
IntoValue = Union[bool, str, int, Value, ValueDict]
"""
...
IntoValuePattern = Union[IntoValue, ValueOfType, None, VariableValueDict]
