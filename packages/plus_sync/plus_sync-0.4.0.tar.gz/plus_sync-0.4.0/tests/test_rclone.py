...
def test_rclone(plus_sync_cmd, initialized, rclone_config, subjects_in_folder, lowercase):
    subjects, tmpdir_path = subjects_in_folder(3, 'testdata', lowercase=lowercase)
