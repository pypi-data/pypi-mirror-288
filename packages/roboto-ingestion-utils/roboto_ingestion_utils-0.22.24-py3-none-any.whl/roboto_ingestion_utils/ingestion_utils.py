...
from roboto.domain.actions import action
...
def setup_logger(logger_name: str, print_to_console: bool = True, print_to_file: bool = False):
    ...
    if print_to_file:
        ...
        output_dir = action_runtime.output_dir if action_runtime.output_dir else pathlib.Path.cwd()

        invocation_id = action_runtime.invocation_id if action_runtime.invocation_id else "local"
