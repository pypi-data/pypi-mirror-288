...
class Hierarchy(
    ...
    def dimension_default(self) -> bool:
        ...
        cube = check_named_object_defined(
            self._atoti_client._graphql_client.get_dimension_default_hierarchy_name(
                cube_name=self._cube_name,
    ...
    def _get_level_names(self, *, key: LevelName | None) -> list[LevelName]:
        ...
        if key is None:
            cube = check_named_object_defined(
                self._atoti_client._graphql_client.get_hierarchy_level_names(
                    cube_name=self._cube_name,
                    dimension_name=self.dimension,
        ...
        return [hierarchy.level.name] if hierarchy.level else []  # type: ignore[attr-defined]
    ...
    def slicing(self) -> bool:
        ...
        * A slicing hierarchy is not aggregable at the top level, meaning that it does not make sense to aggregate data across all members of the hierarchy.
        ...
        cube = check_named_object_defined(
            self._atoti_client._graphql_client.get_hierarchy_slicing(
                cube_name=self._cube_name,
                dimension_name=self.dimension,
                hierarchy_name=self.name,
            ).cube,
    ...
    def virtual(self) -> bool | None:
        ...
        cube = check_named_object_defined(
            self._atoti_client._graphql_client.get_hierarchy_virtual(
                cube_name=self._cube_name,
                dimension_name=self.dimension,
                hierarchy_name=self.name,
            ).cube,
    ...
    def visible(self) -> bool:
        ...
        cube = check_named_object_defined(
            self._atoti_client._graphql_client.get_hierarchy_visible(
                cube_name=self._cube_name,
                dimension_name=self.dimension,
                hierarchy_name=self.name,
            ).cube,
