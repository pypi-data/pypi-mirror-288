...
class AtotiClient:
    ...
    def __init__(self, *, activeviam_client: ActiveViamClient) -> None:
        ...
        self._graphql_client: Final = (
            ...
            if activeviam_client.has_atoti_python_api_endpoints
            else None
        )
    ...
    def has_gaq_service(self) -> bool:
        return self.activeviam_client.has_atoti_python_api_endpoints
