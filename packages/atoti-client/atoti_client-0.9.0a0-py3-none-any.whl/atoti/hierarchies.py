        ...
        *,
        ...
        if hierarchy_name is None:
            cube = check_named_object_defined(
                self._atoti_client._graphql_client.get_hierarchy_names(
        ...
        if dimension_name is None:
            cube = check_named_object_defined(  # type: ignore[assignment]
                (
                    self._atoti_client._graphql_client.get_hierarchy_name_across_dimensions(
                        cube_name=self._cube_name,
        ...
        cube = check_named_object_defined(  # type: ignore[assignment]
            (
                self._atoti_client._graphql_client.get_hierarchy_name(
                    cube_name=self._cube_name,
