...
def extract_div_contents_with_additional_columns(url, log_date):
    ...
    div_classes = ['boilerplate afd vfd xfd-closed', 'boilerplate afd vfd xfd-closed archived mw-archivedtalk','mw-content-ltr mw-parser-output']
    divs = []
