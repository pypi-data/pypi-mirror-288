...
class QuizPlugin(BasePlugin):
    ...
    def generate_quiz_html(self, quiz):
        ...
        quiz_html = f"<div class='quiz' id='quiz-{quiz_id}' data-show-refresh-button='{show_refresh_button}' data-show-indice-on-answer='{show_indice_on_answer}' data-show-score='{show_score}' data-score='0'>"
