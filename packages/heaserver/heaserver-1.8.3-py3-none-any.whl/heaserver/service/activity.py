...
class DesktopObjectActionLifecycle(AbstractAsyncContextManager[DesktopObjectAction]):
    ...
    def __init__(self, request: Request,
                 ...
                 activity_cb: Callable[[Application, DesktopObjectAction], Coroutine[Any, Any, None]] | None = None) -> None:
        """
        ...
        :param activity_cb: an async callable that publishes the action on the message queue. The context manager will
        generate IN_PROGRESS, SUCCEEDED, and FAILED statuses.
        ...
        self.__activity_cb_task: Task | None = None
    ...
    async def __aenter__(self) -> DesktopObjectAction:
        ...
        if self.__activity_cb:
            self.__activity_cb_task = create_task(self.__activity_cb(self.__request.app, self.__activity))
    ...
    async def __aexit__(self, exc_type: Type[BaseException] | None,
        ...
        if self.__activity_cb_task:
            if not self.__activity_cb_task.done():
