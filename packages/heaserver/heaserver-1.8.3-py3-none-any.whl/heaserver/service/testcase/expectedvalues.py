...
async def expected_one_wstl(fixtures: Mapping[str, List[DesktopObjectDict]] | Mapping[CollectionKey, List[DesktopObjectDict]],
                      coll: str | CollectionKey,
...
async def expected_one(fixtures: Mapping[str, List[DesktopObjectDict]] | Mapping[CollectionKey, List[DesktopObjectDict]],
                 coll: str | CollectionKey,
                 wstl_builder: wstl.RuntimeWeSTLDocumentBuilder,
                 context: PermissionContext,
...
async def expected_all_wstl(fixtures: Mapping[str, List[DesktopObjectDict]] | Mapping[CollectionKey, List[DesktopObjectDict]],
                      coll: str | CollectionKey,
                      wstl_builder: wstl.RuntimeWeSTLDocumentBuilder,
                      context: PermissionContext,
...
async def expected_all(fixtures: Mapping[str, List[DesktopObjectDict]] | Mapping[CollectionKey, List[DesktopObjectDict]],
                 coll: str | CollectionKey,
                 wstl_builder: wstl.RuntimeWeSTLDocumentBuilder,
                 context: PermissionContext,
