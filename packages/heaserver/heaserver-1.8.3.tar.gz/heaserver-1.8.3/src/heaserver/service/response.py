...
def status_generic(status: int, body: Optional[Union[bytes, str]] = None,
                   headers: Union[Mapping[Union[str, istr], str], CIMultiDict[str], CIMultiDictProxy[str], None] = None) -> web.Response:
    """
...
def status_generic_error(status: int, body: Optional[Union[bytes, str]] = None,
                         headers: Union[Mapping[Union[str, istr], str], CIMultiDict[str], CIMultiDictProxy[str], None] = None) -> web.HTTPError:
    """
...
async def get_multiple_choices(request: web.Request,
                               ...
                               permissions: Sequence[Sequence[Permission]] = None,
