...
class Ui_PresetAM2RChaos(object):
    def setupUi(self, PresetAM2RChaos):
        ...
        self.scroll_contents.setGeometry(QRect(0, 0, 497, 688))
        ...
        self.verticalLayout_2 = QVBoxLayout(self.gameplay_group)
        self.verticalLayout_2.setSpacing(6)
        self.verticalLayout_2.setContentsMargins(11, 11, 11, 11)
        self.verticalLayout_2.setObjectName(u"verticalLayout_2")
        self.label = QLabel(self.gameplay_group)
        self.label.setObjectName(u"label")
        self.label.setWordWrap(True)

        self.verticalLayout_2.addWidget(self.label)

        self.horizontally_flip_check = QCheckBox(self.gameplay_group)
        self.horizontally_flip_check.setObjectName(u"horizontally_flip_check")

        self.verticalLayout_2.addWidget(self.horizontally_flip_check)

        self.vertically_flip_check = QCheckBox(self.gameplay_group)
        self.vertically_flip_check.setObjectName(u"vertically_flip_check")

        self.verticalLayout_2.addWidget(self.vertically_flip_check)
    ...
    def retranslateUi(self, PresetAM2RChaos):
        ...
        self.gameplay_group.setTitle(QCoreApplication.translate("PresetAM2RChaos", u"Gameplay", None))
        self.label.setText(QCoreApplication.translate("PresetAM2RChaos", u"These flip the gameplay horizontally, to achieve a mirrored game effect, or vertically, to achieve an upside down effect. They can be combined together.", None))
        self.horizontally_flip_check.setText(QCoreApplication.translate("PresetAM2RChaos", u"Horizontally flip gameplay", None))
        self.vertically_flip_check.setText(QCoreApplication.translate("PresetAM2RChaos", u"Vertically flip gameplay", None))
