...
class get_HEE_coord:
    ...
    def plot3D(self):
        ...
        ax_3d.grid(False)
        ax_3d.set_xlim([-lim_plot, lim_plot])
        ax_3d.set_ylim([-lim_plot, lim_plot])
        ax_3d.set_zlim([-lim_plot, lim_plot])
        ...
        ax_3d.set_box_aspect([1, 1, 1])  # Ensure the aspect ratio is equal
        month_strings = {
