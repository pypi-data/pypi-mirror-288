# Endex Factset Fundamentals Python API library
...
These methods return an [`APIResponse`](https://github.com/EndexAI/factset-fundamentals-api-python/tree/main/src/endex_factset_fundamentals/_response.py) object.
