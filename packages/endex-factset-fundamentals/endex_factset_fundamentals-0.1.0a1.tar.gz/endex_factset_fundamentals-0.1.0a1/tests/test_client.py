...
from endex_factset_fundamentals import (
    EndexFactsetFundamentals,
    APIResponseValidationError,
    AsyncEndexFactsetFundamentals,
)
from endex_factset_fundamentals._models import BaseModel, FinalRequestOptions
from endex_factset_fundamentals._constants import RAW_RESPONSE_HEADER
from endex_factset_fundamentals._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from endex_factset_fundamentals._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: EndexFactsetFundamentals | AsyncEndexFactsetFundamentals) -> int:
...
class TestEndexFactsetFundamentals:
    client = EndexFactsetFundamentals(base_url=base_url, access_token=access_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "endex_factset_fundamentals/_legacy_response.py",
                        "endex_factset_fundamentals/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "endex_factset_fundamentals/_compat.py",
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = EndexFactsetFundamentals(
            base_url=base_url,
            access_token=access_token,
            _strict_response_validation=True,
            default_headers={
    ...
    def test_multipart_repeating_array(self, client: EndexFactsetFundamentals) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_FUNDAMENTALS_BASE_URL="http://localhost:5000/from/env"):
            client = EndexFactsetFundamentals(access_token=access_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: EndexFactsetFundamentals) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: EndexFactsetFundamentals) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: EndexFactsetFundamentals) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = EndexFactsetFundamentals(
            base_url=base_url, access_token=access_token, _strict_response_validation=True
        )
    ...
    @mock.patch("endex_factset_fundamentals._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
...
class TestAsyncEndexFactsetFundamentals:
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = AsyncEndexFactsetFundamentals(
            base_url=base_url,
            access_token=access_token,
            _strict_response_validation=True,
            default_headers={
    ...
    def test_multipart_repeating_array(self, async_client: AsyncEndexFactsetFundamentals) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_FUNDAMENTALS_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncEndexFactsetFundamentals(access_token=access_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncEndexFactsetFundamentals) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncEndexFactsetFundamentals) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncEndexFactsetFundamentals) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncEndexFactsetFundamentals(
            base_url=base_url, access_token=access_token, _strict_response_validation=True
        )
