...
class MotionApi:
    ...
    async def stream_move_to_trajectory_via_joint_ptp(self, cell: Annotated[str, Field(strict=True, description="Unique identifier addressing a cell in all API calls. Since the cell identifier is used as Kubernetes namespace, the following rules apply: * Contain only lowercase alphanumeric characters or '-'. * Start with an alphanumeric character. * End with an alphanumeric character. * A maximum length of 63 characters. * The identifier \"kube-system\", \"default\" and \"wandelbots\" are reserved and cannot be used. ")], motion: Annotated[StrictStr, Field(description="This represents the UUID of a motion. Every executable or partially executable motion is cached and an UUID is returned. Indicate the UUID to execute the motion or retrieve information on the motion.")], location_on_trajectory: Union[StrictFloat, StrictInt], limit_override_joint_velocity_limits: Annotated[Optional[List[Union[StrictFloat, StrictInt]]], Field(description="The joint velocity limits for the p2p motion to a previously planned motion.")] = None, limit_override_joint_acceleration_limits: Annotated[Optional[List[Union[StrictFloat, StrictInt]]], Field(description="The joint acceleration limits for the p2p motion to a previously planned motion.")] = None, limit_override_tcp_velocity_limit: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Maximum allowed TCP velocity in [mm/s].")] = None, limit_override_tcp_acceleration_limit: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Maximum allowed TCP acceleration in [mm/s^2].")] = None, limit_override_tcp_orientation_velocity_limit: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Maximum allowed TCP rotation velocity in [rad/s].")] = None, limit_override_tcp_orientation_acceleration_limit: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Maximum allowed TCP rotation acceleration in [rad/s^2].")] = None, responses_coordinate_system: Optional[StrictStr] = None) -> AsyncGenerator[StreamMoveResponse, None]:  # noqa: E501
        ...
        if locals().get("limit_override_joint_velocity_limits") is not None:
            url_schema = append_parameter_connector(url_schema)
            if isinstance(limit_override_joint_velocity_limits, list):
              url_schema += "&".join(["limit_override.joint_velocity_limits=" + s for s in limit_override_joint_velocity_limits])
            else:
              url_schema += "limit_override.joint_velocity_limits="+str(limit_override_joint_velocity_limits)
        if locals().get("limit_override_joint_acceleration_limits") is not None:
            url_schema = append_parameter_connector(url_schema)
            if isinstance(limit_override_joint_acceleration_limits, list):
              url_schema += "&".join(["limit_override.joint_acceleration_limits=" + s for s in limit_override_joint_acceleration_limits])
            else:
              url_schema += "limit_override.joint_acceleration_limits="+str(limit_override_joint_acceleration_limits)
