...
An example for Weber Fechner (for other stimuli and tutorials: [sweetBean](https://autoresearch.github.io/sweetbean/)) Here, we have a simple stimulus timeline:
