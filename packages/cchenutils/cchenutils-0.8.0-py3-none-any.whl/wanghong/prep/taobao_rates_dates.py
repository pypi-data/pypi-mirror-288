...
def main():
    ...
    # Adjust dates for default ratings
    ...
    for col, rdate in tqdm(rdates.items()):
        ...
        # seed(1)
        # dates[f'{col}_sr35'] = rdate.apply(lambda x: adj_date_by(x, -randint(3, 5)))
        # seed(1)
        # dates[f'{col}_sr15'] = rdate.apply(lambda x: adj_date_by(x, -randint(1, 5)))
