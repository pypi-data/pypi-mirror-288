...
class TestSecurityHolders:
    ...
    def test_method_create(self, client: EndexFactsetOwnership) -> None:
        security_holder = client.factset_ownership.v1.security_holders.create(
            ids=["FDS-US"],
        )
        assert_matches_type(SecurityHoldersResponse, security_holder, path=["response"])
    ...
    def test_raw_response_create(self, client: EndexFactsetOwnership) -> None:
        response = client.factset_ownership.v1.security_holders.with_raw_response.create(
            ids=["FDS-US"],
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        security_holder = response.parse()
        assert_matches_type(SecurityHoldersResponse, security_holder, path=["response"])

    @parametrize
    def test_streaming_response_create(self, client: EndexFactsetOwnership) -> None:
        with client.factset_ownership.v1.security_holders.with_streaming_response.create(
            ids=["FDS-US"],
        ) as response:
    ...
    def test_method_list(self, client: EndexFactsetOwnership) -> None:
        security_holder = client.factset_ownership.v1.security_holders.list(
            ids=["string"],
        )
        assert_matches_type(SecurityHoldersResponse, security_holder, path=["response"])
    ...
    def test_raw_response_list(self, client: EndexFactsetOwnership) -> None:
        response = client.factset_ownership.v1.security_holders.with_raw_response.list(
            ids=["string"],
        )
    ...
    def test_streaming_response_list(self, client: EndexFactsetOwnership) -> None:
        with client.factset_ownership.v1.security_holders.with_streaming_response.list(
            ids=["string"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncSecurityHolders:
    parametrize = pytest.mark.parametrize("async_client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    async def test_method_create(self, async_client: AsyncEndexFactsetOwnership) -> None:
        security_holder = await async_client.factset_ownership.v1.security_holders.create(
            ids=["FDS-US"],
        )
        assert_matches_type(SecurityHoldersResponse, security_holder, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncEndexFactsetOwnership) -> None:
        response = await async_client.factset_ownership.v1.security_holders.with_raw_response.create(
            ids=["FDS-US"],
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        security_holder = await response.parse()
        assert_matches_type(SecurityHoldersResponse, security_holder, path=["response"])

    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncEndexFactsetOwnership) -> None:
        async with async_client.factset_ownership.v1.security_holders.with_streaming_response.create(
            ids=["FDS-US"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list(self, async_client: AsyncEndexFactsetOwnership) -> None:
        security_holder = await async_client.factset_ownership.v1.security_holders.list(
            ids=["string"],
        )
        assert_matches_type(SecurityHoldersResponse, security_holder, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncEndexFactsetOwnership) -> None:
        response = await async_client.factset_ownership.v1.security_holders.with_raw_response.list(
            ids=["string"],
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncEndexFactsetOwnership) -> None:
        async with async_client.factset_ownership.v1.security_holders.with_streaming_response.list(
            ids=["string"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
