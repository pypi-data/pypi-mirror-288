...
from endex_factset_ownership import EndexFactsetOwnership, APIResponseValidationError, AsyncEndexFactsetOwnership
from endex_factset_ownership._models import BaseModel, FinalRequestOptions
from endex_factset_ownership._constants import RAW_RESPONSE_HEADER
from endex_factset_ownership._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from endex_factset_ownership._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: EndexFactsetOwnership | AsyncEndexFactsetOwnership) -> int:
...
class TestEndexFactsetOwnership:
    client = EndexFactsetOwnership(base_url=base_url, access_token=access_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "endex_factset_ownership/_legacy_response.py",
                        "endex_factset_ownership/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "endex_factset_ownership/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: EndexFactsetOwnership) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_OWNERSHIP_BASE_URL="http://localhost:5000/from/env"):
            client = EndexFactsetOwnership(access_token=access_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: EndexFactsetOwnership) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: EndexFactsetOwnership) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: EndexFactsetOwnership) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = EndexFactsetOwnership(
        ...
        client = EndexFactsetOwnership(base_url=base_url, access_token=access_token, _strict_response_validation=False)
    ...
    @mock.patch("endex_factset_ownership._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/factset-ownership/v1/fund-holdings").mock(
        ...
        with pytest.raises(APITimeoutError):
            self.client.post(
                ...
                body=cast(object, dict(ids=["VTI-US"])),
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/factset-ownership/v1/fund-holdings").mock(return_value=httpx.Response(500))
...
class TestAsyncEndexFactsetOwnership:
    client = AsyncEndexFactsetOwnership(base_url=base_url, access_token=access_token, _strict_response_validation=True)
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = AsyncEndexFactsetOwnership(
            base_url=base_url,
            access_token=access_token,
            _strict_response_validation=True,
            default_headers={
    ...
    def test_multipart_repeating_array(self, async_client: AsyncEndexFactsetOwnership) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_OWNERSHIP_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncEndexFactsetOwnership(access_token=access_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncEndexFactsetOwnership) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncEndexFactsetOwnership) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncEndexFactsetOwnership) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncEndexFactsetOwnership(
            base_url=base_url, access_token=access_token, _strict_response_validation=True
        )
