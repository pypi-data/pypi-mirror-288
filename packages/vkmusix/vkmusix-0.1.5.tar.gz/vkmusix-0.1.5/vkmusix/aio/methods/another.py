...
class Utils:
    async def APIReq(self, method: str, params: dict = {}) -> Union[dict, List[dict], bool, int]:
        """
        ...
        result = await client.APIReq(method="wall.post", params={"message": "Привет, мир!"})\n
        print(result)
        ...
        return await self._VKReq(method, params)
