...
class ClientAsync(_Init, _UtilsAsync, _SearchAsync, _GetAsync, _UpdateAsync):
    ...
    Пример использования:
        client = ClientAsync(VKToken="yourVKToken", RuCaptchaKey="yourRuCaptchaKey", errorsLanguage="ru", responseType="json", login="admin@VKMusic.ru", password="VKMusic.ru", cookieFilename="admin")
    ...
    async def _VKReq(self, method: str, params: dict = None) -> dict or None:
        if self._closed:
...
class Client(_Init, _Utils, _Search, _Get, _Update):
    ...
    Пример использования:
        client = ClientVKToken="yourVKToken", RuCaptchaKey="yourRuCaptchaKey", errorsLanguage="ru", responseType="json", login="admin@VKMusic.ru", password="VKMusic.ru", cookieFilename="admin")
    ...
    def _VKReq(self, method: str, params: dict = None) -> dict or None:
        if self._closed:
            self._raiseError("sessionClosed")
