...
class Stakings(BaseModel):
    ...
    unlock_time: Optional[StrictInt] = Field(default=None, description="The unlock time.")
    ...
    created_time: StrictInt = Field(description="The time when the stake was created.")
    updated_time: StrictInt = Field(description="The time when the stake was last updated.")
    validator_info: StakingsValidatorInfo
    __properties: ClassVar[List[str]] = ["id", "wallet_id", "address", "amounts", "initiator", "unlock_time", "unlock_block_height", "pool_id", "token_id", "pos_chain", "rewards_info", "created_time", "updated_time", "validator_info"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unlock_time": obj.get("unlock_time"),
