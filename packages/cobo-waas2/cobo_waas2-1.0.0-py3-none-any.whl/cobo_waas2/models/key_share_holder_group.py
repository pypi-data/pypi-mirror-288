...
class KeyShareHolderGroup(BaseModel):
    ...
    node_count: Optional[StrictInt] = Field(default=None, description="The number of key share holders in this key share holder group.")
    ...
    create_timestamp: Optional[StrictInt] = Field(default=None, description="The key share holder group's creation time in Unix timestamp format, measured in milliseconds.")
    __properties: ClassVar[List[str]] = ["key_share_holder_group_id", "type", "tss_key_share_groups", "key_share_holders", "node_count", "threshold", "status", "create_timestamp"]
