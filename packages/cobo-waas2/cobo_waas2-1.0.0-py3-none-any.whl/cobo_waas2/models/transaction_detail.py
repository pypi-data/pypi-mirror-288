...
class TransactionDetail(BaseModel):
    ...
    created_time: StrictInt = Field(description="The time when the transaction was created, in Unix timestamp format, measured in milliseconds.")
    updated_time: StrictInt = Field(description="The time when the transaction was updated, in Unix timestamp format, measured in milliseconds.")
    timeline: Optional[List[TransactionDetailAllOfTimeline]] = None
    __properties: ClassVar[List[str]] = ["transaction_id", "cobo_id", "request_id", "wallet_id", "type", "status", "sub_status", "failed_reason", "chain_id", "token_id", "asset_id", "source", "destination", "result", "fee", "initiator", "initiator_type", "confirmed_num", "confirming_threshold", "transaction_hash", "block_info", "raw_tx_info", "replacement", "category", "description", "is_loop", "created_time", "updated_time", "timeline"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timeline": [TransactionDetailAllOfTimeline.from_dict(_item) for _item in obj["timeline"]] if obj.get("timeline") is not None else None
        })
        return _obj
