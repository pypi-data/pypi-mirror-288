...
class Activity(BaseModel):
    ...
    created_time: Optional[StrictInt] = Field(default=None, description="The time when the activity was created.")
    updated_time: Optional[StrictInt] = Field(default=None, description="The time when the activity was last updated.")
    __properties: ClassVar[List[str]] = ["id", "initiator", "type", "wallet_id", "address", "pool_id", "token_id", "staking_id", "amount", "transaction_ids", "timeline", "fee", "status", "created_time", "updated_time"]
