...
class MPCProject(BaseModel):
    ...
    node_count: Optional[StrictInt] = Field(default=None, description="The number of key share holders in the project.")
    ...
    __properties: ClassVar[List[str]] = ["project_id", "org_id", "name", "node_count", "threshold", "create_timestamp"]
