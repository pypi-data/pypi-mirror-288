    ...
    def __init__(self, name, device, params, node_attr):
        ...
        for r in reductionDimension:
            self.minOps.append(fn._ReduceMin_(
                reductionDimension=r, dtype=dtype, output_zerop=output_zp, output_scale=output_scale))
...
class reduce_max(MediaComplexNode):
    ...
    def __init__(self, name, device, params, node_attr):
        ...
        for r in reductionDimension:
            self.maxOps.append(fn._ReduceMax_(reductionDimension=r, dtype=dtype, output_zerop=output_zp, output_scale=output_scale))
