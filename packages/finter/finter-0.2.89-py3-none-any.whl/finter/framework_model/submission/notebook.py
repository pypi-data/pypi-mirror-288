...
def name_exist(model_name):
    ...
    own_am_list = [am.split(".")[-1] for am in am_list if user_name in am]
...
class NotebookSubmissionHelper:
    ...
    def process(
        ...
        if submit:
            ...
            if name_exist(model_name):
                SubmissionUI.show_resubmit_dialog(
    ...
    def display(self):
        submission_ui = SubmissionUI(self)
        submission_ui.display_ui()
