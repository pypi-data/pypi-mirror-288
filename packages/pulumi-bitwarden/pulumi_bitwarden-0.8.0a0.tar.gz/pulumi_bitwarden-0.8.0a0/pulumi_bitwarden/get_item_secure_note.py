...
class GetItemSecureNoteResult:
    ...
    """
    def __init__(__self__, attachments=None, collection_ids=None, creation_date=None, deleted_date=None, favorite=None, fields=None, filter_collection_id=None, filter_folder_id=None, filter_organization_id=None, folder_id=None, id=None, name=None, notes=None, object=None, organization_id=None, reprompt=None, revision_date=None, search=None, type=None):
...
def get_item_secure_note(filter_collection_id: Optional[str] = None,
                         ...
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetItemSecureNoteResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('bitwarden:index/getItemSecureNote:getItemSecureNote', __args__, opts=opts, typ=GetItemSecureNoteResult).value
...
@_utilities.lift_output_func(get_item_secure_note)
def get_item_secure_note_output(filter_collection_id: Optional[pulumi.Input[Optional[str]]] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetItemSecureNoteResult]:
    """
    Use this data source to get information on an existing secure note item.
