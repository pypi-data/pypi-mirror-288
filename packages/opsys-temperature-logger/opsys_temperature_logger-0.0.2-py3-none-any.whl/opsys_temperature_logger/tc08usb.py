...
class TC08USB(object):
    ...
    def get_single(self):
        return(self._dll.usb_tc08_get_single(self._handle, self._temp.ctypes.data_as(ctypes.POINTER(ctypes.c_float)), self._overflow_flags.ctypes.data_as(ctypes.POINTER(ctypes.c_float)), self._units.value))
