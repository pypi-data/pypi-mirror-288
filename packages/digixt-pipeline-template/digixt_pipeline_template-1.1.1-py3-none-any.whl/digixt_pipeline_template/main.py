...
def main():
    ...
    try:
        ...
        ProjectStructureGenerator.update_template_script(project_name=project_name)
        configs, full_config_file_path = ProjectStructureGenerator.read_config_file(project_name)
        configs = ProjectStructureGenerator.update_template_config(configs, full_config_file_path, project_name)
