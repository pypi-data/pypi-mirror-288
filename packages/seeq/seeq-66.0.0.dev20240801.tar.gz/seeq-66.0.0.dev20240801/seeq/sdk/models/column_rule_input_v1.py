...
class ColumnRuleInputV1(object):
    ...
    def __init__(self, ancestor=None, asset_creator=None, concat_columns=None, constant=None, descendant=None, event_property=None, formula_creator=None, item_property=None, item_search=None, path=None, path_search=None, set_item_property=None, text_extractor=None, text_replacement=None, tree_path_creator=None):
        """
