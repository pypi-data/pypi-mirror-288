...
from infomark_core.app.static.container import Container

from infomark_cli.argparse_translator.argparse_translator import ArgparseTranslator
from infomark_cli.argparse_translator.reference_processor import (
...
class ArgparseClassProcessor:
    ...
    # reference variable used to create custom groups for the ArgparseTranslators
